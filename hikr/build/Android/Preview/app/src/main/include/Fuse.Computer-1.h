// This file was generated based on C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Marshal/1.4.0/Computer.uno.
...
struct Computer1_type : ::g::Fuse::Computer_type
{
    ...
    void(*fp_GreaterOrEqual1)(::g::Fuse::Computer1*, void*, void*, bool*);
    void(*fp_GreaterThan1)(::g::Fuse::Computer1*, void*, void*, bool*);
    void(*fp_LessOrEqual1)(::g::Fuse::Computer1*, void*, void*, bool*);
    void(*fp_LessThan1)(::g::Fuse::Computer1*, void*, void*, bool*);
    void(*fp_Max1)(::g::Fuse::Computer1*, void*, void*, uTRef);
    void(*fp_Min1)(::g::Fuse::Computer1*, void*, void*, uTRef);
...
struct Computer1 : ::g::Fuse::Computer
{
    ...
    template<class T>
    bool GreaterOrEqual1(T a, T b) { bool __retval; return (((Computer1_type*)__type)->fp_GreaterOrEqual1)(this, uConstrain(__type->GetBase(Computer1_typeof())->T(0), a), uConstrain(__type->GetBase(Computer1_typeof())->T(0), b), &__retval), __retval; }
    void GreaterOrEqual1_ex(void* a, void* b, bool* __retval) { (((Computer1_type*)__type)->fp_GreaterOrEqual1)(this, a, b, __retval); }
    template<class T>
    ...
    template<class T>
    bool LessOrEqual1(T a, T b) { bool __retval; return (((Computer1_type*)__type)->fp_LessOrEqual1)(this, uConstrain(__type->GetBase(Computer1_typeof())->T(0), a), uConstrain(__type->GetBase(Computer1_typeof())->T(0), b), &__retval), __retval; }
    void LessOrEqual1_ex(void* a, void* b, bool* __retval) { (((Computer1_type*)__type)->fp_LessOrEqual1)(this, a, b, __retval); }
    template<class T>
    ...
    template<class T>
    T Max1(T a, T b) { T __retval; return (((Computer1_type*)__type)->fp_Max1)(this, uConstrain(__type->GetBase(Computer1_typeof())->T(0), a), uConstrain(__type->GetBase(Computer1_typeof())->T(0), b), &__retval), __retval; }
    void Max1_ex(void* a, void* b, uTRef __retval) { (((Computer1_type*)__type)->fp_Max1)(this, a, b, __retval); }
    template<class T>
    T Min1(T a, T b) { T __retval; return (((Computer1_type*)__type)->fp_Min1)(this, uConstrain(__type->GetBase(Computer1_typeof())->T(0), a), uConstrain(__type->GetBase(Computer1_typeof())->T(0), b), &__retval), __retval; }
    void Min1_ex(void* a, void* b, uTRef __retval) { (((Computer1_type*)__type)->fp_Min1)(this, a, b, __retval); }
    template<class T>
    ...
    template<class T>
    static bool GreaterOrEqual1(Computer1* __this, T a, T b) { bool __retval; return Computer1__GreaterOrEqual1_fn(__this, uConstrain(__this->__type->GetBase(Computer1_typeof())->T(0), a), uConstrain(__this->__type->GetBase(Computer1_typeof())->T(0), b), &__retval), __retval; }
    template<class T>
    ...
    template<class T>
    static bool LessOrEqual1(Computer1* __this, T a, T b) { bool __retval; return Computer1__LessOrEqual1_fn(__this, uConstrain(__this->__type->GetBase(Computer1_typeof())->T(0), a), uConstrain(__this->__type->GetBase(Computer1_typeof())->T(0), b), &__retval), __retval; }
    template<class T>
    ...
    template<class T>
    static T Max1(Computer1* __this, T a, T b) { T __retval; return Computer1__Max1_fn(__this, uConstrain(__this->__type->GetBase(Computer1_typeof())->T(0), a), uConstrain(__this->__type->GetBase(Computer1_typeof())->T(0), b), &__retval), __retval; }
    template<class T>
    static T Min1(Computer1* __this, T a, T b) { T __retval; return Computer1__Min1_fn(__this, uConstrain(__this->__type->GetBase(Computer1_typeof())->T(0), a), uConstrain(__this->__type->GetBase(Computer1_typeof())->T(0), b), &__retval), __retval; }
    template<class T>
