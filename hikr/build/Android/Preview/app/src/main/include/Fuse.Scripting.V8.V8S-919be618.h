// This file was generated based on C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Scripting.JavaScript/1.4.0/V8/V8SimpleExtensions.uno.
...
struct V8SimpleExtensions : uObject
{
    ...
    static int Length1(::JSString* str, ::JSContext* context);
    ...
    static void Retain1(::JSScriptException* jse, ::JSContext* context);
    static ::JSValue* Retain2(::JSValue* value, ::JSContext* context);
    static void SetDebugMessageHandler(::JSContext* context, uDelegate* messageHandler);
    ...
    static bool StrictEquals(::JSValue* value, ::JSContext* context, ::JSValue* that);
