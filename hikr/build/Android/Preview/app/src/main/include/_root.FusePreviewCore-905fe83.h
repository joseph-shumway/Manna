...
namespace g{struct FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_ModalDialog_Header;}
...
struct FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_ModalDialog_Header : ::g::Uno::UX::PropertyAccessor
{
    ...
    void ctor_1();
    static FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_ModalDialog_Header* New1();
};
// }
