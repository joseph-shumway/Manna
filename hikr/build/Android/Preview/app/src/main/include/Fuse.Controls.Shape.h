// This file was generated based on C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Controls.Primitives/1.4.0/Shapes/Shape.Resources.uno.
...
void Shape__get_StrokeAlignment_fn(Shape* __this, int* __retval);
void Shape__set_StrokeAlignment_fn(Shape* __this, int* value);
...
struct Shape : ::g::Fuse::Controls::LayoutControl
{
    ...
    int StrokeAlignment();
    void StrokeAlignment(int value);
