// This file was generated based on C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Motion/1.4.0/Simulation/BoundedRegion2D.uno.
...
struct BoundedRegion2D
{
    ...
    void(*fp_get_IsDestination)(uObject*, bool*);
    ...
    static bool IsDestination(const uInterface& __this) { bool __retval; return __this.VTable<BoundedRegion2D>()->fp_get_IsDestination(__this, &__retval), __retval; }
