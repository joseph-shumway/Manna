// This file was generated based on C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Controls.Primitives/1.4.0/RangeControls/RangeControl.uno.
...
struct RangeControl_type : ::g::Fuse::Controls::Panel_type
{
    ...
    ::g::Fuse::Controls::Native::IRangeViewHost interface20;
};
...
void RangeControl__get_EffectiveMaximum_fn(RangeControl* __this, double* __retval);
void RangeControl__get_EffectiveMinimum_fn(RangeControl* __this, double* __retval);
...
struct RangeControl : ::g::Fuse::Controls::Panel
{
    ...
    static ::g::Uno::UX::Selector& _relativeValueName() { return _relativeValueName_; }
    double _userStep;
