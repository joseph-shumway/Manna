// This file was generated based on C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Outracks.Simulator.Common.Uno/0.0.0/Bytecode/Literal.cs.
...
struct Literal_type : ::g::Outracks::Simulator::Bytecode::Expression_type
{
    ...
    void(*fp_WriteLiteral)(::g::Outracks::Simulator::Bytecode::Literal*, ::g::System::IO::BinaryWriter*);
};
...
struct Literal : ::g::Outracks::Simulator::Bytecode::Expression
{
    ...
    void WriteLiteral(::g::System::IO::BinaryWriter* writer) { (((Literal_type*)__type)->fp_WriteLiteral)(this, writer); }
    static Literal* Read2(::g::System::IO::BinaryReader* reader);
    static void Write2(Literal* literal, ::g::System::IO::BinaryWriter* writer);
};
// }
