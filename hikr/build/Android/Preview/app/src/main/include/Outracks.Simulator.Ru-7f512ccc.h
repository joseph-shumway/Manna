// This file was generated based on C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Outracks.Simulator.Common.Uno/0.0.0/Runtime/ObjectTagRegistry.cs.
...
struct ObjectTagRegistry : uObject
{
    ...
    static int& _visualId() { return _visualId_; }
    static uSStrong< ::g::Uno::Collections::Dictionary*> _tagToObjects_;
    static uSStrong< ::g::Uno::Collections::Dictionary*>& _tagToObjects() { return _tagToObjects_; }
    static uSStrong< ::g::Uno::Collections::Dictionary*> ObjectToTag_;
    static uSStrong< ::g::Uno::Collections::Dictionary*>& ObjectToTag() { return ObjectToTag_; }
    static uSStrong< ::g::Uno::Collections::List*> _eaches_;
    static uSStrong< ::g::Uno::Collections::List*>& _eaches() { return _eaches_; }
    static uSStrong<uDelegate*> OnObjectTagRegistered1_;
    static uSStrong<uDelegate*>& OnObjectTagRegistered1() { return OnObjectTagRegistered1_; }
