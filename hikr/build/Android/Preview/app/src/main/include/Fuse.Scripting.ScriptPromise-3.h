// This file was generated based on C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Scripting/1.4.0/ScriptClass.uno.
...
struct ScriptPromise : ::g::Fuse::Scripting::ScriptMethod
{
    ...
    void ctor_2(uString* name, int thread, uDelegate* futureFactory, uDelegate* resultConverter);
    ...
    static ScriptPromise* New1(uType* __type, uString* name, int thread, uDelegate* futureFactory, uDelegate* resultConverter);
};
// }
