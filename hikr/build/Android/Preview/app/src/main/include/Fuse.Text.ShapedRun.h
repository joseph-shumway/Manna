// This file was generated based on C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Text/1.4.0/ShapedRun.uno.
...
struct ShapedRun : uObject
{
    ...
    int _lineBreakClusterOffset;
    ::g::Uno::Float2 _measureCache;

    void ctor_(::g::Fuse::Text::Bidirectional::Run run, uArray* parent);
    void ctor_1(::g::Fuse::Text::Bidirectional::Run run, uArray* parent, int start, int count, int clusterOffset, ::g::Fuse::Text::Implementation::BitArray* lineBreakClusters, int lineBreakClusterOffset);
    void CacheLineBreaks();
    bool CanLineBreak(int cluster);
    ...
    static ShapedRun* New2(::g::Fuse::Text::Bidirectional::Run run, uArray* parent, int start, int count, int clusterOffset, ::g::Fuse::Text::Implementation::BitArray* lineBreakClusters, int lineBreakClusterOffset);
};
// }
