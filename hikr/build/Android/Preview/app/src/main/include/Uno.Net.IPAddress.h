// This file was generated based on C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Uno.Net.Sockets/1.4.3/IPAddress.uno.
...
struct IPAddress : uObject
{
    ...
    static uSStrong<IPAddress*>& Any() { return Any_; }
    static uSStrong<IPAddress*> Broadcast_;
    static uSStrong<IPAddress*>& Broadcast() { return Broadcast_; }
    static uSStrong<IPAddress*> Loopback_;
    static uSStrong<IPAddress*>& Loopback() { return Loopback_; }
    static uSStrong<IPAddress*> IPv6Any_;
    static uSStrong<IPAddress*>& IPv6Any() { return IPv6Any_; }
    static uSStrong<IPAddress*> IPv6Loopback_;
    static uSStrong<IPAddress*>& IPv6Loopback() { return IPv6Loopback_; }
    static uSStrong<IPAddress*> IPv6None_;
    static uSStrong<IPAddress*>& IPv6None() { return IPv6None_; }
