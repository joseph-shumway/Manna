// This file was generated based on C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Outracks.Simulator.Common.Uno/0.0.0/Runtime/Reflection/ReflectionExtensions.cs.
...
namespace g{namespace Outracks{namespace Simulator{namespace Runtime{struct ReflectionExtensions;}}}}
...
struct ReflectionExtensions : uObject
{
    ...
    static uSStrong<uString*>& PropGetPrefix() { return PropGetPrefix_; }
    static uSStrong<uString*> PropSetPrefix_;
    static uSStrong<uString*>& PropSetPrefix() { return PropSetPrefix_; }
    static uSStrong<uString*> EventAdderPrefix_;
    static uSStrong<uString*>& EventAdderPrefix() { return EventAdderPrefix_; }
    static uSStrong<uString*> EventRemovePrefix_;
    static uSStrong<uString*>& EventRemovePrefix() { return EventRemovePrefix_; }
    static uSStrong< ::g::Outracks::Simulator::Bytecode::TypeMemberName*> ConstructorName_;
    static uSStrong< ::g::Outracks::Simulator::Bytecode::TypeMemberName*>& ConstructorName() { return ConstructorName_; }
