// This file was generated based on C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Outracks.Simulator.Common.Uno/0.0.0/Runtime/Scope.cs.
...
struct Environment : uObject
{
    ...
    uTField _parent() { return __type->Field(this, 1); }

    void ctor_(::g::Outracks::Optional1<uStrong<Environment*> > parent);
    ...
    static Environment* New1(::g::Outracks::Optional1<uStrong<Environment*> > parent);
};
// }
