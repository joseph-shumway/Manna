// This file was generated based on C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Preview.Core/0.1.0/ModalDialog.uno.
...
namespace g{namespace Outracks{namespace Simulator{namespace Client{struct ModalDialog;}}}}
...
struct ModalDialog : uObject
{
    ...
    static void Show(::g::Outracks::Simulator::Client::FakeApp* app, uString* header, uString* body, uString* details, uObject* buttons);
    static void ShowPrompt(::g::Outracks::Simulator::Client::FakeApp* app, uString* header, uString* body, ::g::Fuse::Controls::Control* inputControl, uObject* buttons);
};
// }
