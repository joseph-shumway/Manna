// This file was generated based on C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Reactive.Expressions/1.4.0/BinaryOperator.uno.
...
struct BinaryOperator_type : ::g::Fuse::Reactive::Expression_type
{
    ...
    void(*fp_OnNewOperands)(::g::Fuse::Reactive::BinaryOperator*, uObject*, uObject*, uObject*);
};
...
struct BinaryOperator : ::g::Fuse::Reactive::Expression
{
    ...
    void OnNewOperands(uObject* listener, uObject* left, uObject* right) { (((BinaryOperator_type*)__type)->fp_OnNewOperands)(this, listener, left, right); }
    ...
    static void OnNewOperands(BinaryOperator* __this, uObject* listener, uObject* left, uObject* right) { BinaryOperator__OnNewOperands_fn(__this, listener, left, right); }
