...
namespace g{struct FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_ModalDialog_Body;}
...
struct FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_ModalDialog_Body : ::g::Uno::UX::PropertyAccessor
{
    ...
    void ctor_1();
    static FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_ModalDialog_Body* New1();
};
// }
