// This file was generated based on C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Elements/1.4.0/AspectBoxSizing.uno.
...
struct Element : ::g::Fuse::Visual
{
    ...
    ::g::Uno::UX::Size2 ExplicitTransformOrigin();
    void ExplicitTransformOrigin(::g::Uno::UX::Size2 value);
    ...
    ::g::Uno::Float2 GetLayoutPositionIn(::g::Fuse::Visual* target);
    ...
    bool HasEffects();
    bool HasLayoutIn(::g::Fuse::Visual* target);
    ...
    void RequestLayout();
    ::g::Uno::Collections::List* RootedListeners();
    void SetExplicitTransformOrigin(::g::Uno::UX::Size2 value, uObject* origin);
    ...
    ::g::Uno::Collections::List* UnrootedListeners();
    int Visibility();
    ...
    static uObject* VisualAppearedFactory(uObject* obj, uDelegate* handler);
    static uObject* VisualBoundsChangedFactory(uObject* obj, uDelegate* handler);
    static uObject* VisualDisappearedFactory(uObject* obj, uDelegate* handler);
    static uObject* VisualTransformChangedFactory(uObject* obj, uDelegate* handler);
