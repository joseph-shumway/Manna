...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Graphics\Enums.uno
// ---------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Graphics\DeviceBuffer.uno
// ----------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Graphics\FormatHelpers.uno
// -----------------------------------------------------------------------------------------------------
...
// public static int GetStrideInBytes(Uno.Graphics.Format format) :8
void FormatHelpers__GetStrideInBytes_fn(int* format, int* __retval)
{
    *__retval = FormatHelpers::GetStrideInBytes(*format);
}

// public static int GetStrideInBytes(Uno.Graphics.Format format) [static] :8
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Graphics\Framebuffer.uno
// ---------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Graphics\IndexBuffer.uno
// ---------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Graphics\RenderTarget.uno
// ----------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Graphics\SamplerState.uno
// ----------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Graphics\Texture2D.uno
// -------------------------------------------------------------------------------------------------
...
static void Texture2D_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("C:/Users/Shumcom/AppData/Local/Fusetools/Packages/UnoCore/1.4.3/Source/Uno/Graphics/Texture2D.uno");
...
// public void GenerateMipmap() :330
...
// public bool get_SupportsMipmap() :327
...
// public void GenerateMipmap() [instance] :330
...
// public bool get_SupportsMipmap() [instance] :327
    ...
    if (::g::Uno::String::StartsWith(uPtr(versionString), ::STRINGS[4/*"OpenGL ES "*/]))
    {
        ...
        catch (const uThrowable& __t)
        {
            if (uIs(__t.Exception, ::TYPES[1/*Uno.FormatException*/]))
            {
                ...
                ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[5/*"**** Invali...*/], versionString), 0, ::STRINGS[6/*"C:/Users/Sh...*/], 114);
            }
            else             throw __t;
        }
    }
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Graphics\TextureCube.uno
// ---------------------------------------------------------------------------------------------------

// public intrinsic sealed class TextureCube :14
// {
...
// public generated extern OpenGL.GLTextureHandle get_GLTextureHandle() [instance] :117
uint32_t TextureCube::GLTextureHandle()
{
    return _GLTextureHandle;
}

// private generated extern void set_GLTextureHandle(OpenGL.GLTextureHandle value) [instance] :118
void TextureCube::GLTextureHandle(uint32_t value)
{
    _GLTextureHandle = value;
}

// public generated bool get_IsDisposed() [instance] :147
bool TextureCube::IsDisposed()
{
    return _IsDisposed;
}

// private generated void set_IsDisposed(bool value) [instance] :148
void TextureCube::IsDisposed(bool value)
{
    _IsDisposed = value;
}

// public generated int get_Size() [instance] :99
int TextureCube::Size()
{
    return _Size;
}

// private generated void set_Size(int value) [instance] :100
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Graphics\TextureHelpers.uno
// ------------------------------------------------------------------------------------------------------
...
// public static int2 GetMipSize(textureCube texture, int mip) :27
...
// public static int2 GetMipSize(textureCube texture, int mip) [static] :27
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Graphics\VertexAttributeInfo.uno
// -----------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Graphics\VertexBuffer.uno
// ----------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Graphics\VideoTexture.uno
// ----------------------------------------------------------------------------------------------------
