...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Targets\Android\Uno\Base\Wrappers.uno
// -----------------------------------------------------------------------------------------------------
...
static void JWrapper_build(uType* type)
{
    ...
    type->Reflection.SetFields(2,
        new uField("_javaObject", 2),
        new uField("_subclassed", 3));
