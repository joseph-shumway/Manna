...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.Video\1.4.0\IVideoPlayer.uno
// --------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.Video\1.4.0\VideoContainer.uno
// ----------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.Video\1.4.0\VideoVisual.uno
// -------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.Video\1.4.0\VideoDiskCache.uno
// ----------------------------------------------------------------------------------------------
...
static void VideoDiskCache_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Controls.Video/1.4.0/VideoDiskCache.uno");
...
{
    uStackFrame __("Fuse.Controls.VideoImpl.VideoDiskCache", "OnTerminating(Fuse.Platform.ApplicationState)");
    VideoDiskCache_typeof()->Init();
    ...
    {
        {
            while (enum1.MoveNext(::TYPES[15/*Uno.Collections.Dictionary<string, string>.Enumerator*/]))
            {
                ...
                {
                    ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[2/*"Deleting te...*/], pair.Value(::TYPES[16/*Uno.Collections.KeyValuePair<string, string>*/])), 0, ::STRINGS[3/*"C:/Users/Sh...*/], 29);
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.Video\1.4.0\VideoLoader.uno
// -------------------------------------------------------------------------------------------
...
VideoVisual_type* VideoVisual_typeof()
{
    ...
    type->interface13.fp_get_Volume = (void(*)(uObject*, float*))VideoVisual__FuseTriggersIMediaPlaybackget_Volume_fn;
    type->interface13.fp_set_Volume = (void(*)(uObject*, float*))VideoVisual__FuseTriggersIMediaPlaybackset_Volume_fn;
    ...
    type->interface14.fp_get_CanPlayTo = (void(*)(uObject*, bool*))VideoVisual__FuseTriggersIPlaybackget_CanPlayTo_fn;
    ...
    type->interface14.fp_get_CanStop = (void(*)(uObject*, bool*))VideoVisual__FuseTriggersIPlaybackget_CanStop_fn;
    type->interface14.fp_get_CanPause = (void(*)(uObject*, bool*))VideoVisual__FuseTriggersIPlaybackget_CanPause_fn;
    type->interface14.fp_get_CanResume = (void(*)(uObject*, bool*))VideoVisual__FuseTriggersIPlaybackget_CanResume_fn;
...
void VideoVisual__FuseControlsVideoImplIVideoCallbacksOnError_fn(VideoVisual* __this, ::g::Uno::Exception* e)
{
    ...
    ::g::Fuse::Diagnostics::UnknownException(uString::Const("Video error"), e, __this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Video\\1.4.0\\VideoVisual.uno"), 116, uString::Const("Fuse.Controls.VideoImpl.IVideoCallbacks.OnError"));
}
...
// private float Fuse.Triggers.IMediaPlayback.get_Volume() :161
...
// private void Fuse.Triggers.IMediaPlayback.set_Volume(float value) :162
void VideoVisual__FuseTriggersIMediaPlaybackset_Volume_fn(VideoVisual* __this, float* value)
{
    ...
    float value_ = *value;
    ::g::Fuse::Controls::VideoImpl::IVideoService::Volume(uInterface(uPtr(__this->_videoService), ::g::Fuse::Controls::VideoImpl::IVideoService_typeof()), __this->_volume = value_);
}

// private bool Fuse.Triggers.IPlayback.get_CanPause() :226
void VideoVisual__FuseTriggersIPlaybackget_CanPause_fn(VideoVisual* __this, bool* __retval)
{
    return *__retval = true, void();
}

// private bool Fuse.Triggers.IPlayback.get_CanPlayTo() :189
void VideoVisual__FuseTriggersIPlaybackget_CanPlayTo_fn(VideoVisual* __this, bool* __retval)
{
    return *__retval = false, void();
}

// private bool Fuse.Triggers.IPlayback.get_CanResume() :227
void VideoVisual__FuseTriggersIPlaybackget_CanResume_fn(VideoVisual* __this, bool* __retval)
{
    return *__retval = true, void();
}

// private bool Fuse.Triggers.IPlayback.get_CanStop() :225
...
{
    ::g::Fuse::Diagnostics::Unsupported(uString::Const("IPlayback.PlayTo(double) not supported in Fuse.Controls.Video"), __this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Video\\1.4.0\\VideoVisual.uno"), 186, uString::Const("Fuse.Triggers.IPlayback.PlayTo"));
}
