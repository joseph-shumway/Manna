...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Time\Calendars\Era.uno
// -------------------------------------------------------------------------------------------------
...
static void Era_build(uType* type)
{
    ...
    type->Reflection.SetFields(6,
        new uField("AnnoHegirae", 4),
        new uField("AnnoMartyrum", 3),
        new uField("AnnoMundi", 5),
        new uField("AnnoPersico", 6),
        new uField("BeforeCommon", 2),
        new uField("Common", 1));
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Time\Calendars\GregorianYearMonthDayCalculator.uno
// -----------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Time\Calendars\TimeOfDayCalculator.uno
// -----------------------------------------------------------------------------------------------------------------
...
// internal static int GetMillisecondOfSecond(Uno.Time.Instant instant) :62
...
// internal static int GetMillisecondOfSecondFromTickOfDay(long tickOfDay) :125
...
// internal static long GetTicks(int hourOfDay, int minuteOfHour, int secondOfMinute) :13
...
// internal static long GetTicks(int hourOfDay, int minuteOfHour, int secondOfMinute, int millisecondOfSecond, int tickOfMillisecond) :23
...
// internal static int GetMillisecondOfSecond(Uno.Time.Instant instant) [static] :62
...
// internal static int GetMillisecondOfSecondFromTickOfDay(long tickOfDay) [static] :125
...
// internal static long GetTicks(int hourOfDay, int minuteOfHour, int secondOfMinute) [static] :13
...
// internal static long GetTicks(int hourOfDay, int minuteOfHour, int secondOfMinute, int millisecondOfSecond, int tickOfMillisecond) [static] :23
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Time\Calendars\WeekYearCalculator.uno
// ----------------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Time\Calendars\YearMonthDayCalculator.uno
// --------------------------------------------------------------------------------------------------------------------
