...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.4.0\Internal\Swiper.uno
// -----------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.4.0\Internal\EdgeSwiper.uno
// ---------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Gestures\1.4.0\Internal\TwoFinger.uno
// --------------------------------------------------------------------------------------------
...
static void Swiper_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Gestures\\1.4.0\\Internal\\Swiper.uno");
...
void Swiper__FuseInputIGestureOnCaptureChanged_fn(Swiper* __this, ::g::Fuse::Input::PointerEventArgs* args, int* how, int* prev)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[3/*"invalid OnC...*/], NULL, ::STRINGS[1/*"C:\\Users\\...*/], 472, ::STRINGS[4/*"Fuse.Input....*/]);
        return;
    }
...
void Swiper::CheckNeedUpdated(bool off)
{
    ...
    for (int i = 0; i < uPtr(_regions)->Count(); ++i)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[0/*"incomplete ...*/], this, ::STRINGS[1/*"C:\\Users\\...*/], 380, ::STRINGS[2/*"CheckNeedUp...*/]);
...
bool SwipeRegion::SetProgress(double value, int flags)
{
    ...
    if (endProgress)
    {
        if (::g::Uno::Math::Abs(_progress) < 9.9999997473787516e-06)
            ...
            ::g::Fuse::Diagnostics::InternalError(uString::Const("Unexpected progress in swipe"), this, ::STRINGS[1/*"C:\\Users\\...*/], 104, uString::Const("SetProgress"));
...
TwoFinger_type* TwoFinger_typeof()
{
    ...
    type->interface0.fp_OnPointerPressed = (void(*)(uObject*, ::g::Fuse::Input::PointerPressedArgs*, int*))TwoFinger__FuseInputIGestureOnPointerPressed_fn;
    type->interface0.fp_OnCaptureChanged = (void(*)(uObject*, ::g::Fuse::Input::PointerEventArgs*, int*, int*))TwoFinger__FuseInputIGestureOnCaptureChanged_fn;
    type->interface0.fp_OnPointerMoved = (void(*)(uObject*, ::g::Fuse::Input::PointerMovedArgs*, int*))TwoFinger__FuseInputIGestureOnPointerMoved_fn;
    type->interface0.fp_OnPointerReleased = (void(*)(uObject*, ::g::Fuse::Input::PointerReleasedArgs*, int*))TwoFinger__FuseInputIGestureOnPointerReleased_fn;
