...
#include <Fuse.Text.Renderer.Sh-a6043932.h>
#include <Fuse.Text.Shape.h>
#include <Fuse.Text.ShapedRun.h>
#include <Fuse.Text.ShapedRun.P-e637870f.h>
#include <Fuse.Text.SinglyLinkedList-1.h>
#include <Fuse.Text.SinglyLinke-e800ada7.h>
#include <Fuse.Text.Substring.C-c0d90a03.h>
#include <Fuse.Text.Substring.h>
#include <Fuse.Text.Substring.L-d8b23475.h>
#include <Fuse.Text.Substring.L-e98a159b.h>
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\Renderer.uno
// ------------------------------------------------------------------------------
...
static void Batch_build(uType* type)
{
    type->SetDependencies(
        ::g::Fuse::Text::Renderer__SharedIndexBuffer_typeof());
    type->SetInterfaces(
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\Substring.uno
// -------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\Implementation\SinglyLinkedList.uno
// -----------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\Fallback.uno
// ------------------------------------------------------------------------------
...
static void FallingBackFont_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Text/1.4.0/Fallback.uno");
    ...
    type->SetDependencies(
        ...
        ::g::Fuse::Text::SubstringExtensions_typeof());
    type->SetInterfaces(
...
void FallingBackFont__Shape_fn(FallingBackFont* __this, ::g::Fuse::Text::Substring* text, int* fontIndex, int* dir, uArray** __retval)
{
    ...
    int dir_ = *dir;
    ::g::Uno::Diagnostics::Debug::Assert(fontIndex_ == 0, ::STRINGS[2/*"fontIndex =...*/], ::STRINGS[1/*"C:/Users/Sh...*/], 76, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), fontIndex_), uBox<int>(::g::Uno::Int_typeof(), 0)));
...
void FallingBackFont::ctor_1(uArray* fonts)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 > 0, ::STRINGS[0/*"fonts.Lengt...*/], ::STRINGS[1/*"C:/Users/Sh...*/], 45, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), assert1), uBox<int>(::g::Uno::Int_typeof(), 0)));
    Fonts = fonts;
}
...
void FallingBackFontFace::ctor_1(uArray* fontFaces)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 > 0, ::STRINGS[3/*"fontFaces.L...*/], ::STRINGS[1/*"C:/Users/Sh...*/], 13, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), assert1), uBox<int>(::g::Uno::Int_typeof(), 0)));
    FontFaces = fontFaces;
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\FontFace.uno
// ------------------------------------------------------------------------------
...
static void Font_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Text\\1.4.0\\FontFace.uno");
...
void Font__GetCachedGlyphTexture_fn(Font* __this, ::g::Fuse::Text::Glyph* glyph, ::g::Fuse::Text::GlyphAtlas* atlas, int* currentVersion, ::g::Fuse::Text::GlyphTexture* __retval)
{
    ...
    catch (const uThrowable& __t)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[5/*"Error loadi...*/], uBox<uint32_t>(::g::Uno::UInt_typeof(), glyph_.Index)), ::STRINGS[6/*" "*/]), uPtr(e)->Message()), NULL, ::STRINGS[7/*"C:\\Users\\...*/], 191, ::STRINGS[8/*"GetCachedGl...*/]);
    }
...
FontFace* FontFace::Load2(uString* fileName, int index, uDelegate* stylePredicate)
{
    ...
    return ::g::Fuse::Text::Implementation::FreeTypeFontFace::New2(fileName, index, stylePredicate);
}
// }
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\GlyphAtlas.uno
// --------------------------------------------------------------------------------
...
static void GlyphAtlas_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Text/1.4.0/GlyphAtlas.uno");
...
::g::Fuse::Text::SubTexture GlyphAtlas::Add(::g::Uno::Content::Images::Bitmap* bitmap)
{
    ...
    assert1 = format == 1;
    assert2 = format == 3;
    ::g::Uno::Diagnostics::Debug::Assert(assert1 || assert2, ::STRINGS[9/*"(format == ...*/], ::STRINGS[10/*"C:/Users/Sh...*/], 27, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox(::g::Uno::Bool_typeof(), assert1), uBox(::g::Uno::Bool_typeof(), assert2)));
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\LazyFontFace.uno
// ----------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\LineBreaks.uno
// --------------------------------------------------------------------------------
...
{
    type->SetDependencies(
        ::g::Fuse::Text::Implementation::JavaLineBreaks_typeof());
}
...
::g::Fuse::Text::Implementation::BitArray* LineBreaks::Get(::g::Fuse::Text::Substring* text)
{
    ...
    return ::g::Fuse::Text::Implementation::JavaLineBreaks::GetSoftLineBreaks(text);
}
// }
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\Measure.uno
// -----------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\ShapedRun.uno
// -------------------------------------------------------------------------------
...
{
    type->SetDependencies(
        Renderer__SharedIndexBuffer_typeof());
    type->SetInterfaces(
...
// private static Uno.Buffer CreateIndexBufferData(int length) :301
void Renderer__CreateIndexBufferData_fn(int* length, ::g::Uno::Buffer** __retval)
{
    *__retval = Renderer::CreateIndexBufferData(*length);
}

// private static Uno.Buffer CreateVertexBufferData(Uno.Collections.List<Fuse.Text.Quad> quads, int2 texSize) :319
...
// private Uno.Collections.List<Fuse.Text.Batch> GetBatches() :185
void Renderer__GetBatches_fn(Renderer* __this, ::g::Uno::Collections::List** __retval)
{
    *__retval = __this->GetBatches();
}

// private Uno.Collections.List<Uno.Collections.List<Fuse.Text.Quad>> GetTexturedQuads() :210
...
// private static Uno.Collections.List<Uno.Collections.List<Fuse.Text.Quad>> TexturedQuads(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> positionedRuns, int approximateGlyphCount) :221
            ...
            {
                {
                    while (enum2.MoveNext(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Text::Batch_typeof(), NULL)))
                    {
                        ...
                        ::g::Uno::Graphics::Texture2D* texture = (::g::Uno::Collections::List__get_Item_fn(uPtr(textures), uCRef<int>(batch.TextureIndex), &ret11), ret11);
...
// private Uno.Collections.List<Fuse.Text.Batch> GetBatches() [instance] :185
::g::Uno::Collections::List* Renderer::GetBatches()
{
    ...
    for (int i = 0; i < len; ++i)
    {
        ::g::Uno::Collections::List* quads = (::g::Uno::Collections::List__get_Item_fn(uPtr(texturedQuads), uCRef<int>(i), &ret12), ret12);
        int quadCount = uPtr(quads)->Count();

        if (quadCount > 0)
        {
            ::g::Uno::Graphics::VertexBuffer* vertexBuffer = ::g::Uno::Graphics::VertexBuffer::New3(2);
            vertexBuffer->Update(Renderer::CreateVertexBufferData(quads, uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(textures), uCRef<int>(i), &ret13), ret13))->Size()));
...
// private Uno.Collections.List<Uno.Collections.List<Fuse.Text.Quad>> GetTexturedQuads() [instance] :210
...
// private static Uno.Buffer CreateIndexBufferData(int length) [static] :301
...
// private static Uno.Buffer CreateVertexBufferData(Uno.Collections.List<Fuse.Text.Quad> quads, int2 texSize) [static] :319
::g::Uno::Buffer* Renderer::CreateVertexBufferData(::g::Uno::Collections::List* quads, ::g::Uno::Int2 texSize)
{
    ...
    for (int i = 0; i < length; ++i)
    {
        ::g::Fuse::Text::Quad quad = (::g::Uno::Collections::List__get_Item_fn(uPtr(quads), uCRef<int>(i), &ret8), ret8);
...
// private static Uno.Collections.List<Uno.Collections.List<Fuse.Text.Quad>> TexturedQuads(Fuse.Text.Font font, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> positionedRuns, int approximateGlyphCount) [static] :221
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\Shape.uno
// ---------------------------------------------------------------------------
    ...
    {
        {
            while (enum3.MoveNext(::TYPES[14/*Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>>.Enumerator*/]))
            {
                ...
                for (int i = 0; i < positionedRuns->Count(); ++i)
                    ::g::Uno::Collections::List__set_Item_fn(uPtr(positionedRuns), uCRef<int>(i), ::g::Fuse::Text::PositionedRun::Translate((::g::Uno::Collections::List__get_Item_fn(uPtr(positionedRuns), uCRef<int>(i), &ret7), ret7), pos));
...
void ShapedRun__ctor_1_fn(ShapedRun* __this, ::g::Fuse::Text::Bidirectional::Run* run, uArray* parent, int* start, int* count, int* clusterOffset, ::g::Fuse::Text::Implementation::BitArray* lineBreakClusters, int* lineBreakClusterOffset)
{
...
void ShapedRun__CanLineBreak_fn(ShapedRun* __this, int* cluster, bool* __retval)
{
...
void ShapedRun__New2_fn(::g::Fuse::Text::Bidirectional::Run* run, uArray* parent, int* start, int* count, int* clusterOffset, ::g::Fuse::Text::Implementation::BitArray* lineBreakClusters, int* lineBreakClusterOffset, ShapedRun** __retval)
{
...
void ShapedRun::ctor_1(::g::Fuse::Text::Bidirectional::Run run, uArray* parent, int start, int count, int clusterOffset, ::g::Fuse::Text::Implementation::BitArray* lineBreakClusters, int lineBreakClusterOffset)
{
...
bool ShapedRun::CanLineBreak(int cluster)
{
...
::g::Uno::Float2 ShapedRun::Measure()
{
    ...
    if (::g::Uno::Float2__op_Equality(_measureCache, uDefault< ::g::Uno::Float2>()))
    {
        ...
        int strLen = uPtr(Run().String)->Length;

        for (int i = _start; i < end; ++i)
        {
            measurements = ::g::Uno::Float2__op_Addition2(measurements, uPtr(_parent)->Item< ::g::Fuse::Text::PositionedGlyph>(i).Advance());
            int cluster = uPtr(_parent)->Item< ::g::Fuse::Text::PositionedGlyph>(i).Cluster + _clusterOffset;
...
ShapedRun* ShapedRun::New2(::g::Fuse::Text::Bidirectional::Run run, uArray* parent, int start, int count, int clusterOffset, ::g::Fuse::Text::Implementation::BitArray* lineBreakClusters, int lineBreakClusterOffset)
{
...
// internal static class Renderer.SharedIndexBuffer :267
// {
...
// public static void EnsureSize(int length) [static] :280
...
// public static void Release() [static] :289
...
// public static void Retain() [static] :273
    ...
    {
        {
            while (::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[27/*Uno.Collections.IEnumerator*/])))
            {
                uChar c = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Char_typeof(), NULL)), &ret5), ret5);
...
static void SubstringExtensions_build(uType* type)
{
    ...
    ::STRINGS[15] = uString::Const("C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Text/1.4.0/Substring.uno");
...
::g::Fuse::Text::Substring* SubstringExtensions::InclusiveRange(::g::Fuse::Text::Substring* s, int start, int end)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(!assert1, ::STRINGS[14/*"!Fuse.Text....*/], ::STRINGS[15/*"C:/Users/Sh...*/], 295, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 1, uBox(::g::Uno::Bool_typeof(), assert1)));

    if (SubstringExtensions::IsLeadingSurrogate(s->Item(end)))
        ++end;

    ::g::Uno::Diagnostics::Debug::Assert(end < s->Length, ::STRINGS[16/*"end < s.Len...*/], ::STRINGS[15/*"C:/Users/Sh...*/], 298, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Int_typeof(), end), uBox<int>(::g::Uno::Int_typeof(), s->Length)));
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\TextureAtlas.uno
// ----------------------------------------------------------------------------------
...
static void TextureAtlas_build(uType* type)
{
    ...
    ::STRINGS[19] = uString::Const("C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Text/1.4.0/TextureAtlas.uno");
...
::g::Fuse::Text::SubTexture TextureAtlas::Add(::g::Uno::Content::Images::Bitmap* bitmap)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(assert1 == _format, ::STRINGS[18/*"bitmap.Form...*/], ::STRINGS[19/*"C:/Users/Sh...*/], 50, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Graphics::Format_typeof(), assert1), uBox<int>(::g::Uno::Graphics::Format_typeof(), _format)));
...
void TextureAtlas::Blit(::g::Uno::Content::Images::Bitmap* dst, ::g::Uno::Content::Images::Bitmap* src, ::g::Uno::Int2 dstPos)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(::g::Uno::Recti__New2(::g::Uno::Int2__New1(0), uPtr(dst)->Size()).Contains1(assert2), ::STRINGS[21/*"(&new Uno.R...*/], ::STRINGS[19/*"C:/Users/Sh...*/], 96, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 1, uBox(::g::Uno::Recti_typeof(), assert2)));
    assert3 = src->Format();
    assert4 = dst->Format();
    ::g::Uno::Diagnostics::Debug::Assert(assert3 == assert4, ::STRINGS[22/*"src.Format ...*/], ::STRINGS[19/*"C:/Users/Sh...*/], 97, uArray::Init<uObject*>(::TYPES[1/*object[]*/], 2, uBox<int>(::g::Uno::Graphics::Format_typeof(), assert3), uBox<int>(::g::Uno::Graphics::Format_typeof(), assert4)));
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\Truncate.uno
// ------------------------------------------------------------------------------
...
::g::Uno::Collections::List* Truncate::TruncatedLine(::g::Fuse::Text::Font* font, ::g::Uno::Collections::List* lineRuns, float maxPixelWidth, float* minTolerance, float* maxTolerance, ::g::Uno::Float2 pos, int runIndex, int i)
{
    ...
    for (; runIndex >= 0; --runIndex)
    {
        ...
        for (; (0 <= i) && (i < srun->Count); i = i + step)
        {
            if (pos.X <= truncationBoundary)
            {
                ...
                ::g::Fuse::Text::ShapedRun* truncationSrun = ::g::Fuse::Text::ShapedRun::New1(::g::Fuse::Text::Bidirectional::Run__New1(::g::Fuse::Text::Substring::New1(::g::Fuse::Text::Font::Truncation_), srun->Run().Level), uPtr(font)->ShapedTruncation());
    ...
    *maxTolerance = ::g::Uno::Math::Min1(*maxTolerance, lastAdvance.X);
    ::g::Fuse::Text::ShapedRun* truncationSrun1 = ::g::Fuse::Text::ShapedRun::New1(::g::Fuse::Text::Bidirectional::Run__New1(::g::Fuse::Text::Substring::New1(::g::Fuse::Text::Font::Truncation_), 0), uPtr(font)->ShapedTruncation());
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\Wrap.uno
// --------------------------------------------------------------------------
