...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.4.0\V8\Array.uno
// ----------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.4.0\V8\Handle.uno
// -----------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.4.0\V8\V8SimpleExtensions.uno
// -----------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.4.0\V8\Context.uno
// ------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.4.0\V8\Debugger.uno
// -------------------------------------------------------------------------------------------------
...
static void Debugger__Connected_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Scripting.JavaScript/1.4.0/V8/Debugger.uno");
...
void Debugger__Connected::ctor_(::g::Fuse::Scripting::V8::Debugger* parent, ::g::Uno::Net::Sockets::Socket* socket, ::g::Uno::IO::TextReader* reader)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[0/*"DEBUG_V8: C...*/], 0, ::STRINGS[1/*"C:/Users/Sh...*/], 246);
    _parent = parent;
    _socket = socket;
    _reader = reader;
}

// public void Dispose() [instance] :328
...
// public void Reconnect() [instance] :323
    ...
    {
        {
            ...
            int i = ::g::Uno::String::op_Equality(line, NULL) ? -1 : ::g::Uno::String::IndexOf1(uPtr(line), ::g::Fuse::Scripting::V8::Debugger::_contentLengthString_, 0);

            if (i >= 0)
            {
                int contentLength = ::g::Uno::Int::Parse(::g::Uno::String::Substring(uPtr(line), i + uPtr(::g::Fuse::Scripting::V8::Debugger::_contentLengthString_)->Length()));
    ...
    {
        {
            if (_listenSocket == NULL)
            {
                ...
                ::g::Uno::Net::IPEndPoint* endPoint = ::g::Uno::Net::IPEndPoint::New1(::g::Uno::Net::IPAddress::Any_, uPtr(_parent)->_port);
...
void Context::ctor_1(uObject* worker)
{
    ...
    _instanceOf = uAs< ::g::Fuse::Scripting::V8::Function*>(Evaluate(uString::Const("(instanceof)"), uString::Const("(function(x, y) { return x instanceof y; })")), ::TYPES[9/*Fuse.Scripting.V8.Function*/]);
}
...
void Context::OnScriptException(::JSScriptException* e)
{
    ...
    if (jsExceptionObj != NULL)
        exceptionName = uAs<uString*>(uPtr(jsExceptionObj)->CallMethod(uString::Const("toString"), uArray::New(::TYPES[10/*object[]*/], 0)), ::TYPES[12/*string*/]);
...
void Debugger::ctor_(::g::Fuse::Scripting::V8::Context* context, int port)
{
    ...
    _context = context;
    _port = port;
    _offlineMessages = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::g::Uno::Collections::List_typeof()->MakeType(::TYPES[12/*string*/], NULL)));
    _messageHandler = uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::TYPES[12/*string*/], NULL), (void*)Debugger__DisconnectedMessageHandler_fn, this);
...
uString* Debugger::AddHeader(uString* body)
{
    ...
    uString* header = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(Debugger::_contentLengthString_, uBox<int>(::TYPES[8/*int*/], uPtr(::g::Uno::Text::Utf8::GetBytes(body))->Length())), uString::Const("\r\n"
        "\r\n"
        ""));
    uString* replacedBody = body;

    for (int i = 2; i <= 8; ++i)
        replacedBody = ::g::Uno::String::Replace1(uPtr(replacedBody), ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(uString::Const("\"threads\":[{\"current\":true,\"id\":"), uBox<int>(::TYPES[8/*int*/], i)), uString::Const("}]")), uString::Const("\"threads\":[{\"current\":true,\"id\":1}]"));
...
uObject* Debugger::Connect(Debugger* parent)
{
    ...
    uPtr(parent)->_messageHandler = uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::TYPES[12/*string*/], NULL), (void*)Debugger__DisconnectedMessageHandler_fn, uPtr(parent));
    ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(uString::Const("DEBUG_V8: Waiting for a debugger agent to connect on port "), uBox<int>(::TYPES[8/*int*/], parent->_port)), uString::Const("...")), 0, ::STRINGS[1/*"C:/Users/Sh...*/], 87);
...
uObject* Debugger::ToConnected(Debugger* parent, ::g::Uno::Net::Sockets::Socket* communicationSocket)
{
    ...
    uPtr(parent)->_messageHandler = uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::TYPES[12/*string*/], NULL), (void*)Debugger__ConnectedMessageHandler__MessageHandler_fn, Debugger__ConnectedMessageHandler::New1(state, writer));
    writer->Write9(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(uString::Const("Type: connect\r\n"
        ...
        "Protocol-Version: 1\r\n"
        "Embedding-Host: ")), uString::Const("Fuse.Scripting.JavaScript")), uString::Const(" ")), uString::Const("1.4.0")), uString::Const("\r\n"
        "Content-Length: 0\r\n"
        "\r\n"
        "")));
    ...
    {
        {
            while (enum1.MoveNext(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[12/*string*/], NULL)))
            {
                uString* message = enum1.Current(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[12/*string*/], NULL));
                uPtr(writer)->Write9(message);
            }
        }
        {
            enum1.Dispose(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::TYPES[12/*string*/], NULL));
        }
    }
    ...
    parent->_offlineMessages = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::g::Uno::Collections::List_typeof()->MakeType(::TYPES[12/*string*/], NULL)));
    writer->Flush();
...
void Error::Check1(int err)
{
    ...
    if (err != 0)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::Int::ToString(err, ::TYPES[8/*int*/])));
}
// }

// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.4.0\V8\Function.uno
// -------------------------------------------------------------------------------------------------
...
int Marshaller::ToInt(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[8/*int*/]))
        return uUnbox<int>(::TYPES[8/*int*/], o);
...
::JSValue* Marshaller::Unwrap(::g::Fuse::Scripting::V8::Context* context, uObject* obj, ::g::Fuse::Scripting::V8::AutoReleasePool pool)
{
    ...
    if (uIs(obj, ::TYPES[8/*int*/]))
        return ::g::Fuse::Scripting::V8::V8SimpleExtensions::NewInt(uUnbox<int>(::TYPES[8/*int*/], obj), pool);
    ...
    if (uIs(obj, ::TYPES[12/*string*/]))
        return ::g::Fuse::Scripting::V8::V8SimpleExtensions::AsValue4(::g::Fuse::Scripting::V8::V8SimpleExtensions::NewString(cxt, uCast<uString*>(obj, ::TYPES[12/*string*/]), pool));
...
uObject* Marshaller::Wrap(::g::Fuse::Scripting::V8::Context* context, ::JSValue* val)
{
    ...
    switch (::g::Fuse::Scripting::V8::V8SimpleExtensions::GetJSType(val))
    {
        case 0:
            return NULL;
        case 1:
            return uBox<int>(::TYPES[8/*int*/], ::g::Fuse::Scripting::V8::V8SimpleExtensions::AsInt(val));
        case 2:
...
uArray* Marshaller::WrapArray(::g::Fuse::Scripting::V8::Context* context, uArray* values)
{
    ...
    uArray* wrappedValues = uArray::New(::TYPES[10/*object[]*/], len);
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.4.0\V8\Object.uno
// -----------------------------------------------------------------------------------------------
...
{
    ::STRINGS[3] = uString::Const("No such method: ");
            ...
            {
                {
                    ...
                    if (fun == NULL)
                        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition1(::STRINGS[3/*"No such met...*/], fun)));
...
void Object__InstanceOf_fn(Object* __this, ::g::Fuse::Scripting::Function* type, bool* __retval)
{
    ...
    return *__retval = uUnbox<bool>(::g::Uno::Bool_typeof(), uPtr(uPtr(__this->_context)->_instanceOf)->Call(uArray::Init<uObject*>(::TYPES[10/*object[]*/], 2, __this, type))), void();
}
            ...
            {
                {
                    ...
                    result = uArray::New(::TYPES[11/*string[]*/], len);
                    ...
                    for (int i = 0; i < len; ++i)
                    {
                        ...
                        uString* strProp = uAs<uString*>(wrappedProp, ::TYPES[12/*string*/]);
