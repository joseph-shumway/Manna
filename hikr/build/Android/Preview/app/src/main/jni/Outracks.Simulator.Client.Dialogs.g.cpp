...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Preview.Core\0.1.0\.uno\ux13\Outracks.Simulator.Client.Dialogs.LoadingScreen.g.uno
// -----------------------------------------------------------------------------------------------------------------------------------------
...
void LoadingScreen::InitializeUX()
{
    ...
    ::g::Fuse::Reactive::Property* temp3 = ::g::Fuse::Reactive::Property::New1(temp2, ::g::FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_LoadingScreen_Header::Singleton_);
    ...
    ::g::Fuse::Reactive::Property* temp5 = ::g::Fuse::Reactive::Property::New1(temp4, ::g::FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_LoadingScreen_Message::Singleton_);
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Preview.Core\0.1.0\.uno\ux13\Outracks.Simulator.Client.Dialogs.ModalDialog.g.uno
// ---------------------------------------------------------------------------------------------------------------------------------------
...
static void ModalDialog__cctor_4_fn(uType* __type)
{
    ...
    ModalDialog::__selector1_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[3/*"ButtonGrid"*/]);
}
...
static void ModalDialog_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("1*,auto");
    ::STRINGS[5] = uString::Const("1*,1*,2*");
    ::STRINGS[6] = uString::Const("auto");
    ::STRINGS[7] = uString::Const("Body");
    ::STRINGS[8] = uString::Const("Details");
    ::STRINGS[1] = uString::Const("Header");
    ::TYPES[0] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[1] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL);
    type->SetDependencies(
...
void ModalDialog::InitializeUX()
{
    ...
    ::g::Fuse::Reactive::Property* temp5 = ::g::Fuse::Reactive::Property::New1(temp4, ::g::FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_ModalDialog_Header::Singleton_);
    ...
    ::g::Fuse::Reactive::Property* temp7 = ::g::Fuse::Reactive::Property::New1(temp6, ::g::FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_ModalDialog_Body::Singleton_);
    ...
    ::g::Fuse::Reactive::Property* temp9 = ::g::Fuse::Reactive::Property::New1(temp8, ::g::FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_ModalDialog_Details::Singleton_);
    ...
    ::g::Fuse::Reactive::Property* temp11 = ::g::Fuse::Reactive::Property::New1(temp10, ::g::FusePreviewCore_accessor_Outracks_Simulator_Client_Dialogs_ModalDialog_Details::Singleton_);
    ...
    temp15->File(::g::Uno::UX::BundleFileSource::New1(::g::FusePreviewCore_bundle::fight0c6f52b6()));
    temp->TextWrapping(1);
    temp->FontSize(25.0f);
    temp->TextAlignment(1);
    temp->Alignment(8);
    ...
    uPtr(ButtonGrid)->DefaultRow(::STRINGS[6/*"auto"*/]);
...
void ModalDialog::SetBody(uString* value, uObject* origin)
{
    ...
    {
        _field_Body = value;
        OnPropertyChanged1(::g::Uno::UX::Selector__op_Implicit(::STRINGS[7/*"Body"*/]), origin);
    }
}
...
void ModalDialog::SetDetails(uString* value, uObject* origin)
{
    ...
    if (::g::Uno::String::op_Inequality(value, _field_Details))
    {
        ...
        OnPropertyChanged1(::g::Uno::UX::Selector__op_Implicit(::STRINGS[8/*"Details"*/]), origin);
    }
}
