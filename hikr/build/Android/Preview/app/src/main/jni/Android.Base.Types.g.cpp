...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Targets\Android\Uno\Base\Types.uno
// --------------------------------------------------------------------------------------------------
...
static void ByteBuffer_build(uType* type)
{
    type->Reflection.SetFunctions(2,
        ...
        new uFunction("ValidDirectByteBuffer", NULL, (void*)ByteBuffer__ValidDirectByteBuffer_fn, 0, true, ::g::Uno::Bool_typeof(), 1, ::g::Android::Base::Primitives::ujobject_typeof()));
}
