...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Testing\1.4.0\JavaScriptTest.uno
// ---------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Testing\1.4.0\TestRootPanel.uno
// --------------------------------------------------------------------------------------
...
void TestRootPanel::IncrementFrameImpl(float elapsedTime, int flags)
{
    ...
    if ((flags & 1) == 1)
    {
        ::g::Fuse::Scripting::ThreadWorker* w = ::g::Fuse::Reactive::JavaScript::Worker();
    ...
    {
        {
            ...
            catch (const uThrowable& __t)
            {
                ...
                if (testFailedException != NULL)
                    ::g::Uno::Testing::Assert::Fail(uPtr(testFailedException)->Message(), uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Testing\\1.4.0\\TestRootPanel.uno"), 115, uString::Const("RunTest"));
                else
                    throw __t;
            }
        }
    ...
    {
        {
            while (enum2.MoveNext(::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Diagnostic_typeof(), NULL)))
            {
                ...
                ::g::Uno::Testing::Assert::Fail(uPtr(e1)->ToString(), uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Testing\\1.4.0\\TestRootPanel.uno"), 127, uString::Const("RunTest"));
            }
        }
        {
...
void TestRootPanel::StepFrameJS()
{
    ...
    ::g::Fuse::Scripting::ThreadWorker__Fence* fence = uPtr(::g::Fuse::Reactive::JavaScript::Worker())->PostFence();
    bool loop = true;
...
static void TestRootViewport_build(uType* type)
{
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Visual_typeof(), NULL), offsetof(TestRootViewport_type, interface9),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(TestRootViewport_type, interface10),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL), offsetof(TestRootViewport_type, interface11),
        ::g::Fuse::IViewport_typeof(), offsetof(TestRootViewport_type, interface12),
        ::g::Uno::IDisposable_typeof(), offsetof(TestRootViewport_type, interface13),
        ::g::Fuse::ICommonViewport_typeof(), offsetof(TestRootViewport_type, interface14),
        ::g::Fuse::IRenderViewport_typeof(), offsetof(TestRootViewport_type, interface15));
    type->SetFields(76);
}
...
TestRootViewport_type* TestRootViewport_typeof()
{
    ...
    type->interface15.fp_get_ProjectionTransform = (void(*)(uObject*, ::g::Uno::Float4x4*))::g::Fuse::RootViewport__get_ProjectionTransform_fn;
    type->interface15.fp_get_ViewProjectionTransform = (void(*)(uObject*, ::g::Uno::Float4x4*))::g::Fuse::RootViewport__get_ViewProjectionTransform_fn;
    type->interface15.fp_get_ViewOrigin = (void(*)(uObject*, ::g::Uno::Float3*))::g::Fuse::RootViewport__get_ViewOrigin_fn;
    type->interface15.fp_get_ViewRange = (void(*)(uObject*, ::g::Uno::Float2*))::g::Fuse::RootViewport__get_ViewRange_fn;
