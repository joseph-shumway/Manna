...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Threading\1.4.3\IDispatcher.uno
// -------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Threading\1.4.3\AutoResetEvent.uno
// ----------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Threading\1.4.3\Tasks\Tasks.uno
// -------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Threading\1.4.3\Future.uno
// --------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Threading\1.4.3\ConcurrentDictionary.uno
// ----------------------------------------------------------------------------------------------
...
static void ConcurrentDictionary_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(16,
        ...
        new uFunction("Add", NULL, (void*)ConcurrentDictionary__Add1_fn, 0, false, uVoid_typeof(), 1, ::TYPES[1/*Uno.Collections.KeyValuePair`2*/]->MakeType(type->T(0), type->T(1), NULL)),
        ...
        new uFunction("Contains", NULL, (void*)ConcurrentDictionary__Contains_fn, 0, false, ::g::Uno::Bool_typeof(), 1, ::TYPES[1/*Uno.Collections.KeyValuePair`2*/]->MakeType(type->T(0), type->T(1), NULL)),
        ...
        new uFunction("GetEnumerator", NULL, (void*)ConcurrentDictionary__GetEnumerator_fn, 0, false, ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::TYPES[1/*Uno.Collections.KeyValuePair`2*/]->MakeType(type->T(0), type->T(1), NULL), NULL), 0),
        ...
        new uFunction("get_Keys", NULL, (void*)ConcurrentDictionary__get_Keys_fn, 0, false, ::TYPES[2/*Uno.Collections.ICollection`1*/]->MakeType(type->T(0), NULL), 0),
        ...
        new uFunction("Remove", NULL, (void*)ConcurrentDictionary__Remove1_fn, 0, false, ::g::Uno::Bool_typeof(), 1, ::TYPES[1/*Uno.Collections.KeyValuePair`2*/]->MakeType(type->T(0), type->T(1), NULL)),
        ...
        new uFunction("get_Values", NULL, (void*)ConcurrentDictionary__get_Values_fn, 0, false, ::TYPES[2/*Uno.Collections.ICollection`1*/]->MakeType(type->T(1), NULL), 0));
}
...
// public void AddOrUpdate(TKey key, TValue addValue, Uno.Func<TKey, TValue, TValue> updateFun) :88
...
// public Uno.Collections.ICollection<TKey> get_Keys() :25
...
// public Uno.Collections.ICollection<TValue> get_Values() :39
...
uObject* ConcurrentDictionary::GetEnumerator()
{
    uType* __types[] = {
        ...
        __type->Precalced(6/*Uno.Collections.List<Uno.Collections.KeyValuePair<TKey, TValue>>*/),
    };
...
// public Uno.Collections.ICollection<TKey> get_Keys() [instance] :25
uObject* ConcurrentDictionary::Keys()
{
    uType* __types[] = {
        __type->Precalced(4/*Uno.Collections.List<TKey>*/),
    };
...
// public Uno.Collections.ICollection<TValue> get_Values() [instance] :39
uObject* ConcurrentDictionary::Values()
{
    uType* __types[] = {
        __type->Precalced(5/*Uno.Collections.List<TValue>*/),
    };
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Threading\1.4.3\ConcurrentQueue.uno
// -----------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Threading\1.4.3\ThreadPool.uno
// ------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Threading\1.4.3\EventWaitHandle.uno
// -----------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Threading\1.4.3\FutureState.uno
// -------------------------------------------------------------------------------------
...
static void IDispatcherExtensions_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(3,
        ...
        new uFunction("Invoke1`2", type->MethodTypes[1], (void*)IDispatcherExtensions__Invoke11_fn, 0, true, uVoid_typeof(), 3, ::g::Uno::Threading::IDispatcher_typeof(), ::g::Uno::Func1_typeof()->MakeType(type->MethodTypes[1]->U(0), type->MethodTypes[1]->U(1), NULL), type->MethodTypes[1]->U(0)),
        new uFunction("Invoke2`2", type->MethodTypes[2], (void*)IDispatcherExtensions__Invoke2_fn, 0, true, uVoid_typeof(), 4, ::g::Uno::Threading::IDispatcher_typeof(), ::g::Uno::Action2_typeof()->MakeType(type->MethodTypes[2]->U(0), type->MethodTypes[2]->U(1), NULL), type->MethodTypes[2]->U(0), type->MethodTypes[2]->U(1)));
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Threading\MainThreadAttribute.uno
// ------------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Threading\1.4.3\ManualResetEvent.uno
// ------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Threading\Monitor.uno
// ------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Threading\1.4.3\Mutex.uno
// -------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Threading\1.4.3\Implementation\Posix\PthreadHelpers.uno
// -------------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Threading\1.4.3\Promise.uno
// ---------------------------------------------------------------------------------
...
// public Promise(Uno.Threading.IDispatcher dispatcher, T result) :23
...
// public Promise New(Uno.Threading.IDispatcher dispatcher) :28
void Promise__New3_fn(uType* __type, uObject* dispatcher, Promise** __retval)
{
    *__retval = Promise::New3(__type, dispatcher);
}

// public Promise New(Uno.Threading.IDispatcher dispatcher, T result) :23
...
// public override sealed void Wait() :10
...
// public Promise New(Uno.Threading.IDispatcher dispatcher) [static] :28
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Threading\1.4.3\SyncDispatcher.uno
// ----------------------------------------------------------------------------------------
...
// public override sealed void Wait() :86
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Threading\1.4.3\Thread.uno
// --------------------------------------------------------------------------------
