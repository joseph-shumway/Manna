...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\TriggerAnimation.uno
// --------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\Animator.uno
// ------------------------------------------------------------------------------------
...
// public virtual bool get_IsOpenEnd() :141
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\Attract.uno
// -----------------------------------------------------------------------------------
...
static void Attract_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Attract__New1_fn, 0, true, type, 2, ::g::Fuse::Reactive::Expression_typeof(), ::g::Fuse::Animations::AttractorConfig_typeof()));
}
...
// public Attract(Fuse.Reactive.Expression value, Fuse.Animations.AttractorConfig config) :47
void Attract__ctor_1_fn(Attract* __this, ::g::Fuse::Reactive::Expression* value, ::g::Fuse::Animations::AttractorConfig* config)
{
    __this->ctor_1(value, config);
}

// public Attract New(Fuse.Reactive.Expression value, Fuse.Animations.AttractorConfig config) :47
void Attract__New1_fn(::g::Fuse::Reactive::Expression* value, ::g::Fuse::Animations::AttractorConfig* config, Attract** __retval)
{
    *__retval = Attract::New1(value, config);
}
...
{
    uStackFrame __("Fuse.Animations.Attract", "Subscribe(Fuse.Reactive.IContext,Fuse.Reactive.IListener)");
    Attract__Subscription* sub = Attract__Subscription::New1(__this, context, listener);
    sub->Init(context);
    return *__retval = (uObject*)sub, void();
}

// public Attract(Fuse.Reactive.Expression value, Fuse.Animations.AttractorConfig config) [instance] :47
void Attract::ctor_1(::g::Fuse::Reactive::Expression* value, ::g::Fuse::Animations::AttractorConfig* config)
{
    ctor_();
    _config = config;
    _sourceValue = value;
...
// public Attract New(Fuse.Reactive.Expression value, Fuse.Animations.AttractorConfig config) [static] :47
Attract* Attract::New1(::g::Fuse::Reactive::Expression* value, ::g::Fuse::Animations::AttractorConfig* config)
{
    Attract* obj1 = (Attract*)uNew(Attract_typeof());
    obj1->ctor_1(value, config);
    return obj1;
}
// }

// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\Attractor.uno
// -------------------------------------------------------------------------------------
...
static void Attractor_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Animations\\1.4.0\\Attractor.uno");
    ...
    type->SetFields(16,
        ::TYPES[0/*Fuse.Motion.DestinationMotion`1*/]->MakeType(type->T(0), NULL), offsetof(Attractor, _motion), 0,
        ::TYPES[3/*Fuse.Motion.Simulation.DestinationSimulation`1*/]->MakeType(type->T(0), NULL), offsetof(Attractor, _sim), 0,
...
// internal Attractor() :28
void Attractor__ctor_3_fn(Attractor* __this)
{
    __this->ctor_3();
}

// public Attractor(Uno.UX.Property<T> target) :36
...
void Attractor__get_Value_fn(Attractor* __this, uTRef __retval)
{
    ...
    if (__this->IsRootingCompleted())
        return __retval.Store((::g::Fuse::Motion::Simulation::DestinationSimulation::get_Destination_ex(uInterface(uPtr(__this->_sim), __types[0]), &ret7), ret7)), void();

    return __retval.Store((::g::Uno::UX::Property1__Get_fn(uPtr(__this->Target()), &ret8), ret8)), void();
}

// public void set_Value(T value) :138
void Attractor__set_Value_fn(Attractor* __this, void* value)
{
    ...
    if (__this->IsRootingCompleted())
    {
        ...
        ::g::Uno::UX::Property1__Set_fn(uPtr(__this->Target()), value, (uObject*)__this);
}

// internal Attractor() [instance] :28
void Attractor::ctor_3()
{
    uType* __types[] = {
        __type->Precalced(0/*Fuse.Motion.DestinationMotion<T>*/),
    };
    _motion = ((::g::Fuse::Motion::DestinationMotion*)::g::Fuse::Motion::DestinationMotion::New2(__types[0]));
    _isEnabled = true;
    _timeMultiplier = 1.0f;
    ctor_2();
}

// public Attractor(Uno.UX.Property<T> target) [instance] :36
...
// public float get_Distance() [instance] :92
...
// public void set_Distance(float value) [instance] :93
...
// public float get_Duration() [instance] :80
...
// public void set_Duration(float value) [instance] :81
...
// public float get_DurationExp() [instance] :86
...
// public void set_DurationExp(float value) [instance] :87
...
// public Fuse.Animations.Easing get_Easing() [instance] :67
...
// public void set_Easing(Fuse.Animations.Easing value) [instance] :68
...
void Attractor::Motion(::g::Fuse::Motion::DestinationMotion* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(::STRINGS[1/*"Motion shou...*/], this, ::STRINGS[2/*"C:\\Users\\...*/], 51, ::STRINGS[3/*"set_Motion"*/], NULL);
}
...
// public float get_TimeMultiplier() [instance] :126
float Attractor::TimeMultiplier()
{
    return _timeMultiplier;
}

// public void set_TimeMultiplier(float value) [instance] :127
void Attractor::TimeMultiplier(float value)
{
    _timeMultiplier = value;
}

// public Fuse.Motion.MotionDestinationType get_Type() [instance] :59
int Attractor::Type()
{
...
// public void set_Type(Fuse.Motion.MotionDestinationType value) [instance] :60
...
// public Fuse.Motion.MotionUnit get_Unit() [instance] :101
int Attractor::Unit()
{
...
// public void set_Unit(Fuse.Motion.MotionUnit value) [instance] :102
...
// internal Attractor New() [static] :28
...
// public Attractor New(Uno.UX.Property<T> target) [static] :36
...
static void AttractorConfig_build(uType* type)
{
    type->SetFields(9);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)AttractorConfig__New2_fn, 0, true, type, 0));
}
...
uType* AttractorConfig_typeof()
{
    ...
    type->fp_ctor_ = (void*)AttractorConfig__New2_fn;
    return type;
}

// public generated AttractorConfig() :19
void AttractorConfig__ctor_1_fn(AttractorConfig* __this)
{
    __this->ctor_1();
}

// public generated AttractorConfig New() :19
void AttractorConfig__New2_fn(AttractorConfig** __retval)
{
    *__retval = AttractorConfig::New2();
}

// public generated AttractorConfig() [instance] :19
void AttractorConfig::ctor_1()
{
    ctor_();
}

// public generated AttractorConfig New() [static] :19
AttractorConfig* AttractorConfig::New2()
{
    AttractorConfig* obj1 = (AttractorConfig*)uNew(AttractorConfig_typeof());
    obj1->ctor_1();
    return obj1;
}
// }

// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\AverageMixer.uno
// ----------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Common\1.4.0\Easing.uno
// ------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\Change.uno
// ----------------------------------------------------------------------------------
...
static void Change_build(uType* type)
{
    ...
    type->SetFields(20,
        ::TYPES[9/*Fuse.Animations.Converter`1*/]->MakeType(type->T(0), NULL), offsetof(Change, ContinuousConverter), 0,
...
// public float get_DegreesY() [instance] :143
float Change::DegreesY()
{
    return ::g::Uno::Math::RadiansToDegrees1(Y());
}

// public void set_DegreesY(float value) [instance] :144
void Change::DegreesY(float value)
{
    Y(::g::Uno::Math::DegreesToRadians1(value));
}

// public float get_DegreesZ() [instance] :157
float Change::DegreesZ()
{
    return ::g::Uno::Math::RadiansToDegrees1(Y());
}

// public void set_DegreesZ(float value) [instance] :158
...
// public float get_X() [instance] :122
float Change::X()
{
    return _vectorValue.X;
}

// public void set_X(float value) [instance] :123
void Change::X(float value)
{
    _vectorValue.X = value;
}

// public float2 get_XY() [instance] :164
...
// public void set_XY(float2 value) [instance] :165
void Change::XY(::g::Uno::Float2 value)
{
    _vectorValue = ::g::Uno::Float4__New6(value, _vectorValue.Z, _vectorValue.W);
}

// public float get_Y() [instance] :136
float Change::Y()
{
    return _vectorValue.Y;
}

// public void set_Y(float value) [instance] :137
void Change::Y(float value)
{
    _vectorValue.Y = value;
}

// public float get_Z() [instance] :150
float Change::Z()
{
    return _vectorValue.Z;
}

// public void set_Z(float value) [instance] :151
...
static void ContinuousTrackChangeState_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Animations/1.4.0/Change.uno");
    ...
    type->SetFields(6,
        ::TYPES[13/*Fuse.Animations.IMixerHandle`1*/]->MakeType(type->T(0), NULL), offsetof(ContinuousTrackChangeState, mixHandle), 0,
...
void ContinuousTrackChangeState__SeekValue_fn(ContinuousTrackChangeState* __this, ::g::Uno::Float4* value, float* strength)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[5/*"Invalid Seek"*/], 0, ::STRINGS[6/*"C:/Users/Sh...*/], 234);
        return;
    }
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\TrackAnimator.uno
// -----------------------------------------------------------------------------------------
...
// public generated CubicBezierEasing() :449
...
// public generated CubicBezierEasing New() :449
void CubicBezierEasing__New1_fn(CubicBezierEasing** __retval)
{
    *__retval = CubicBezierEasing::New1();
}

// public generated CubicBezierEasing() [instance] :449
...
// public generated CubicBezierEasing New() [static] :449
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\Cycle.uno
// ---------------------------------------------------------------------------------
...
static void Cycle_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(20,
        ...
        new uFunction("get_Offset", NULL, (void*)Cycle__get_Offset_fn, 0, false, type->T(0), 0),
        new uFunction("set_Offset", NULL, (void*)Cycle__set_Offset_fn, 0, false, uVoid_typeof(), 1, type->T(0)),
...
// public Cycle(Uno.UX.Property<T> Target) :79
...
// public Cycle New(Uno.UX.Property<T> Target) :79
...
// public Cycle(Uno.UX.Property<T> Target) [instance] :79
void Cycle::ctor_3(::g::Uno::UX::Property1* Target1)
{
    ...
    Target(Target1);
    ::g::Fuse::Internal::Blender* blender = (::g::Fuse::Internal::Blender*)::g::Fuse::Internal::BlenderMap::Get(__types[0]);
    Cycle__set_Base_fn(this, (uPtr(blender)->get_One_ex(&ret2), ret2));
    Cycle__set_Offset_fn(this, (blender->get_Zero_ex(&ret3), ret3));
}
...
// public Cycle New(Uno.UX.Property<T> Target) [static] :79
...
static void CycleState_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Animations/1.4.0/Cycle.uno");
    ::TYPES[12] = ::g::Fuse::Animations::IMixer_typeof();
    ::TYPES[5] = ::g::Fuse::Internal::BlenderMap_typeof();
    ::TYPES[13] = ::g::Fuse::Animations::IMixerHandle_typeof();
    type->SetDependencies(
    ...
    type->SetPrecalc(
        ...
        ::g::Fuse::Animations::IMixer_typeof()->MakeMethod(0/*Register<T>*/, type->T(0), NULL));
    type->SetFields(5,
        ::TYPES[13/*Fuse.Animations.IMixerHandle`1*/]->MakeType(type->T(0), NULL), offsetof(CycleState, mixHandle), 0,
...
void CycleState__Seek_fn(CycleState* __this, bool* on, float* interval, float* strength, int* dir, bool* __retval)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[8/*"Invalid seek"*/], 0, ::STRINGS[9/*"C:/Users/Sh...*/], 258);
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Motion\1.4.0\DestinationBehavior.uno
// -------------------------------------------------------------------------------------------
...
void DestinationBehavior__SetValue_fn(DestinationBehavior* __this, void* value, uDelegate* handler)
{
    ...
    uStackFrame __("Fuse.Animations.DestinationBehavior`1", "SetValue(T,Fuse.Animations.DestinationBehavior<T>.ValueHandler)");
    uT ret3(__this->__type->T(0), U_ALLOCA(__this->__type->T(0)->ValueSize));
    ...
    {
        ::g::Fuse::UpdateManager::AddAction1(uDelegate::New(::TYPES[2/*Uno.Action*/], (void*)DestinationBehavior__OnUpdate_fn, __this), 0);
...
void DestinationBehavior::OnUpdate()
{
    ...
    uStackFrame __("Fuse.Animations.DestinationBehavior`1", "OnUpdate()");
    uT ret2(__type->T(0), U_ALLOCA(__type->T(0)->ValueSize));
    ...
    ::g::Fuse::Motion::Simulation::Simulation::Update(uInterface(uPtr(_simulation), ::TYPES[1/*Fuse.Motion.Simulation.Simulation*/]), ::g::Fuse::Time::FrameInterval());
    ...
    if (::g::Fuse::Motion::Simulation::Simulation::IsStatic(uInterface(uPtr(_simulation), ::TYPES[1/*Fuse.Motion.Simulation.Simulation*/])))
        StopListenUpdate();
}
...
{
    uStackFrame __("Fuse.Animations.DestinationBehavior`1", "StopListenUpdate()");

    if (_listenUpdate)
    {
        ::g::Fuse::UpdateManager::RemoveAction1(uDelegate::New(::TYPES[2/*Uno.Action*/], (void*)DestinationBehavior__OnUpdate_fn, this), 0);
        _listenUpdate = false;
    }
}
...
{
    uStackFrame __("Fuse.Animations.DestinationBehavior`1", "Unroot()");
    StopListenUpdate();
    _simulation = NULL;
    _handler = NULL;
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\DiscreteKeyframeTrack.uno
// -------------------------------------------------------------------------------------------------
...
static void DiscreteKeyframeTrack_build(uType* type)
{
    ...
    type->SetFields(0,
        ::TYPES[15/*Uno.Collections.List<Fuse.Animations.Keyframe>*/], offsetof(DiscreteKeyframeTrack, _frames), 0,
        ::g::Uno::Double_typeof(), offsetof(DiscreteKeyframeTrack, _duration), 0,
        ::g::Uno::Bool_typeof(), offsetof(DiscreteKeyframeTrack, _init), 0,
        ::g::Fuse::Animations::KeyframeInterpolation_typeof(), offsetof(DiscreteKeyframeTrack, _Interpolation), 0);
}
...
// public generated DiscreteKeyframeTrack() :7
void DiscreteKeyframeTrack__ctor__fn(DiscreteKeyframeTrack* __this)
{
    __this->ctor_();
}

// private Fuse.Animations.SeekResult Fuse.Animations.DiscreteTrackProvider.GetSeekProgress(Fuse.Animations.TrackAnimatorState tas, double progress, double interval, Fuse.Animations.SeekDirection dir, object& value, double& strength) :40
...
// private Fuse.Animations.SeekResult Fuse.Animations.DiscreteTrackProvider.GetSeekTime(Fuse.Animations.TrackAnimatorState tas, double elapsed, double interval, Fuse.Animations.SeekDirection dir, object& value, double& strength) :48
...
// private Fuse.Animations.AnimatorVariant Fuse.Animations.TrackProvider.GetAnimatorVariant(Fuse.Animations.TrackAnimator ta) :35
...
// private double Fuse.Animations.TrackProvider.GetDuration(Fuse.Animations.TrackAnimator ta, Fuse.Animations.AnimationVariant variant) :29
...
// public generated Fuse.Animations.KeyframeInterpolation get_Interpolation() [instance] :16
int DiscreteKeyframeTrack::Interpolation()
{
    return _Interpolation;
}

// public generated void set_Interpolation(Fuse.Animations.KeyframeInterpolation value) [instance] :16
void DiscreteKeyframeTrack::Interpolation(int value)
{
    _Interpolation = value;
}

// public Uno.Collections.IList<Fuse.Animations.Keyframe> get_Keyframes() [instance] :13
...
// public generated DiscreteKeyframeTrack New() [static] :7
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\DiscreteMixer.uno
// -----------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\DiscreteSingleTrack.uno
// -----------------------------------------------------------------------------------------------
...
static void DiscreteTrackChangeState_build(uType* type)
{
    ...
    type->SetPrecalc(
        ...
        ::g::Fuse::Animations::IMixer_typeof()->MakeMethod(0/*Register<T>*/, type->T(0), NULL));
    type->SetFields(6,
        ::TYPES[13/*Fuse.Animations.IMixerHandle`1*/]->MakeType(type->T(0), NULL), offsetof(DiscreteTrackChangeState, mixHandle), 0,
...
void DiscreteTrackChangeState__SeekObjectValue_fn(DiscreteTrackChangeState* __this, uObject* value, float* strength)
{
    ...
    if (__this->mixHandle == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[5/*"Invalid Seek"*/], 0, ::STRINGS[6/*"C:/Users/Sh...*/], 201);
        return;
    }
...
static void Easing_build(uType* type)
{
    ...
    type->Reflection.SetFields(31,
        new uField("BackIn", 25),
        new uField("BackInOut", 27),
        new uField("BackOut", 26),
        new uField("BounceIn", 28),
        new uField("BounceInOut", 30),
        new uField("BounceOut", 29),
        new uField("CircularIn", 19),
        new uField("CircularInOut", 21),
        new uField("CircularOut", 20),
        new uField("CubicIn", 4),
        new uField("CubicInOut", 6),
        new uField("CubicOut", 5),
        new uField("ElasticIn", 22),
        new uField("ElasticInOut", 24),
        new uField("ElasticOut", 23),
        new uField("ExponentialIn", 16),
        new uField("ExponentialInOut", 18),
        new uField("ExponentialOut", 17),
        new uField("Linear", 0),
        new uField("QuadraticIn", 1),
        new uField("QuadraticInOut", 3),
        new uField("QuadraticOut", 2),
        new uField("QuarticIn", 7),
        new uField("QuarticInOut", 9),
        new uField("QuarticOut", 8),
        new uField("QuinticIn", 10),
        new uField("QuinticInOut", 12),
        new uField("QuinticOut", 11),
        new uField("SinusoidalIn", 13),
        new uField("SinusoidalInOut", 15),
        new uField("SinusoidalOut", 14));
    type->Reflection.SetFunctions(1,
...
// public static float BackInOut(float k) [static] :750
...
// public static float BackOut(float k) [static] :743
...
// public static float BounceIn(float k) [static] :762
float EasingFunctions::BounceIn(float k)
{
    return 1.0f - EasingFunctions::BounceOut(1.0f - k);
}

// public static float BounceInOut(float k) [static] :790
...
// public static float BounceOut(float k) [static] :767
...
// public static float CircularIn(float k) [static] :681
float EasingFunctions::CircularIn(float k)
{
    return 1.0f - ::g::Uno::Math::Sqrt1(1.0f - (k * k));
}

// public static float CircularInOut(float k) [static] :692
...
// public static float CircularOut(float k) [static] :686
...
// public static float CubicIn(float k) [static] :579
float EasingFunctions::CubicIn(float k)
{
    return (k * k) * k;
}

// public static float CubicInOut(float k) [static] :590
...
// public static float CubicOut(float k) [static] :584
...
// public static float ElasticIn(float k) [static] :701
...
// public static float ElasticInOut(float k) [static] :723
...
// public static float ElasticOut(float k) [static] :712
...
// public static float ExponentialIn(float k) [static] :656
float EasingFunctions::ExponentialIn(float k)
{
    return (k == 0.0f) ? 0.0f : ::g::Uno::Math::Pow1(1024.0f, k - 1.0f);
}

// public static float ExponentialInOut(float k) [static] :666
...
// public static float ExponentialOut(float k) [static] :661
float EasingFunctions::ExponentialOut(float k)
{
    return (k == 1.0f) ? 1.0f : 1.0f - ::g::Uno::Math::Pow1(2.0f, -10.0f * k);
}

// public static Fuse.Animations.EasingFunction FromEasing(Fuse.Animations.Easing e) [static] :505
...
// public static float Linear(float k) [static] :552
float EasingFunctions::Linear(float k)
{
    return k;
}

// public static float QuadraticIn(float k) [static] :557
float EasingFunctions::QuadraticIn(float k)
{
    return k * k;
}

// public static float QuadraticInOut(float k) [static] :567
...
// public static float QuadraticOut(float k) [static] :562
float EasingFunctions::QuadraticOut(float k)
{
    return k * (2.0f - k);
}

// public static float QuarticIn(float k) [static] :600
float EasingFunctions::QuarticIn(float k)
{
    return ((k * k) * k) * k;
}

// public static float QuarticInOut(float k) [static] :611
...
// public static float QuarticOut(float k) [static] :605
...
// public static float QuinticIn(float k) [static] :620
float EasingFunctions::QuinticIn(float k)
{
    return (((k * k) * k) * k) * k;
}

// public static float QuinticInOut(float k) [static] :631
...
// public static float QuinticOut(float k) [static] :625
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\EasingTrack.uno
// ---------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\Mixer.uno
// ---------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\Resize.uno
// ----------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\Keyframe.uno
// ------------------------------------------------------------------------------------
...
static void Keyframe_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::Float4_typeof(), offsetof(Keyframe, _value), 0,
        uObject_typeof(), offsetof(Keyframe, _objectValue), 0,
        ::g::Uno::Double_typeof(), offsetof(Keyframe, _timeDelta), 0,
        ::g::Uno::Bool_typeof(), offsetof(Keyframe, _hasTimeDelta), 0,
        ::g::Uno::Double_typeof(), offsetof(Keyframe, _time), 0,
        ::g::Uno::Bool_typeof(), offsetof(Keyframe, _hasTime), 0,
        ::g::Uno::Float4_typeof(), offsetof(Keyframe, _tangentIn), 0,
        ::g::Uno::Float4_typeof(), offsetof(Keyframe, _tangentOut), 0,
        ::g::Uno::Bool_typeof(), offsetof(Keyframe, _hasTangentIn), 0,
        ::g::Uno::Bool_typeof(), offsetof(Keyframe, _hasTangentOut), 0);
...
// public generated Keyframe() :37
void Keyframe__ctor__fn(Keyframe* __this)
{
    __this->ctor_();
}

// internal static double CompleteFrames(Uno.Collections.IList<Fuse.Animations.Keyframe> frames, float tension, float bias, float continuity) :168
...
// public void set_DegreesXY(float2 value) [instance] :104
...
// public float4 get_TangentOut() [instance] :146
::g::Uno::Float4 Keyframe::TangentOut()
{
    return _tangentOut;
}

// public void set_TangentOut(float4 value) [instance] :147
...
// public double get_Time() [instance] :124
double Keyframe::Time()
{
    return _time;
}

// public void set_Time(double value) [instance] :125
...
// public double get_TimeDelta() [instance] :112
double Keyframe::TimeDelta()
{
    return _timeDelta;
}

// public void set_TimeDelta(double value) [instance] :113
...
// public float4 get_Value() [instance] :42
::g::Uno::Float4 Keyframe::Value()
{
    return _value;
}

// public void set_Value(float4 value) [instance] :43
void Keyframe::Value(::g::Uno::Float4 value)
{
    _value = value;
}

// public float get_X() [instance] :55
float Keyframe::X()
{
    return _value.X;
}

// public void set_X(float value) [instance] :56
void Keyframe::X(float value)
{
    _value.X = value;
}

// public float2 get_XY() [instance] :73
...
// public void set_XYZ(float3 value) [instance] :80
void Keyframe::XYZ(::g::Uno::Float3 value)
{
    _value = ::g::Uno::Float4__New8(value, _value.W);
}

// public float get_Y() [instance] :61
float Keyframe::Y()
{
    return _value.Y;
}

// public void set_Y(float value) [instance] :62
void Keyframe::Y(float value)
{
    _value.Y = value;
}

// public float get_Z() [instance] :67
float Keyframe::Z()
{
    return _value.Z;
}

// public void set_Z(float value) [instance] :68
void Keyframe::Z(float value)
{
    _value.Z = value;
}

// internal static double CompleteFrames(Uno.Collections.IList<Fuse.Animations.Keyframe> frames, float tension, float bias, float continuity) [static] :168
double Keyframe::CompleteFrames(uObject* frames, float tension, float bias, float continuity)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(frames), ::TYPES[51/*Uno.Collections.ICollection<Fuse.Animations.Keyframe>*/])); ++i)
    {
        ...
        ::g::Uno::Float4 ta, tb;
        ::g::Fuse::Internal::Curves::KochanekBartelTangent(uPtr(prev)->Value(), uPtr(frame)->Value(), uPtr(next)->Value(), uPtr(next2)->Value(), tension, bias, continuity, &ta, &tb);
...
// public generated Keyframe New() [static] :37
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\SplineTrack.uno
// ---------------------------------------------------------------------------------------
...
void MasterBase::MarkDirty()
{
    ...
    ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[2/*Uno.Action*/], (void*)MasterBase__Complete_fn, this), -1, 2);
}
...
static void MasterProperty_build(uType* type)
{
    ...
    ::STRINGS[13] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Animations\\1.4.0\\Mixer.uno");
...
void MasterProperty__OnInactive_fn(MasterProperty* __this)
{
    ...
    if (__this->_isListening)
    {
        ...
        ::g::Uno::UX::Property1__Set_fn(uPtr(__this->Property), (__this->get_RestValue_ex(&ret2), ret2), (uObject*)__this);
        __this->_isListening = false;
    }
}

// public override sealed T get_RestValue() :225
...
void MasterProperty::GiveOriginSetterWarning()
{
    ...
    {
        _warningGiven = true;
        ::g::Fuse::Diagnostics::UserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[10/*"The property "*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(Property)->Name())), ::STRINGS[11/*" of "*/]), uPtr(Property)->Object()), ::STRINGS[12/*" cannot be ...*/]), this, ::STRINGS[13/*"C:\\Users\\...*/], 275, ::STRINGS[14/*"GiveOriginS...*/]);
    }
}
// }
...
{
    ::TYPES[53] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
...
void MasterTransform__OnActive_fn(MasterTransform* __this)
{
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(__this->Visual)->Children()), ::TYPES[53/*Uno.Collections.ICollection<Fuse.Node>*/]), __this->FMT);
}
...
void MasterTransform__OnInactive_fn(MasterTransform* __this)
{
    ...
    bool ret1;
    ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(uPtr(__this->Visual)->Children()), ::TYPES[53/*Uno.Collections.ICollection<Fuse.Node>*/]), __this->FMT, &ret1);
    __this->FMT = NULL;
}

// public override sealed Fuse.Transform get_RestValue() :356
void MasterTransform__get_RestValue_fn(MasterTransform* __this, ::g::Fuse::Transform** __retval)
{
    return *__retval = MasterTransform::identity_, void();
}
...
// public generated Mixer() [instance] :35
void Mixer::ctor_()
{
}

// public generated Mixer New() [static] :35
Mixer* Mixer::New1()
{
...
{
    ::TYPES[54] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(uObject_typeof(), uObject_typeof(), NULL);
    ::TYPES[55] = ::g::Fuse::Animations::MasterBase_typeof();
    ::TYPES[56] = ::g::Fuse::Animations::MixerHandle_typeof();
    ::TYPES[57] = ::TYPES[55/*Fuse.Animations.MasterBase`1*/]->MakeType(::g::Fuse::Transform_typeof(), NULL);
    ::TYPES[58] = ::TYPES[56/*Fuse.Animations.MixerHandle`1*/]->MakeType(::g::Fuse::Transform_typeof(), NULL);
    ::TYPES[59] = ::g::Fuse::Animations::MasterPropertyGet_typeof();
    ::TYPES[60] = ::g::Fuse::Animations::MasterTransform_typeof();
    type->SetDependencies(
        ::g::Fuse::Properties_typeof());
    type->MethodTypes[1]->SetPrecalc(
        type->MakeMethod(0/*CreateMaster<T>*/, type->MethodTypes[1]->U(0), NULL),
        ::TYPES[55/*Fuse.Animations.MasterBase`1*/]->MakeType(type->MethodTypes[1]->U(0), NULL),
        ::TYPES[56/*Fuse.Animations.MixerHandle`1*/]->MakeType(type->MethodTypes[1]->U(0), NULL));
    type->SetInterfaces(
        ::g::Fuse::Animations::IMixer_typeof(), offsetof(MixerBase_type, interface0));
    type->SetFields(0,
        ::TYPES[54/*Uno.Collections.Dictionary<object, object>*/], offsetof(MixerBase, Masters), 0,
...
{
    Masters = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[54/*Uno.Collections.Dictionary<object, object>*/]));
...
uObject* MixerBase::RegisterTransform(::g::Fuse::Visual* element, int mode, int priority)
{
    ...
    ::g::Fuse::Animations::MasterBase* masterT = uCast< ::g::Fuse::Animations::MasterBase*>(master, ::TYPES[57/*Fuse.Animations.MasterBase<Fuse.Transform>*/]);
    return (uObject*)((::g::Fuse::Animations::MixerHandle*)::g::Fuse::Animations::MixerHandle::New1(::TYPES[58/*Fuse.Animations.MixerHandle<Fuse.Transform>*/], masterT, mode, priority));
}
...
void MixerBase::Unused(uObject* mb)
{
    ...
    bool ret2;
    uObject* prop = uAs<uObject*>(mb, ::TYPES[59/*Fuse.Animations.MasterPropertyGet*/]);

    if (prop != NULL)
        ::g::Uno::Collections::Dictionary__Remove_fn(uPtr(Masters), ::g::Fuse::Animations::MasterPropertyGet::GetPropertyObject(uInterface(uPtr(prop), ::TYPES[59/*Fuse.Animations.MasterPropertyGet*/])), &ret2);

    ::g::Fuse::Animations::MasterTransform* trans = uAs< ::g::Fuse::Animations::MasterTransform*>(mb, ::TYPES[60/*Fuse.Animations.MasterTransform*/]);
...
static void MixerHandle_build(uType* type)
{
    ...
    ::STRINGS[16] = uString::Const("C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Animations/1.4.0/Mixer.uno");
...
void MixerHandle__get_RestValue_fn(MixerHandle* __this, uTRef __retval)
{
    ...
    if (__this->Master == NULL)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[17/*"Invalid Mix...*/]));
...
void MixerHandle__Set_fn(MixerHandle* __this, void* value, float* strength)
{
    ...
    if (__this->Master == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[15/*"invalid Mix...*/], 0, ::STRINGS[16/*"C:/Users/Sh...*/], 392);
        return;
    }
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\TransformAnimator.uno
// ---------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\Nothing.uno
// -----------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\OpenAnimator.uno
// ----------------------------------------------------------------------------------------
...
// protected generated OpenAnimator() :14
...
// public void ResetDuration() [instance] :37
...
// public override sealed bool get_IsOpenEnd() :69
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\Player.uno
// ----------------------------------------------------------------------------------
...
{
    ::TYPES[61] = ::g::Fuse::Animations::IPlayerFeedback_typeof();
    ::TYPES[62] = ::g::Fuse::Animations::IBasePlayerFeedback_typeof();
    type->SetInterfaces(
        ::g::Fuse::IUpdateListener_typeof(), offsetof(Player_type, interface0));
    type->SetFields(0,
        ::TYPES[61/*Fuse.Animations.IPlayerFeedback*/], offsetof(Player, Feedback), 0,
...
void Player::CheckUpdate(bool interval)
{
    ...
    if (uPtr(_progress)->Animate)
    {
        ...
        if (Feedback != NULL)
            ::g::Fuse::Animations::IPlayerFeedback::OnProgressUpdated(uInterface(uPtr(Feedback), ::TYPES[61/*Fuse.Animations.IPlayerFeedback*/]), this, (wrapped ? 1 : 0) | 2);
    ...
    if (stable != _allStable)
    {
        ...
        if ((Feedback != NULL) && stable)
            ::g::Fuse::Animations::IBasePlayerFeedback::OnStable(uInterface(uPtr(Feedback), ::TYPES[62/*Fuse.Animations.IBasePlayerFeedback*/]), this);
    }
}
...
void Player::Done()
{
    ...
    if (!_isDone)
    {
        ...
        if (Feedback != NULL)
            ::g::Fuse::Animations::IBasePlayerFeedback::OnPlaybackDone(uInterface(uPtr(Feedback), ::TYPES[62/*Fuse.Animations.IBasePlayerFeedback*/]), this);
    }
}
...
void Player::SeekProgress(double progress, bool triggerUpdate)
{
    ...
    if (triggerUpdate && (Feedback != NULL))
        ::g::Fuse::Animations::IPlayerFeedback::OnProgressUpdated(uInterface(uPtr(Feedback), ::TYPES[61/*Fuse.Animations.IPlayerFeedback*/]), this, 0);
}
...
// public void Suspend() [instance] :288
void Player::Suspend()
{
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\RangeAdapter.uno
// ----------------------------------------------------------------------------------------
...
static void RangeAdapter_build(uType* type)
{
    ...
    type->SetFields(16,
        ::g::Fuse::Internal::ScalarBlender_typeof()->MakeType(type->T(0), NULL), offsetof(RangeAdapter, _blender), 0,
        ::g::Uno::Double_typeof(), offsetof(RangeAdapter, _sourceRangeMin), 0,
        ::g::Uno::Double_typeof(), offsetof(RangeAdapter, _sourceRangeMax), 0,
        ::g::Uno::Double_typeof(), offsetof(RangeAdapter, _valueRangeMin), 0,
        ::g::Uno::Double_typeof(), offsetof(RangeAdapter, _valueRangeMax), 0,
...
// public RangeAdapter New(Uno.UX.Property<T> source) :43
...
// public void SetValue(T value, Uno.UX.IPropertyListener origin) :58
void RangeAdapter__SetValue_fn(RangeAdapter* __this, void* value, uObject* origin)
{
    ...
    uT ret6(__this->__type->T(0), U_ALLOCA(__this->__type->T(0)->ValueSize));
    ::g::Uno::UX::Property1__Set_fn(uPtr(__this->Source()), (RangeAdapter__In_fn(__this, value, &ret6), ret6), origin);
}
...
// public T get_SourceRangeMax() :96
...
// public void set_SourceRangeMax(T value) :97
...
// public T get_SourceRangeMin() :87
...
// public void set_SourceRangeMin(T value) :88
...
void RangeAdapter__get_Value_fn(RangeAdapter* __this, uTRef __retval)
{
    ...
    return __retval.Store((RangeAdapter__Out_fn(__this, (::g::Uno::UX::Property1__Get_fn(uPtr(__this->Source()), &ret12), ret12), &ret11), ret11)), void();
}

// public void set_Value(T value) :55
...
// public T get_ValueRangeMax() :115
...
// public void set_ValueRangeMax(T value) :116
...
// public T get_ValueRangeMin() :106
void RangeAdapter__get_ValueRangeMin_fn(RangeAdapter* __this, uTRef __retval)
{
    ...
    uT ret15(__this->__type->T(0), U_ALLOCA(__this->__type->T(0)->ValueSize));
    return __retval.Store((uPtr(__this->_blender)->FromDouble_ex(uCRef(__this->_valueRangeMin), &ret15), ret15)), void();
}

// public void set_ValueRangeMin(T value) :107
...
// public RangeAdapter(Uno.UX.Property<T> source) [instance] :43
...
// public RangeAdapter New(Uno.UX.Property<T> source) [static] :43
...
// public float get_X() :56
void Resize__get_X_fn(Resize* __this, float* __retval)
{
    *__retval = __this->X();
}

// public void set_X(float value) :57
...
// public float get_X() [instance] :56
float Resize::X()
{
    return _vectorValue.X;
}

// public void set_X(float value) [instance] :57
...
static void ResizeAnimatorState_build(uType* type)
{
    ...
    ::STRINGS[20] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Animations\\1.4.0\\Resize.uno");
    ...
    type->SetFields(6,
        ...
        ::TYPES[63/*Fuse.Animations.IResize*/], offsetof(ResizeAnimatorState, _target), 0,
        ::g::Uno::Bool_typeof(), offsetof(ResizeAnimatorState, _valid), 0,
        ::TYPES[66/*Fuse.Animations.IResizeMode*/], offsetof(ResizeAnimatorState, _relativeTo), 0,
...
void ResizeAnimatorState::ctor_2(::g::Fuse::Animations::Resize* r, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    if (_target == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[19/*"Resize star...*/], r, ::STRINGS[20/*"C:\\Users\\...*/], 98, ::STRINGS[21/*".ctor"*/]);
        _valid = false;
        return;
    }
    ...
    if (_relativeTo == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[22/*"Resize star...*/], r, ::STRINGS[20/*"C:\\Users\\...*/], 106, ::STRINGS[21/*".ctor"*/]);
        _valid = false;
        return;
    }
...
// public float get_DegreesX() :286
void Rotate__get_DegreesX_fn(Rotate* __this, float* __retval)
{
    *__retval = __this->DegreesX();
}

// public void set_DegreesX(float value) :287
...
// public float get_DegreesX() [instance] :286
float Rotate::DegreesX()
{
    return ::g::Uno::Math::RadiansToDegrees1(X());
}

// public void set_DegreesX(float value) [instance] :287
...
// public float get_DegreesX() [instance] :391
float Skew::DegreesX()
{
    return ::g::Uno::Math::RadiansToDegrees1(X());
}

// public void set_DegreesX(float value) [instance] :392
void Skew::DegreesX(float value)
{
    X(::g::Uno::Math::DegreesToRadians1(value));
}

// public float2 get_DegreesXY() [instance] :412
::g::Uno::Float2 Skew::DegreesXY()
{
    return ::g::Uno::Float2__New2(::g::Uno::Math::RadiansToDegrees1(X()), ::g::Uno::Math::RadiansToDegrees1(Y()));
}

// public void set_DegreesXY(float2 value) [instance] :413
void Skew::DegreesXY(::g::Uno::Float2 value)
{
    XY(::g::Uno::Float2__New2(::g::Uno::Math::DegreesToRadians1(value.X), ::g::Uno::Math::DegreesToRadians1(value.Y)));
}

// public float get_DegreesY() [instance] :398
float Skew::DegreesY()
{
    return ::g::Uno::Math::RadiansToDegrees1(Y());
}

// public void set_DegreesY(float value) [instance] :399
void Skew::DegreesY(float value)
{
    Y(::g::Uno::Math::DegreesToRadians1(value));
}

// public float2 get_XY() [instance] :405
...
// public void set_XY(float2 value) [instance] :406
void Skew::XY(::g::Uno::Float2 value)
{
    _vectorValue = ::g::Uno::Float4__New6(value, _vectorValue.Z, _vectorValue.W);
}

// public Skew New() [static] :378
Skew* Skew::New2()
{
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Animations\1.4.0\Spin.uno
// --------------------------------------------------------------------------------
...
{
    ::STRINGS[8] = uString::Const("Invalid seek");
    ::STRINGS[23] = uString::Const("C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Animations/1.4.0/Spin.uno");
    ::TYPES[12] = ::g::Fuse::Animations::IMixer_typeof();
    ...
    type->SetFields(5,
        ...
        ::TYPES[67/*Fuse.Animations.IMixerHandle<Fuse.Transform>*/], offsetof(SpinState, mixHandle), 0,
...
void SpinState__Seek_fn(SpinState* __this, bool* on, float* interval, float* strength, int* dir, bool* __retval)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[8/*"Invalid seek"*/], 0, ::STRINGS[23/*"C:/Users/Sh...*/], 76);
        return *__retval = true, void();
    }
...
{
    ::TYPES[15] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Animations::Keyframe_typeof(), NULL);
    ::TYPES[68] = ::g::Fuse::Internal::Curves__PointInterpolater_typeof();
    ::TYPES[50] = ::g::Fuse::Animations::ContinuousTrackProvider_typeof();
    type->SetInterfaces(
    ...
    type->SetFields(0,
        ::TYPES[15/*Uno.Collections.List<Fuse.Animations.Keyframe>*/], offsetof(SplineTrack, _frames), 0,
        ::g::Uno::Float_typeof(), offsetof(SplineTrack, _tension), 0,
        ::g::Uno::Float_typeof(), offsetof(SplineTrack, _bias), 0,
        ::g::Uno::Float_typeof(), offsetof(SplineTrack, _continuity), 0,
        ::TYPES[68/*Fuse.Internal.Curves.PointInterpolater*/], offsetof(SplineTrack, _pointInterpolater), 0,
        ::g::Fuse::Animations::KeyframeInterpolation_typeof(), offsetof(SplineTrack, _style), 0,
        ::g::Uno::Double_typeof(), offsetof(SplineTrack, _duration), 0,
        ::g::Uno::Bool_typeof(), offsetof(SplineTrack, _init), 0);
}
...
// public generated SplineTrack() :26
void SplineTrack__ctor__fn(SplineTrack* __this)
{
    __this->ctor_();
}

// public float get_Bias() :55
void SplineTrack__get_Bias_fn(SplineTrack* __this, float* __retval)
{
    *__retval = __this->Bias();
}

// public void set_Bias(float value) :56
void SplineTrack__set_Bias_fn(SplineTrack* __this, float* value)
{
    __this->Bias(*value);
}

// public float get_Continuity() :69
void SplineTrack__get_Continuity_fn(SplineTrack* __this, float* __retval)
{
    *__retval = __this->Continuity();
}

// public void set_Continuity(float value) :70
void SplineTrack__set_Continuity_fn(SplineTrack* __this, float* value)
{
    __this->Continuity(*value);
}

// private Fuse.Animations.SeekResult Fuse.Animations.ContinuousTrackProvider.GetSeekProgress(Fuse.Animations.TrackAnimatorState tas, double progress, double interval, Fuse.Animations.SeekDirection dir, float4& value, double& strength) :131
...
// private Fuse.Animations.SeekResult Fuse.Animations.ContinuousTrackProvider.GetSeekTime(Fuse.Animations.TrackAnimatorState tas, double elapsed, double interval, Fuse.Animations.SeekDirection dir, float4& value, double& strength) :139
...
// private Fuse.Animations.AnimatorVariant Fuse.Animations.TrackProvider.GetAnimatorVariant(Fuse.Animations.TrackAnimator tas) :126
...
// private double Fuse.Animations.TrackProvider.GetDuration(Fuse.Animations.TrackAnimator ta, Fuse.Animations.AnimationVariant variant) :120
...
// private void Init() :112
void SplineTrack__Init_fn(SplineTrack* __this)
{
    __this->Init();
}

// public Fuse.Animations.KeyframeInterpolation get_Interpolation() :82
void SplineTrack__get_Interpolation_fn(SplineTrack* __this, int* __retval)
{
    *__retval = __this->Interpolation();
}

// public void set_Interpolation(Fuse.Animations.KeyframeInterpolation value) :83
void SplineTrack__set_Interpolation_fn(SplineTrack* __this, int* value)
{
    __this->Interpolation(*value);
}

// public Uno.Collections.IList<Fuse.Animations.Keyframe> get_Keyframes() :32
void SplineTrack__get_Keyframes_fn(SplineTrack* __this, uObject** __retval)
{
    *__retval = __this->Keyframes();
}

// public generated SplineTrack New() :26
void SplineTrack__New1_fn(SplineTrack** __retval)
{
    *__retval = SplineTrack::New1();
}

// public float get_Tension() :41
void SplineTrack__get_Tension_fn(SplineTrack* __this, float* __retval)
{
    *__retval = __this->Tension();
}

// public void set_Tension(float value) :42
void SplineTrack__set_Tension_fn(SplineTrack* __this, float* value)
{
    __this->Tension(*value);
}

// public generated SplineTrack() [instance] :26
void SplineTrack::ctor_()
{
    _frames = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[15/*Uno.Collections.List<Fuse.Animations.Keyframe>*/]));
    _tension = 1.0f;
    _continuity = -1.0f;
    _pointInterpolater = uDelegate::New(::TYPES[68/*Fuse.Internal.Curves.PointInterpolater*/], (void*)::g::Fuse::Internal::Curves__LinearPoint_fn);
}

// public float get_Bias() [instance] :55
float SplineTrack::Bias()
{
    return _bias;
}

// public void set_Bias(float value) [instance] :56
...
// public float get_Continuity() [instance] :69
float SplineTrack::Continuity()
{
    return _continuity;
}

// public void set_Continuity(float value) [instance] :70
...
// private void Init() [instance] :112
...
// public Fuse.Animations.KeyframeInterpolation get_Interpolation() [instance] :82
int SplineTrack::Interpolation()
{
    return _style;
}

// public void set_Interpolation(Fuse.Animations.KeyframeInterpolation value) [instance] :83
void SplineTrack::Interpolation(int value)
{
    ...
    switch (_style)
    {
        ...
        case 1:
        {
            ...
            _tension = 0.0f;
            _continuity = 0.0f;
            _pointInterpolater = uDelegate::New(::TYPES[68/*Fuse.Internal.Curves.PointInterpolater*/], (void*)::g::Fuse::Internal::Curves__CubicHermitePoint_fn);
            break;
        }
        default:
        {
...
// public Uno.Collections.IList<Fuse.Animations.Keyframe> get_Keyframes() [instance] :32
...
// public float get_Tension() [instance] :41
float SplineTrack::Tension()
{
    return _tension;
}

// public void set_Tension(float value) [instance] :42
...
// public generated SplineTrack New() [static] :26
...
static void Attract__Subscription_build(uType* type)
{
    ...
    ::STRINGS[25] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Animations\\1.4.0\\Attract.uno");
    ...
    ::TYPES[71] = ::g::Fuse::Animations::DestinationBehavior_typeof()->MakeType(::g::Uno::Float_typeof(), NULL);
    ::TYPES[72] = ::g::Fuse::Animations::DestinationBehavior_typeof()->MakeType(::g::Uno::Float2_typeof(), NULL);
    ::TYPES[73] = ::g::Fuse::Animations::DestinationBehavior_typeof()->MakeType(::g::Uno::Float3_typeof(), NULL);
    ::TYPES[74] = ::g::Fuse::Animations::DestinationBehavior__ValueHandler_typeof()->MakeType(::g::Uno::Float_typeof(), NULL);
    ::TYPES[75] = ::g::Fuse::Animations::DestinationBehavior__ValueHandler_typeof()->MakeType(::g::Uno::Float2_typeof(), NULL);
    ::TYPES[76] = ::g::Fuse::Animations::DestinationBehavior__ValueHandler_typeof()->MakeType(::g::Uno::Float3_typeof(), NULL);
    ::TYPES[77] = ::g::Fuse::Animations::DestinationBehavior__ValueHandler_typeof()->MakeType(::g::Uno::Float4_typeof(), NULL);
    ::TYPES[78] = ::g::Fuse::Reactive::IListener_typeof();
    ::TYPES[79] = type->MakeMethod(0/*OnValueUpdate<float>*/, ::g::Uno::Float_typeof(), NULL);
    ::TYPES[80] = type->MakeMethod(0/*OnValueUpdate<float2>*/, ::g::Uno::Float2_typeof(), NULL);
    ::TYPES[81] = type->MakeMethod(0/*OnValueUpdate<float3>*/, ::g::Uno::Float3_typeof(), NULL);
    ::TYPES[82] = type->MakeMethod(0/*OnValueUpdate<float4>*/, ::g::Uno::Float4_typeof(), NULL);
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetInterfaces(
        ::TYPES[70/*Uno.IDisposable*/], offsetof(::g::Fuse::Reactive::InnerListener_type, interface0),
        ::TYPES[78/*Fuse.Reactive.IListener*/], offsetof(::g::Fuse::Reactive::InnerListener_type, interface1));
    type->SetFields(2,
        ::TYPES[78/*Fuse.Reactive.IListener*/], offsetof(Attract__Subscription, _target), 0,
        ::g::Fuse::Animations::Attract_typeof(), offsetof(Attract__Subscription, _attract), 0,
        ::TYPES[70/*Uno.IDisposable*/], offsetof(Attract__Subscription, _sourceSub), 0,
        ::TYPES[69/*Fuse.Animations.DestinationBehavior<float4>*/], offsetof(Attract__Subscription, _simulation4), 0,
        ::TYPES[73/*Fuse.Animations.DestinationBehavior<float3>*/], offsetof(Attract__Subscription, _simulation3), 0,
        ::TYPES[72/*Fuse.Animations.DestinationBehavior<float2>*/], offsetof(Attract__Subscription, _simulation2), 0,
        ::TYPES[71/*Fuse.Animations.DestinationBehavior<float>*/], offsetof(Attract__Subscription, _simulation1), 0,
...
{
    uStackFrame __("Fuse.Animations.Attract.Subscription", "Dispose()");
    ::g::Fuse::Reactive::InnerListener__Dispose_fn(__this);

    if (__this->_sourceSub != NULL)
    {
        ::g::Uno::IDisposable::Dispose(uInterface(uPtr(__this->_sourceSub), ::TYPES[70/*Uno.IDisposable*/]));
...
{
    uStackFrame __("Fuse.Animations.Attract.Subscription", "OnNewData(Fuse.Reactive.IExpression,object)");
    ...
    if (__this->_simulation1 != NULL)
        ::g::Fuse::Animations::DestinationBehavior__SetValue_fn(uPtr(__this->_simulation1), uCRef(value.X), uDelegate::New(::TYPES[74/*Fuse.Animations.DestinationBehavior<float>.ValueHandler*/], (void*)Attract__Subscription__OnValueUpdate1_fn, __this));

    if (__this->_simulation2 != NULL)
        ::g::Fuse::Animations::DestinationBehavior__SetValue_fn(uPtr(__this->_simulation2), uCRef(::g::Uno::Float2__New2(value.X, value.Y)), uDelegate::New(::TYPES[75/*Fuse.Animations.DestinationBehavior<float2>.ValueHandler*/], (void*)Attract__Subscription__OnValueUpdate2_fn, __this));

    if (__this->_simulation3 != NULL)
        ::g::Fuse::Animations::DestinationBehavior__SetValue_fn(uPtr(__this->_simulation3), uCRef(::g::Uno::Float3__New2(value.X, value.Y, value.Z)), uDelegate::New(::TYPES[76/*Fuse.Animations.DestinationBehavior<float3>.ValueHandler*/], (void*)Attract__Subscription__OnValueUpdate3_fn, __this));

    if (__this->_simulation4 != NULL)
        ::g::Fuse::Animations::DestinationBehavior__SetValue_fn(uPtr(__this->_simulation4), uCRef(value), uDelegate::New(::TYPES[77/*Fuse.Animations.DestinationBehavior<float4>.ValueHandler*/], (void*)Attract__Subscription__OnValueUpdate4_fn, __this));
}
...
{
    uStackFrame __("Fuse.Animations.Attract.Subscription", "OnValueUpdate`1(T)");

    if (__this->_target == NULL)
        return;

    ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(__this->_target), ::TYPES[78/*Fuse.Reactive.IListener*/]), (uObject*)__this->_attract, uBoxPtr(__type->U(0), value));
}
...
{
    uStackFrame __("Fuse.Animations.Attract.Subscription", ".ctor(Fuse.Animations.Attract,Fuse.Reactive.IContext,Fuse.Reactive.IListener)");
    ctor_();
    _target = target;
    _attract = attract;
    _simulation4 = ((::g::Fuse::Animations::DestinationBehavior*)::g::Fuse::Animations::DestinationBehavior::New1(::TYPES[69/*Fuse.Animations.DestinationBehavior<float4>*/]));
...
{
    uStackFrame __("Fuse.Animations.Attract.Subscription", "CleanSimulation()");
...
{
    uStackFrame __("Fuse.Animations.Attract.Subscription", "Init(Fuse.Reactive.IContext)");
...
{
    uStackFrame __("Fuse.Animations.Attract.Subscription", "NeedSim(int)");
    ...
    if ((size < 0) || (size > 4))
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[24/*"Unexpected ...*/], uBox<int>(::g::Uno::Int_typeof(), size)), this, ::STRINGS[25/*"C:\\Users\\...*/], 134, ::STRINGS[26/*"NeedSim"*/]);
        return;
    }

    if ((size == 1) && (_simulation1 == NULL))
    {
        _simulation1 = ((::g::Fuse::Animations::DestinationBehavior*)::g::Fuse::Animations::DestinationBehavior::New1(::TYPES[71/*Fuse.Animations.DestinationBehavior<float>*/]));
        uPtr(_simulation1)->Motion = uPtr(_attract)->_config;
    }
    else if ((size == 2) && (_simulation2 == NULL))
    {
        _simulation2 = ((::g::Fuse::Animations::DestinationBehavior*)::g::Fuse::Animations::DestinationBehavior::New1(::TYPES[72/*Fuse.Animations.DestinationBehavior<float2>*/]));
        uPtr(_simulation2)->Motion = uPtr(_attract)->_config;
    }
    else if ((size == 3) && (_simulation3 == NULL))
    {
        _simulation3 = ((::g::Fuse::Animations::DestinationBehavior*)::g::Fuse::Animations::DestinationBehavior::New1(::TYPES[73/*Fuse.Animations.DestinationBehavior<float3>*/]));
...
{
    uStackFrame __("Fuse.Animations.Attract.Subscription", "OnValueUpdate1(float)");
    Attract__Subscription__OnValueUpdate_fn(this, ::TYPES[79/*Fuse.Animations.Attract.Subscription.OnValueUpdate<float>*/], uCRef(value));
}

// private void OnValueUpdate2(float2 value) [instance] :97
void Attract__Subscription::OnValueUpdate2(::g::Uno::Float2 value)
{
    uStackFrame __("Fuse.Animations.Attract.Subscription", "OnValueUpdate2(float2)");
    Attract__Subscription__OnValueUpdate_fn(this, ::TYPES[80/*Fuse.Animations.Attract.Subscription.OnValueUpdate<float2>*/], uCRef(value));
}

// private void OnValueUpdate3(float3 value) [instance] :96
void Attract__Subscription::OnValueUpdate3(::g::Uno::Float3 value)
{
    uStackFrame __("Fuse.Animations.Attract.Subscription", "OnValueUpdate3(float3)");
    Attract__Subscription__OnValueUpdate_fn(this, ::TYPES[81/*Fuse.Animations.Attract.Subscription.OnValueUpdate<float3>*/], uCRef(value));
}

// private void OnValueUpdate4(float4 value) [instance] :95
void Attract__Subscription::OnValueUpdate4(::g::Uno::Float4 value)
{
    uStackFrame __("Fuse.Animations.Attract.Subscription", "OnValueUpdate4(float4)");
    Attract__Subscription__OnValueUpdate_fn(this, ::TYPES[82/*Fuse.Animations.Attract.Subscription.OnValueUpdate<float4>*/], uCRef(value));
}
...
{
    ::TYPES[83] = ::g::Fuse::Animations::TrackProvider_typeof();
    ::TYPES[84] = ::g::Fuse::Animations::KeyframeTrack_typeof();
    ::TYPES[85] = ::g::Fuse::Animations::ITrackProvider_typeof();
    ::TYPES[50] = ::g::Fuse::Animations::ContinuousTrackProvider_typeof();
    type->SetDependencies(
    ...
    type->SetFields(5,
        ::TYPES[83/*Fuse.Animations.TrackProvider*/], offsetof(TrackAnimator, _discreteProvider), 0,
        ::g::Uno::Bool_typeof(), offsetof(TrackAnimator, _isDiscrete), 0,
        ::TYPES[83/*Fuse.Animations.TrackProvider*/], offsetof(TrackAnimator, _continuousProvider), 0,
        ...
        ::TYPES[84/*Fuse.Animations.KeyframeTrack*/], offsetof(TrackAnimator, _keyframeTrack), 0,
    ...
    type->Reflection.SetFunctions(17,
        ...
        new uFunction("get_Provider", NULL, (void*)TrackAnimator__get_Provider_fn, 0, false, ::TYPES[85/*Fuse.Animations.ITrackProvider*/], 0),
        new uFunction("set_Provider", NULL, (void*)TrackAnimator__set_Provider_fn, 0, false, uVoid_typeof(), 1, ::TYPES[85/*Fuse.Animations.ITrackProvider*/]),
...
void TrackAnimator__get_AnimatorVariant_fn(TrackAnimator* __this, int* __retval)
{
    ...
    if (__this->_discreteProvider != NULL)
        return *__retval = ::g::Fuse::Animations::TrackProvider::GetAnimatorVariant(uInterface(uPtr(__this->_discreteProvider), ::TYPES[83/*Fuse.Animations.TrackProvider*/]), __this), void();
    else if (__this->_continuousProvider != NULL)
        return *__retval = ::g::Fuse::Animations::TrackProvider::GetAnimatorVariant(uInterface(uPtr(__this->_continuousProvider), ::TYPES[83/*Fuse.Animations.TrackProvider*/]), __this), void();
...
void TrackAnimator__GetDurationWithDelay_fn(TrackAnimator* __this, int* dir, double* __retval)
{
    ...
    if (__this->_discreteProvider != NULL)
        duration = ::g::Fuse::Animations::TrackProvider::GetDuration(uInterface(uPtr(__this->_discreteProvider), ::TYPES[83/*Fuse.Animations.TrackProvider*/]), __this, dir_);
    else if (__this->_continuousProvider != NULL)
        duration = ::g::Fuse::Animations::TrackProvider::GetDuration(uInterface(uPtr(__this->_continuousProvider), ::TYPES[83/*Fuse.Animations.TrackProvider*/]), __this, dir_);
...
// public Fuse.Animations.ITrackProvider get_Provider() :88
void TrackAnimator__get_Provider_fn(TrackAnimator* __this, uObject** __retval)
{
    *__retval = __this->Provider();
}

// public void set_Provider(Fuse.Animations.ITrackProvider value) :94
...
// public Fuse.Animations.KeyframeInterpolation get_KeyframeInterpolation() [instance] :202
int TrackAnimator::KeyframeInterpolation()
{
    uStackFrame __("Fuse.Animations.TrackAnimator", "get_KeyframeInterpolation()");
    return ::g::Fuse::Animations::KeyframeTrack::Interpolation(uInterface(uPtr(KeyframeTrack()), ::TYPES[84/*Fuse.Animations.KeyframeTrack*/]));
}

// public void set_KeyframeInterpolation(Fuse.Animations.KeyframeInterpolation value) [instance] :203
void TrackAnimator::KeyframeInterpolation(int value)
{
    ...
    ::g::Fuse::Animations::KeyframeTrack::Interpolation(uInterface(uPtr(KeyframeTrack()), ::TYPES[84/*Fuse.Animations.KeyframeTrack*/]), value);
}

// public Uno.Collections.IList<Fuse.Animations.Keyframe> get_Keyframes() [instance] :245
uObject* TrackAnimator::Keyframes()
{
    uStackFrame __("Fuse.Animations.TrackAnimator", "get_Keyframes()");
    return ::g::Fuse::Animations::KeyframeTrack::Keyframes(uInterface(uPtr(KeyframeTrack()), ::TYPES[84/*Fuse.Animations.KeyframeTrack*/]));
}

// private Fuse.Animations.KeyframeTrack get_KeyframeTrack() [instance] :178
...
// public Fuse.Animations.ITrackProvider get_Provider() [instance] :88
uObject* TrackAnimator::Provider()
{
    if (_continuousProvider != NULL)
        return uAs<uObject*>(_continuousProvider, ::TYPES[85/*Fuse.Animations.ITrackProvider*/]);

    return NULL;
}

// public void set_Provider(Fuse.Animations.ITrackProvider value) [instance] :94
void TrackAnimator::Provider(uObject* value)
{
    _continuousProvider = NULL;

    if (uIs(value, ::TYPES[50/*Fuse.Animations.ContinuousTrackProvider*/]))
        _continuousProvider = uAs<uObject*>(value, ::TYPES[83/*Fuse.Animations.TrackProvider*/]);
}
...
static void TrackAnimatorState_build(uType* type)
{
    ...
    type->SetFields(3,
        ...
        ::TYPES[50/*Fuse.Animations.ContinuousTrackProvider*/], offsetof(TrackAnimatorState, _continuousProvider), 0,
        ::TYPES[16/*Fuse.Animations.DiscreteTrackProvider*/], offsetof(TrackAnimatorState, _discreteProvider), 0);
}
...
{
    ::TYPES[86] = ::g::Fuse::Animations::TransformAnimatorState_typeof();
    type->SetPrecalc(
...
{
    ::STRINGS[8] = uString::Const("Invalid seek");
    ::STRINGS[27] = uString::Const("C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Animations/1.4.0/TransformAnimator.uno");
    ::TYPES[12] = ::g::Fuse::Animations::IMixer_typeof();
    ::TYPES[87] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Transform_typeof(), NULL);
    ::TYPES[88] = ::g::Fuse::Transform_typeof();
    ::TYPES[67] = ::g::Fuse::Animations::IMixerHandle_typeof()->MakeType(::TYPES[88/*Fuse.Transform*/], NULL);
    type->SetDependencies(
        ::g::Uno::Diagnostics::Debug_typeof());
    type->SetFields(6,
        ::g::Fuse::Animations::TransformAnimator_typeof()->MakeType(type->T(0), NULL), offsetof(TransformAnimatorState, Animator1), 0,
        ::TYPES[67/*Fuse.Animations.IMixerHandle<Fuse.Transform>*/], offsetof(TransformAnimatorState, mixHandle), 0,
        type->T(0), offsetof(TransformAnimatorState, transform), 0,
        ::TYPES[87/*Uno.Action<Fuse.Transform>*/], offsetof(TransformAnimatorState, _matAct), 0,
...
void TransformAnimatorState__Disable_fn(TransformAnimatorState* __this)
{
    ...
    ::g::Fuse::Animations::IMixerHandle::Unregister(uInterface(uPtr(__this->mixHandle), ::TYPES[67/*Fuse.Animations.IMixerHandle<Fuse.Transform>*/]));
    __this->mixHandle = NULL;
    uPtr(uAs< ::g::Fuse::Transform*>(__this->transform, ::TYPES[88/*Fuse.Transform*/]))->remove_MatrixChanged(__this->_matAct);
...
void TransformAnimatorState__SeekValue_fn(TransformAnimatorState* __this, ::g::Uno::Float4* value, float* strength)
{
    ...
    if ((__this->mixHandle == NULL) || (__this->transform == NULL))
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[8/*"Invalid seek"*/], 0, ::STRINGS[27/*"C:/Users/Sh...*/], 171);
        return;
    }
...
void TransformAnimatorState::ctor_2(::g::Fuse::Animations::TransformAnimator* animator, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    _matAct = uDelegate::New(::TYPES[87/*Uno.Action<Fuse.Transform>*/], (void*)TransformAnimatorState__OnMatrixChanged_fn, this);
    uPtr(uAs< ::g::Fuse::Transform*>(transform, ::TYPES[88/*Fuse.Transform*/]))->add_MatrixChanged(_matAct);
...
{
    ::TYPES[89] = ::g::Fuse::Animations::AnimatorState_typeof()->Array();
    ::TYPES[90] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof(), NULL);
    ::TYPES[2] = ::g::Uno::Action_typeof();
    type->SetFields(0,
        ::TYPES[90/*Uno.Collections.List<Fuse.Animations.Animator>*/], offsetof(TriggerAnimation, _animators), 0,
        ...
        ::TYPES[2/*Uno.Action*/], offsetof(TriggerAnimation, TimeChanged1), 0);
...
// public bool get_HasAnimators() :40
...
uObject* TriggerAnimation::Animators()
{
    ...
    if (_animators == NULL)
        _animators = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[90/*Uno.Collections.List<Fuse.Animations.Animator>*/]));
...
uArray* TriggerAnimation::CreateAnimatorsState(int variant, ::g::Fuse::Visual* elm)
{
    ...
    if (_animators == NULL)
        return uArray::New(::TYPES[89/*Fuse.Animations.AnimatorState[]*/], 0);

    uArray* state = uArray::New(::TYPES[89/*Fuse.Animations.AnimatorState[]*/], uPtr(_animators)->Count());
...
// public bool get_HasAnimators() [instance] :40
...
// public double get_StretchDuration() [instance] :114
double TriggerAnimation::StretchDuration()
{
    return _stretchDuration;
}

// public void set_StretchDuration(double value) [instance] :115
...
{
    uStackFrame __("Fuse.Animations.TriggerAnimationState", "Fuse.Animations.IBasePlayerFeedback.OnPlaybackDone(object)");

    if (s != __this->_curPlayer)
        return;

    if (__this->Feedback != NULL)
        ::g::Fuse::Animations::IBasePlayerFeedback::OnPlaybackDone(uInterface(uPtr(__this->Feedback), ::TYPES[62/*Fuse.Animations.IBasePlayerFeedback*/]), __this);
}
...
{
    uStackFrame __("Fuse.Animations.TriggerAnimationState", "Fuse.Animations.IBasePlayerFeedback.OnStable(object)");

    if (s != __this->_curPlayer)
        return;

    if (__this->Feedback != NULL)
        ::g::Fuse::Animations::IBasePlayerFeedback::OnStable(uInterface(uPtr(__this->Feedback), ::TYPES[62/*Fuse.Animations.IBasePlayerFeedback*/]), __this);
}
...
{
    uStackFrame __("Fuse.Animations.TriggerAnimationState", "Fuse.Animations.IPlayerFeedback.OnProgressUpdated(object,Fuse.Animations.PlayerFeedbackFlags)");
    int flags_ = *flags;
...
// public double get_PreviousProgress() :451
...
void TriggerAnimationState::Dispose()
{
    ...
    uPtr(Animation())->remove_TimeChanged(uDelegate::New(::TYPES[2/*Uno.Action*/], (void*)TriggerAnimationState__OnTimeChanged_fn, this));
    Feedback = NULL;
...
// public double get_PreviousProgress() [instance] :451
