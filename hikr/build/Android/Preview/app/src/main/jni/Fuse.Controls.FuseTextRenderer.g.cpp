...
#include <Fuse.Controls.FuseTex-148cbbef.h>
#include <Fuse.Controls.FuseTex-2d99832d.h>
#include <Fuse.Controls.FuseTex-605a4b93.h>
#include <Fuse.Controls.FuseTex-74f69a8b.h>
#include <Fuse.Controls.FuseTex-7c93df0c.h>
#include <Fuse.Controls.FuseTex-7f6678da.h>
#include <Fuse.Controls.FuseTex-a0313cf6.h>
#include <Fuse.Controls.FuseTex-a3df34db.h>
#include <Fuse.Controls.FuseTex-b0def7da.h>
#include <Fuse.Controls.FuseTex-c7cdbff7.h>
#include <Fuse.Controls.FuseTex-f3912613.h>
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\1.4.0\TextControls\FuseTextRenderer\LoadAsync.uno
// ----------------------------------------------------------------------------------------------------------------------------
...
// public AsyncMeasurer(Fuse.Controls.FuseTextRenderer.CacheState state, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Action<Fuse.Controls.FuseTextRenderer.CacheState> done) :12
...
// public AsyncMeasurer New(Fuse.Controls.FuseTextRenderer.CacheState state, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Action<Fuse.Controls.FuseTextRenderer.CacheState> done) :12
...
// public AsyncMeasurer(Fuse.Controls.FuseTextRenderer.CacheState state, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Action<Fuse.Controls.FuseTextRenderer.CacheState> done) [instance] :12
...
// public AsyncMeasurer New(Fuse.Controls.FuseTextRenderer.CacheState state, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Action<Fuse.Controls.FuseTextRenderer.CacheState> done) [static] :12
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\1.4.0\TextControls\FuseTextRenderer\CacheState.uno
// -----------------------------------------------------------------------------------------------------------------------------
...
static void CacheState_build(uType* type)
{
    type->SetDependencies(
        ::g::Fuse::Controls::FuseTextRenderer::Helpers_typeof());
    type->SetInterfaces(
...
// protected generated CacheState() :137
void CacheState__ctor__fn(CacheState* __this)
{
    __this->ctor_();
}

// public virtual void Dispose() :174
void CacheState__Dispose_fn(CacheState* __this)
{
}

// public Fuse.Controls.FuseTextRenderer.CacheState GetBounds(Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Rect& bounds) :145
...
// public Fuse.Controls.FuseTextRenderer.CacheState GetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer) :157
...
// public virtual bool TryGetMeasurements(Fuse.Controls.FuseTextRenderer.TextControlData data, float2& measurements) :140
...
// public bool TryGetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer) :168
...
// public virtual bool TryGetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>>& positionedRuns) :162
...
// protected generated CacheState() [instance] :137
void CacheState::ctor_()
{
}

// public Fuse.Controls.FuseTextRenderer.CacheState GetBounds(Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Rect& bounds) [instance] :145
...
// public Fuse.Controls.FuseTextRenderer.CacheState GetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer) [instance] :157
...
// public bool TryGetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer) [instance] :168
...
// public override sealed void Dispose() :447
...
// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetMeasurements(Fuse.Controls.FuseTextRenderer.TextControlData data, float2& measurements) :394
...
// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>>& positionedRuns) :419
...
// public override sealed bool TryGetMeasurements(Fuse.Controls.FuseTextRenderer.TextControlData data, float2& measurements) :407
...
// public override sealed bool TryGetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>>& positionedRuns) :432
...
// public EverythingCached(Fuse.Controls.FuseTextRenderer.LogicalRunsCached previousState, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, float2 measurements, Fuse.Text.Renderer renderer, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> positionedRuns) [instance] :377
...
// public EverythingCached New(Fuse.Controls.FuseTextRenderer.LogicalRunsCached previousState, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, float2 measurements, Fuse.Text.Renderer renderer, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> positionedRuns) [static] :377
...
static void Helpers_build(uType* type)
{
    ...
    type->SetDependencies(
        ::g::Fuse::Text::Bidirectional::Runs_typeof(),
        ::g::Fuse::Controls::FuseTextRenderer::Tolerances_typeof(),
        ::g::Fuse::Text::Truncate_typeof(),
        ::g::Fuse::Text::Wrap_typeof());
}
...
// public static Fuse.Text.Renderer GetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>>& positionedRuns) :110
...
// public static float2 Measure(Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns) :103
...
// public static float ToAlignmentNumber(Fuse.Controls.TextAlignment alignment) :125
void Helpers__ToAlignmentNumber_fn(int* alignment, float* __retval)
{
    *__retval = Helpers::ToAlignmentNumber(*alignment);
}

// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> Wrap(Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.Bidirectional.Run>> logicalRuns, Fuse.Controls.FuseTextRenderer.Tolerances& tolerances) :74
...
// public static Fuse.Text.Renderer GetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>>& positionedRuns) [static] :110
...
// public static float2 Measure(Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns) [static] :103
...
// public static float ToAlignmentNumber(Fuse.Controls.TextAlignment alignment) [static] :125
...
// public static Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> Wrap(Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.Bidirectional.Run>> logicalRuns, Fuse.Controls.FuseTextRenderer.Tolerances& tolerances) [static] :74
::g::Uno::Collections::List* Helpers::Wrap(::g::Fuse::Controls::FuseTextRenderer::TextControlData data, ::g::Uno::Collections::List* logicalRuns, ::g::Fuse::Controls::FuseTextRenderer::Tolerances* tolerances)
{
    ...
    *tolerances = ::g::Fuse::Controls::FuseTextRenderer::Tolerances__New1(0);
    ...
    ::g::Uno::Collections::List* wrappedLines = (data.TextWrapping == 1) ? (::g::Uno::Collections::List*)::g::Fuse::Text::Wrap::Lines(data.Font, shapedRuns, data.PixelWidth + ::g::Fuse::Controls::FuseTextRenderer::Tolerances::Epsilon_, &(*tolerances).MinWrap, &(*tolerances).MaxWrap) : shapedRuns;
    ...
    switch (data.TextTruncation)
    {
        ...
        case 0:
        {
            ::g::Uno::Collections::List* result = ::g::Fuse::Text::Truncate::Lines(data.Font, wrappedLines, data.PixelWidth + ::g::Fuse::Controls::FuseTextRenderer::Tolerances::Epsilon_, &(*tolerances).MinTruncation, &(*tolerances).MaxTruncation);
            return result;
            break;
        }
        default:
...
// public LogicalRunsCached(string renderValue) :208
void LogicalRunsCached__ctor_1_fn(LogicalRunsCached* __this, uString* renderValue)
{
    __this->ctor_1(renderValue);
}

// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetMeasurements(Fuse.Controls.FuseTextRenderer.TextControlData data, float2& measurements) :214
...
// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>>& positionedRuns) :225
...
// public LogicalRunsCached New(string renderValue) :208
...
// public LogicalRunsCached(string renderValue) [instance] :208
...
// public LogicalRunsCached New(string renderValue) [static] :208
...
// public MeasurementsCached(Fuse.Controls.FuseTextRenderer.LogicalRunsCached previousState, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, float2 measurements) :245
...
// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetMeasurements(Fuse.Controls.FuseTextRenderer.TextControlData data, float2& measurements) :254
...
// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>>& positionedRuns) :278
...
// public MeasurementsCached New(Fuse.Controls.FuseTextRenderer.LogicalRunsCached previousState, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, float2 measurements) :245
...
// public override sealed bool TryGetMeasurements(Fuse.Controls.FuseTextRenderer.TextControlData data, float2& measurements) :266
...
// public MeasurementsCached(Fuse.Controls.FuseTextRenderer.LogicalRunsCached previousState, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, float2 measurements) [instance] :245
...
// public generated NothingCached() :177
void NothingCached__ctor_1_fn(NothingCached* __this)
{
    __this->ctor_1();
}

// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetMeasurements(Fuse.Controls.FuseTextRenderer.TextControlData data, float2& measurements) :179
...
// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>>& positionedRuns) :190
...
// public generated NothingCached New() :177
void NothingCached__New1_fn(NothingCached** __retval)
{
    *__retval = NothingCached::New1();
}

// public generated NothingCached() [instance] :177
void NothingCached::ctor_1()
{
    ctor_();
}

// public generated NothingCached New() [static] :177
...
// public RendererCached(Fuse.Controls.FuseTextRenderer.LogicalRunsCached previousState, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, Fuse.Text.Renderer renderer, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> positionedRuns) :304
...
// public override sealed void Dispose() :362
...
// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetMeasurements(Fuse.Controls.FuseTextRenderer.TextControlData data, float2& measurements) :314
...
// public override sealed Fuse.Controls.FuseTextRenderer.CacheState GetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>>& positionedRuns) :333
...
// public override sealed bool TryGetRenderer(Fuse.Controls.FuseTextRenderer.TextControlData data, Fuse.Text.Renderer& renderer, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>>& positionedRuns) :346
...
// public RendererCached(Fuse.Controls.FuseTextRenderer.LogicalRunsCached previousState, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, Fuse.Text.Renderer renderer, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> positionedRuns) [instance] :304
...
// public RendererCached New(Fuse.Controls.FuseTextRenderer.LogicalRunsCached previousState, Fuse.Controls.FuseTextRenderer.TextControlData data, Uno.Collections.List<Uno.Collections.List<Fuse.Text.ShapedRun>> wrappedRuns, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, Fuse.Text.Renderer renderer, Uno.Collections.List<Uno.Collections.List<Fuse.Text.PositionedRun>> positionedRuns) [static] :304
...
// public bool Subsumes(Fuse.Controls.FuseTextRenderer.TextControlData other, Fuse.Controls.FuseTextRenderer.Tolerances tolerances, bool measureOnly) :29
...
bool TextControlData::Subsumes(TextControlData other, ::g::Fuse::Controls::FuseTextRenderer::Tolerances tolerances, bool measureOnly)
{
    ...
    bool withinWrapTolerance = (measureOnly || (TextAlignment == 0)) ? ((tolerances.MinWrap - ::g::Fuse::Controls::FuseTextRenderer::Tolerances::Epsilon_) <= PixelWidth) && (PixelWidth <= (tolerances.MaxWrap + ::g::Fuse::Controls::FuseTextRenderer::Tolerances::Epsilon_)) : ::g::Uno::Math::Abs1(PixelWidth - other.PixelWidth) <= ::g::Fuse::Controls::FuseTextRenderer::Tolerances::Epsilon_;
    return ((((((((Font == other.Font) && ::g::Uno::String::op_Equality(RenderValue, other.RenderValue)) && (TextWrapping == other.TextWrapping)) && (TextTruncation == other.TextTruncation)) && (TextAlignment == other.TextAlignment)) && (::g::Uno::Math::Abs1(LineSpacing - other.LineSpacing) <= ::g::Fuse::Controls::FuseTextRenderer::Tolerances::Epsilon_)) && withinWrapTolerance) && ((tolerances.MinTruncation - ::g::Fuse::Controls::FuseTextRenderer::Tolerances::Epsilon_) <= PixelWidth)) && (PixelWidth <= (tolerances.MaxTruncation + ::g::Fuse::Controls::FuseTextRenderer::Tolerances::Epsilon_));
}

// public TextControlData New(Fuse.Text.Font font, Fuse.Controls.TextControl control, float pixelWidth) [static] :18
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\1.4.0\TextControls\FuseTextRenderer\FuseTextRenderer.uno
// -----------------------------------------------------------------------------------------------------------------------------------

// internal sealed class TextRenderer :14
// {
// static generated TextRenderer() :14
...
static void TextRenderer_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("C:/Users/Shumcom/AppData/Local/Fusetools/Packages/Fuse.Controls.Primitives/1.4.0/TextControls/FuseTextRenderer/FuseTextRenderer.uno");
    ...
    type->SetDependencies(
        ::g::Fuse::Internal::CacheItem_typeof()->MakeType(::g::Uno::Int_typeof(), ::g::Fuse::Text::Font_typeof(), NULL),
        ::g::Fuse::Internal::CacheItem_typeof()->MakeType(::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Internal::FontFaceDescriptor_typeof(), NULL), ::g::Fuse::Text::FontFace_typeof(), NULL),
...
// public TextRenderer(Fuse.Controls.TextControl control, bool loadAsync) :84
...
// public void Arrange(float2 position, float2 size) :176
void TextRenderer__Arrange_fn(TextRenderer* __this, ::g::Uno::Float2* position, ::g::Uno::Float2* size)
{
    __this->Arrange(*position, *size);
}

// private void AsyncMeasurementsDone(Fuse.Controls.FuseTextRenderer.CacheState state) :145
...
// private Fuse.Controls.FuseTextRenderer.TextControlData CreateTextControlData() :98
...
// private Fuse.Controls.FuseTextRenderer.TextControlData CreateTextControlData(float pointWidth) :103
...
// private static Fuse.Text.FontFace GetFallbackFontFace(Uno.Collections.List<Fuse.Internal.FontFaceDescriptor> descriptors) :23
...
// private static Fuse.Text.FontFace GetFontFace(Fuse.Internal.FontFaceDescriptor descriptor) :34
...
// public void SoftDispose() :220
void TextRenderer__SoftDispose_fn(TextRenderer* __this)
{
    __this->SoftDispose();
}

// private void UpdateFont() :188
...
// public TextRenderer(Fuse.Controls.TextControl control, bool loadAsync) [instance] :84
...
// public void Arrange(float2 position, float2 size) [instance] :176
...
// private void AsyncMeasurementsDone(Fuse.Controls.FuseTextRenderer.CacheState state) [instance] :145
void TextRenderer::AsyncMeasurementsDone(::g::Fuse::Controls::FuseTextRenderer::CacheState* state)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(_cacheState == NULL, ::STRINGS[3/*"this._cache...*/], ::STRINGS[4/*"C:/Users/Sh...*/], 148, uArray::New(::TYPES[7/*object[]*/], 0));
    _cacheState = state;
    uPtr(_control)->InvalidateLayout(2);
    uPtr(_control)->InvalidateVisual();
}

// private Fuse.Controls.FuseTextRenderer.TextControlData CreateTextControlData() [instance] :98
...
// private Fuse.Controls.FuseTextRenderer.TextControlData CreateTextControlData(float pointWidth) [instance] :103
...
// public void Draw(Fuse.DrawContext dc, Fuse.Visual where) [instance] :154
...
// public Fuse.Internal.CacheItem<int, Fuse.Text.Font> get_Font() [instance] :61
::g::Fuse::Internal::CacheItem TextRenderer::Font()
{
    return _font;
}

// private void set_Font(Fuse.Internal.CacheItem<int, Fuse.Text.Font> value) [instance] :62
...
// private Fuse.Internal.CacheItem<Uno.Collections.List<Fuse.Internal.FontFaceDescriptor>, Fuse.Text.FontFace> get_FontFace() [instance] :47
::g::Fuse::Internal::CacheItem TextRenderer::FontFace()
{
    return _fontFace;
}

// private void set_FontFace(Fuse.Internal.CacheItem<Uno.Collections.List<Fuse.Internal.FontFaceDescriptor>, Fuse.Text.FontFace> value) [instance] :48
...
// public float2 GetContentSize(Fuse.LayoutParams lp) [instance] :109
...
// public Uno.Rect GetRenderBounds() [instance] :206
...
// public void Invalidate() [instance] :182
...
// public void SoftDispose() [instance] :220
...
// private void UpdateFont() [instance] :188
...
// private static Fuse.Text.FontFace GetFallbackFontFace(Uno.Collections.List<Fuse.Internal.FontFaceDescriptor> descriptors) [static] :23
::g::Fuse::Text::FontFace* TextRenderer::GetFallbackFontFace(::g::Uno::Collections::List* descriptors)
{
    ...
    for (int i = 0; i < len; ++i)
        uPtr(fontFaces)->Item< ::g::Fuse::Internal::CacheItem>(i) = (::g::Fuse::Internal::Cache__Get_fn(uPtr(TextRenderer::_fontCache_), (::g::Uno::Collections::List__get_Item_fn(uPtr(descriptors), uCRef<int>(i), &ret3), ret3), &ret2), ret2);

    return ::g::Fuse::Text::FallingBackFontFace::New1(fontFaces);
}

// private static Fuse.Text.FontFace GetFontFace(Fuse.Internal.FontFaceDescriptor descriptor) [static] :34
...
// public TextRenderer New(Fuse.Controls.TextControl control, bool loadAsync) [static] :84
...
// {
// static generated Tolerances() :54
...
// public Tolerances New(int dummy) [static] :63
