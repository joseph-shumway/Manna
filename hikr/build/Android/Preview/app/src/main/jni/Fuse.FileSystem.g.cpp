...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.FileSystem\1.4.0\AndroidPaths.uno
// ----------------------------------------------------------------------------------------
...
// public generated AndroidPaths() :9
...
// public generated AndroidPaths New() :9
void AndroidPaths__New1_fn(AndroidPaths** __retval)
{
    *__retval = AndroidPaths::New1();
}

// public generated AndroidPaths() [instance] :9
...
{
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetCacheDirectory373", "()Ljava/lang/String;");
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetExternalCacheDirectory374", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetExternalFilesDirectory375", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetFilesDirectory376", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
// public generated AndroidPaths New() [static] :9
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.FileSystem\1.4.0\FileSystemOperations.uno
// ------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.FileSystem\1.4.0\Uno\IO\DirectoryInfo.uno
// ------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.FileSystem\1.4.0\Uno\IO\FileAttributes.uno
// -------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.FileSystem\1.4.0\Uno\IO\FileInfo.uno
// -------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.FileSystem\1.4.0\Uno\IO\FileStatus.uno
// ---------------------------------------------------------------------------------------------
...
// public Uno.Time.ZonedDateTime get_CreationTimeUtc() :51
...
// public Uno.Time.ZonedDateTime get_CreationTimeUtc() [instance] :51
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.FileSystem\1.4.0\Uno\IO\FileStatusHelpers.Unix.uno
// ---------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.FileSystem\1.4.0\Uno\IO\FileSystemInfo.uno
// -------------------------------------------------------------------------------------------------
...
// public Fuse.FileSystem.FileAttributes get_Attributes() :47
...
// public Fuse.FileSystem.FileAttributes get_Attributes() [instance] :47
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.FileSystem\1.4.0\FileSystemModule.uno
// --------------------------------------------------------------------------------------------
...
static void FileSystemModule_build(uType* type)
{
    ...
    ::TYPES[27] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(9/*ToArray<object>*/, uObject_typeof(), NULL);
    ...
    type->MethodTypes[1]->SetPrecalc(
        ::TYPES[28/*Uno.Collections.EnumerableExtensions*/]->MakeMethod(5/*OfType<T, object>*/, type->MethodTypes[1]->U(0), uObject_typeof(), NULL),
...
uArray* FileSystemOperations::ListDirectoriesSync(uString* path)
{
    ...
    return (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[28/*Uno.Collections.EnumerableExtensions*/]->MakeMethod(9/*ToArray<string>*/, ::TYPES[26/*string*/], NULL), (uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[28/*Uno.Collections.EnumerableExtensions*/]->MakeMethod(7/*Select<string, string>*/, ::TYPES[26/*string*/], ::TYPES[26/*string*/], NULL), ::g::Uno::IO::Directory::EnumerateDirectories(path), uDelegate::New(::g::Uno::Func1_typeof()->MakeType(::TYPES[26/*string*/], ::TYPES[26/*string*/], NULL), (void*)::g::Fuse::FileSystem::PathTools__NormalizePath_fn)));
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.FileSystem\1.4.0\Nothing.uno
// -----------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.FileSystem\1.4.0\PathTools.uno
// -------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.FileSystem\1.4.0\UnifiedPaths.Android.uno
// ------------------------------------------------------------------------------------------------
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetDataDirectory378", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
