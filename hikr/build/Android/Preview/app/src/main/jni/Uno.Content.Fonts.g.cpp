...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Fonts\BitmapFont.uno
// -------------------------------------------------------------------------------------------------------
...
// public static Uno.Content.Fonts.BitmapFont CreateFromPbf(Uno.Buffer pbf, texture2D tex) :63
...
// public static Uno.Content.Fonts.BitmapFont CreateFromPbf(Uno.Buffer pbf, texture2D tex) [static] :63
BitmapFont* BitmapFont::CreateFromPbf(::g::Uno::Buffer* pbf, ::g::Uno::Graphics::Texture2D* tex)
{
    ...
    if (magic != 21386064U)
        U_THROW(::g::Uno::Exception::New2(uString::Const("Corrupt PBF bitmap font file: Invalid magic number")));
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Fonts\CppFontFace.uno
// --------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Fonts\DefaultTextTransform.uno
// -----------------------------------------------------------------------------------------------------------------
...
static void DefaultTextTransform_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:/Users/Shumcom/AppData/Local/Fusetools/Packages/UnoCore/1.4.3/Source/Uno/Content/Fonts/DefaultTextTransform.uno");
...
{
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[0/*"DefaultText...*/], 0, ::STRINGS[1/*"C:/Users/Sh...*/], 26);
    return *__retval = __this->_matrix, void();
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Fonts\FontFace.uno
// -----------------------------------------------------------------------------------------------------

// public abstract class FontFace :9
// {
...
// protected generated FontFace() :9
void FontFace__ctor__fn(FontFace* __this)
{
    __this->ctor_();
}

// public static Uno.Content.Fonts.FontFace Load(string name, byte[] data, int offset, int length) :30
...
// public static Uno.Content.Fonts.FontFace Load(Uno.IO.BundleFile file) :12
void FontFace__Load1_fn(::g::Uno::IO::BundleFile* file, FontFace** __retval)
{
    *__retval = FontFace::Load1(file);
}

// protected generated FontFace() [instance] :9
void FontFace::ctor_()
{
}

// public static Uno.Content.Fonts.FontFace Load(string name, byte[] data, int offset, int length) [static] :30
...
// public static Uno.Content.Fonts.FontFace Load(Uno.IO.BundleFile file) [static] :12
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Fonts\FontFaceHelpers.uno
// ------------------------------------------------------------------------------------------------------------
...
::g::Uno::Content::Fonts::BitmapFont* FontFaceHelpers::RenderSpriteFont(::g::Uno::Content::Fonts::FontFace* font, float size, uString* charset)
{
    ...
    int gi = 0;
    ::g::Uno::Collections::Dictionary__Enumerator<uChar, ::g::Uno::Content::Fonts::RenderedGlyph> enum2 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(glyphs), &ret4), ret4);
    ...
    {
        {
            ...
            {
                ::g::Uno::Collections::KeyValuePair<uChar, ::g::Uno::Content::Fonts::RenderedGlyph> e = enum2.Current(::TYPES[1/*Uno.Collections.Dictionary<char, Uno.Content.Fonts.RenderedGlyph>.Enumerator*/]);
                ...
                ::g::Uno::Collections::Dictionary__Add_fn(uPtr(uPtr(result)->Glyphs), uCRef<uChar>(e.Key(::TYPES[2/*Uno.Collections.KeyValuePair<char, Uno.Content.Fonts.RenderedGlyph>*/])), uCRef(g1));
                ::g::Uno::Collections::Dictionary__Add_fn(uPtr(result->Advances), uCRef<uChar>(e.Key(::TYPES[2/*Uno.Collections.KeyValuePair<char, Uno.Content.Fonts.RenderedGlyph>*/])), uCRef(g1.Advance));
            }
        }
        {
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Fonts\RenderedGlyph.uno
// ----------------------------------------------------------------------------------------------------------
...
// public RenderedGlyph(float2 advance, float2 bearing, Uno.Content.Images.Bitmap bitmap) :13
...
// public RenderedGlyph New(float2 advance, float2 bearing, Uno.Content.Images.Bitmap bitmap) :13
...
// public RenderedGlyph(float2 advance, float2 bearing, Uno.Content.Images.Bitmap bitmap) [instance] :13
...
// public RenderedGlyph New(float2 advance, float2 bearing, Uno.Content.Images.Bitmap bitmap) [static] :13
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Fonts\SdfFontShader.uno
// ----------------------------------------------------------------------------------------------------------
...
{
    type->SetFields(0,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall_typeof(), offsetof(SdfFontShader, _draw_379fdedc), 0);
    type->Reflection.SetFunctions(1,
...
// public generated SdfFontShader() :23
void SdfFontShader__ctor_1_fn(SdfFontShader* __this)
{
    __this->ctor_1();
}

// public override sealed void Draw(Uno.Content.Fonts.TextShaderData data) :25
...
// private generated void init_DrawCalls() [instance] :23
...
// public generated SdfFontShader New() [static] :23
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Fonts\SpriteFontShader.uno
// -------------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Fonts\TextRenderer.uno
// ---------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Fonts\TextShader.uno
// -------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Fonts\TextTransform.uno
// ----------------------------------------------------------------------------------------------------------
