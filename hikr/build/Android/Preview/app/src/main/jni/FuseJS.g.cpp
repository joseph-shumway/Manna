...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\FuseJS\1.4.0\Base64.uno
// -------------------------------------------------------------------------
...
static void Base64_build(uType* type)
{
    ...
    ::TYPES[2] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(3/*FirstOrDefault<object>*/, uObject_typeof(), NULL);
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\FuseJS\1.4.0\Bundle.uno
// -------------------------------------------------------------------------
...
static void Bundle_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(6,
        new uFunction("Extract", NULL, (void*)Bundle__Extract_fn, 0, true, ::g::Uno::Threading::Future1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), 1, uObject_typeof()->Array()),
        new uFunction("GetList", NULL, (void*)Bundle__GetList_fn, 0, true, ::g::Uno::Threading::Future1_typeof()->MakeType(::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof(), NULL), NULL), 1, uObject_typeof()->Array()),
        new uFunction(".ctor", NULL, (void*)Bundle__New2_fn, 0, true, type, 0),
        new uFunction("ReadAsync", NULL, (void*)Bundle__ReadAsync_fn, 0, true, ::g::Uno::Threading::Future1_typeof()->MakeType(::g::Uno::String_typeof(), NULL), 1, uObject_typeof()->Array()),
        new uFunction("ReadBuffer", NULL, (void*)Bundle__ReadBuffer_fn, 0, true, ::g::Uno::Threading::Future1_typeof()->MakeType(::g::Uno::Byte_typeof()->Array(), NULL), 1, uObject_typeof()->Array()),
        new uFunction("ReadSync", NULL, (void*)Bundle__ReadSync1_fn, 0, true, ::g::Uno::String_typeof(), 1, ::g::Uno::String_typeof()));
}
...
{
    uStackFrame __("FuseJS.Bundle", "Extract(object[])");
    uString* ret4;
    uString* ret5;
    bool ret6;
    uString* searchPath = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault1_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(3/*ValueOrDefault<string>*/, ::TYPES[1/*string*/], NULL), args, uCRef<int>(0), ::STRINGS[23/*""*/], &ret4), ret4);
    uString* destinationPath = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault1_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(3/*ValueOrDefault<string>*/, ::TYPES[1/*string*/], NULL), args, uCRef<int>(1), ::STRINGS[23/*""*/], &ret5), ret5);
    bool overwrite = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault1_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(3/*ValueOrDefault<bool>*/, ::g::Uno::Bool_typeof(), NULL), args, uCRef<int>(2), uCRef(false), &ret6), ret6);
...
{
    uStackFrame __("FuseJS.Bundle", "GetList([object[]])");
...
{
    uStackFrame __("FuseJS.Bundle", "ListConverter(Fuse.Scripting.Context,Uno.Collections.IEnumerable<Uno.IO.BundleFile>)");
...
{
    uStackFrame __("FuseJS.Bundle", "ReadBuffer(object[])");
    uString* ret8;
    uString* searchPath = (::g::Fuse::Scripting::JSObjectUtils__ValueOrDefault1_fn(::g::Fuse::Scripting::JSObjectUtils_typeof()->MakeMethod(3/*ValueOrDefault<string>*/, ::TYPES[1/*string*/], NULL), args, uCRef<int>(0), ::STRINGS[23/*""*/], &ret8), ret8);
...
{
    uStackFrame __("FuseJS.Bundle", "ReadSync(Fuse.Scripting.Context,object[])");
...
{
    uStackFrame __("FuseJS.Bundle", "ReadSync(string)");
...
::g::Uno::Threading::Future1* Bundle::Reject(uType* __type, uString* reason)
{
    ...
    uStackFrame __("FuseJS.Bundle", "Reject`1(string)");
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\FuseJS\1.4.0\Environment.uno
// ------------------------------------------------------------------------------
...
void Environment::ctor_2()
{
    ...
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[5/*Fuse.Scripting.NativeProperty<bool, bool>*/], ::STRINGS[19/*"preview"*/], uCRef(true), &ret6), ret6));
    ...
    AddMember((::g::Fuse::Scripting::NativeProperty__New3_fn(::TYPES[5/*Fuse.Scripting.NativeProperty<bool, bool>*/], ::STRINGS[21/*"host_mac"*/], uCRef(false), &ret8), ret8));
...
{
    uStackFrame __("FuseJS.Bundle.ExtractClosure", "Invoke()");
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\FuseJS\1.4.0\FileReader.uno
// -----------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\FuseJS\1.4.0\Globals.uno
// --------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\FuseJS\1.4.0\Latin1Helpers.uno
// --------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\FuseJS\1.4.0\Lifecycle.uno
// ----------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\FuseJS\1.4.0\UserEvents.uno
// -----------------------------------------------------------------------------
...
static void RaiseEvent_build(uType* type)
{
    ...
    ::STRINGS[51] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\FuseJS\\1.4.0\\UserEvents.uno");
...
void RaiseEvent::Raise()
{
    ...
    if (dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[50/*"Cannot find...*/], Name), this, ::STRINGS[51/*"C:\\Users\\...*/], 20, ::STRINGS[52/*"Raise"*/], NULL);
        return;
    }
...
{
    uStackFrame __("FuseJS.Bundle.ReadBufferClosure", "Invoke()");
    ::g::Uno::IO::BundleFile* bfile;
...
uObject* UserEvents::Raise(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[55/*"The FuseJS/...*/], context, ::STRINGS[51/*"C:\\Users\\...*/], 51, ::STRINGS[52/*"Raise"*/]);
