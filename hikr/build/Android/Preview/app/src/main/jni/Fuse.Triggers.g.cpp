...
#include <Fuse.Triggers.WhileVi-ed2f3bf.h>
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\AddingAnimation.uno
// -----------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Platforms.uno
// -----------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Busy.uno
// ------------------------------------------------------------------------------
...
static void Busy_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\Busy.ScriptClass.uno");
    ...
    ::STRINGS[7] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\Busy.uno");
...
void Busy::UpdateState()
{
    ...
    if ((_rootOn & 1) == 1)
    {
        ...
        {
            _rootOn = (_rootOn & -2);
            ::g::Fuse::Diagnostics::UserError(::STRINGS[6/*"On='Paramet...*/], this, ::STRINGS[7/*"C:\\Users\\...*/], 132, ::STRINGS[8/*"UpdateState"*/], NULL);
        }
        else
...
{
    uStackFrame __("Fuse.Triggers.Busy", "activate(Fuse.Scripting.Context,Fuse.Triggers.Busy,object[])");
    Busy_typeof()->Init();

    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[2/*"Busy.activa...*/], b, ::STRINGS[3/*"C:\\Users\\...*/], 29, ::STRINGS[0/*"activate"*/], NULL);
        return;
    }
...
{
    uStackFrame __("Fuse.Triggers.Busy", "deactivate(Fuse.Scripting.Context,Fuse.Triggers.Busy,object[])");
    Busy_typeof()->Init();

    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"Busy.deacti...*/], b, ::STRINGS[3/*"C:\\Users\\...*/], 47, ::STRINGS[1/*"deactivate"*/], NULL);
        return;
    }
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\BusyTask.uno
// ----------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\BusyTaskModule.uno
// ----------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Completed.uno
// -----------------------------------------------------------------------------------
...
static void Completed_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\Completed.ScriptClass.uno");
    ::TYPES[1] = ::g::Uno::Type_typeof();
    ::TYPES[2] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
...
{
    uStackFrame __("Fuse.Triggers.Completed", "reset(Fuse.Scripting.Context,Fuse.Triggers.Completed,object[])");
    Completed_typeof()->Init();

    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[10/*"Completed.r...*/], cp, ::STRINGS[11/*"C:\\Users\\...*/], 28, ::STRINGS[9/*"reset"*/], NULL);
        return;
    }
...
static void BusyTaskModule__ConstructorClosure_build(uType* type)
{
    ...
    ::STRINGS[13] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\BusyTaskModule.uno");
...
uObject* BusyTaskModule__ConstructorClosure::Construct(uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[12/*"Use the `Bu...*/], this, ::STRINGS[13/*"C:\\Users\\...*/], 40, ::STRINGS[14/*"Construct"*/]);
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\1.4.0\Triggers\ContainsText.uno
// ----------------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[17] = uString::Const("Use the trigger WhileContainsText instead");
    ::STRINGS[18] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Primitives\\1.4.0\\Triggers\\ContainsText.uno");
...
{
    ctor_6();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[17/*"Use the tri...*/], this, ::STRINGS[18/*"C:\\Users\\...*/], 77, ::STRINGS[19/*".ctor"*/]);
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\1.4.0\Triggers\ScrollRegion.uno
// ----------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Trigger.uno
// ---------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\StateGroup.uno
// ------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\Playback.uno
// ------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls\1.4.0\Triggers\WhileInteracting.uno
// ---------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\ProgressAnimation.uno
// -------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Timeline.uno
// ----------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\IValue.uno
// --------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\OnKeyPress.uno
// ------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.0\Triggers\LayoutAnimation.uno
// --------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[20] = uString::Const("LayoutAnimation can only be used on an Element");
    ::STRINGS[21] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.4.0\\Triggers\\LayoutAnimation.uno");
    ::STRINGS[22] = uString::Const("OnRooted");
...
void LayoutAnimation__OnRooted_fn(LayoutAnimation* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[20/*"LayoutAnima...*/], __this, ::STRINGS[21/*"C:\\Users\\...*/], 227, ::STRINGS[22/*"OnRooted"*/], NULL);
        return;
    }
...
{
    ::TYPES[20] = ::g::Fuse::Input::KeyPressedHandler_typeof();
    ::TYPES[21] = ::g::Fuse::Triggers::KeyPressHandler_typeof();
    type->SetDependencies(
    ...
    type->SetFields(37,
        ...
        ::TYPES[21/*Fuse.Triggers.KeyPressHandler*/], offsetof(OnKeyPress, Handler1), 0);
    type->Reflection.SetFunctions(5,
        new uFunction("add_Handler", NULL, (void*)OnKeyPress__add_Handler_fn, 0, false, uVoid_typeof(), 1, ::TYPES[21/*Fuse.Triggers.KeyPressHandler*/]),
        new uFunction("remove_Handler", NULL, (void*)OnKeyPress__remove_Handler_fn, 0, false, uVoid_typeof(), 1, ::TYPES[21/*Fuse.Triggers.KeyPressHandler*/]),
...
void OnKeyPress__OnRooted_fn(OnKeyPress* __this)
{
    ...
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    ::g::Fuse::VisualEvent__AddGlobalHandler_fn(uPtr(::g::Fuse::Input::Keyboard::KeyPressed()), uDelegate::New(::TYPES[20/*Fuse.Input.KeyPressedHandler*/], (void*)OnKeyPress__OnKeyPressed_fn, __this));
}
...
void OnKeyPress__OnUnrooted_fn(OnKeyPress* __this)
{
    ...
    ::g::Fuse::VisualEvent__RemoveGlobalHandler_fn(uPtr(::g::Fuse::Input::Keyboard::KeyPressed()), uDelegate::New(::TYPES[20/*Fuse.Input.KeyPressedHandler*/], (void*)OnKeyPress__OnKeyPressed_fn, __this));
    ::g::Fuse::Triggers::Trigger__OnUnrooted_fn(__this);
}
...
void OnKeyPress::add_Handler(uDelegate* value)
{
    ...
    Handler1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Handler1, value), ::TYPES[21/*Fuse.Triggers.KeyPressHandler*/]);
}
...
void OnKeyPress::remove_Handler(uDelegate* value)
{
    ...
    Handler1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Handler1, value), ::TYPES[21/*Fuse.Triggers.KeyPressHandler*/]);
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.UserEvents\1.4.0\OnUserEvent.uno
// ---------------------------------------------------------------------------------------
...
{
    ::STRINGS[23] = uString::Const("OnUserEvent requires a `EventName`");
    ::STRINGS[24] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.UserEvents\\1.4.0\\OnUserEvent.uno");
    ::STRINGS[22] = uString::Const("OnRooted");
    ::TYPES[22] = ::g::Fuse::UserEventHandler_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof(),
    ...
    type->SetFields(37,
        ...
        ::TYPES[22/*Fuse.UserEventHandler*/], offsetof(OnUserEvent, Handler1), 0);
    type->Reflection.SetFunctions(7,
        ...
        new uFunction("add_Handler", NULL, (void*)OnUserEvent__add_Handler_fn, 0, false, uVoid_typeof(), 1, ::TYPES[22/*Fuse.UserEventHandler*/]),
        new uFunction("remove_Handler", NULL, (void*)OnUserEvent__remove_Handler_fn, 0, false, uVoid_typeof(), 1, ::TYPES[22/*Fuse.UserEventHandler*/]),
...
void OnUserEvent__OnRooted_fn(OnUserEvent* __this)
{
    ...
    if (::g::Uno::String::op_Equality(::g::Uno::UX::Selector__op_Implicit1(__this->EventName()), NULL))
        ::g::Fuse::Diagnostics::UserError(::STRINGS[23/*"OnUserEvent...*/], __this, ::STRINGS[24/*"C:\\Users\\...*/], 97, ::STRINGS[22/*"OnRooted"*/], NULL);
    else
    {
        __this->_rootedEvent = ::g::Fuse::UserEventDispatch::GetByName(__this->EventName());
        uPtr(__this->_rootedEvent)->add_Raised(uDelegate::New(::TYPES[22/*Fuse.UserEventHandler*/], (void*)OnUserEvent__OnRaised_fn, __this));
    }
...
void OnUserEvent__OnUnrooted_fn(OnUserEvent* __this)
{
    ...
    {
        uPtr(__this->_rootedEvent)->remove_Raised(uDelegate::New(::TYPES[22/*Fuse.UserEventHandler*/], (void*)OnUserEvent__OnRaised_fn, __this));
...
void OnUserEvent::add_Handler(uDelegate* value)
{
    ...
    Handler1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Handler1, value), ::TYPES[22/*Fuse.UserEventHandler*/]);
}
...
void OnUserEvent::remove_Handler(uDelegate* value)
{
    ...
    Handler1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Handler1, value), ::TYPES[22/*Fuse.UserEventHandler*/]);
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.WebView\1.4.0\PageBeginLoading.uno
// --------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[25] = uString::Const("WebView");
    ::STRINGS[26] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.WebView\\1.4.0\\PageBeginLoading.uno");
    ::STRINGS[22] = uString::Const("OnRooted");
    ::TYPES[23] = ::g::Fuse::Controls::IWebView_typeof();
    ::TYPES[6] = ::g::Uno::EventHandler_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface7));
    type->SetFields(37,
        ::TYPES[23/*Fuse.Controls.IWebView*/], offsetof(PageBeginLoading, _webView), 0);
    type->Reflection.SetFunctions(1,
...
void PageBeginLoading__OnRooted_fn(PageBeginLoading* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[23/*Fuse.Controls.IWebView*/]))
    {
        __this->_webView = uAs<uObject*>(__this->Parent(), ::TYPES[23/*Fuse.Controls.IWebView*/]);
        ::g::Fuse::Controls::IWebView::add_BeginLoading(uInterface(uPtr(__this->_webView), ::TYPES[23/*Fuse.Controls.IWebView*/]), uDelegate::New(::TYPES[6/*Uno.EventHandler*/], (void*)PageBeginLoading__OnPageBeginLoading_fn, __this));
    }
    else
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[25/*"WebView"*/], __this->Parent(), __this, ::STRINGS[26/*"C:\\Users\\...*/], 36, ::STRINGS[22/*"OnRooted"*/]);
}
...
void PageBeginLoading__OnUnrooted_fn(PageBeginLoading* __this)
{
    ...
    {
        ::g::Fuse::Controls::IWebView::remove_BeginLoading(uInterface(uPtr(__this->_webView), ::TYPES[23/*Fuse.Controls.IWebView*/]), uDelegate::New(::TYPES[6/*Uno.EventHandler*/], (void*)PageBeginLoading__OnPageBeginLoading_fn, __this));
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.WebView\1.4.0\PageLoaded.uno
// --------------------------------------------------------------------------------------------
...
{
    ::STRINGS[25] = uString::Const("WebView");
    ::STRINGS[27] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.WebView\\1.4.0\\PageLoaded.uno");
    ::STRINGS[22] = uString::Const("OnRooted");
    ::TYPES[23] = ::g::Fuse::Controls::IWebView_typeof();
    ::TYPES[6] = ::g::Uno::EventHandler_typeof();
    type->SetDependencies(
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface7));
    type->SetFields(37,
        ::TYPES[23/*Fuse.Controls.IWebView*/], offsetof(PageLoaded, _webView), 0);
    type->Reflection.SetFunctions(1,
...
void PageLoaded__OnRooted_fn(PageLoaded* __this)
{
    ...
    {
        __this->_webView = uAs<uObject*>(__this->Parent(), ::TYPES[23/*Fuse.Controls.IWebView*/]);
        ::g::Fuse::Controls::IWebView::add_PageLoaded(uInterface(uPtr(__this->_webView), ::TYPES[23/*Fuse.Controls.IWebView*/]), uDelegate::New(::TYPES[6/*Uno.EventHandler*/], (void*)PageLoaded__OnPageLoaded_fn, __this));
    }
    else
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[25/*"WebView"*/], __this->Parent(), __this, ::STRINGS[27/*"C:\\Users\\...*/], 36, ::STRINGS[22/*"OnRooted"*/]);
}
...
void PageLoaded__OnUnrooted_fn(PageLoaded* __this)
{
    ...
    if (__this->_webView != NULL)
    {
        ::g::Fuse::Controls::IWebView::remove_PageLoaded(uInterface(uPtr(__this->_webView), ::TYPES[23/*Fuse.Controls.IWebView*/]), uDelegate::New(::TYPES[6/*Uno.EventHandler*/], (void*)PageLoaded__OnPageLoaded_fn, __this));
        __this->_webView = NULL;
    }
...
{
    ::TYPES[24] = ::g::Fuse::Triggers::IProgress_typeof();
    ::TYPES[25] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Uno::Double_typeof(), NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface7));
    type->SetFields(37,
        ::TYPES[24/*Fuse.Triggers.IProgress*/], offsetof(ProgressAnimation, _source), 0,
        ::TYPES[24/*Fuse.Triggers.IProgress*/], offsetof(ProgressAnimation, _progress), 0,
    ...
    type->Reflection.SetFunctions(3,
        ...
        new uFunction("get_Source", NULL, (void*)ProgressAnimation__get_Source_fn, 0, false, ::TYPES[24/*Fuse.Triggers.IProgress*/], 0),
        new uFunction("set_Source", NULL, (void*)ProgressAnimation__set_Source_fn, 0, false, uVoid_typeof(), 1, ::TYPES[24/*Fuse.Triggers.IProgress*/]));
}
...
void ProgressAnimation::DeinitProgress()
{
    ...
    if (_progress != NULL)
    {
        ::g::Fuse::Triggers::IProgress::remove_ProgressChanged(uInterface(uPtr(_progress), ::TYPES[24/*Fuse.Triggers.IProgress*/]), uDelegate::New(::TYPES[25/*Uno.UX.ValueChangedHandler<double>*/], (void*)ProgressAnimation__OnChanged_fn, this));
        _progress = NULL;
    }
}
...
uObject* ProgressAnimation::FindIProgress()
{
    ...
    while ((p != NULL) && !uIs(p, ::TYPES[24/*Fuse.Triggers.IProgress*/]))
        p = uPtr(p)->Parent();

    return uAs<uObject*>(p, ::TYPES[24/*Fuse.Triggers.IProgress*/]);
}
...
void ProgressAnimation::InitProgress()
{
    ...
    if (_progress != NULL)
    {
        ::g::Fuse::Triggers::IProgress::add_ProgressChanged(uInterface(uPtr(_progress), ::TYPES[24/*Fuse.Triggers.IProgress*/]), uDelegate::New(::TYPES[25/*Uno.UX.ValueChangedHandler<double>*/], (void*)ProgressAnimation__OnChanged_fn, this));
        _prevValue = ::g::Fuse::Triggers::IProgress::Progress(uInterface(uPtr(_progress), ::TYPES[24/*Fuse.Triggers.IProgress*/]));
...
void ProgressAnimation::OnChanged(uObject* s, uObject* a)
{
    ...
    double p = ::g::Fuse::Triggers::IProgress::Progress(uInterface(uPtr(_progress), ::TYPES[24/*Fuse.Triggers.IProgress*/]));
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\1.4.0\Triggers\PullToReload.uno
// ----------------------------------------------------------------------------------------------------------
...
{
    ::TYPES[26] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Triggers::State_typeof(), NULL);
    ::TYPES[27] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Triggers::State_typeof(), NULL);
    ::TYPES[0] = ::g::Uno::Action_typeof();
    ::TYPES[28] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof(), NULL);
    ::TYPES[29] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Triggers::Actions::TriggerAction_typeof(), NULL);
    ::TYPES[30] = ::g::Fuse::VisualEventHandler_typeof();
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::ScrollingAnimation_type, interface4),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::ScrollingAnimation_type, interface5),
    ...
    type->SetFields(47,
        ...
        ::TYPES[30/*Fuse.VisualEventHandler*/], offsetof(PullToReload, ReloadHandler1), 0);
    type->Reflection.SetFunctions(13,
        ...
        new uFunction("add_ReloadHandler", NULL, (void*)PullToReload__add_ReloadHandler_fn, 0, false, uVoid_typeof(), 1, ::TYPES[30/*Fuse.VisualEventHandler*/]),
        new uFunction("remove_ReloadHandler", NULL, (void*)PullToReload__remove_ReloadHandler_fn, 0, false, uVoid_typeof(), 1, ::TYPES[30/*Fuse.VisualEventHandler*/]),
...
void PullToReload::Ensure(::g::Fuse::Triggers::State* s)
{
    ...
    if (!(::g::Uno::Collections::ICollection::Contains_ex(uInterface(uPtr(uPtr(StateGroup)->States()), ::TYPES[26/*Uno.Collections.ICollection<Fuse.Triggers.State>*/]), s, &ret5), ret5))
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(StateGroup)->States()), ::TYPES[26/*Uno.Collections.ICollection<Fuse.Triggers.State>*/]), s);
}
...
void PullToReload::EnsureStates()
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(uPtr(StateGroup)->States()), ::TYPES[26/*Uno.Collections.ICollection<Fuse.Triggers.State>*/])); i++)
        if (!IsState((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(uPtr(StateGroup)->States()), ::TYPES[27/*Uno.Collections.IList<Fuse.Triggers.State>*/]), uCRef<int>(i), &ret6), ret6)))
            ::g::Uno::Collections::IList::RemoveAt(uInterface(uPtr(uPtr(StateGroup)->States()), ::TYPES[27/*Uno.Collections.IList<Fuse.Triggers.State>*/]), i--);
...
void PullToReload::InitializeUX()
{
    ...
    temp3->Duration(1.0);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Animators()), ::TYPES[28/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp3);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Actions()), ::TYPES[29/*Uno.Collections.ICollection<Fuse.Triggers.Actions.TriggerAction>*/]), temp);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Actions()), ::TYPES[29/*Uno.Collections.ICollection<Fuse.Triggers.Actions.TriggerAction>*/]), temp1);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Actions()), ::TYPES[29/*Uno.Collections.ICollection<Fuse.Triggers.Actions.TriggerAction>*/]), temp2);
}
...
void PullToReload::add_ReloadHandler(uDelegate* value)
{
    ...
    ReloadHandler1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(ReloadHandler1, value), ::TYPES[30/*Fuse.VisualEventHandler*/]);
}
...
void PullToReload::remove_ReloadHandler(uDelegate* value)
{
    ...
    ReloadHandler1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(ReloadHandler1, value), ::TYPES[30/*Fuse.VisualEventHandler*/]);
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\PulseTrigger.uno
// --------------------------------------------------------------------------------------
...
void PulseTrigger::AddHandlerImpl(uType* __type, ::g::Fuse::Visual* visual, uDelegate* handler)
{
    ...
    if (r == NULL)
    {
        ...
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(visual)->Children()), ::TYPES[48/*Uno.Collections.ICollection<Fuse.Node>*/]), r);
    }
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\WhileFloat.uno
// ------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\RangeAnimation.uno
// ----------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\KeyboardVisible.uno
// -----------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\RemovingAnimation.uno
// -------------------------------------------------------------------------------------------
...
{
    ::STRINGS[28] = uString::Const("Double removal of Visual");
    ::STRINGS[29] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\RemovingAnimation.uno");
    ::STRINGS[30] = uString::Const("Fuse.IBeginRemoveVisualListener.OnBeginRemoveVisual");
    ::STRINGS[31] = uString::Const("Unexpected done");
    ::STRINGS[32] = uString::Const("OnDone");
    ::TYPES[0] = ::g::Uno::Action_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetInterfaces(
...
void RemovingAnimation__FuseIBeginRemoveVisualListenerOnBeginRemoveVisual_fn(RemovingAnimation* __this, ::g::Fuse::PendingRemoveVisual* pr)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[28/*"Double remo...*/], __this, ::STRINGS[29/*"C:\\Users\\...*/], 49, ::STRINGS[30/*"Fuse.IBegin...*/]);
        return;
    }
...
void RemovingAnimation::OnDone()
{
    ...
    if (_args == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[31/*"Unexpected ...*/], this, ::STRINGS[29/*"C:\\Users\\...*/], 62, ::STRINGS[32/*"OnDone"*/]);
        return;
    }
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\1.4.0\Triggers\Scrolled.ScriptClass.uno
// ------------------------------------------------------------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::ScriptClass_typeof()->Init();
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[2/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[31/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.Scrolled>*/], ::STRINGS[33/*"check"*/], uDelegate::New(::TYPES[32/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.Scrolled, object[]>*/], (void*)Scrolled__check_fn), 2)));
}

static void Scrolled_build(uType* type)
{
    ::STRINGS[33] = uString::Const("check");
    ::STRINGS[34] = uString::Const("check takes no parameters");
    ::STRINGS[35] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.4.0\\Triggers\\Scrolled.ScriptClass.uno");
    ::STRINGS[36] = uString::Const("Scrolled could not find a Scrollable control.");
    ::STRINGS[37] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.4.0\\Triggers\\Scrolled.uno");
    ::STRINGS[22] = uString::Const("OnRooted");
    ::TYPES[1] = ::g::Uno::Type_typeof();
    ::TYPES[2] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ...
    ::TYPES[0] = ::g::Uno::Action_typeof();
    ::TYPES[33] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Controls.ScrollViewBase>*/, ::g::Fuse::Controls::ScrollViewBase_typeof(), NULL);
    ::TYPES[34] = ::g::Fuse::Controls::ScrollPositionChangedHandler_typeof();
...
void Scrolled__OnRooted_fn(Scrolled* __this)
{
    ...
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    __this->_scrollable = ((::g::Fuse::Controls::ScrollViewBase*)uPtr(__this->Parent())->FindByType(::TYPES[33/*Fuse.Node.FindByType<Fuse.Controls.ScrollViewBase>*/]));

    if (__this->_scrollable == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[36/*"Scrolled co...*/], __this, ::STRINGS[37/*"C:\\Users\\...*/], 35, ::STRINGS[22/*"OnRooted"*/], NULL);
        return;
    }

    uPtr(__this->_scrollable)->add_ScrollPositionChanged(uDelegate::New(::TYPES[34/*Fuse.Controls.ScrollPositionChangedHandler*/], (void*)Scrolled__OnScrollPositionChanged_fn, __this));
...
void Scrolled__OnUnrooted_fn(Scrolled* __this)
{
    ...
    if (__this->_scrollable != NULL)
    {
        uPtr(__this->_scrollable)->remove_ScrollPositionChanged(uDelegate::New(::TYPES[34/*Fuse.Controls.ScrollPositionChangedHandler*/], (void*)Scrolled__OnScrollPositionChanged_fn, __this));
...
void Scrolled::check(::g::Fuse::Scripting::Context* c, Scrolled* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[34/*"check takes...*/], s, ::STRINGS[35/*"C:\\Users\\...*/], 27, ::STRINGS[33/*"check"*/], NULL);
        return;
    }
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\1.4.0\Triggers\Scrolled.uno
// ------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\1.4.0\Triggers\ScrollingAnimation.uno
// ----------------------------------------------------------------------------------------------------------------
...
static void ScrollingAnimation__cctor_2_fn(uType* __type)
{
    ...
    ScrollingAnimation::_scrollPositionName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[38/*"ScrollPosit...*/]);
}

static void ScrollingAnimation_build(uType* type)
{
    ::STRINGS[38] = uString::Const("ScrollPosition");
    ::TYPES[35] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Controls.ScrollView>*/, ::g::Fuse::Controls::ScrollView_typeof(), NULL);
    type->SetDependencies(
        ::g::Uno::UX::Selector_typeof());
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(ScrollingAnimation_type, interface4),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(ScrollingAnimation_type, interface5),
...
void ScrollingAnimation__OnRooted_fn(ScrollingAnimation* __this)
{
    ...
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    __this->_scrollable = ((::g::Fuse::Controls::ScrollView*)uPtr(__this->Parent())->FindByType(::TYPES[35/*Fuse.Node.FindByType<Fuse.Controls.ScrollView>*/]));
...
{
    ::TYPES[36] = ::g::Fuse::Triggers::IScrolledLength_typeof();
    type->SetDependencies(
    ...
    type->SetFields(0,
        ...
        ::TYPES[36/*Fuse.Triggers.IScrolledLength*/], offsetof(ScrollRegion, RelativeTo), 0);
}
...
{
    RelativeTo = ::g::Fuse::Triggers::IScrolledLengths::Points_;
}
...
::g::Uno::Float2 ScrollRegion::CalcWithin(::g::Fuse::Controls::ScrollViewBase* scrollable)
{
    ...
    return ::g::Fuse::Triggers::IScrolledLength::GetPoints(uInterface(uPtr(RelativeTo), ::TYPES[36/*Fuse.Triggers.IScrolledLength*/]), Within, scrollable);
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\State.ScriptClass.uno
// -------------------------------------------------------------------------------------------
...
{
    ::g::Fuse::Scripting::ScriptClass_typeof()->Init();
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[2/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[37/*Fuse.Scripting.ScriptMethod<Fuse.Triggers.State>*/], ::STRINGS[39/*"goto"*/], uDelegate::New(::TYPES[38/*Uno.Action<Fuse.Scripting.Context, Fuse.Triggers.State, object[]>*/], (void*)State__goto__fn), 2)));
}

static void State_build(uType* type)
{
    ::STRINGS[39] = uString::Const("goto");
    ::STRINGS[40] = uString::Const("Cannot call `Goto` on an unrooted `State`");
    ::STRINGS[41] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\State.uno");
    ::STRINGS[42] = uString::Const("Goto");
    ::TYPES[1] = ::g::Uno::Type_typeof();
    ::TYPES[2] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
...
void State::Goto()
{
    ...
    if (_stateGroup == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[40/*"Cannot call...*/], NULL, ::STRINGS[41/*"C:\\Users\\...*/], 62, ::STRINGS[42/*"Goto"*/]);
        return;
    }
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\StateGroup.ScriptClass.uno
// ------------------------------------------------------------------------------------------------
...
void StateGroup__OnRooted_fn(StateGroup* __this)
{
    ...
    if ((__this->_active == NULL) && (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(__this->_states), ::TYPES[26/*Uno.Collections.ICollection<Fuse.Triggers.State>*/])) > 0))
        __this->_active = (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(__this->_states), ::TYPES[27/*Uno.Collections.IList<Fuse.Triggers.State>*/]), uCRef<int>(0), &ret10), ret10);
...
int StateGroup::ActiveIndex()
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(States()), ::TYPES[26/*Uno.Collections.ICollection<Fuse.Triggers.State>*/])); ++i)
        if (_active == (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(States()), ::TYPES[27/*Uno.Collections.IList<Fuse.Triggers.State>*/]), uCRef<int>(i), &ret13), ret13))
            return i;
...
void StateGroup::ActiveIndex(int value)
{
    ...
    Active((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(_states), ::TYPES[27/*Uno.Collections.IList<Fuse.Triggers.State>*/]), uCRef<int>(value), &ret14), ret14));
}
...
void StateGroup::GotoNextState()
{
    ...
    ActiveIndex((ActiveIndex() + 1) % ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_states), ::TYPES[26/*Uno.Collections.ICollection<Fuse.Triggers.State>*/])));
}
...
::g::Fuse::Triggers::State* StateGroup::Rest()
{
    ...
    if (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_states), ::TYPES[26/*Uno.Collections.ICollection<Fuse.Triggers.State>*/])) > 0)
        return (::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(_states), ::TYPES[27/*Uno.Collections.IList<Fuse.Triggers.State>*/]), uCRef<int>(0), &ret15), ret15);
...
void StateGroup::goto_(::g::Fuse::Scripting::Context* c, StateGroup* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("StateGroup.goto requires 1 argument"), n, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\StateGroup.ScriptClass.uno"), 48, uString::Const("goto_"), NULL);
        return;
    }
...
void StateGroup::gotoName(::g::Fuse::Scripting::Context* c, StateGroup* n, uString* name)
{
    ...
    if (state == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(uString::Const("Unable to find State with Name: "), name), n, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\StateGroup.ScriptClass.uno"), 28, uString::Const("gotoName"), NULL);
        return;
    }
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\1.4.0\Triggers\TextInputActionTriggered.uno
// ----------------------------------------------------------------------------------------------------------------------
...
static void TextInputActionTriggered_build(uType* type)
{
    ...
    ::STRINGS[44] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Primitives\\1.4.0\\Triggers\\TextInputActionTriggered.uno");
    ::STRINGS[22] = uString::Const("OnRooted");
    ::TYPES[39] = ::g::Fuse::Controls::ITextEditControl_typeof();
    ::TYPES[40] = ::g::Fuse::Controls::TextInputActionHandler_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
    ...
    type->SetFields(37,
        ...
        ::TYPES[39/*Fuse.Controls.ITextEditControl*/], offsetof(TextInputActionTriggered, _textEdit), 0);
    type->Reflection.SetFunctions(3,
...
void TextInputActionTriggered__OnRooted_fn(TextInputActionTriggered* __this)
{
    ...
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    __this->_textEdit = uAs<uObject*>(__this->Parent(), ::TYPES[39/*Fuse.Controls.ITextEditControl*/]);

    if (__this->_textEdit == NULL)
        ::g::Fuse::Diagnostics::UserError(::STRINGS[43/*"TextInputAc...*/], __this, ::STRINGS[44/*"C:\\Users\\...*/], 39, ::STRINGS[22/*"OnRooted"*/], NULL);
    else
        ::g::Fuse::Controls::ITextEditControl::add_ActionTriggered(uInterface(uPtr(__this->_textEdit), ::TYPES[39/*Fuse.Controls.ITextEditControl*/]), uDelegate::New(::TYPES[40/*Fuse.Controls.TextInputActionHandler*/], (void*)TextInputActionTriggered__OnActionTriggered_fn, __this));
}
...
void TextInputActionTriggered__OnUnrooted_fn(TextInputActionTriggered* __this)
{
    ...
    if (__this->_textEdit != NULL)
    {
        ::g::Fuse::Controls::ITextEditControl::remove_ActionTriggered(uInterface(uPtr(__this->_textEdit), ::TYPES[39/*Fuse.Controls.ITextEditControl*/]), uDelegate::New(::TYPES[40/*Fuse.Controls.TextInputActionHandler*/], (void*)TextInputActionTriggered__OnActionTriggered_fn, __this));
...
Timeline_type* Timeline_typeof()
{
    ...
    type->interface8.fp_get_CanPlayTo = (void(*)(uObject*, bool*))Timeline__FuseTriggersIPlaybackget_CanPlayTo_fn;
    type->interface8.fp_get_CanStop = (void(*)(uObject*, bool*))Timeline__FuseTriggersIPlaybackget_CanStop_fn;
    type->interface8.fp_get_CanPause = (void(*)(uObject*, bool*))Timeline__FuseTriggersIPlaybackget_CanPause_fn;
    type->interface8.fp_get_CanResume = (void(*)(uObject*, bool*))Timeline__FuseTriggersIPlaybackget_CanResume_fn;
...
void Timeline::playTo(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Timeline.seek requires 1 argument"), n, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\Timeline.ScriptClass.uno"), 67, uString::Const("playTo"), NULL);
        return;
    }
...
void Timeline::seek(::g::Fuse::Scripting::Context* c, Timeline* n, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Timeline.seek requires 1 argument"), n, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\Timeline.ScriptClass.uno"), 116, uString::Const("seek"), NULL);
        return;
    }
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.Navigation\1.4.0\Transition.uno
// -----------------------------------------------------------------------------------------------
...
static void Transition_build(uType* type)
{
    ...
    ::TYPES[28] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof(), NULL);
    ::TYPES[41] = ::g::Fuse::Internal::MiniList_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[42] = ::g::Fuse::Navigation::INavigation_typeof();
    ::TYPES[0] = ::g::Uno::Action_typeof();
    ::TYPES[43] = ::g::Fuse::Navigation::NavigationHandler_typeof();
    ::TYPES[44] = ::g::Uno::Char_typeof()->Array();
    type->SetDependencies(
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface7));
    type->SetFields(37,
        ::TYPES[41/*Fuse.Internal.MiniList<string>*/], offsetof(Transition, _to), 0,
        ::TYPES[41/*Fuse.Internal.MiniList<string>*/], offsetof(Transition, _from), 0,
...
void Transition__OnRooted_fn(Transition* __this)
{
    ...
    if (__this->_group != NULL)
    {
        ...
        uPtr(uPtr(__this->_group)->Navigator())->add_PageProgressChanged(uDelegate::New(::TYPES[43/*Fuse.Navigation.NavigationHandler*/], (void*)Transition__OnPageProgressChanged_fn, __this));
    }
}
...
void Transition__OnUnrooted_fn(Transition* __this)
{
    ...
    if (__this->_group != NULL)
    {
        uPtr(uPtr(__this->_group)->Navigator())->remove_PageProgressChanged(uDelegate::New(::TYPES[43/*Fuse.Navigation.NavigationHandler*/], (void*)Transition__OnPageProgressChanged_fn, __this));
        uPtr(uPtr(__this->_group)->Navigator())->SetTransitionState(__this, false);
...
void Transition::OnPageProgressChanged(uObject* sender, ::g::Fuse::Navigation::NavigationArgs* args)
{
    ...
    ::g::Fuse::Navigation::NavigationPageState ps = ::g::Fuse::Navigation::INavigation::GetPageState(uInterface(uPtr(uAs<uObject*>(uPtr(_group)->Navigator(), ::TYPES[42/*Fuse.Navigation.INavigation*/])), ::TYPES[42/*Fuse.Navigation.INavigation*/]), uPtr(_group)->Page());
...
int Transition::Priority(bool isActive, bool isBackward, uString* newPath, uString* oldPath, int mode, uString* operationStyle)
{
    ...
    if (_to.Count(::TYPES[41/*Fuse.Internal.MiniList<string>*/]) > 0)
    {
        if (!normActive && _to.Contains(::TYPES[41/*Fuse.Internal.MiniList<string>*/], toPath))
            return priority + 20;

        return -1;
    }

    if (_from.Count(::TYPES[41/*Fuse.Internal.MiniList<string>*/]) > 0)
    {
        if (normActive && _from.Contains(::TYPES[41/*Fuse.Internal.MiniList<string>*/], fromPath))
            return priority + 10;
...
uString* Transition::Join(::g::Fuse::Internal::MiniList* list)
{
    ...
    for (int i = 0; i < (*list).Count(::TYPES[41/*Fuse.Internal.MiniList<string>*/]); ++i)
    {
        if (i != 0)
            o = ::g::Uno::String::op_Addition2(o, ::STRINGS[45/*","*/]);

        o = ::g::Uno::String::op_Addition2(o, (uString*)(*list).Item(::TYPES[41/*Fuse.Internal.MiniList<string>*/], i));
    }
...
void Transition::Parse(::g::Fuse::Internal::MiniList* list, uString* src)
{
    ...
    (*list).Clear(::TYPES[41/*Fuse.Internal.MiniList<string>*/]);
    uArray* s = ::g::Uno::String::Split(uPtr(src), uArray::Init<int>(::TYPES[44/*char[]*/], 1, ','));

    for (int i = 0; i < uPtr(s)->Length(); ++i)
        (*list).Add(::TYPES[41/*Fuse.Internal.MiniList<string>*/], ::g::Uno::String::Trim(uPtr(uPtr(s)->Strong<uString*>(i))));
}
// }
...
{
    TransitionGroup::_groupMap_ = ((::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[45/*Uno.Collections.Dictionary<Fuse.Node, Fuse.Triggers.TransitionGroup>*/]));
}

static void TransitionGroup_build(uType* type)
{
    ::STRINGS[46] = uString::Const("Transition must have a Navigator ancestor");
    ::STRINGS[47] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Navigation\\1.4.0\\Transition.uno");
    ::STRINGS[48] = uString::Const("Root");
    ::STRINGS[49] = uString::Const("Transition must have a Visual parent");
    ::TYPES[45] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Node_typeof(), type, NULL);
    ::TYPES[46] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Triggers::Transition_typeof(), NULL);
    ::TYPES[47] = ::g::Fuse::Controls::NavigationSwitchedHandler_typeof();
    ::TYPES[48] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    ::TYPES[49] = ::g::Fuse::Controls::Navigator_typeof();
    ::TYPES[5] = ::g::Fuse::Visual_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(0,
        ::TYPES[49/*Fuse.Controls.Navigator*/], offsetof(TransitionGroup, _navigator), 0,
        ::TYPES[5/*Fuse.Visual*/], offsetof(TransitionGroup, _parent), 0,
        ::TYPES[46/*Uno.Collections.List<Fuse.Triggers.Transition>*/], offsetof(TransitionGroup, _states), 0,
        ::g::Fuse::Triggers::Transition_typeof(), offsetof(TransitionGroup, _selected), 0,
        ::TYPES[45/*Uno.Collections.Dictionary<Fuse.Node, Fuse.Triggers.TransitionGroup>*/], (uintptr_t)&TransitionGroup::_groupMap_, uFieldFlagsStatic);
}
...
void TransitionGroup::ctor_(::g::Fuse::Controls::Navigator* navigator, ::g::Fuse::Visual* parent)
{
    ...
    _states = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[46/*Uno.Collections.List<Fuse.Triggers.Transition>*/]));
    _parent = parent;
    _navigator = navigator;
    uPtr(_navigator)->add_Switched(uDelegate::New(::TYPES[47/*Fuse.Controls.NavigationSwitchedHandler*/], (void*)TransitionGroup__OnSwitched_fn, this));
}
...
void TransitionGroup::Cleanup()
{
    ...
    uPtr(_navigator)->remove_Switched(uDelegate::New(::TYPES[47/*Fuse.Controls.NavigationSwitchedHandler*/], (void*)TransitionGroup__OnSwitched_fn, this));
}
...
void TransitionGroup::OnSwitched(uObject* sender, ::g::Fuse::Controls::NavigatorSwitchedArgs* args)
{
    ...
    if ((selectTrans == NULL) && (uPtr(_navigator)->Transition() != 1))
    {
        ...
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(_parent)->Children()), ::TYPES[48/*Uno.Collections.ICollection<Fuse.Node>*/]), trans);
        selectTrans = trans;
    }
...
TransitionGroup* TransitionGroup::Root(::g::Fuse::Triggers::Transition* t)
{
    ...
    {
        nav = uAs< ::g::Fuse::Controls::Navigator*>(q, ::TYPES[49/*Fuse.Controls.Navigator*/]);
        q = uPtr(q)->ContextParent();
    }

    if (nav == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[46/*"Transition ...*/], t, ::STRINGS[47/*"C:\\Users\\...*/], 26, ::STRINGS[48/*"Root"*/], NULL);
        return NULL;
    }
    ...
    if (vis == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[49/*"Transition ...*/], t, ::STRINGS[47/*"C:\\Users\\...*/], 33, ::STRINGS[48/*"Root"*/], NULL);
        return NULL;
    }
...
void Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn(Trigger* __this, uObject* s)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Trigger.OnPlaybackdone called with _animState == null"), __this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\Trigger.uno"), 303, uString::Const("Fuse.Animations.IBasePlayerFeedback.OnPlaybackDone"));
        return;
    }
...
void Trigger::Bypass(int value)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(uString::Const("ExceptLayout mode indicates a problem in trigger expecations and should no tbe used"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\Trigger.uno"), 110, uString::Const("set_Bypass"));
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\WhileBool.uno
// -----------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\WhileBusy.uno
// -----------------------------------------------------------------------------------
...
static void WhileBusy_build(uType* type)
{
    ...
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(WhileBusy_type, interface4),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(WhileBusy_type, interface5),
...
WhileBusy_type* WhileBusy_typeof()
{
    ...
    type->interface8.fp_get_BusyActivityHandled = (void(*)(uObject*, int*))WhileBusy__FuseTriggersIBusyHandlerget_BusyActivityHandled_fn;
    type->interface7.fp_OnPlaybackDone = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn;
    type->interface7.fp_OnStable = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnStable_fn;
    type->interface6.fp_OnProgressUpdated = (void(*)(uObject*, uObject*, double*, double*, int*))::g::Fuse::Triggers::Trigger__FuseAnimationsIUnwrappedPlayerFeedbackOnProgressUpdated_fn;
    type->interface4.fp_Clear = (void(*)(uObject*))::g::Fuse::Node__UnoCollectionsICollectionFuseBindingClear_fn;
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\WhilePlaying.uno
// --------------------------------------------------------------------------------------
...
static void WhileCompleted_build(uType* type)
{
    ...
    ::TYPES[51] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FirstChild<Fuse.Triggers.WhileCompleted>*/, type, NULL);
    ::TYPES[52] = ::g::Fuse::Node_typeof()->MakeMethod(3/*NextSibling<Fuse.Triggers.WhileCompleted>*/, type, NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
    ...
    type->Reflection.SetFunctions(2,
        ...
        new uFunction("SetState", NULL, (void*)WhileCompleted__SetState_fn, 0, true, uVoid_typeof(), 2, ::g::Fuse::Visual_typeof(), ::TYPES[50/*bool*/]));
}
...
void WhileCompleted::SetState(::g::Fuse::Visual* n, bool paused)
{
    ...
    if (v != paused)
    {
        uPtr(uPtr(n)->Properties())->Set(WhileCompleted::_whileCompletedProp_, uBox(::TYPES[50/*bool*/], paused));

        for (WhileCompleted* wl = (WhileCompleted*)n->FirstChild(::TYPES[51/*Fuse.Visual.FirstChild<Fuse.Triggers.WhileCompleted>*/]); wl != NULL; wl = (WhileCompleted*)uPtr(wl)->NextSibling(::TYPES[52/*Fuse.Node.NextSibling<Fuse.Triggers.WhileCompleted>*/]))
...
{
    ::STRINGS[50] = uString::Const("No TextInput or Source found for string");
    ::STRINGS[18] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Primitives\\1.4.0\\Triggers\\ContainsText.uno");
    ::STRINGS[22] = uString::Const("OnRooted");
    ::TYPES[53] = ::g::Fuse::Triggers::IValue_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    ::TYPES[54] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Uno::String_typeof(), NULL);
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface7));
    type->SetFields(38,
        ::TYPES[53/*Fuse.Triggers.IValue<string>*/], offsetof(WhileContainsText, _source), 0,
        ::TYPES[53/*Fuse.Triggers.IValue<string>*/], offsetof(WhileContainsText, _value), 0);
    type->Reflection.SetFunctions(3,
        new uFunction(".ctor", NULL, (void*)WhileContainsText__New2_fn, 0, true, type, 0),
        new uFunction("get_Source", NULL, (void*)WhileContainsText__get_Source_fn, 0, false, ::TYPES[53/*Fuse.Triggers.IValue<string>*/], 0),
        new uFunction("set_Source", NULL, (void*)WhileContainsText__set_Source_fn, 0, false, uVoid_typeof(), 1, ::TYPES[53/*Fuse.Triggers.IValue<string>*/]));
}
...
void WhileContainsText__OnRooted_fn(WhileContainsText* __this)
{
    ...
    if (__this->Source() != NULL)
        ...
        __this->_value = uAs<uObject*>(__this->Parent(), ::TYPES[53/*Fuse.Triggers.IValue<string>*/]);

    if (__this->_value != NULL)
    {
        ::g::Fuse::Triggers::IValue::add_ValueChanged(uInterface(uPtr(__this->_value), ::TYPES[53/*Fuse.Triggers.IValue<string>*/]), uDelegate::New(::TYPES[54/*Uno.UX.ValueChangedHandler<string>*/], (void*)WhileContainsText__OnValueChanged_fn, __this));
        __this->SetActive(!::g::Uno::String::IsNullOrEmpty((::g::Fuse::Triggers::IValue::get_Value_ex(uInterface(uPtr(__this->_value), ::TYPES[53/*Fuse.Triggers.IValue<string>*/]), &ret2), ret2)));
    }
    else
        ::g::Fuse::Diagnostics::UserError(::STRINGS[50/*"No TextInpu...*/], __this, ::STRINGS[18/*"C:\\Users\\...*/], 49, ::STRINGS[22/*"OnRooted"*/], NULL);
}
...
void WhileContainsText__OnUnrooted_fn(WhileContainsText* __this)
{
    ...
    if (__this->_value != NULL)
    {
        ::g::Fuse::Triggers::IValue::remove_ValueChanged(uInterface(uPtr(__this->_value), ::TYPES[53/*Fuse.Triggers.IValue<string>*/]), uDelegate::New(::TYPES[54/*Uno.UX.ValueChangedHandler<string>*/], (void*)WhileContainsText__OnValueChanged_fn, __this));
        __this->_value = NULL;
    }
...
void WhileContainsText::OnValueChanged(uObject* sender, ::g::Uno::UX::ValueChangedArgs* args)
{
    ...
    uString* ret3;
    SetActive(!::g::Uno::String::IsNullOrEmpty((::g::Fuse::Triggers::IValue::get_Value_ex(uInterface(uPtr(_value), ::TYPES[53/*Fuse.Triggers.IValue<string>*/]), &ret3), ret3)));
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Disabled.uno
// ----------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\WhileFailed.uno
// -------------------------------------------------------------------------------------
...
static void WhileFailed_build(uType* type)
{
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::WhileBusy_type, interface4),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::WhileBusy_type, interface5),
...
::g::Fuse::Triggers::WhileBusy_type* WhileFailed_typeof()
{
    ...
    type->interface8.fp_get_BusyActivityHandled = (void(*)(uObject*, int*))::g::Fuse::Triggers::WhileBusy__FuseTriggersIBusyHandlerget_BusyActivityHandled_fn;
    type->interface7.fp_OnPlaybackDone = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn;
    type->interface7.fp_OnStable = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnStable_fn;
    type->interface6.fp_OnProgressUpdated = (void(*)(uObject*, uObject*, double*, double*, int*))::g::Fuse::Triggers::Trigger__FuseAnimationsIUnwrappedPlayerFeedbackOnProgressUpdated_fn;
    type->interface4.fp_Clear = (void(*)(uObject*))::g::Fuse::Node__UnoCollectionsICollectionFuseBindingClear_fn;
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\WhileFocused.uno
// --------------------------------------------------------------------------------------
...
{
    ::TYPES[55] = ::g::Fuse::Input::FocusGainedHandler_typeof();
    ::TYPES[56] = ::g::Fuse::Input::FocusLostHandler_typeof();
    type->SetDependencies(
...
void WhileFocused__OnRooted_fn(WhileFocused* __this)
{
    ...
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Focus::Gained()), __this->Parent(), uDelegate::New(::TYPES[55/*Fuse.Input.FocusGainedHandler*/], (void*)WhileFocused__OnGotFocus_fn, __this));
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Focus::Lost()), __this->Parent(), uDelegate::New(::TYPES[56/*Fuse.Input.FocusLostHandler*/], (void*)WhileFocused__OnLostFocus_fn, __this));
...
void WhileFocused__OnUnrooted_fn(WhileFocused* __this)
{
    ...
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Focus::Gained()), __this->Parent(), uDelegate::New(::TYPES[55/*Fuse.Input.FocusGainedHandler*/], (void*)WhileFocused__OnGotFocus_fn, __this));
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Focus::Lost()), __this->Parent(), uDelegate::New(::TYPES[56/*Fuse.Input.FocusLostHandler*/], (void*)WhileFocused__OnLostFocus_fn, __this));
    ::g::Fuse::Triggers::Trigger__OnUnrooted_fn(__this);
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\WhileFocusWithin.uno
// ------------------------------------------------------------------------------------------
...
void WhileFocusWithin__OnRooted_fn(WhileFocusWithin* __this)
{
    ...
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Focus::Gained()), __this->Parent(), uDelegate::New(::TYPES[55/*Fuse.Input.FocusGainedHandler*/], (void*)WhileFocusWithin__OnFocusChange_fn, __this));
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Focus::Lost()), __this->Parent(), uDelegate::New(::TYPES[56/*Fuse.Input.FocusLostHandler*/], (void*)WhileFocusWithin__OnFocusChange_fn, __this));
...
void WhileFocusWithin__OnUnrooted_fn(WhileFocusWithin* __this)
{
    ...
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Focus::Gained()), __this->Parent(), uDelegate::New(::TYPES[55/*Fuse.Input.FocusGainedHandler*/], (void*)WhileFocusWithin__OnFocusChange_fn, __this));
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Focus::Lost()), __this->Parent(), uDelegate::New(::TYPES[56/*Fuse.Input.FocusLostHandler*/], (void*)WhileFocusWithin__OnFocusChange_fn, __this));
    ::g::Fuse::Triggers::Trigger__OnUnrooted_fn(__this);
}
...
void WhileKeyboardVisible::OnBottomBarResize(uObject* sender, ::g::Fuse::Platform::SystemUIWillResizeEventArgs* args)
{
    ...
    if (vp != NULL)
        density = ::g::Fuse::ICommonViewport::PixelsPerPoint(uInterface(uPtr(vp), ::TYPES[65/*Fuse.ICommonViewport*/]));
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\WhileLoading.uno
// --------------------------------------------------------------------------------------
...
void WhileNotFocused__OnRooted_fn(WhileNotFocused* __this)
{
    ...
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Focus::Gained()), __this->Parent(), uDelegate::New(::TYPES[55/*Fuse.Input.FocusGainedHandler*/], (void*)WhileNotFocused__OnGotFocus_fn, __this));
    ::g::Fuse::VisualEvent__AddHandler_fn(uPtr(::g::Fuse::Input::Focus::Lost()), __this->Parent(), uDelegate::New(::TYPES[56/*Fuse.Input.FocusLostHandler*/], (void*)WhileNotFocused__OnLostFocus_fn, __this));
    __this->SetActive(::g::Fuse::Input::Focus::FocusedVisual() != __this->Parent());
}
...
void WhileNotFocused__OnUnrooted_fn(WhileNotFocused* __this)
{
    ...
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Focus::Gained()), __this->Parent(), uDelegate::New(::TYPES[55/*Fuse.Input.FocusGainedHandler*/], (void*)WhileNotFocused__OnGotFocus_fn, __this));
    ::g::Fuse::VisualEvent__RemoveHandler_fn(uPtr(::g::Fuse::Input::Focus::Lost()), __this->Parent(), uDelegate::New(::TYPES[56/*Fuse.Input.FocusLostHandler*/], (void*)WhileNotFocused__OnLostFocus_fn, __this));
    ::g::Fuse::Triggers::Trigger__OnUnrooted_fn(__this);
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.WebView\1.4.0\WhilePageLoading.uno
// --------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[25] = uString::Const("WebView");
    ::STRINGS[51] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.WebView\\1.4.0\\WhilePageLoading.uno");
    ::STRINGS[22] = uString::Const("OnRooted");
    ::TYPES[23] = ::g::Fuse::Controls::IWebView_typeof();
    ::TYPES[57] = ::g::Fuse::Controls::WebView_typeof();
    ::TYPES[25] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Uno::Double_typeof(), NULL);
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface7));
    type->SetFields(38,
        ::TYPES[57/*Fuse.Controls.WebView*/], offsetof(WhilePageLoading, _webView), 0);
    type->Reflection.SetFunctions(1,
...
void WhilePageLoading__OnRooted_fn(WhilePageLoading* __this)
{
    ...
    if (uIs((::g::Fuse::Visual*)__this->Parent(), ::TYPES[23/*Fuse.Controls.IWebView*/]))
    {
        __this->_webView = uAs< ::g::Fuse::Controls::WebView*>(__this->Parent(), ::TYPES[57/*Fuse.Controls.WebView*/]);
        uPtr(__this->_webView)->add_ProgressChanged(uDelegate::New(::TYPES[25/*Uno.UX.ValueChangedHandler<double>*/], (void*)WhilePageLoading__OnProgressChanged1_fn, __this));
        __this->SetActive(uPtr(__this->_webView)->Progress() != 1.0);
    }
    else
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[25/*"WebView"*/], __this->Parent(), __this, ::STRINGS[51/*"C:\\Users\\...*/], 39, ::STRINGS[22/*"OnRooted"*/]);
}
...
void WhilePageLoading__OnUnrooted_fn(WhilePageLoading* __this)
{
    ...
    if (__this->_webView != NULL)
    {
        uPtr(__this->_webView)->remove_ProgressChanged(uDelegate::New(::TYPES[25/*Uno.UX.ValueChangedHandler<double>*/], (void*)WhilePageLoading__OnProgressChanged1_fn, __this));
        __this->_webView = NULL;
    }
...
{
    ::TYPES[50] = ::g::Uno::Bool_typeof();
    ::TYPES[58] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FirstChild<Fuse.Triggers.WhilePaused>*/, type, NULL);
    ::TYPES[59] = ::g::Fuse::Node_typeof()->MakeMethod(3/*NextSibling<Fuse.Triggers.WhilePaused>*/, type, NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
    ...
    type->Reflection.SetFunctions(2,
        ...
        new uFunction("SetState", NULL, (void*)WhilePaused__SetState_fn, 0, true, uVoid_typeof(), 2, ::g::Fuse::Visual_typeof(), ::TYPES[50/*bool*/]));
}
...
void WhilePaused::SetState(::g::Fuse::Visual* n, bool paused)
{
    ...
    if (v != paused)
    {
        uPtr(uPtr(n)->Properties())->Set(WhilePaused::_whilePausedProp_, uBox(::TYPES[50/*bool*/], paused));

        for (WhilePaused* wl = (WhilePaused*)n->FirstChild(::TYPES[58/*Fuse.Visual.FirstChild<Fuse.Triggers.WhilePaused>*/]); wl != NULL; wl = (WhilePaused*)uPtr(wl)->NextSibling(::TYPES[59/*Fuse.Node.NextSibling<Fuse.Triggers.WhilePaused>*/]))
            uPtr(wl)->SetActive(paused);
    }
}
// }
...
{
    ::TYPES[50] = ::g::Uno::Bool_typeof();
    ::TYPES[60] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FirstChild<Fuse.Triggers.WhilePlaying>*/, type, NULL);
    ::TYPES[61] = ::g::Fuse::Node_typeof()->MakeMethod(3/*NextSibling<Fuse.Triggers.WhilePlaying>*/, type, NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::Trigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface2),
    ...
    type->Reflection.SetFunctions(2,
        ...
        new uFunction("SetState", NULL, (void*)WhilePlaying__SetState_fn, 0, true, uVoid_typeof(), 2, ::g::Fuse::Visual_typeof(), ::TYPES[50/*bool*/]));
}
...
void WhilePlaying::SetState(::g::Fuse::Visual* n, bool playing)
{
    ...
    if (v != playing)
    {
        uPtr(uPtr(n)->Properties())->Set(WhilePlaying::_whilePlayingProp_, uBox(::TYPES[50/*bool*/], playing));

        for (WhilePlaying* wl = (WhilePlaying*)n->FirstChild(::TYPES[60/*Fuse.Visual.FirstChild<Fuse.Triggers.WhilePlaying>*/]); wl != NULL; wl = (WhilePlaying*)uPtr(wl)->NextSibling(::TYPES[61/*Fuse.Node.NextSibling<Fuse.Triggers.WhilePlaying>*/]))
...
{
    ::TYPES[62] = ::g::Fuse::Controls::ScrollView_typeof();
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(WhileScrollable_type, interface4),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(WhileScrollable_type, interface5),
    ...
    type->SetFields(38,
        ::TYPES[62/*Fuse.Controls.ScrollView*/], offsetof(WhileScrollable, _scrollable), 0,
        ::TYPES[62/*Fuse.Controls.ScrollView*/], offsetof(WhileScrollable, _source), 0,
    ...
    type->Reflection.SetFunctions(5,
        ...
        new uFunction("get_ScrollView", NULL, (void*)WhileScrollable__get_ScrollView_fn, 0, false, ::TYPES[62/*Fuse.Controls.ScrollView*/], 0),
        new uFunction("set_ScrollView", NULL, (void*)WhileScrollable__set_ScrollView_fn, 0, false, uVoid_typeof(), 1, ::TYPES[62/*Fuse.Controls.ScrollView*/]));
}
...
WhileScrollable_type* WhileScrollable_typeof()
{
    ...
    type->interface8.fp_OnPropertyChanged = (void(*)(uObject*, ::g::Uno::UX::PropertyObject*, ::g::Uno::UX::Selector*))WhileScrollable__UnoUXIPropertyListenerOnPropertyChanged_fn;
    type->interface7.fp_OnPlaybackDone = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn;
    type->interface7.fp_OnStable = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnStable_fn;
    type->interface6.fp_OnProgressUpdated = (void(*)(uObject*, uObject*, double*, double*, int*))::g::Fuse::Triggers::Trigger__FuseAnimationsIUnwrappedPlayerFeedbackOnProgressUpdated_fn;
    type->interface4.fp_Clear = (void(*)(uObject*))::g::Fuse::Node__UnoCollectionsICollectionFuseBindingClear_fn;
...
::g::Fuse::Controls::ScrollView* WhileScrollable::ScrollView()
{
    ...
    ind1 = _source;
    return (ind1 != NULL) ? ind1 : uAs< ::g::Fuse::Controls::ScrollView*>(Parent(), ::TYPES[62/*Fuse.Controls.ScrollView*/]);
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\1.4.0\Triggers\WhileScrolled.uno
// -----------------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[36] = uString::Const("Scrolled could not find a Scrollable control.");
    ::STRINGS[52] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.4.0\\Triggers\\WhileScrolled.uno");
    ::STRINGS[22] = uString::Const("OnRooted");
    ::TYPES[33] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Controls.ScrollViewBase>*/, ::g::Fuse::Controls::ScrollViewBase_typeof(), NULL);
    ::TYPES[34] = ::g::Fuse::Controls::ScrollPositionChangedHandler_typeof();
    type->SetDependencies(
...
void WhileScrolled__OnRooted_fn(WhileScrolled* __this)
{
    ...
    if (__this->_scrollable == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[36/*"Scrolled co...*/], __this, ::STRINGS[52/*"C:\\Users\\...*/], 23, ::STRINGS[22/*"OnRooted"*/], NULL);
        return;
    }

    uPtr(__this->_scrollable)->add_ScrollPositionChanged(uDelegate::New(::TYPES[34/*Fuse.Controls.ScrollPositionChangedHandler*/], (void*)WhileScrolled__OnScrollPositionChanged_fn, __this));
    __this->Update();
}
...
void WhileScrolled__OnUnrooted_fn(WhileScrolled* __this)
{
    ...
    if (__this->_scrollable != NULL)
    {
        uPtr(__this->_scrollable)->remove_ScrollPositionChanged(uDelegate::New(::TYPES[34/*Fuse.Controls.ScrollPositionChangedHandler*/], (void*)WhileScrolled__OnScrollPositionChanged_fn, __this));
        __this->_scrollable = NULL;
    }
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\WhileString.uno
// -------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\WhileTrigger.uno
// --------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\WhileValue.uno
// ------------------------------------------------------------------------------------
...
{
    ::STRINGS[53] = uString::Const("`Pulse` on a `WhileValue` will be removed, create a `Timeline` instead.");
    ::STRINGS[54] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\WhileValue.uno");
    ::STRINGS[55] = uString::Const("Pulse");
    ::TYPES[63] = ::g::Fuse::Triggers::IValue_typeof();
    ::TYPES[64] = ::g::Uno::UX::ValueChangedHandler_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetPrecalc(
    ...
    type->SetFields(38,
        ...
        ::TYPES[63/*Fuse.Triggers.IValue`1*/]->MakeType(type->T(0), NULL), offsetof(WhileValue, _source), 0,
        ::TYPES[63/*Fuse.Triggers.IValue`1*/]->MakeType(type->T(0), NULL), offsetof(WhileValue, _obj), 0,
        ::TYPES[64/*Uno.UX.ValueChangedHandler`1*/]->MakeType(type->T(0), NULL), offsetof(WhileValue, ValueChanged1), 0);
    type->Reflection.SetFunctions(7,
        new uFunction("Pulse", NULL, (void*)WhileValue__Pulse1_fn, 0, false, uVoid_typeof(), 0),
        new uFunction("get_Source", NULL, (void*)WhileValue__get_Source_fn, 0, false, ::TYPES[63/*Fuse.Triggers.IValue`1*/]->MakeType(type->T(0), NULL), 0),
        new uFunction("set_Source", NULL, (void*)WhileValue__set_Source_fn, 0, false, uVoid_typeof(), 1, ::TYPES[63/*Fuse.Triggers.IValue`1*/]->MakeType(type->T(0), NULL)),
        ...
        new uFunction("add_ValueChanged", NULL, (void*)WhileValue__add_ValueChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[64/*Uno.UX.ValueChangedHandler`1*/]->MakeType(type->T(0), NULL)),
        new uFunction("remove_ValueChanged", NULL, (void*)WhileValue__remove_ValueChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[64/*Uno.UX.ValueChangedHandler`1*/]->MakeType(type->T(0), NULL)));
}
...
void WhileValue::Pulse1()
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[53/*"`Pulse` on ...*/], this, ::STRINGS[54/*"C:\\Users\\...*/], 47, ::STRINGS[55/*"Pulse"*/]);
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\WhileVisible.uno
// --------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.ScrollView\1.4.0\Triggers\WhileVisibleInScrollView.uno
// ----------------------------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[56] = uString::Const("Could not find a ScrollView control.");
    ::STRINGS[57] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.ScrollView\\1.4.0\\Triggers\\WhileVisibleInScrollView.uno");
    ::STRINGS[22] = uString::Const("OnRooted");
    ::STRINGS[58] = uString::Const("Parent must be an Element");
    ::STRINGS[59] = uString::Const("Must have an Element path to the ScrollView");
    ::TYPES[33] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Controls.ScrollViewBase>*/, ::g::Fuse::Controls::ScrollViewBase_typeof(), NULL);
    ::TYPES[16] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[34] = ::g::Fuse::Controls::ScrollPositionChangedHandler_typeof();
    ::TYPES[17] = ::g::Fuse::PlacedHandler_typeof();
    ...
    type->SetFields(38,
        ...
        ::TYPES[16/*Fuse.Elements.Element*/], offsetof(WhileVisibleInScrollView, _element), 0,
        ::g::Uno::Float_typeof(), offsetof(WhileVisibleInScrollView, _distance), 0,
        ::TYPES[36/*Fuse.Triggers.IScrolledLength*/], offsetof(WhileVisibleInScrollView, _relativeTo), 0,
    ...
    type->Reflection.SetFunctions(7,
        ...
        new uFunction("get_RelativeTo", NULL, (void*)WhileVisibleInScrollView__get_RelativeTo_fn, 0, false, ::TYPES[36/*Fuse.Triggers.IScrolledLength*/], 0),
        new uFunction("set_RelativeTo", NULL, (void*)WhileVisibleInScrollView__set_RelativeTo_fn, 0, false, uVoid_typeof(), 1, ::TYPES[36/*Fuse.Triggers.IScrolledLength*/]));
}
...
void WhileVisibleInScrollView__OnRooted_fn(WhileVisibleInScrollView* __this)
{
    ...
    if (__this->_scrollable == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[56/*"Could not f...*/], __this, ::STRINGS[57/*"C:\\Users\\...*/], 63, ::STRINGS[22/*"OnRooted"*/], NULL);
        return;
    }
    ...
    if (__this->_element == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[58/*"Parent must...*/], __this, ::STRINGS[57/*"C:\\Users\\...*/], 70, ::STRINGS[22/*"OnRooted"*/], NULL);
        return;
    }

    if (!uPtr(__this->_element)->HasLayoutIn(__this->_scrollable))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[59/*"Must have a...*/], __this, ::STRINGS[57/*"C:\\Users\\...*/], 76, ::STRINGS[22/*"OnRooted"*/], NULL);
        return;
    }

    uPtr(__this->_scrollable)->add_ScrollPositionChanged(uDelegate::New(::TYPES[34/*Fuse.Controls.ScrollPositionChangedHandler*/], (void*)WhileVisibleInScrollView__OnScrollPositionChanged_fn, __this));
    uPtr(__this->_element)->add_Placed(uDelegate::New(::TYPES[17/*Fuse.PlacedHandler*/], (void*)WhileVisibleInScrollView__OnElementPlaced_fn, __this));
...
void WhileVisibleInScrollView__OnUnrooted_fn(WhileVisibleInScrollView* __this)
{
    ...
    if (__this->_scrollable != NULL)
    {
        uPtr(__this->_element)->remove_Placed(uDelegate::New(::TYPES[17/*Fuse.PlacedHandler*/], (void*)WhileVisibleInScrollView__OnElementPlaced_fn, __this));
        uPtr(__this->_scrollable)->remove_ScrollPositionChanged(uDelegate::New(::TYPES[34/*Fuse.Controls.ScrollPositionChangedHandler*/], (void*)WhileVisibleInScrollView__OnScrollPositionChanged_fn, __this));
        __this->_scrollable = NULL;
    }
...
{
    _distance = 0.0f;
    _relativeTo = ::g::Fuse::Triggers::IScrolledLengths::Points_;
    ctor_5();
}
...
void WhileVisibleInScrollView::Update()
{
    ...
    float maxDist = uPtr(_scrollable)->ToScalarPosition(::g::Fuse::Triggers::IScrolledLength::GetPoints(uInterface(uPtr(RelativeTo()), ::TYPES[36/*Fuse.Triggers.IScrolledLength*/]), Distance(), _scrollable));
    bool isInView = false;
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\WhileWindowAspect.uno
// -------------------------------------------------------------------------------------------
...
{
    ::TYPES[65] = ::g::Fuse::ICommonViewport_typeof();
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Triggers::WindowSizeTrigger_type, interface4),
...
float WhileWindowAspect::Aspect()
{
    ...
    ::g::Uno::Float2 sz = ::g::Fuse::ICommonViewport::Size(uInterface(uPtr(Viewport()), ::TYPES[65/*Fuse.ICommonViewport*/]));
    return sz.X / sz.Y;
}
// }
...
void WhileWindowSize__get_IsActive_fn(WhileWindowSize* __this, bool* __retval)
{
    ...
    ::g::Uno::Float2 sz = ::g::Fuse::ICommonViewport::Size(uInterface(uPtr(__this->Viewport()), ::TYPES[65/*Fuse.ICommonViewport*/]));
...
static void WindowSizeTrigger_build(uType* type)
{
    ...
    ::TYPES[67] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.RootViewport>*/, ::g::Fuse::RootViewport_typeof(), NULL);
    ::TYPES[6] = ::g::Uno::EventHandler_typeof();
    type->SetDependencies(
        ::g::Fuse::Platform::SystemUI_typeof());
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(WindowSizeTrigger_type, interface4),
    ...
    type->SetFields(38,
        ::TYPES[66/*Fuse.IViewport*/], offsetof(WindowSizeTrigger, _Viewport), 0);
}
...
void WindowSizeTrigger__OnRooted_fn(WindowSizeTrigger* __this)
{
    ...
    uObject* ind1;
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    __this->Viewport((ind1 = uAs<uObject*>((::g::Fuse::RootViewport*)uPtr(__this->Parent())->FindByType(::TYPES[67/*Fuse.Node.FindByType<Fuse.RootViewport>*/]), ::TYPES[66/*Fuse.IViewport*/]), (ind1 != NULL) ? ind1 : (uObject*)uPtr(__this->Parent())->Viewport()));
