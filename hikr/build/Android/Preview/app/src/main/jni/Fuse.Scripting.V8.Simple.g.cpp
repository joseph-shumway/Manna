...
#include <Fuse.Scripting.V8.Sim-901cc247.h>
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Scripting.JavaScript\1.4.0\V8\V8Simple.uno
// -------------------------------------------------------------------------------------------------
...
// public static extern string GetV8Version() :151
...
// public static extern void Retain(Fuse.Scripting.V8.Simple.JSContext context) :133
...
// public static extern string GetV8Version() [static] :151
...
// public static extern void Retain(Fuse.Scripting.V8.Simple.JSContext context) [static] :133
...
// public static extern void ProcessMessages(Fuse.Scripting.V8.Simple.JSContext context) :163
void Debug__ProcessMessages_fn(::JSContext** context)
{
    Debug::ProcessMessages(*context);
}

// public static extern void SendCommand(Fuse.Scripting.V8.Simple.JSContext context, string command, int length) :162
void Debug__SendCommand_fn(::JSContext** context, uString* command, int* length)
{
    Debug::SendCommand(*context, command, *length);
}

// public static extern void ProcessMessages(Fuse.Scripting.V8.Simple.JSContext context) [static] :163
void Debug::ProcessMessages(::JSContext* context)
{
    ::ProcessJSDebugMessages(context);
}

// public static extern void SendCommand(Fuse.Scripting.V8.Simple.JSContext context, string command, int length) [static] :162
...
// internal static extern class DllDirectory :12
// {
...
// public static void SetTargetSpecific() :14
void DllDirectory__SetTargetSpecific_fn()
{
    DllDirectory::SetTargetSpecific();
}

// public static void SetTargetSpecific() [static] :14
...
// internal extern delegate void JSCallbackFinalizer(Uno.IntPtr data) :51
...
// internal extern delegate void JSDebugMessageHandler(Uno.IntPtr data, Fuse.Scripting.V8.Simple.JSString message) :54
...
// internal extern delegate void JSExternalFinalizer(Uno.IntPtr external) :48
...
// public static extern void Retain(Fuse.Scripting.V8.Simple.JSContext context, Fuse.Scripting.V8.Simple.JSScriptException e) :242
...
// public static extern void Retain(Fuse.Scripting.V8.Simple.JSContext context, Fuse.Scripting.V8.Simple.JSScriptException e) [static] :242
...
// public static extern bool StrictEquals(Fuse.Scripting.V8.Simple.JSContext context, Fuse.Scripting.V8.Simple.JSValue obj1, Fuse.Scripting.V8.Simple.JSValue obj2) :184
...
// public static extern bool StrictEquals(Fuse.Scripting.V8.Simple.JSContext context, Fuse.Scripting.V8.Simple.JSValue obj1, Fuse.Scripting.V8.Simple.JSValue obj2) [static] :184
