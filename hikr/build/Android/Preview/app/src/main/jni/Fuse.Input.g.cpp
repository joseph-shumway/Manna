...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Nodes\1.4.0\Input\Gesture.uno
// ------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Nodes\1.4.0\Input\Pointer.uno
// ------------------------------------------------------------------------------------
...
static void Pointer__CaptureLockImpl_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Nodes\\1.4.0\\Input\\Pointer.uno");
...
bool CaptureTypeHelper::BecameHard(int prev, int next)
{
...
bool CaptureTypeHelper::GainedCapture(int prev, int next)
{
    return (!((prev & 1) == 1) && !((prev & 2) == 2)) && (((next & 1) == 1) || ((next & 2) == 2));
}
// }

// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Nodes\1.4.0\Input\PointerEvents.uno
// ------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Nodes\1.4.0\Input\Focus.uno
// ----------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Nodes\1.4.0\Input\FocusEvents.uno
// ----------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Nodes\1.4.0\Input\Focus.Prediction.uno
// ---------------------------------------------------------------------------------------------
...
::g::Fuse::Visual* FocusPrediction::NextSibling1(::g::Fuse::Visual* parent, ::g::Fuse::Visual* child)
{
    ...
    int index = (::g::Uno::Collections::EnumerableExtensions__IndexOf_fn(::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(4/*IndexOf<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL), parent->Children(), child, &ret1), ret1);
    int offset = index + 1;
...
::g::Fuse::Visual* FocusPrediction::PreviousSibling1(::g::Fuse::Visual* parent, ::g::Fuse::Visual* child)
{
    ...
    int ret5;
    ::g::Fuse::Node* ret6;
    int offset = (::g::Uno::Collections::EnumerableExtensions__IndexOf_fn(::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(4/*IndexOf<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL), uPtr(parent)->Children(), child, &ret5), ret5) - 1;
...
static void Gesture_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Nodes\\1.4.0\\Input\\Gesture.uno");
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Nodes\1.4.0\Input\HitTestHelpers.uno
// -------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Nodes\1.4.0\Input\Keyboard.uno
// -------------------------------------------------------------------------------------
...
bool Keyboard::IsKeyPressed(int key)
{
    ...
    for (int i = 0; i < uPtr(Keyboard::_keysDown_)->Count(); i++)
        if ((::g::Uno::Collections::List__get_Item_fn(uPtr(Keyboard::_keysDown_), uCRef<int>(i), &ret2), ret2) == key)
            return true;
...
void Pointer__IsCaptured1_fn(int* pointIndex, uObject* identity, bool* __retval)
{
...
::g::Fuse::Input::Capture* Pointer::GetFirstCapture(int type, int pointIndex, uObject* identity)
{
    ...
    for (int i = 0; i < uPtr(Pointer::_captures_)->Count(); ++i)
    {
        ::g::Fuse::Input::Capture* c = (::g::Uno::Collections::List__get_Item_fn(uPtr(Pointer::_captures_), uCRef<int>(i), &ret7), ret7);
...
bool Pointer::IsCaptured1(int pointIndex, uObject* identity)
{
...
uArray* Pointer::Coords()
{
    ...
    Pointer_typeof()->Init();
    ::g::Uno::Collections::Dictionary__Enumerator<int, uStrong<Pointer__PointerRecord*> > ret23;
    uArray* f = uArray::New(::g::Uno::Float2_typeof()->Array(), uPtr(Pointer::_pointersDown_)->Count());
    int i = 0;
    ::g::Uno::Collections::Dictionary__Enumerator<int, uStrong<Pointer__PointerRecord*> > enum1 = (::g::Uno::Collections::Dictionary__GetEnumerator_fn(uPtr(Pointer::_pointersDown_), &ret23), ret23);
    ...
    {
        {
            ...
            {
                ::g::Uno::Collections::KeyValuePair<int, uStrong<Pointer__PointerRecord*> > p = enum1.Current(::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Uno::Int_typeof(), Pointer__PointerRecord_typeof(), NULL));
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Nodes\1.4.0\Input\PointerEventArgs.uno
// ---------------------------------------------------------------------------------------------
...
static void PointerEventArgs_build(uType* type)
{
    ...
    ::STRINGS[14] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Nodes\\1.4.0\\Input\\PointerEventArgs.uno");
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Nodes\1.4.0\Input\TextService.uno
// ----------------------------------------------------------------------------------------
