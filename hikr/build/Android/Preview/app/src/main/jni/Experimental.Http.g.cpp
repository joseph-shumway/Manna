...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Experimental.Http\1.4.0\BinaryLoader.uno
// ------------------------------------------------------------------------------------------
...
{
    uStackFrame __("Experimental.Http.BinaryLoader", "ExtractHeaders(string)");
    uArray* array1;
    int index2;
    int length3;
...
{
    uStackFrame __("Experimental.Http.BinaryLoader", "Initiate()");
    MakeRequest();
}
...
{
    uStackFrame __("Experimental.Http.BinaryLoader", "MakeRequest()");
...
{
    uStackFrame __("Experimental.Http.BinaryLoader", "OnError(Uno.Net.Http.HttpMessageHandlerRequest,string)");
...
{
    uStackFrame __("Experimental.Http.BinaryLoader", "OnLoaded(Uno.Net.Http.HttpMessageHandlerRequest)");
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Experimental.Http\1.4.0\HttpLoader.uno
// ----------------------------------------------------------------------------------------
...
static void HttpLoader_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction("LoadBinary", NULL, (void*)HttpLoader__LoadBinary_fn, 0, true, uVoid_typeof(), 3, ::g::Uno::String_typeof(), ::g::Uno::Action2_typeof()->MakeType(::g::Experimental::Http::HttpResponseHeader_typeof(), ::g::Uno::Byte_typeof()->Array(), NULL), ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof(), NULL)));
}
...
{
    uStackFrame __("Experimental.Http.HttpLoader", "LoadBinary(string,Uno.Action<Experimental.Http.HttpResponseHeader, byte[]>,Uno.Action<string>)");
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Experimental.Http\1.4.0\HttpResponseHeader.uno
// ------------------------------------------------------------------------------------------------
...
static void HttpResponseHeader_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(4,
        new uFunction("get_Headers", NULL, (void*)HttpResponseHeader__get_Headers_fn, 0, false, ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof(), NULL), 0),
