// This file was generated based on C:/Users/Shumcom/Documents/Fuse/Manna/hikr/build/Android/Preview/preamble/$.uno.
...
static void GeneratedApplication_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("192.168.1.15");
    ::STRINGS[2] = uString::Const("192.168.1.33");
    ::STRINGS[3] = uString::Const("C:\\Users\\Shumcom\\Documents\\Fuse\\Manna\\hikr\\hikr.unoproj");
    ::STRINGS[4] = uString::Const("hikr");
...
void GeneratedApplication::ctor_5()
{
    ...
    ctor_4(uArray::Init< ::g::Uno::Net::IPEndPoint*>(::TYPES[0/*Uno.Net.IPEndPoint[]*/], 3, (::g::Uno::Net::IPEndPoint*)::g::Uno::Net::IPEndPoint::New1(::g::Uno::Net::IPAddress::Parse(::STRINGS[0/*"127.0.0.1"*/]), 12124), (::g::Uno::Net::IPEndPoint*)::g::Uno::Net::IPEndPoint::New1(::g::Uno::Net::IPAddress::Parse(::STRINGS[1/*"192.168.1.15"*/]), 12124), (::g::Uno::Net::IPEndPoint*)::g::Uno::Net::IPEndPoint::New1(::g::Uno::Net::IPAddress::Parse(::STRINGS[2/*"192.168.1.33"*/]), 12124)), ::STRINGS[3/*"C:\\Users\\...*/], uArray::Init<uString*>(::TYPES[1/*string[]*/], 0));
    ::g::Outracks::Simulator::Runtime::Bundle::Initialize(::STRINGS[4/*"hikr"*/]);
