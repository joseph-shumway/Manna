...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\Implementation\BitArray.uno
// ---------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\Implementation\Util.uno
// -----------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\Implementation\FreeType.uno
// ---------------------------------------------------------------------------------------------
...
// private static Uno.IntPtr Current_Glyph_Bitmap_Buffer(Uno.IntPtr face) :257
void FreeType__Current_Glyph_Bitmap_Buffer_fn(void** face, void** __retval)
{
    *__retval = FreeType::Current_Glyph_Bitmap_Buffer(*face);
}

// private static bool Current_Glyph_Bitmap_Buffer_Is_BGRA(Uno.IntPtr face) :263
...
// public static int2 Current_Glyph_Bitmap_Offset(Uno.IntPtr face) :241
...
// private static void Current_Glyph_Bitmap_Offset_Raw(Uno.IntPtr face, int& x, int& y) :249
void FreeType__Current_Glyph_Bitmap_Offset_Raw_fn(void** face, int* x, int* y)
{
    FreeType::Current_Glyph_Bitmap_Offset_Raw(*face, x, y);
}

// public static int2 Current_Glyph_Bitmap_Size(Uno.IntPtr face) :227
...
// private static void Current_Glyph_Bitmap_Size_Raw(Uno.IntPtr face, int& width, int& rows) :235
...
// private static int Init_FreeType(Uno.IntPtr& library) :75
...
// public static void Load_Glyph(Uno.IntPtr face, uint glyph, int flags) :216
void FreeType__Load_Glyph_fn(void** face, uint32_t* glyph, int* flags)
{
    FreeType::Load_Glyph(*face, *glyph, *flags);
}

// private static int Load_Glyph_Raw(Uno.IntPtr face, uint glyph, int flags) :222
...
// public static void Load_Render_Glyph(Uno.IntPtr face, uint glyph) :205
void FreeType__Load_Render_Glyph_fn(void** face, uint32_t* glyph)
{
    FreeType::Load_Render_Glyph(*face, *glyph);
}

// private static int Load_Render_Glyph_Raw(Uno.IntPtr face, uint glyph) :211
...
// public static void New_Face(string fileName, int index, Uno.IntPtr& face) :97
void FreeType__New_Face_fn(uString* fileName, int* index, void** face)
{
    FreeType::New_Face(fileName, *index, face);
}

// private static int New_Face_Raw(Uno.IntPtr library, byte[] fileName, int index, Uno.IntPtr& face) :111
...
// public static void New_Memory_Face(byte[] buffer, int index, Uno.IntPtr& face) :86
void FreeType__New_Memory_Face_fn(uArray* buffer, int* index, void** face)
{
    FreeType::New_Memory_Face(buffer, *index, face);
}

// private static int New_Memory_Face_Raw(Uno.IntPtr library, byte[] buffer, int length, int index, Uno.IntPtr& face) :92
...
// public static string Style_Name(Uno.IntPtr face) :328
void FreeType__Style_Name_fn(void** face, uString** __retval)
{
    *__retval = FreeType::Style_Name(*face);
}

// private static Uno.IntPtr Style_Name_Raw(Uno.IntPtr face) :334
...
// public static void Activate_Size(Uno.IntPtr size) [static] :149
...
// private static int Activate_Size_Raw(Uno.IntPtr size) [static] :155
int FreeType::Activate_Size_Raw(void* size)
{
    return FT_Activate_Size((FT_Size)size);
}

// public static int Ascender(Uno.IntPtr face) [static] :300
int FreeType::Ascender(void* face)
{
    return (int)((FT_Face)face)->size->metrics.ascender;
}

// public static void BGRAToRGBA(byte[] buffer) [static] :288
...
// public static Uno.Content.Images.Bitmap Current_Glyph_Bitmap(Uno.IntPtr face) [static] :268
...
// private static Uno.IntPtr Current_Glyph_Bitmap_Buffer(Uno.IntPtr face) [static] :257
void* FreeType::Current_Glyph_Bitmap_Buffer(void* face)
{
    return (void*)((FT_Face)face)->glyph->bitmap.buffer;
}

// private static bool Current_Glyph_Bitmap_Buffer_Is_BGRA(Uno.IntPtr face) [static] :263
...
// public static int2 Current_Glyph_Bitmap_Offset(Uno.IntPtr face) [static] :241
...
// private static void Current_Glyph_Bitmap_Offset_Raw(Uno.IntPtr face, int& x, int& y) [static] :249
...
// public static int2 Current_Glyph_Bitmap_Size(Uno.IntPtr face) [static] :227
...
// private static void Current_Glyph_Bitmap_Size_Raw(Uno.IntPtr face, int& width, int& rows) [static] :235
...
// public static int Descender(Uno.IntPtr face) [static] :306
int FreeType::Descender(void* face)
{
    return (int)((FT_Face)face)->size->metrics.descender;
}

// public static void Done_Face(Uno.IntPtr face) [static] :116
...
// private static int Done_Face_Raw(Uno.IntPtr face) [static] :122
int FreeType::Done_Face_Raw(void* face)
{
    return FT_Done_Face((FT_Face)face);
}

// public static void Done_Size(Uno.IntPtr size) [static] :138
...
// private static int Init_FreeType(Uno.IntPtr& library) [static] :75
int FreeType::Init_FreeType(void** library)
{
    return FT_Init_FreeType((FT_Library*)library);
}

// public static void Load_Glyph(Uno.IntPtr face, uint glyph, int flags) [static] :216
...
// private static int Load_Glyph_Raw(Uno.IntPtr face, uint glyph, int flags) [static] :222
int FreeType::Load_Glyph_Raw(void* face, uint32_t glyph, int flags)
{
    return FT_Load_Glyph((FT_Face)face, glyph, flags);
}

// public static void Load_Render_Glyph(Uno.IntPtr face, uint glyph) [static] :205
...
// private static int Load_Render_Glyph_Raw(Uno.IntPtr face, uint glyph) [static] :211
...
// public static void New_Face(string fileName, int index, Uno.IntPtr& face) [static] :97
...
// private static int New_Face_Raw(Uno.IntPtr library, byte[] fileName, int index, Uno.IntPtr& face) [static] :111
...
// public static void New_Memory_Face(byte[] buffer, int index, Uno.IntPtr& face) [static] :86
...
// private static int New_Memory_Face_Raw(Uno.IntPtr library, byte[] buffer, int length, int index, Uno.IntPtr& face) [static] :92
...
// public static void New_Size(Uno.IntPtr face, Uno.IntPtr& size) [static] :127
...
// private static int New_Size_Raw(Uno.IntPtr face, Uno.IntPtr& size) [static] :133
int FreeType::New_Size_Raw(void* face, void** size)
{
    return FT_New_Size((FT_Face)face, (FT_Size*)size);
}

// public static int Num_Faces(Uno.IntPtr face) [static] :340
int FreeType::Num_Faces(void* face)
{
    return (int)((FT_Face)face)->num_faces;
}

// public static int Num_Glyphs(Uno.IntPtr face) [static] :346
int FreeType::Num_Glyphs(void* face)
{
    return (int)((FT_Face)face)->num_glyphs;
}

// public static void Set_Pixel_Sizes(Uno.IntPtr face, int w, int h, float& scale) [static] :160
...
// private static int Set_Pixel_Sizes_Raw(Uno.IntPtr rawFace, int w, int h, float& scale) [static] :167
...
// public static string Style_Name(Uno.IntPtr face) [static] :328
uString* FreeType::Style_Name(void* face)
{
    return ::g::Fuse::Text::Implementation::CString::ToString(FreeType::Style_Name_Raw(face));
}

// private static Uno.IntPtr Style_Name_Raw(Uno.IntPtr face) [static] :334
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\Implementation\FreeTypeFontFace.uno
// -----------------------------------------------------------------------------------------------------
...
void FreeTypeFont__get_NumGlyphs_fn(FreeTypeFont* __this, int* __retval)
{
    ...
    {
        {
            int __uno_retval = ::g::Fuse::Text::Implementation::FreeType::Num_Glyphs(__this->_ftFace);
            ::g::Uno::Threading::Monitor::Exit(__this->_faceMutex);
            return *__retval = __uno_retval, void();
        }
        {
...
void FreeTypeFont__Shape_fn(FreeTypeFont* __this, ::g::Fuse::Text::Substring* text, int* fontIndex, int* dir, uArray** __retval)
{
    ...
    try
    {
        {
            ::g::Fuse::Text::Implementation::FreeType::Activate_Size(__this->_ftSize);
            uArray* __uno_retval = (::g::Fuse::Text::Implementation::HarfbuzzFont__Shape_fn(__this, text, uCRef<int>(fontIndex_), uCRef<int>(dir_), &ret5), ret5);
            ::g::Uno::Threading::Monitor::Exit(__this->_faceMutex);
            return *__retval = __uno_retval, void();
        }
        {
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\Implementation\Harfbuzz.uno
// ---------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\Implementation\HarfbuzzFont.uno
// -------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Text\1.4.0\Implementation\JavaLineBreaks.uno
// ---------------------------------------------------------------------------------------------------
...
// private static void CopyLineBreaks(string text, Java.Object outByteBufferHandle) :17
...
// private static Java.Object DirectBufferFromUnoByteBuffer(byte[] byteArray) :35
...
// public static Fuse.Text.Implementation.BitArray GetSoftLineBreaks(Fuse.Text.Substring text) :9
...
// private static void CopyLineBreaks(string text, Java.Object outByteBufferHandle) [static] :17
void JavaLineBreaks::CopyLineBreaks(uString* text, ::g::Java::Object* outByteBufferHandle)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "CopyLineBreaks320", "(Ljava/lang/String;Ljava/lang/Object;)V");
        uString* _utext=text;
...
// private static Java.Object DirectBufferFromUnoByteBuffer(byte[] byteArray) [static] :35
...
// public static Fuse.Text.Implementation.BitArray GetSoftLineBreaks(Fuse.Text.Substring text) [static] :9
