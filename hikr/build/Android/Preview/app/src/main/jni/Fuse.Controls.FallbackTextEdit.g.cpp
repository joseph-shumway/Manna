...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\1.4.0\TextControls\FallbackTextEdit\Helpers.uno
// --------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\1.4.0\TextControls\FallbackTextEdit\LineCache.uno
// ----------------------------------------------------------------------------------------------------------------------------
...
static void LineCache_build(uType* type)
{
    ...
    ::TYPES[3] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2/*First<Fuse.Controls.FallbackTextEdit.LineCacheLine>*/, ::g::Fuse::Controls::FallbackTextEdit::LineCacheLine_typeof(), NULL);
    type->SetDependencies(
        ::g::Fuse::Controls::FallbackTextEdit::TextPosition_typeof(),
        ::g::Fuse::Controls::FallbackTextEdit::TextSpan_typeof());
    type->SetFields(0,
...
::g::Uno::Collections::List* LineCache::DecomposeLines(uString* text)
{
    ...
    if (lines->Count() == 0)
        ::g::Uno::Collections::List__Add_fn(uPtr(lines), ::g::Fuse::Controls::FallbackTextEdit::LineCacheLine::New1(::g::Uno::String::Empty_, _transform));
...
::g::Fuse::Controls::FallbackTextEdit::TextSpan* LineCache::GetFullTextSpan()
{
    ...
    return ::g::Fuse::Controls::FallbackTextEdit::TextSpan::New1(::g::Fuse::Controls::FallbackTextEdit::TextPosition::Default_, GetLastTextPos());
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\1.4.0\TextControls\FallbackTextEdit\LineCacheLine.uno
// --------------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\1.4.0\TextControls\FallbackTextEdit\LineCacheTransform.uno
// -------------------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\1.4.0\TextControls\FallbackTextEdit\TextPosition.uno
// -------------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.Primitives\1.4.0\TextControls\FallbackTextEdit\TextWindow.uno
// -----------------------------------------------------------------------------------------------------------------------------

// internal sealed class TextWindow :7
// {
static void TextWindow_build(uType* type)
{
    type->SetDependencies(
        ::g::Fuse::Elements::Internal::ElementDraw_typeof(),
        ::g::Fuse::Controls::FallbackTextEdit::TextSpan_typeof(),
...
// public TextWindow(Fuse.Visual parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache) :11
...
// protected override sealed Fuse.VisualBounds CalcRenderBounds() :27
...
// public void Draw(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextSpan selection, float4 textColor, float4 selectionColor, int maxTextLength, Fuse.Controls.TextAlignment textAlignment, float2 textBoundsSize, float2 offset, Fuse.DrawContext dc) :32
...
// public TextWindow New(Fuse.Visual parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache) :11
...
// protected override sealed void OnDraw(Fuse.DrawContext dc) :49
            ...
            else if (drawY >= -lineHeight)
            {
                ...
                if (::g::Fuse::Controls::FallbackTextEdit::TextSpan::op_Inequality(__this->_selection, NULL))
                {
                    ...
                    if (::g::Fuse::Controls::FallbackTextEdit::TextSpan::op_Inequality(intersection, NULL))
                    {
                        ...
                        uPtr(::g::Fuse::Elements::Internal::ElementDraw::Impl_)->Rectangle(dc, __this, ::g::Uno::Math::Floor2(::g::Uno::Float2__New2((__this->_offset.X + x) + startPos, __this->_offset.Y + selectionY)), ::g::Uno::Float2__New2(endPos - startPos, uPtr(__this->_wrapInfo)->LineHeight), __this->_selectionColor);
                    }
                }
...
// public TextWindow(Fuse.Visual parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache) [instance] :11
...
// public void Draw(Fuse.Controls.FallbackTextRenderer.WordWrapInfo wrapInfo, Fuse.Controls.FallbackTextEdit.TextSpan selection, float4 textColor, float4 selectionColor, int maxTextLength, Fuse.Controls.TextAlignment textAlignment, float2 textBoundsSize, float2 offset, Fuse.DrawContext dc) [instance] :32
...
// public TextWindow New(Fuse.Visual parent, Fuse.Controls.FallbackTextEdit.LineCache lineCache) [static] :11
