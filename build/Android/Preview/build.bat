:: This file was generated based on '../../../Local/Fusetools/Packages/UnoCore/1.4.3/Targets/Android/build.bat'.
...
"C:\Program Files (x86)\Fuse\uno.exe" cp app/build/outputs/apk/app-debug.apk Manna.apk || goto ERROR
