...
static void Debugger__Connected_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("../../../Local/Fusetools/Packages/Fuse.Scripting.JavaScript/1.4.0/V8/Debugger.uno");
...
void Debugger__Connected::ctor_(::g::Fuse::Scripting::V8::Debugger* parent, ::g::Uno::Net::Sockets::Socket* socket, ::g::Uno::IO::TextReader* reader)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[0/*"DEBUG_V8: C...*/], 0, ::STRINGS[1/*"../../../Lo...*/], 246);
    _parent = parent;
    _socket = socket;
    _reader = reader;
}
...
uObject* Debugger::Connect(Debugger* parent)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(uString::Const("DEBUG_V8: Waiting for a debugger agent to connect on port "), uBox<int>(::TYPES[8/*int*/], parent->_port)), uString::Const("...")), 0, ::STRINGS[1/*"../../../Lo...*/], 87);
