...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.0\Drawing\Rectangle.uno
// -------------------------------------------------------------------------------------------

// internal sealed class ElementDraw :6
// {
// static generated ElementDraw() :6
...
static void ElementDraw_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::Graphics::VertexBuffer_typeof(), offsetof(ElementDraw, Rectangle_VertexData_ecf1769_6_2_1), 0,
        ::g::Uno::Float4x4_typeof(), offsetof(ElementDraw, Rectangle_LocalTransform_ecf1769_3_9_2), 0,
        ::g::Uno::Float4x4_typeof(), offsetof(ElementDraw, Rectangle_LocalTransform_ecf1769_3_9_3), 0,
        ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLDrawCall_typeof(), offsetof(ElementDraw, _draw_ecf1769), 0,
        type, (uintptr_t)&ElementDraw::Impl_, uFieldFlagsStatic);
}
...
// public generated ElementDraw() :6
...
// public generated ElementDraw New() :6
void ElementDraw__New1_fn(ElementDraw** __retval)
{
    *__retval = ElementDraw::New1();
}

// public void Rectangle(Fuse.DrawContext dc, Fuse.Elements.Element element, float2 offset, float2 size, float4 color) :10
...
// public generated ElementDraw() [instance] :6
...
// public void Rectangle(Fuse.DrawContext dc, Fuse.Elements.Element element, float2 offset, float2 size, float4 color) [instance] :10
...
// public generated ElementDraw New() [static] :6
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.0\Drawing\Scale9Rectangle.uno
// -------------------------------------------------------------------------------------------------
...
static void Scale9Rectangle_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[2/*ushort[]*/], offsetof(Scale9Rectangle, Draw_indices_42808b82_1_2_13), 0,
