...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.WebSockets\1.4.0\WebSocketModule.uno
// -------------------------------------------------------------------------------------------
...
{
    uStackFrame __("Fuse.WebSocket.NativeFunctionModule.FunctionClosure", "function(object[])");
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.WebSockets\1.4.0\WebSocketClient.uno
// -------------------------------------------------------------------------------------------
...
{
    uStackFrame __("Fuse.WebSocket.NativeFunctionModule", "Evaluate(Fuse.Scripting.Context,Fuse.Scripting.ModuleResult)");
...
{
    uStackFrame __("Fuse.WebSocket.NativeFunctionModule", ".ctor(string)");
    ctor_1();
...
static void WebSocketClient_build(uType* type)
{
    ...
    type->Reflection.SetFields(5,
        new uField("Closed", 2),
        new uField("DataReceived", 4),
        new uField("ErrorReceived", 5),
        new uField("MessageReceived", 3),
        new uField("Opened", 1));
    type->Reflection.SetFunctions(5,
        ...
        new uFunction(".ctor", NULL, (void*)WebSocketClient__New1_fn, 0, true, type, 2, ::g::Uno::String_typeof(), ::g::Uno::String_typeof()->Array()),
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClient", ".ctor(string,string[])");
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClient", "Close()");
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClient", "Connect()");
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClient", "OnClose()");
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClient", "OnError(string)");
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClient", "OnOpen()");
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClient", "OnReceiveData(byte[])");
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClient", "OnReceiveMessage(string)");
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClient", "Send(byte[])");
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClient", "Send(string)");
...
static void WebSocketClientModule_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(2,
        new uFunction(".ctor", NULL, (void*)WebSocketClientModule__New2_fn, 0, true, type, 0),
        new uFunction("OnReset", NULL, (void*)WebSocketClientModule__OnReset_fn, 0, false, uVoid_typeof(), 2, uObject_typeof(), ::g::Uno::EventArgs_typeof()));
}
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClientModule", "Create(Fuse.Scripting.Context,object[])");
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClientModule", ".ctor()");
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClientWrapper", "Close(Fuse.Scripting.Context,object[])");
    uPtr(_client)->Close();
    return NULL;
}
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClientWrapper", "Closed()");
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClientWrapper", "Connect(Fuse.Scripting.Context,object[])");
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClientWrapper", "DataReceived(byte[])");
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClientWrapper", "ErrorReceived(string)");
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClientWrapper", "MessageReceived(string)");
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClientWrapper", "Opened()");
...
{
    uStackFrame __("Fuse.WebSocket.WebSocketClientWrapper", "Send(Fuse.Scripting.Context,object[])");
