...
::g::Uno::Graphics::Framebuffer* Element::CaptureRegion(::g::Fuse::DrawContext* dc, ::g::Uno::Rect region, ::g::Uno::Float2 padding)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(uString::Const("CaptureRegion bigger than maximum texture size, dropping rendering (size: "), uBox(::g::Uno::Int2_typeof(), fsz)), uString::Const(", max-size: ")), uBox<int>(::g::Uno::Int_typeof(), ::g::Uno::Graphics::Texture2D::MaxSize())), 0, uString::Const("../../../Local/Fusetools/Packages/Fuse.Elements/1.4.0/Element.Drawing.uno"), 40);
        return NULL;
    }
...
static void ElementBatcher_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("../../../Local/Fusetools/Packages/Fuse.Elements/1.4.0/Caching/ElementBatcher.uno");
    ...
    {
        {
            while (enum4.MoveNext(::TYPES[19/*Uno.Collections.List<Fuse.Visual>.Enumerator*/]))
            {
                ...
                if (emitNewBatch || (atlas == NULL))
                {
                    ...
                    {
                        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[10/*"BUG: atlas-...*/], 0, ::STRINGS[11/*"../../../Lo...*/], 253);
