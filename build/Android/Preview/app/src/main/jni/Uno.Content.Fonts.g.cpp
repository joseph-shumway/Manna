...
static void DefaultTextTransform_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("../../../Local/Fusetools/Packages/UnoCore/1.4.3/Source/Uno/Content/Fonts/DefaultTextTransform.uno");
...
{
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[0/*"DefaultText...*/], 0, ::STRINGS[1/*"../../../Lo...*/], 26);
    return *__retval = __this->_matrix, void();
}
