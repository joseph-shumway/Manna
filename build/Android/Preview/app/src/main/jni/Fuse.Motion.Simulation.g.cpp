...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Motion\1.4.0\Simulation\AngularAdapter.uno
// -------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Motion\1.4.0\Simulation\BoundedRegion2D.uno
// --------------------------------------------------------------------------------------------------
...
{
    type->SetDependencies(
        ::g::Fuse::Motion::Simulation::ElasticForce_typeof()->MakeType(::g::Uno::Float2_typeof(), NULL),
...
BasicBoundedRegion2D_type* BasicBoundedRegion2D_typeof()
{
    ...
    type->interface0.fp_get_IsDestination = (void(*)(uObject*, bool*))BasicBoundedRegion2D__get_IsDestination_fn;
...
// public static Fuse.Motion.Simulation.BasicBoundedRegion2D CreateExponential() :43
...
// public static Fuse.Motion.Simulation.BasicBoundedRegion2D CreatePoints() :35
void BasicBoundedRegion2D__CreatePoints_fn(BasicBoundedRegion2D** __retval)
{
    *__retval = BasicBoundedRegion2D::CreatePoints();
}

// public static Fuse.Motion.Simulation.BasicBoundedRegion2D CreateRadians() :52
...
// public bool get_IsDestination() :136
void BasicBoundedRegion2D__get_IsDestination_fn(BasicBoundedRegion2D* __this, bool* __retval)
{
    *__retval = __this->IsDestination();
}
...
{
    uStackFrame __("Fuse.Motion.Simulation.BasicBoundedRegion2D", "Adjust(float2)");
...
// public bool get_IsDestination() [instance] :136
bool BasicBoundedRegion2D::IsDestination()
{
    return _moveMode == 4;
}
...
// public static Fuse.Motion.Simulation.BasicBoundedRegion2D CreateExponential() [static] :43
BasicBoundedRegion2D* BasicBoundedRegion2D::CreateExponential()
{
    ...
    region->_destination = (uObject*)((::g::Fuse::Motion::Simulation::ElasticForce*)::g::Fuse::Motion::Simulation::ElasticForce::CreateNormalized(::g::Fuse::Motion::Simulation::ElasticForce_typeof()->MakeType(::g::Uno::Float2_typeof(), NULL)));
    region->_snap = (uObject*)((::g::Fuse::Motion::Simulation::SmoothSnap*)::g::Fuse::Motion::Simulation::SmoothSnap::CreateNormalized(::g::Fuse::Motion::Simulation::SmoothSnap_typeof()->MakeType(::g::Uno::Float2_typeof(), NULL)));
    region->_overflowExtent = ::g::Uno::Float2__New1(0.5f);
    return region;
}

// public static Fuse.Motion.Simulation.BasicBoundedRegion2D CreatePoints() [static] :35
BasicBoundedRegion2D* BasicBoundedRegion2D::CreatePoints()
{
    ...
    BasicBoundedRegion2D* region = BasicBoundedRegion2D::New1();
    ::g::Fuse::Motion::Simulation::ElasticForce* dest = (::g::Fuse::Motion::Simulation::ElasticForce*)::g::Fuse::Motion::Simulation::ElasticForce::CreatePoints(::g::Fuse::Motion::Simulation::ElasticForce_typeof()->MakeType(::g::Uno::Float2_typeof(), NULL));
    region->_destination = (uObject*)dest;
    return region;
}

// public static Fuse.Motion.Simulation.BasicBoundedRegion2D CreateRadians() [static] :52
BasicBoundedRegion2D* BasicBoundedRegion2D::CreateRadians()
{
    ...
    BasicBoundedRegion2D* region = BasicBoundedRegion2D::New1();
    region->_destination = (uObject*)((::g::Fuse::Motion::Simulation::ElasticForce*)::g::Fuse::Motion::Simulation::ElasticForce::CreateRadians(::g::Fuse::Motion::Simulation::ElasticForce_typeof()->MakeType(::g::Uno::Float2_typeof(), NULL)));
    region->_snap = (uObject*)((::g::Fuse::Motion::Simulation::SmoothSnap*)::g::Fuse::Motion::Simulation::SmoothSnap::CreateRadians(::g::Fuse::Motion::Simulation::SmoothSnap_typeof()->MakeType(::g::Uno::Float2_typeof(), NULL)));
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Motion\1.4.0\Simulation\Simulation.uno
// ---------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Motion\1.4.0\Simulation\EasingMotion.uno
// -----------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Motion\1.4.0\Simulation\ElasticForce.uno
// -----------------------------------------------------------------------------------------------
...
// public void ResetMaxSpeed() [instance] :134
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Motion\1.4.0\Simulation\Friction.uno
// -------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Motion\1.4.0\Simulation\PointerVelocity.uno
// --------------------------------------------------------------------------------------------------
...
// public T get_AverageVelocity() :44
...
// public double get_TotalDistance() :57
...
// public float get_Period() [instance] :28
float PointerVelocity::Period()
{
    return _period;
}

// public void set_Period(float value) [instance] :29
void PointerVelocity::Period(float value)
{
    _period = value;
}

// public double get_TotalDistance() [instance] :57
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Motion\1.4.0\Simulation\SmoothSnap.uno
// ---------------------------------------------------------------------------------------------
