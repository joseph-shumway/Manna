...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Elements\1.4.0\Triggers\Actions\BringIntoView.uno
// --------------------------------------------------------------------------------------------------------
...
// public generated BringIntoView() :39
void BringIntoView__ctor_2_fn(BringIntoView* __this)
{
    __this->ctor_2();
}

// public generated BringIntoView New() :39
...
// public generated BringIntoView() [instance] :39
void BringIntoView::ctor_2()
{
    ctor_1();
}

// public generated BringIntoView New() [static] :39
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls\1.4.0\Triggers\BringToFront.uno
// -----------------------------------------------------------------------------------------------
...
// public generated BringToFront() :37
void BringToFront__ctor_2_fn(BringToFront* __this)
{
    __this->ctor_2();
}

// public generated BringToFront New() :37
...
// public generated BringToFront() [instance] :37
...
// public generated BringToFront New() [static] :37
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\Callback.uno
// ------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\CancelInteractions.uno
// ----------------------------------------------------------------------------------------------------
...
// public generated CancelInteractions() :8
void CancelInteractions__ctor_2_fn(CancelInteractions* __this)
{
    __this->ctor_2();
}

// public generated CancelInteractions New() :8
...
// public generated CancelInteractions() [instance] :8
...
// public generated CancelInteractions New() [static] :8
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\Visibility.uno
// --------------------------------------------------------------------------------------------
...
static void Collapse_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\Actions\\Visibility.uno");
...
// public generated Collapse() :102
void Collapse__ctor_2_fn(Collapse* __this)
{
    __this->ctor_2();
}

// public generated Collapse New() :102
...
void Collapse__Perform_fn(Collapse* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[0/*"Cannot find...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 110, ::STRINGS[2/*"Perform"*/], NULL);
}

// public generated Collapse() [instance] :102
void Collapse::ctor_2()
{
    ctor_1();
}

// public generated Collapse New() [static] :102
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\DebugAction.uno
// ---------------------------------------------------------------------------------------------
...
// public Uno.Collections.IList<Fuse.Triggers.Actions.ITaggedDebugProperty> get_Properties() :29
...
// public Uno.Collections.IList<Fuse.Triggers.Actions.ITaggedDebugProperty> get_Properties() [instance] :29
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\DebugProperty.uno
// -----------------------------------------------------------------------------------------------
...
// public DebugProperty(Uno.UX.Property<T> val) :18
...
// public DebugProperty New(Uno.UX.Property<T> val) :18
...
// public DebugProperty(Uno.UX.Property<T> val) [instance] :18
...
// public DebugProperty New(Uno.UX.Property<T> val) [static] :18
...
// public string GetTag() [instance] :45
uString* DebugTime::GetTag()
{
    return ::STRINGS[6/*"Time"*/];
}

// public generated DebugTime New() [static] :43
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.WebView\1.4.0\EvaluateJS.uno
// --------------------------------------------------------------------------------------------
...
// public Fuse.Controls.IWebView get_WebView() :113
void EvaluateJS__get_WebView_fn(EvaluateJS* __this, uObject** __retval)
{
    *__retval = __this->WebView();
}

// public void set_WebView(Fuse.Controls.IWebView value) :114
...
// public Fuse.Controls.IWebView get_WebView() [instance] :113
uObject* EvaluateJS::WebView()
{
    return _target;
}

// public void set_WebView(Fuse.Controls.IWebView value) [instance] :114
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\Focus.uno
// ---------------------------------------------------------------------------------------
...
// public generated Hide() :66
void Hide__ctor_2_fn(Hide* __this)
{
    __this->ctor_2();
}

// public generated Hide New() :66
...
void Hide__Perform_fn(Hide* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[9/*"Cannot find...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 74, ::STRINGS[2/*"Perform"*/], NULL);
}

// public generated Hide() [instance] :66
void Hide::ctor_2()
{
    ctor_1();
}

// public generated Hide New() [static] :66
Hide* Hide::New2()
{
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\Toggle.uno
// ----------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.WebView\1.4.0\WebViewNavActions.uno
// ---------------------------------------------------------------------------------------------------
...
// public generated LoadHtml() [instance] :94
...
// public Fuse.Controls.HTML get_HTMLSource() [instance] :103
::g::Fuse::Controls::HTML* LoadHtml::HTMLSource()
{
    return _html;
}

// public void set_HTMLSource(Fuse.Controls.HTML value) [instance] :107
...
// public generated LoadHtml New() [static] :94
...
// public generated LoadUrl New() :52
...
// public generated LoadUrl() [instance] :52
void LoadUrl::ctor_3()
{
    ctor_2();
}
...
// public generated LoadUrl New() [static] :52
...
// public generated Play() :213
void Play__ctor_3_fn(Play* __this)
{
    __this->ctor_3();
}

// public generated Play New() :213
...
// public generated Play() [instance] :213
void Play::ctor_3()
{
    ctor_2();
}

// public generated Play New() [static] :213
Play* Play::New2()
{
...
// internal PlaybackAction() [instance] :45
...
static void PlayTo_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\Actions\\Playback.uno");
...
// public PlayTo() [instance] :285
void PlayTo::ctor_3()
{
    ctor_2();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[11/*"Use the Tim...*/], this, ::STRINGS[12/*"C:\\Users\\...*/], 288, ::STRINGS[13/*".ctor"*/]);
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\Pulse.uno
// ---------------------------------------------------------------------------------------
...
// public generated Pulse() :21
void Pulse__ctor_2_fn(Pulse* __this)
{
    __this->ctor_2();
}

// public generated Pulse New() :21
...
// public generated Pulse() [instance] :21
void Pulse::ctor_2()
{
    ctor_1();
}
...
// public generated Pulse New() [static] :21
Pulse* Pulse::New2()
{
...
// public generated PulseBackward() :36
void PulseBackward__ctor_2_fn(PulseBackward* __this)
{
    __this->ctor_2();
}

// public generated PulseBackward New() :36
...
// public generated PulseBackward() [instance] :36
...
// public generated PulseBackward New() [static] :36
...
// public generated PulseForward() :51
void PulseForward__ctor_2_fn(PulseForward* __this)
{
    __this->ctor_2();
}

// public generated PulseForward New() :51
...
// public generated PulseForward() [instance] :51
...
// public generated PulseForward New() [static] :51
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.UserEvents\1.4.0\RaiseUserEvent.uno
// ------------------------------------------------------------------------------------------
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[15] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.UserEvents\\1.4.0\\RaiseUserEvent.uno");
    ::STRINGS[2] = uString::Const("Perform");
...
void RaiseUserEvent__Perform_fn(RaiseUserEvent* __this, ::g::Fuse::Node* target)
{
    ...
    if (__this->_event == NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[14/*"no UserEven...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->EventName())), __this, ::STRINGS[15/*"C:\\Users\\...*/], 86, ::STRINGS[2/*"Perform"*/], NULL);
    else
...
// public generated ReleaseFocus() :49
void ReleaseFocus__ctor_2_fn(ReleaseFocus* __this)
{
    __this->ctor_2();
}

// public generated ReleaseFocus New() :49
...
// public generated ReleaseFocus() [instance] :49
void ReleaseFocus::ctor_2()
{
    ctor_1();
}

// public generated ReleaseFocus New() [static] :49
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Controls.Navigation\1.4.0\NavigationActions.uno
// ------------------------------------------------------------------------------------------------------
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[17] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Controls.Navigation\\1.4.0\\NavigationActions.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[16/*"Requires a ...*/], __this, ::STRINGS[17/*"C:\\Users\\...*/], 26, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
// public generated Reload New() :28
void Reload__New2_fn(Reload** __retval)
{
    *__retval = Reload::New2();
}

// public generated Reload() [instance] :28
void Reload::ctor_3()
{
    ctor_2();
}

// public generated Reload New() [static] :28
Reload* Reload::New2()
{
...
// public Resume New() :228
void Resume__New3_fn(Resume** __retval)
{
    *__retval = Resume::New3();
}

// public Resume() [instance] :228
void Resume::ctor_4()
{
    ctor_3();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[18/*"Use `Play` ...*/], this, ::STRINGS[12/*"C:\\Users\\...*/], 231, ::STRINGS[13/*".ctor"*/]);
}

// public Resume New() [static] :228
Resume* Resume::New3()
{
...
// public generated SendToBack() :82
void SendToBack__ctor_2_fn(SendToBack* __this)
{
    __this->ctor_2();
}

// public generated SendToBack New() :82
...
// public generated SendToBack() [instance] :82
...
// public generated SendToBack New() [static] :82
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\Set.uno
// -------------------------------------------------------------------------------------
...
// public generated Show() :30
void Show__ctor_2_fn(Show* __this)
{
    __this->ctor_2();
}

// public generated Show New() :30
...
void Show__Perform_fn(Show* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[20/*"Cannot find...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 38, ::STRINGS[2/*"Perform"*/], NULL);
}

// public generated Show() [instance] :30
void Show::ctor_2()
{
    ctor_1();
}

// public generated Show New() [static] :30
Show* Show::New2()
{
...
// public generated Stop() :112
void Stop__ctor_3_fn(Stop* __this)
{
    __this->ctor_3();
}

// public generated Stop New() :112
...
// public generated Stop() [instance] :112
void Stop::ctor_3()
{
    ctor_2();
}

// public generated Stop New() [static] :112
Stop* Stop::New2()
{
...
// public generated StopLoading() :40
...
// public generated StopLoading New() :40
void StopLoading__New2_fn(StopLoading** __retval)
{
    *__retval = StopLoading::New2();
}

// public generated StopLoading() [instance] :40
void StopLoading::ctor_3()
{
    ctor_2();
}

// public generated StopLoading New() [static] :40
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\TimelineAction.uno
// ------------------------------------------------------------------------------------------------
...
static void TimelineAction_build(uType* type)
{
    ...
    ::STRINGS[22] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\Actions\\TimelineAction.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(9,
...
// public generated TimelineAction() :32
...
// public generated TimelineAction New() :32
...
void TimelineAction__Perform_fn(TimelineAction* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[21/*"`TimelineAc...*/], __this, ::STRINGS[22/*"C:\\Users\\...*/], 48, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
// public generated TimelineAction() [instance] :32
...
// public generated TimelineAction New() [static] :32
...
static void Toggle_build(uType* type)
{
    ...
    ::STRINGS[24] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\Actions\\Toggle.uno");
    ::STRINGS[2] = uString::Const("Perform");
...
void Toggle__Perform_fn(Toggle* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[23/*"Could not f...*/], __this, ::STRINGS[24/*"C:\\Users\\...*/], 41, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
static void TransitionLayout_build(uType* type)
{
    ...
    ::STRINGS[26] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Elements\\1.4.0\\Triggers\\LayoutAnimation.uno");
    ::STRINGS[2] = uString::Const("Perform");
    ::TYPES[0] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[1] = ::g::Fuse::Node_typeof()->MakeMethod(1/*FindByType<Fuse.Visual>*/, ::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[27] = ::g::Uno::Action_typeof();
...
// public generated TransitionLayout() :342
...
// public generated TransitionLayout New() :342
...
void TransitionLayout__Perform_fn(TransitionLayout* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[25/*"Missing `Fr...*/], __this, ::STRINGS[26/*"C:\\Users\\...*/], 355, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
// public generated TransitionLayout() [instance] :342
...
// public generated TransitionLayout New() [static] :342
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\StateTransition.uno
// -------------------------------------------------------------------------------------------------
...
static void TransitionState_build(uType* type)
{
    ...
    ::STRINGS[28] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\Actions\\StateTransition.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(9,
...
// public generated TransitionState() :13
void TransitionState__ctor_2_fn(TransitionState* __this)
{
    __this->ctor_2();
}

// public generated TransitionState New() :13
...
void TransitionState__Perform_fn(TransitionState* __this, ::g::Fuse::Node* target)
{
    ...
    if (t == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[27/*"Missing `Ta...*/], __this, ::STRINGS[28/*"C:\\Users\\...*/], 24, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
// public generated TransitionState() [instance] :13
...
// public generated TransitionState New() [static] :13
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Triggers\1.4.0\Actions\TriggerAction.uno
// -----------------------------------------------------------------------------------------------
...
static void TriggerAction_build(uType* type)
{
    ...
    ::STRINGS[30] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Triggers\\1.4.0\\Actions\\TriggerAction.uno");
...
// public Fuse.Triggers.Actions.TriggerWhen get_Direction() :41
void TriggerAction__get_Direction_fn(TriggerAction* __this, int* __retval)
{
    *__retval = __this->Direction();
}

// public void set_Direction(Fuse.Triggers.Actions.TriggerWhen value) :42
...
// public Fuse.Triggers.Actions.TriggerWhen get_Direction() [instance] :41
int TriggerAction::Direction()
{
    return When();
}

// public void set_Direction(Fuse.Triggers.Actions.TriggerWhen value) [instance] :42
void TriggerAction::Direction(int value)
{
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[29/*"Use `Trigge...*/], this, ::STRINGS[30/*"C:\\Users\\...*/], 45, ::STRINGS[31/*"set_Direction"*/]);
    When(value);
}
...
// public bool get_BoolValue() [instance] :183
...
// public void set_BoolValue(bool value) [instance] :184
void UserEventArg::BoolValue(bool value)
{
    Value(uBox(::g::Uno::Bool_typeof(), value));
}

// public float get_FloatValue() [instance] :165
...
// public void set_FloatValue(float value) [instance] :166
void UserEventArg::FloatValue(float value)
{
    Value(uBox(::g::Uno::Double_typeof(), (double)value));
}

// public int get_IntValue() [instance] :155
...
// public void set_IntValue(int value) [instance] :156
...
// internal WebViewNavAction() [instance] :11
