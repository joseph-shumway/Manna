...
static void Error_build(uType* type)
{
    ...
    ::STRINGS[12] = uString::Const("../../../Local/Fusetools/Packages/Outracks.Simulator.Common.Uno/0.0.0/Messages/Error.cs");
...
Error* Error::ReadDataFrom(::g::System::IO::BinaryReader* reader)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[11/*"Read Error"*/], 0, ::STRINGS[12/*"../../../Lo...*/], 28);
