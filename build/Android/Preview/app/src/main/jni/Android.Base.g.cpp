...
int64_t JNI::GetUnoRef(jobject obj)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(JNI::_inited_, uString::Const("Android.Base.JNI._inited"), uString::Const("../../../Local/Fusetools/Packages/UnoCore/1.4.3/Targets/Android/Uno/Base/JNI.uno"), 296, uArray::New(uObject_typeof()->Array(), 0));
...
jclass JNI::LoadClass1(JNIEnv* jni, const char* name, bool systemClass)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(JNI::_inited_, uString::Const("Android.Base.JNI._inited"), uString::Const("../../../Local/Fusetools/Packages/UnoCore/1.4.3/Targets/Android/Uno/Base/JNI.uno"), 109, uArray::New(uObject_typeof()->Array(), 0));
    jclass result;
