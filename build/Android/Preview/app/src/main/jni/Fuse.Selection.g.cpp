...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Selection\1.4.0\Selected.uno
// -----------------------------------------------------------------------------------
...
static void Deselected_build(uType* type)
{
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Selection::SelectionEvent_type, interface4),
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Selection\1.4.0\Selection.uno
// ------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Selection\1.4.0\Selectable.ScriptClass.uno
// -------------------------------------------------------------------------------------------------
...
static void Selectable_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.4.0\\Selectable.ScriptClass.uno");
    ::STRINGS[6] = uString::Const("No selection, perhaps not rooted");
    ::STRINGS[7] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.4.0\\Selectable.uno");
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Selection\1.4.0\Selection.ScriptClass.uno
// ------------------------------------------------------------------------------------------------
...
void Selection__FuseReactiveIObserverOnFailed_fn(Selection* __this, uString* message)
{
    ...
    ::g::Fuse::Diagnostics::InternalError(message, __this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.4.0\\Selection.uno"), 495, uString::Const("Fuse.Reactive.IObserver.OnFailed"));
}
...
void Selection__FuseReactiveIObserverOnInsertAt_fn(Selection* __this, int* index, uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("removing invalid observable item"), __this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.4.0\\Selection.uno"), 485, uString::Const("Fuse.Reactive.IObserver.OnInsertAt"));
        return;
    }
...
void Selection__FuseReactiveIObserverOnNewAt_fn(Selection* __this, int* index, uObject* newValue)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("removing invalid observable item"), __this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.4.0\\Selection.uno"), 450, uString::Const("Fuse.Reactive.IObserver.OnNewAt"));
        return;
    }
...
void Selection__FuseReactiveIObserverOnRemoveAt_fn(Selection* __this, int* index)
{
    ...
    if ((index_ < 0) || (index_ >= uPtr(__this->_values)->Count()))
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("removing invalid observable item"), __this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.4.0\\Selection.uno"), 474, uString::Const("Fuse.Reactive.IObserver.OnRemoveAt"));
        return;
    }
...
void Selection::MaxCount(int value)
{
    ...
    if (value < 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("MaxCount must >= 1"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.4.0\\Selection.uno"), 138, uString::Const("set_MaxCount"), NULL);
        return;
    }
...
void Selection::OnSelectionChanged(int how)
{
    ...
    if ((how == 0) && (_subscription != NULL))
    {
        ...
        if (sub != NULL)
            ...
            ::g::Fuse::Diagnostics::UserWarning(uString::Const("Selection changed, but the bound collection is not writeable."), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.4.0\\Selection.uno"), 360, uString::Const("OnSelectionChanged"));
    }
}
...
void Selection::add_SelectionChanged(uDelegate* value)
{
    ...
    SelectionChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(SelectionChanged1, value), ::TYPES[4/*Uno.EventHandler*/]);
}
...
void Selection::remove_SelectionChanged(uDelegate* value)
{
    ...
    SelectionChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(SelectionChanged1, value), ::TYPES[4/*Uno.EventHandler*/]);
}
...
uString* Selection::Value()
{
    ...
    uString* ret25;
    return (uPtr(_values)->Count() > 0) ? (::g::Uno::Collections::List__get_Item_fn(uPtr(_values), uCRef<int>(0), &ret25), ret25) : uString::Const("");
}
...
void Selection::Values(uObject* value)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`Values` must be an IObservableArray"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.4.0\\Selection.uno"), 394, uString::Const("set_Values"), NULL);
        return;
    }
...
void Selection::add(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("add requires 1 argument, the value of the item"), s, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.4.0\\Selection.ScriptClass.uno"), 49, ::STRINGS[1/*"add"*/], NULL);
        return;
    }
...
void Selection::clear(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 0)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("clear requires 0 arguments"), s, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.4.0\\Selection.ScriptClass.uno"), 31, uString::Const("clear"), NULL);
        return;
    }
...
void Selection::forceAdd(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("forceAdd requires 1 argument, the value of the item"), s, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.4.0\\Selection.ScriptClass.uno"), 81, uString::Const("forceAdd"), NULL);
        return;
    }
...
void Selection::forceRemove(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("forceRemove requires 1 argument, the value of the item"), s, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.4.0\\Selection.ScriptClass.uno"), 95, uString::Const("forceRemove"), NULL);
        return;
    }
...
void Selection::remove(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("remove requires 1 argument, the value of the item"), s, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.4.0\\Selection.ScriptClass.uno"), 67, ::STRINGS[2/*"remove"*/], NULL);
        return;
    }
...
void Selection::toggle(::g::Fuse::Scripting::Context* c, Selection* s, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("toggle requires 1 argument, the value of them item"), s, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.4.0\\Selection.ScriptClass.uno"), 111, ::STRINGS[3/*"toggle"*/], NULL);
        return;
    }
...
{
    ::STRINGS[15] = uString::Const("Unable to locate a `Selectable` and `Selection`");
    ::STRINGS[16] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.4.0\\Selected.uno");
    ::STRINGS[10] = uString::Const("OnRooted");
    ...
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(SelectionEvent_type, interface4),
...
void SelectionEvent__OnRooted_fn(SelectionEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[15/*"Unable to l...*/], __this, ::STRINGS[16/*"C:\\Users\\...*/], 41, ::STRINGS[10/*"OnRooted"*/], NULL);
        return;
    }

    uPtr(__this->_selection)->add_SelectionChanged(uDelegate::New(::TYPES[4/*Uno.EventHandler*/], (void*)SelectionEvent__OnSelectionChanged_fn, __this));
...
void SelectionEvent__OnUnrooted_fn(SelectionEvent* __this)
{
    ...
    if (__this->_selection != NULL)
        uPtr(__this->_selection)->remove_SelectionChanged(uDelegate::New(::TYPES[4/*Uno.EventHandler*/], (void*)SelectionEvent__OnSelectionChanged_fn, __this));
...
void SelectionEventArgs__FuseScriptingIScriptEventSerialize_fn(SelectionEventArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[5/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[17/*"value"*/], __this->Value());
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Selection\1.4.0\ToggleSelection.uno
// ------------------------------------------------------------------------------------------
...
static void ToggleSelection_build(uType* type)
{
    ...
    ::STRINGS[19] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.4.0\\ToggleSelection.uno");
...
void ToggleSelection__Perform_fn(ToggleSelection* __this, ::g::Fuse::Node* target)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[18/*"Unable to l...*/], __this, ::STRINGS[19/*"C:\\Users\\...*/], 46, ::STRINGS[20/*"Perform"*/], NULL);
        return;
    }
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Selection\1.4.0\WhileSelected.uno
// ----------------------------------------------------------------------------------------
...
{
    ::STRINGS[15] = uString::Const("Unable to locate a `Selectable` and `Selection`");
    ::STRINGS[21] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Selection\\1.4.0\\WhileSelected.uno");
    ::STRINGS[10] = uString::Const("OnRooted");
    ::TYPES[4] = ::g::Uno::EventHandler_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(WhileSelected_type, interface4),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(WhileSelected_type, interface5),
...
WhileSelected_type* WhileSelected_typeof()
{
    ...
    type->interface8.fp_OnPropertyChanged = (void(*)(uObject*, ::g::Uno::UX::PropertyObject*, ::g::Uno::UX::Selector*))WhileSelected__UnoUXIPropertyListenerOnPropertyChanged_fn;
    type->interface7.fp_OnPlaybackDone = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn;
    type->interface7.fp_OnStable = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnStable_fn;
    type->interface6.fp_OnProgressUpdated = (void(*)(uObject*, uObject*, double*, double*, int*))::g::Fuse::Triggers::Trigger__FuseAnimationsIUnwrappedPlayerFeedbackOnProgressUpdated_fn;
    type->interface4.fp_Clear = (void(*)(uObject*))::g::Fuse::Node__UnoCollectionsICollectionFuseBindingClear_fn;
...
// public generated WhileSelected() :15
void WhileSelected__ctor_6_fn(WhileSelected* __this)
{
    __this->ctor_6();
}

// public generated WhileSelected New() :15
...
void WhileSelected__OnRooted_fn(WhileSelected* __this)
{
    ...
    if (!::g::Fuse::Selection::Selection::TryFindSelectable(__this->Parent(), &__this->_selectable, &__this->_selection))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[15/*"Unable to l...*/], __this, ::STRINGS[21/*"C:\\Users\\...*/], 26, ::STRINGS[10/*"OnRooted"*/], NULL);
        return;
    }

    __this->SetActive(uPtr(__this->_selection)->IsSelected(__this->_selectable));
    uPtr(__this->_selection)->add_SelectionChanged(uDelegate::New(::TYPES[4/*Uno.EventHandler*/], (void*)WhileSelected__OnSelectionChanged_fn, __this));
    uPtr(__this->_selectable)->AddPropertyListener((uObject*)__this);
}

// private void OnSelectionChanged(object s, object args) :58
void WhileSelected__OnSelectionChanged_fn(WhileSelected* __this, uObject* s, uObject* args)
{
    __this->OnSelectionChanged(s, args);
}

// protected override sealed void OnUnrooted() :35
void WhileSelected__OnUnrooted_fn(WhileSelected* __this)
{
    ...
    if (__this->_selection != NULL)
    {
        uPtr(__this->_selection)->remove_SelectionChanged(uDelegate::New(::TYPES[4/*Uno.EventHandler*/], (void*)WhileSelected__OnSelectionChanged_fn, __this));
...
// private void Uno.UX.IPropertyListener.OnPropertyChanged(Uno.UX.PropertyObject obj, Uno.UX.Selector prop) :48
...
// public generated WhileSelected() [instance] :15
void WhileSelected::ctor_6()
{
    ctor_5();
}

// private void OnSelectionChanged(object s, object args) [instance] :58
...
// public generated WhileSelected New() [static] :15
