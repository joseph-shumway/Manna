// This file was generated based on '../../../Local/Fusetools/Packages/UnoCore/1.4.3/Backends/CPlusPlus/Uno/Support.cpp'.
...
void uLogv(int level, const char* format, va_list args)
{
    ...
    __android_log_vprint(logs[level], "Manna", format, args);
#else
