...
static void Texture2D_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("../../../Local/Fusetools/Packages/UnoCore/1.4.3/Source/Uno/Graphics/Texture2D.uno");
    ...
    if (::g::Uno::String::StartsWith(uPtr(versionString), ::STRINGS[4/*"OpenGL ES "*/]))
    {
        ...
        catch (const uThrowable& __t)
        {
            if (uIs(__t.Exception, ::TYPES[1/*Uno.FormatException*/]))
            {
                ...
                ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[5/*"**** Invali...*/], versionString), 0, ::STRINGS[6/*"../../../Lo...*/], 114);
            }
            else             throw __t;
        }
    }
