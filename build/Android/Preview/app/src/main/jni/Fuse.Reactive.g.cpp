...
{
    ::STRINGS[16] = uString::Const("../../../Local/Fusetools/Packages/Fuse.Scripting.JavaScript/1.4.0/FuseJS/DebugLog.uno");
...
uObject* Console::Dir(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(builder->ToString(), 0, ::STRINGS[16/*"../../../Lo...*/], 53);
    return NULL;
}
...
uObject* Console::Log(uArray* args)
{
    ...
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[17/*"null"*/], 0, ::STRINGS[16/*"../../../Lo...*/], 39);
...
uObject* DebugLog::Log(uArray* args)
{
    ...
    for (int i = 0; i < uPtr(args)->Length(); i++)
        ::g::Uno::Diagnostics::Debug::Log5((uPtr(args)->Strong<uObject*>(i) != NULL) ? (uString*)::g::Uno::Object::ToString(uPtr(uPtr(args)->Strong<uObject*>(i))) : ::STRINGS[17/*"null"*/], 0, ::STRINGS[16/*"../../../Lo...*/], 17);
