...
static void TextRenderer_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("../../../Local/Fusetools/Packages/Fuse.Controls.Primitives/1.4.0/TextControls/FuseTextRenderer/FuseTextRenderer.uno");
...
void TextRenderer::AsyncMeasurementsDone(::g::Fuse::Controls::FuseTextRenderer::CacheState* state)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(_cacheState == NULL, ::STRINGS[3/*"this._cache...*/], ::STRINGS[4/*"../../../Lo...*/], 148, uArray::New(::TYPES[7/*object[]*/], 0));
    _cacheState = state;
