...
#include <Uno.Content.Splines.F-4342b261.h>
#include <Uno.Content.Splines.K-28fac039.h>
#include <Uno.Content.Splines.K-6d15f6c0.h>
#include <Uno.Content.Splines.L-6e1d2f5e.h>
#include <Uno.Content.Splines.L-76ac92a5.h>
#include <Uno.Content.Splines.L-cb75bac3.h>
#include <Uno.Content.Splines.L-f2c1b9fd.h>
#include <Uno.Content.Splines.L-fb88ff21.h>
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Splines\FullsampledSpline.uno
// ----------------------------------------------------------------------------------------------------------------

// public sealed class FullsampledSpline<T> :6
// {
static void FullsampledSpline_build(uType* type)
{
    type->SetBase(::g::Uno::Content::Splines::Spline_typeof()->MakeType(type->T(0), NULL));
    type->SetFields(0,
        ::g::Uno::Double_typeof(), offsetof(FullsampledSpline, _start), 0,
        ::g::Uno::Double_typeof(), offsetof(FullsampledSpline, _fps), 0,
        type->T(0)->Array(), offsetof(FullsampledSpline, _frames), 0);
}
...
::g::Uno::Content::Splines::Spline_type* FullsampledSpline_typeof()
{
    ...
    options.ObjectSize = sizeof(FullsampledSpline);
    options.TypeSize = sizeof(::g::Uno::Content::Splines::Spline_type);
    type = (::g::Uno::Content::Splines::Spline_type*)uClassType::New("Uno.Content.Splines.FullsampledSpline`1", options);
    type->fp_build_ = FullsampledSpline_build;
    type->fp_get_End = (void(*)(::g::Uno::Content::Splines::Spline*, double*))FullsampledSpline__get_End_fn;
    type->fp_Sample1 = (void(*)(::g::Uno::Content::Splines::Spline*, double*, uTRef))FullsampledSpline__Sample1_fn;
    type->fp_get_Start = (void(*)(::g::Uno::Content::Splines::Spline*, double*))FullsampledSpline__get_Start_fn;
    return type;
}

// public override sealed double get_End() :25
void FullsampledSpline__get_End_fn(FullsampledSpline* __this, double* __retval)
{
    uStackFrame __("Uno.Content.Splines.FullsampledSpline`1", "get_End()");
    return *__retval = __this->_start + ((double)(uPtr(__this->_frames)->Length() - 1) / __this->_fps), void();
}

// public override sealed void Sample(double time, T& result) :28
void FullsampledSpline__Sample1_fn(FullsampledSpline* __this, double* time, uTRef result)
{
    uStackFrame __("Uno.Content.Splines.FullsampledSpline`1", "Sample(double,T&)");
    double time_ = *time;
    int index = ::g::Uno::Math::Clamp8((int)((time_ - __this->_start) * __this->_fps), 0, uPtr(__this->_frames)->Length() - 1);
    result.Store(uPtr(__this->_frames)->TItem(index));
}

// public override sealed double get_Start() :20
void FullsampledSpline__get_Start_fn(FullsampledSpline* __this, double* __retval)
{
    return *__retval = __this->_start, void();
}
// }

// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Splines\KeyframedSpline.uno
// --------------------------------------------------------------------------------------------------------------
...
// public Key(double time, TData value) :15
void KeyframedSpline__Key__ctor__fn(uTRef __this, uType* __type, double* time, void* value)
{
    uT value_(__type->T(1), U_ALLOCA(__type->T(1)->ValueSize));
    double time_ = *time;
    value_ = value;
...
// public Key New(double time, TData value) :15
...
// public abstract class KeyframedSpline<TValue, TData> :6
// {
static void KeyframedSpline_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::Collections::List_typeof()->MakeType(KeyframedSpline__Key_typeof()->MakeType(type->T(0), type->T(1), NULL), NULL), offsetof(KeyframedSpline, keys), 0,
        ::g::Uno::Int_typeof(), offsetof(KeyframedSpline, cache), 0);
...
// protected KeyframedSpline() :25
void KeyframedSpline__ctor_1_fn(KeyframedSpline* __this)
{
    __this->ctor_1();
}

// protected KeyframedSpline(Uno.Content.Splines.KeyframedSpline<TValue, TData>.Key[] keys) :29
void KeyframedSpline__ctor_2_fn(KeyframedSpline* __this, uArray* keys1)
{
    __this->ctor_2(keys1);
}

// public int AddKey(double time, TData value) :87
void KeyframedSpline__AddKey_fn(KeyframedSpline* __this, double* time, void* value, int* __retval)
{
    uType* __types[] = {
        __this->__type->GetBase(KeyframedSpline_typeof())->Precalced(0/*Uno.Content.Splines.KeyframedSpline<TValue, TData>.Key*/),
    };
    uStackFrame __("Uno.Content.Splines.KeyframedSpline`2", "AddKey(double,TData)");
    uT ret2(__types[0], U_ALLOCA(__types[0]->ValueSize));
    uT value_(__this->__type->GetBase(KeyframedSpline_typeof())->T(1), U_ALLOCA(__this->__type->GetBase(KeyframedSpline_typeof())->T(1)->ValueSize));
    double time_ = *time;
    value_ = value;
...
// public void ClearKeys() :100
void KeyframedSpline__ClearKeys_fn(KeyframedSpline* __this)
{
    __this->ClearKeys();
}

// public override sealed double get_End() :42
...
// public TData FindValue(double time) :142
...
// public void FindValues(double time, TData& a, TData& b, float& p) :156
...
// public void FindValues(double time, TData& a, TData& b, TData& c, TData& d, float& p) :171
...
// public void SetValue(int index, TData value) :121
...
// public override sealed double get_Start() :37
...
// protected KeyframedSpline() [instance] :25
void KeyframedSpline::ctor_1()
{
    uType* __types[] = {
        __type->GetBase(KeyframedSpline_typeof())->Precalced(1/*Uno.Collections.List<Uno.Content.Splines.KeyframedSpline<TValue, TData>.Key>*/),
    };
    keys = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(__types[0]));
    ctor_();
}

// protected KeyframedSpline(Uno.Content.Splines.KeyframedSpline<TValue, TData>.Key[] keys) [instance] :29
void KeyframedSpline::ctor_2(uArray* keys1)
{
    uType* __types[] = {
        __type->GetBase(KeyframedSpline_typeof())->Precalced(1/*Uno.Collections.List<Uno.Content.Splines.KeyframedSpline<TValue, TData>.Key>*/),
        __type->GetBase(KeyframedSpline_typeof())->Precalced(0/*Uno.Content.Splines.KeyframedSpline<TValue, TData>.Key*/),
    };
...
// public void ClearKeys() [instance] :100
...
// public int FindLeftIndex(double time) [instance] :45
...
// public int FindNearestIndex(double time) [instance] :67
...
// public double GetTime(int index) [instance] :116
...
// public int get_KeyCount() [instance] :108
...
// public void RemoveKey(int index) [instance] :94
...
// public int SetTime(int index, double time) [instance] :126
int KeyframedSpline::SetTime(int index, double time)
{
    ...
    uT ret20(__type->GetBase(KeyframedSpline_typeof())->T(1), U_ALLOCA(__type->GetBase(KeyframedSpline_typeof())->T(1)->ValueSize));
    uT ret22(__types[0], U_ALLOCA(__types[0]->ValueSize));
    uT ret23(__types[0], U_ALLOCA(__types[0]->ValueSize));
    uT v(__type->GetBase(KeyframedSpline_typeof())->T(1), U_ALLOCA(__type->GetBase(KeyframedSpline_typeof())->T(1)->ValueSize));
    int ret21;
...
// public static float Map(double a, double b, double t) [static] :147
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Splines\LinearSplineFloat.uno
// ----------------------------------------------------------------------------------------------------------------

// public sealed class LinearSplineFloat :6
// {
...
// public LinearSplineFloat() [instance] :8
void LinearSplineFloat::ctor_3()
{
    ctor_1();
}

// public LinearSplineFloat(Uno.Content.Splines.KeyframedSpline<float, float>.Key[] keys) [instance] :12
...
// public LinearSplineFloat New() [static] :8
...
// public LinearSplineFloat New(Uno.Content.Splines.KeyframedSpline<float, float>.Key[] keys) [static] :12
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Splines\LinearSplineFloat2.uno
// -----------------------------------------------------------------------------------------------------------------

// public sealed class LinearSplineFloat2 :6
// {
...
// public LinearSplineFloat2() [instance] :8
void LinearSplineFloat2::ctor_3()
{
    ctor_1();
}

// public LinearSplineFloat2(Uno.Content.Splines.KeyframedSpline<float2, float2>.Key[] keys) [instance] :12
...
// public LinearSplineFloat2 New() [static] :8
...
// public LinearSplineFloat2 New(Uno.Content.Splines.KeyframedSpline<float2, float2>.Key[] keys) [static] :12
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Splines\LinearSplineFloat3.uno
// -----------------------------------------------------------------------------------------------------------------
...
// public LinearSplineFloat3() [instance] :8
void LinearSplineFloat3::ctor_3()
{
    ctor_1();
}

// public LinearSplineFloat3(Uno.Content.Splines.KeyframedSpline<float3, float3>.Key[] keys) [instance] :12
...
// public LinearSplineFloat3 New() [static] :8
...
// public LinearSplineFloat3 New(Uno.Content.Splines.KeyframedSpline<float3, float3>.Key[] keys) [static] :12
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Splines\LinearSplineFloat4.uno
// -----------------------------------------------------------------------------------------------------------------

// public sealed class LinearSplineFloat4 :6
// {
...
// public LinearSplineFloat4() [instance] :8
void LinearSplineFloat4::ctor_3()
{
    ctor_1();
}

// public LinearSplineFloat4(Uno.Content.Splines.KeyframedSpline<float4, float4>.Key[] keys) [instance] :12
...
// public LinearSplineFloat4 New() [static] :8
...
// public LinearSplineFloat4 New(Uno.Content.Splines.KeyframedSpline<float4, float4>.Key[] keys) [static] :12
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Splines\LinearSplineFloat4x4.uno
// -------------------------------------------------------------------------------------------------------------------
...
// public LinearSplineFloat4x4() [instance] :8
void LinearSplineFloat4x4::ctor_3()
{
    ctor_1();
}

// public LinearSplineFloat4x4(Uno.Content.Splines.KeyframedSpline<float4x4, float4x4>.Key[] keys) [instance] :12
...
// public LinearSplineFloat4x4 New() [static] :8
...
// public LinearSplineFloat4x4 New(Uno.Content.Splines.KeyframedSpline<float4x4, float4x4>.Key[] keys) [static] :12
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Content\Splines\Spline.uno
// -----------------------------------------------------------------------------------------------------

// public abstract class Spline<T> :4
// {
