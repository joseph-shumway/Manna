...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Net.Sockets\1.4.3\Dns.uno
// -------------------------------------------------------------------------------
...
// public generated Dns() :16
void Dns__ctor__fn(Dns* __this)
{
    __this->ctor_();
}

// public static Uno.Net.IPAddress[] GetHostAddresses(string hostNameOrAddress) :129
void Dns__GetHostAddresses_fn(uString* hostNameOrAddress, uArray** __retval)
{
    *__retval = Dns::GetHostAddresses(hostNameOrAddress);
}

// private static Uno.Net.IPAddress[] GetHostAddressesImpl(string hostNameOrAddress) :99
...
// private static extern Uno.Net.IPAddress[] GetLocalAddresses() :86
void Dns__GetLocalAddresses_fn(uArray** __retval)
{
    *__retval = Dns::GetLocalAddresses();
}

// private static extern bool JavaGetLocalAddresses(Uno.Collections.List<string> addresses) :50
...
// public generated Dns New() :16
void Dns__New1_fn(Dns** __retval)
{
    *__retval = Dns::New1();
}

// public generated Dns() [instance] :16
void Dns::ctor_()
{
}

// public static Uno.Net.IPAddress[] GetHostAddresses(string hostNameOrAddress) [static] :129
...
// private static Uno.Net.IPAddress[] GetHostAddressesImpl(string hostNameOrAddress) [static] :99
...
// private static extern Uno.Net.IPAddress[] GetLocalAddresses() [static] :86
...
// private static extern bool JavaGetLocalAddresses(Uno.Collections.List<string> addresses) [static] :50
bool Dns::JavaGetLocalAddresses(::g::Uno::Collections::List* addresses)
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "JavaGetLocalAddresses57", "(Lcom/uno/UnoObject;)Z");
...
// public generated Dns New() [static] :16
Dns* Dns::New1()
{
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Net.Sockets\1.4.3\IPAddress.uno
// -------------------------------------------------------------------------------------
...
// internal EndPoint(Uno.Net.Sockets.AddressFamily addressFamily) :17
void EndPoint__ctor__fn(EndPoint* __this, int* addressFamily)
{
    __this->ctor_(*addressFamily);
}

// public generated Uno.Net.Sockets.AddressFamily get_AddressFamily() :13
void EndPoint__get_AddressFamily_fn(EndPoint* __this, int* __retval)
{
    *__retval = __this->AddressFamily();
}

// private generated void set_AddressFamily(Uno.Net.Sockets.AddressFamily value) :14
void EndPoint__set_AddressFamily_fn(EndPoint* __this, int* value)
{
    __this->AddressFamily(*value);
}

// internal EndPoint(Uno.Net.Sockets.AddressFamily addressFamily) [instance] :17
void EndPoint::ctor_(int addressFamily)
{
    AddressFamily(addressFamily);
}

// public generated Uno.Net.Sockets.AddressFamily get_AddressFamily() [instance] :13
int EndPoint::AddressFamily()
{
    return _AddressFamily;
}

// private generated void set_AddressFamily(Uno.Net.Sockets.AddressFamily value) [instance] :14
...
static void IPAddress_build(uType* type)
{
    ...
    type->SetFields(0,
        ::TYPES[2/*byte[]*/], offsetof(IPAddress, _address), 0,
...
// public IPAddress(byte[] octets) [instance] :103
...
// public IPAddress(byte[] address, long scopeId) [instance] :117
...
// public Uno.Net.Sockets.AddressFamily get_AddressFamily() [instance] :87
int IPAddress::AddressFamily()
{
    return _addressFamily;
}

// public byte[] GetAddressBytes() [instance] :199
...
// public long get_ScopeId() [instance] :86
int64_t IPAddress::ScopeId()
{
    return (int64_t)_scopeId;
}

// private static extern string IPv6AddressToString(byte[] bytes) [static] :207
...
// public IPAddress New(byte[] octets) [static] :103
...
// public IPAddress New(byte[] address, long scopeId) [static] :117
...
// public static Uno.Net.IPAddress Parse(string address) [static] :149
...
// private static extern byte[] ParseIPv6Address(string address) [static] :136
...
// public IPEndPoint(Uno.Net.IPAddress address, int port) [instance] :30
...
// public generated Uno.Net.IPAddress get_Address() [instance] :28
::g::Uno::Net::IPAddress* IPEndPoint::Address()
{
    return _Address;
}

// private generated void set_Address(Uno.Net.IPAddress value) [instance] :28
void IPEndPoint::Address(::g::Uno::Net::IPAddress* value)
{
    _Address = value;
}

// public generated int get_Port() [instance] :26
int IPEndPoint::Port()
{
    return _Port;
}

// private generated void set_Port(int value) [instance] :26
void IPEndPoint::Port(int value)
{
    _Port = value;
}

// public IPEndPoint New(Uno.Net.IPAddress address, int port) [static] :30
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Net.Sockets\1.4.3\NetworkHelpers.uno
// ------------------------------------------------------------------------------------------
