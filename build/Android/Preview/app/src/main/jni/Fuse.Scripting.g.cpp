...
static void NativeEvent_build(uType* type)
{
    ...
    ::STRINGS[39] = uString::Const("../../../Local/Fusetools/Packages/Fuse.Scripting/1.4.0/NativeEvent.uno");
...
uObject* NativeEvent::RaiseSync(uArray* args)
{
    ...
    ::g::Uno::Diagnostics::Debug::Assert(Context() != NULL, ::STRINGS[38/*"this.Contex...*/], ::STRINGS[39/*"../../../Lo...*/], 46, uArray::New(::TYPES[16/*object[]*/], 0));
