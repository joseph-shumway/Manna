...
#include <Fuse.Navigation.Activ-e73f4510.h>
...
#include <Fuse.Navigation.GotoRoute.h>
#include <Fuse.Navigation.Hiera-c147686e.h>
...
#include <Fuse.Navigation.ModifyRoute.h>
...
#include <Fuse.Navigation.Navig-4005d784.h>
#include <Fuse.Navigation.Navig-4be788bd.h>
#include <Fuse.Navigation.Navig-5566e4c1.h>
#include <Fuse.Navigation.Navig-7d6b9b9f.h>
#include <Fuse.Navigation.Navig-7e82305c.h>
#include <Fuse.Navigation.Navig-a00b4ee0.h>
#include <Fuse.Navigation.Navig-a918a648.h>
#include <Fuse.Navigation.Navig-acaa1313.h>
...
#include <Fuse.Navigation.PushRoute.h>
...
#include <Fuse.Navigation.Route-9f70783b.h>
...
#include <Fuse.Navigation.While-25ea7a5b.h>
#include <Fuse.Navigation.While-4de49602.h>
#include <Fuse.Navigation.While-65c5df16.h>
#include <Fuse.Navigation.While-87a81bce.h>
#include <Fuse.Navigation.While-89f5a828.h>
#include <Fuse.Navigation.While-943620aa.h>
#include <Fuse.Navigation.WhileActive.h>
#include <Fuse.Navigation.While-b6b04f4b.h>
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\Activated.uno
// -------------------------------------------------------------------------------------
...
static void Activated_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Fuse::Triggers::PulseTrigger_typeof()->MakeType(::g::Uno::EventArgs_typeof(), NULL)->MakeMethod(1/*RemoveHandlerImpl<Fuse.Navigation.Activated>*/, type, NULL);
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Navigation::NavigationTrigger_type, interface4),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Navigation::NavigationTrigger_type, interface5),
        ::g::Fuse::Animations::IUnwrappedPlayerFeedback_typeof(), offsetof(::g::Fuse::Navigation::NavigationTrigger_type, interface6),
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Navigation::NavigationTrigger_type, interface7));
    type->SetFields(41);
...
{
    uStackFrame __("Fuse.Navigation.Activated", "ActiveChanged(bool,bool)");
...
// public static void AddHandler(Fuse.Visual visual, Fuse.Triggers.PulseTrigger<Uno.EventArgs>.PulseHandler handler) :102
...
// public static void RemoveHandler(Fuse.Visual visual, Fuse.Triggers.PulseTrigger<Uno.EventArgs>.PulseHandler handler) :108
...
// public static void AddHandler(Fuse.Visual visual, Fuse.Triggers.PulseTrigger<Uno.EventArgs>.PulseHandler handler) [static] :102
...
// public static void RemoveHandler(Fuse.Visual visual, Fuse.Triggers.PulseTrigger<Uno.EventArgs>.PulseHandler handler) [static] :108
void Activated::RemoveHandler(::g::Fuse::Visual* visual, uDelegate* handler)
{
    ...
    ::g::Fuse::Triggers::PulseTrigger::RemoveHandlerImpl(::TYPES[1/*Fuse.Triggers.PulseTrigger<Uno.EventArgs>.RemoveHandlerImpl<Fuse.Navigation.Activated>*/], visual, handler);
}
// }
...
// public delegate void ActivatedHandler(object sender, Uno.EventArgs args) :8
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\NavigationAnimations.uno
// ------------------------------------------------------------------------------------------------
...
void ActivatingAnimation__ForceUpdate_fn(ActivatingAnimation* __this)
{
    ...
    __this->Seek(__this->InvertProgress((double)(__this->Scale() * ::g::Fuse::Navigation::INavigation::GetPageState(uInterface(uPtr(__this->NavContext()), ::TYPES[2/*Fuse.Navigation.INavigation*/]), __this->PageContext()).Progress)), 0);
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\RoutePageProxy.uno
// ------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\INavigation.uno
// ---------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\SwipeNavigate.uno
// -----------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\ModifyRouteCommand.uno
// ----------------------------------------------------------------------------------------------
...
{
    uStackFrame __("Fuse.Navigation.RouteModificationCommand.ArgumentArrayAdapter", "get_Item(int)");
...
{
    uStackFrame __("Fuse.Navigation.RouteModificationCommand.ArgumentArrayAdapter", "get_Length()");
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\Router.uno
// ----------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\TriggerActions.uno
// ------------------------------------------------------------------------------------------
...
static void BackForwardNavigationTriggerAction_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\TriggerActions.uno");
...
void BackForwardNavigationTriggerAction__Perform_fn(BackForwardNavigationTriggerAction* __this, ::g::Fuse::Node* n)
{
    ...
    if (nav != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[0/*"No Navigati...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 135, ::STRINGS[2/*"Perform"*/], NULL);
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\RouterPage.uno
// --------------------------------------------------------------------------------------
...
{
    ::TYPES[3] = ::g::Fuse::Triggers::PulseTrigger_typeof()->MakeType(::g::Uno::EventArgs_typeof(), NULL)->MakeMethod(0/*AddHandlerImpl<Fuse.Navigation.Deactivated>*/, type, NULL);
    ::TYPES[4] = ::g::Fuse::Triggers::PulseTrigger_typeof()->MakeType(::g::Uno::EventArgs_typeof(), NULL)->MakeMethod(1/*RemoveHandlerImpl<Fuse.Navigation.Deactivated>*/, type, NULL);
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(::g::Fuse::Navigation::NavigationTrigger_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Navigation::NavigationTrigger_type, interface1),
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::Navigation::NavigationTrigger_type, interface2),
...
{
    uStackFrame __("Fuse.Navigation.Deactivated", "ActiveChanged(bool,bool)");
    bool isRoot_ = *isRoot;
    bool isActive_ = *isActive;
...
// public static void AddHandler(Fuse.Visual visual, Fuse.Triggers.PulseTrigger<Uno.EventArgs>.PulseHandler handler) :150
...
// public static void RemoveHandler(Fuse.Visual visual, Fuse.Triggers.PulseTrigger<Uno.EventArgs>.PulseHandler handler) :156
...
// public static void AddHandler(Fuse.Visual visual, Fuse.Triggers.PulseTrigger<Uno.EventArgs>.PulseHandler handler) [static] :150
void Deactivated::AddHandler(::g::Fuse::Visual* visual, uDelegate* handler)
{
    ...
    ::g::Fuse::Triggers::PulseTrigger::AddHandlerImpl(::TYPES[3/*Fuse.Triggers.PulseTrigger<Uno.EventArgs>.AddHandlerImpl<Fuse.Navigation.Deactivated>*/], visual, handler);
}
...
// public static void RemoveHandler(Fuse.Visual visual, Fuse.Triggers.PulseTrigger<Uno.EventArgs>.PulseHandler handler) [static] :156
void Deactivated::RemoveHandler(::g::Fuse::Visual* visual, uDelegate* handler)
{
    ...
    ::g::Fuse::Triggers::PulseTrigger::RemoveHandlerImpl(::TYPES[4/*Fuse.Triggers.PulseTrigger<Uno.EventArgs>.RemoveHandlerImpl<Fuse.Navigation.Deactivated>*/], visual, handler);
}
// }
...
// public generated DeactivatingAnimation() :301
...
void DeactivatingAnimation__ForceUpdate_fn(DeactivatingAnimation* __this)
{
    ...
    __this->Seek((double)::g::Uno::Math::Abs1(__this->Scale() * ::g::Fuse::Navigation::INavigation::GetPageState(uInterface(uPtr(__this->NavContext()), ::TYPES[2/*Fuse.Navigation.INavigation*/]), __this->PageContext()).Progress), 0);
}

// public generated DeactivatingAnimation New() :301
...
// public generated DeactivatingAnimation() [instance] :301
void DeactivatingAnimation::ctor_6()
{
    ctor_5();
}

// public generated DeactivatingAnimation New() [static] :301
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\DynamicLinearNavigation.uno
// ---------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\DirectNavigation.uno
// --------------------------------------------------------------------------------------------
...
static void DirectNavigation_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\DirectNavigation.uno");
    ::STRINGS[5] = uString::Const("SetProgressState");
    ::TYPES[5] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Navigation::PageData_typeof(), NULL);
    ::TYPES[6] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Navigation::PageData_typeof(), NULL);
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetInterfaces(
...
::g::Fuse::Navigation::VisualNavigation_type* DirectNavigation_typeof()
{
    ...
    type->interface6.fp_GetPage = (void(*)(uObject*, int*, ::g::Fuse::Visual**))::g::Fuse::Navigation::VisualNavigation__GetPage_fn;
    ...
    type->interface6.fp_get_PageCount = (void(*)(uObject*, int*))::g::Fuse::Navigation::VisualNavigation__get_PageCount_fn;
    type->interface6.fp_get_PageProgress = (void(*)(uObject*, double*))DirectNavigation__get_PageProgress_fn;
    ...
    type->interface6.fp_add_PageCountChanged = (void(*)(uObject*, uDelegate*))::g::Fuse::Navigation::VisualNavigation__add_PageCountChanged_fn;
    type->interface6.fp_remove_PageCountChanged = (void(*)(uObject*, uDelegate*))::g::Fuse::Navigation::VisualNavigation__remove_PageCountChanged_fn;
...
// public generated DirectNavigation() :16
...
// public generated DirectNavigation New() :16
...
// public override sealed double get_PageProgress() :95
...
// public generated DirectNavigation() [instance] :16
...
void DirectNavigation::SetProgressState(::g::Fuse::Visual* elm, int progress)
{
    ...
    if (pd == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[3/*"Unexpected ...*/], elm, ::STRINGS[4/*"C:\\Users\\...*/], 85, ::STRINGS[5/*"SetProgress...*/]);
        return;
    }
...
void DirectNavigation::UpdateState(bool bypass)
{
    ...
    for (int t = 0; t < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Pages()), ::TYPES[5/*Uno.Collections.ICollection<Fuse.Navigation.PageData>*/])); t++)
    {
        ::g::Fuse::Visual* c = uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Pages()), ::TYPES[6/*Uno.Collections.IList<Fuse.Navigation.PageData>*/]), uCRef<int>(t), &ret2), ret2))->Visual();
...
// public generated DirectNavigation New() [static] :16
...
static void DynamicLinearNavigation_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(10,
        new uFunction("get_DesiredActive", NULL, (void*)DynamicLinearNavigation__get_DesiredActive_fn, 0, false, ::g::Fuse::Visual_typeof(), 0),
        new uFunction("set_DesiredActive", NULL, (void*)DynamicLinearNavigation__set_DesiredActive_fn, 0, false, uVoid_typeof(), 1, ::g::Fuse::Visual_typeof()),
        new uFunction("get_DesiredActiveIndex", NULL, (void*)DynamicLinearNavigation__get_DesiredActiveIndex_fn, 0, false, ::g::Uno::Int_typeof(), 0),
        new uFunction("set_DesiredActiveIndex", NULL, (void*)DynamicLinearNavigation__set_DesiredActiveIndex_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Int_typeof()),
        new uFunction("GotoImpl", NULL, (void*)DynamicLinearNavigation__GotoImpl_fn, 0, false, uVoid_typeof(), 2, ::g::Fuse::Visual_typeof(), ::g::Fuse::Navigation::NavigationGotoMode_typeof()),
        new uFunction("get_Motion", NULL, (void*)DynamicLinearNavigation__get_Motion_fn, 0, false, ::g::Fuse::Motion::MotionConfig_typeof(), 0),
        new uFunction("set_Motion", NULL, (void*)DynamicLinearNavigation__set_Motion_fn, 0, false, uVoid_typeof(), 1, ::g::Fuse::Motion::MotionConfig_typeof()),
        new uFunction(".ctor", NULL, (void*)DynamicLinearNavigation__New2_fn, 0, true, type, 0),
        new uFunction("get_Progress", NULL, (void*)DynamicLinearNavigation__get_Progress_fn, 0, false, ::g::Uno::Float_typeof(), 0),
        new uFunction("get_SeekRange", NULL, (void*)DynamicLinearNavigation__get_SeekRange_fn, 0, false, ::g::Uno::Float2_typeof(), 0));
}
...
DynamicLinearNavigation_type* DynamicLinearNavigation_typeof()
{
    ...
    type->fp_get_PageProgress = (void(*)(::g::Fuse::Navigation::VisualNavigation*, double*))DynamicLinearNavigation__get_PageProgress_fn;
    ...
    type->interface9.fp_get_SeekRange = (void(*)(uObject*, ::g::Uno::Float2*))DynamicLinearNavigation__get_SeekRange_fn;
    type->interface6.fp_GetPage = (void(*)(uObject*, int*, ::g::Fuse::Visual**))::g::Fuse::Navigation::VisualNavigation__GetPage_fn;
    ...
    type->interface6.fp_Toggle = (void(*)(uObject*, ::g::Fuse::Visual*))::g::Fuse::Navigation::VisualNavigation__Toggle_fn;
    type->interface6.fp_get_PageCount = (void(*)(uObject*, int*))::g::Fuse::Navigation::VisualNavigation__get_PageCount_fn;
    type->interface6.fp_get_PageProgress = (void(*)(uObject*, double*))DynamicLinearNavigation__get_PageProgress_fn;
    type->interface6.fp_get_ActivePage = (void(*)(uObject*, ::g::Fuse::Visual**))::g::Fuse::Navigation::VisualNavigation__get_ActivePage_fn;
    type->interface6.fp_get_State = (void(*)(uObject*, int*))::g::Fuse::Navigation::VisualNavigation__get_State_fn;
    type->interface6.fp_add_PageCountChanged = (void(*)(uObject*, uDelegate*))::g::Fuse::Navigation::VisualNavigation__add_PageCountChanged_fn;
    type->interface6.fp_remove_PageCountChanged = (void(*)(uObject*, uDelegate*))::g::Fuse::Navigation::VisualNavigation__remove_PageCountChanged_fn;
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "set_Active(Fuse.Visual)");
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "get_CanGoBack()");
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "get_CanGoForward()");
...
// public Fuse.Visual get_DesiredActive() :407
void DynamicLinearNavigation__get_DesiredActive_fn(DynamicLinearNavigation* __this, ::g::Fuse::Visual** __retval)
{
    *__retval = __this->DesiredActive();
}

// public void set_DesiredActive(Fuse.Visual value) :408
void DynamicLinearNavigation__set_DesiredActive_fn(DynamicLinearNavigation* __this, ::g::Fuse::Visual* value)
{
    __this->DesiredActive(value);
}

// public int get_DesiredActiveIndex() :413
void DynamicLinearNavigation__get_DesiredActiveIndex_fn(DynamicLinearNavigation* __this, int* __retval)
{
    *__retval = __this->DesiredActiveIndex();
}

// public void set_DesiredActiveIndex(int value) :414
void DynamicLinearNavigation__set_DesiredActiveIndex_fn(DynamicLinearNavigation* __this, int* value)
{
    __this->DesiredActiveIndex(*value);
}
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "Fuse.Navigation.ISeekableNavigation.BeginSeek()");
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "Fuse.Navigation.ISeekableNavigation.EndSeek(Fuse.Navigation.EndSeekArgs)");
    ::g::Uno::Float2 ret6;
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "Fuse.Navigation.ISeekableNavigation.Seek(Fuse.Navigation.UpdateSeekArgs)");
    ::g::Uno::Float2 ret7;

    if (__this->_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Seek being called on an unrooted navigation"), __this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\DynamicLinearNavigation.uno"), 466, uString::Const("Fuse.Navigation.ISeekableNavigation.Seek"));
        return;
    }
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "GetPageState(Fuse.Visual)");
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "GoBack()");
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "GoForward()");
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "Goto(Fuse.Visual,Fuse.Navigation.NavigationGotoMode)");
    int mode_ = *mode;
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "OnChildAddedWhileRooted(Fuse.Node)");
    ::g::Fuse::Navigation::VisualNavigation__OnChildAddedWhileRooted_fn(__this, child);
    ::g::Fuse::Visual* v = uAs< ::g::Fuse::Visual*>(child, ::TYPES[14/*Fuse.Visual*/]);
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "OnChildRemovedWhileRooted(Fuse.Node)");
    ::g::Fuse::Navigation::VisualNavigation__OnChildRemovedWhileRooted_fn(__this, child);
    ::g::Fuse::Visual* v = uAs< ::g::Fuse::Visual*>(child, ::TYPES[14/*Fuse.Visual*/]);
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "OnRooted()");
    ::g::Fuse::Navigation::VisualNavigation__OnRooted_fn(__this);
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "OnUnrooted()");
    ::g::Uno::Float2 ret8;
...
// public override sealed double get_PageProgress() :130
void DynamicLinearNavigation__get_PageProgress_fn(DynamicLinearNavigation* __this, double* __retval)
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "get_PageProgress()");
    return *__retval = (double)__this->Progress(), void();
}
...
// public float2 get_SeekRange() :459
...
// private void SetDesiredActiveIndex(int index) :424
void DynamicLinearNavigation__SetDesiredActiveIndex_fn(DynamicLinearNavigation* __this, int* index)
{
    __this->SetDesiredActiveIndex(*index);
}
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "AnimationDone()");
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "get_Back()");
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "ChangeProgress(float,float,Fuse.Navigation.NavigationMode)");
    _prevProgress = prev;
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "CheckNeedUpdate([bool])");
    ...
    if (needUpdated)
    {
        ::g::Fuse::UpdateManager::AddAction1(uDelegate::New(::TYPES[18/*Uno.Action*/], (void*)DynamicLinearNavigation__OnUpdated_fn, this), 0);
        _hasUpdated = true;
    }
    else if (off)
    {
        AnimationDone();
        ::g::Fuse::UpdateManager::RemoveAction1(uDelegate::New(::TYPES[18/*Uno.Action*/], (void*)DynamicLinearNavigation__OnUpdated_fn, this), 0);
        _hasUpdated = false;
    }
}
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "CleanupListenComplete()");

    if (_listenComplete != NULL)
    {
        uPtr(_listenComplete)->remove_RootingCompleted(uDelegate::New(::TYPES[18/*Uno.Action*/], (void*)DynamicLinearNavigation__GotoDesiredActiveAction_fn, this));
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "ClearForwardHistory()");
    bool ret5;
    ...
    if (HasPages() && (_active != Front()))
    {
        ...
        for (int i = target - 1; i >= 0; i--)
            ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(uPtr(Parent())->Children()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[42/*Fuse.Node*/], NULL)), GetPage(i), &ret5);
    }

    OnHistoryChanged();
}

// public Fuse.Visual get_DesiredActive() [instance] :407
::g::Fuse::Visual* DynamicLinearNavigation::DesiredActive()
{
    return _desiredActive;
}

// public void set_DesiredActive(Fuse.Visual value) [instance] :408
void DynamicLinearNavigation::DesiredActive(::g::Fuse::Visual* value)
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "set_DesiredActive(Fuse.Visual)");
    SetDesiredActive(value);
}

// public int get_DesiredActiveIndex() [instance] :413
int DynamicLinearNavigation::DesiredActiveIndex()
{
    return _desiredIndex;
}

// public void set_DesiredActiveIndex(int value) [instance] :414
void DynamicLinearNavigation::DesiredActiveIndex(int value)
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "set_DesiredActiveIndex(int)");
    SetDesiredActiveIndex(value);
}
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "DesiredTransition(Fuse.Visual)");
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "DirectSetActive(Fuse.Visual)");
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "get_Front()");
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "GotoDesiredActive()");
    ::g::Fuse::Visual* ind3;
    ...
    if (!uPtr(desiredPage)->IsRootingStarted())
    {
        ...
        uPtr(_listenComplete)->add_RootingCompleted(uDelegate::New(::TYPES[18/*Uno.Action*/], (void*)DynamicLinearNavigation__GotoDesiredActiveAction_fn, this));
        return false;
    }
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "GotoDesiredActiveAction()");
    GotoDesiredActive();
}
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "GotoImpl(Fuse.Visual,Fuse.Navigation.NavigationGotoMode)");

    if (uPtr(element)->Parent() != Parent())
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Attempting to navigate to element with different parent"), element, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\DynamicLinearNavigation.uno"), 171, uString::Const("GotoImpl"), NULL);
        return;
    }
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "GotoInternal(Fuse.Visual,Fuse.Navigation.NavigationGotoMode)");
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "get_MaxIndex()");
    return PageCount() - 1;
}
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "get_Motion()");
...
void DynamicLinearNavigation::Motion(::g::Fuse::Motion::MotionConfig* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(uString::Const("Motion should not be changed post-rooting"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\DynamicLinearNavigation.uno"), 31, uString::Const("set_Motion"), NULL);
}

// private Fuse.Visual get_Next() [instance] :555
::g::Fuse::Visual* DynamicLinearNavigation::Next()
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "get_Next()");
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "OnUpdated()");
    ::g::Uno::Float2 ret9;
    ::g::Uno::Float2 ret10;

    if (_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Updated called without a region"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\DynamicLinearNavigation.uno"), 231, uString::Const("OnUpdated"));
        return;
    }
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "get_Previous()");
    return GetPage(GetPageIndex(_active) + 1);
}
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "get_Progress()");
    ::g::Uno::Float2 ret13;
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "ResetRegionLimits()");
...
// public float2 get_SeekRange() [instance] :459
::g::Uno::Float2 DynamicLinearNavigation::SeekRange()
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "get_SeekRange()");
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "SetDesiredActive(Fuse.Visual)");
    UpdateDesired(page, -1);
    _desired = 1;
    GotoInternal(page, 0);
}

// private void SetDesiredActiveIndex(int index) [instance] :424
void DynamicLinearNavigation::SetDesiredActiveIndex(int index)
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "SetDesiredActiveIndex(int)");
    UpdateDesired(NULL, index);
    _desired = 2;
    GotoInternal(_desiredActive, 0);
}

// private void SetProgress(float value) [instance] :252
void DynamicLinearNavigation::SetProgress(float value)
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "SetProgress(float)");
    ::g::Uno::Float2 ret11;
    ::g::Uno::Float2 ret12;
    float prev;
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "TransitionToChild(Fuse.Visual,[bool],[bool])");
...
{
    uStackFrame __("Fuse.Navigation.DynamicLinearNavigation", "UpdateDesired(Fuse.Visual,int)");
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\EdgeNavigation.uno
// ------------------------------------------------------------------------------------------
...
static void EdgeNavigation_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\EdgeNavigation.uno");
    ...
    ::TYPES[7] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Navigation::NavigationEdge_typeof(), ::g::Fuse::Gestures::Internal::EdgeSwiper_typeof(), NULL);
    ::TYPES[8] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Visual_typeof(), NULL);
    ::TYPES[5] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Navigation::PageData_typeof(), NULL);
    ::TYPES[6] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Navigation::PageData_typeof(), NULL);
    ::TYPES[9] = ::g::Fuse::Elements::Element_typeof();
    ::TYPES[10] = ::g::Uno::Action2_typeof()->MakeType(uObject_typeof(), ::g::Uno::Double_typeof(), NULL);
    ::TYPES[11] = ::g::Uno::Collections::Dictionary__Enumerator_typeof()->MakeType(::g::Fuse::Navigation::NavigationEdge_typeof(), ::g::Fuse::Gestures::Internal::EdgeSwiper_typeof(), NULL);
    ::TYPES[12] = ::g::Uno::Collections::KeyValuePair_typeof()->MakeType(::g::Fuse::Navigation::NavigationEdge_typeof(), ::g::Fuse::Gestures::Internal::EdgeSwiper_typeof(), NULL);
    ::TYPES[13] = ::g::Fuse::Gestures::Internal::EdgeSwiper_typeof();
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Navigation::IBaseNavigation_typeof(), offsetof(::g::Fuse::Navigation::VisualNavigation_type, interface8));
    type->SetFields(24,
        ::TYPES[14/*Fuse.Visual*/], offsetof(EdgeNavigation, _active), 0,
        ::TYPES[7/*Uno.Collections.Dictionary<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>*/], offsetof(EdgeNavigation, _swipers), 0,
        ::TYPES[8/*Uno.Collections.List<Fuse.Visual>*/], offsetof(EdgeNavigation, _mains), 0,
    ...
    type->Reflection.SetFunctions(4,
        new uFunction("GetEdge", NULL, (void*)EdgeNavigation__GetEdge_fn, 0, true, ::g::Fuse::Navigation::NavigationEdge_typeof(), 1, ::TYPES[14/*Fuse.Visual*/]),
        new uFunction(".ctor", NULL, (void*)EdgeNavigation__New2_fn, 0, true, type, 0),
        new uFunction("ResetEdge", NULL, (void*)EdgeNavigation__ResetEdge_fn, 0, true, uVoid_typeof(), 1, ::TYPES[14/*Fuse.Visual*/]),
        new uFunction("SetEdge", NULL, (void*)EdgeNavigation__SetEdge_fn, 0, true, uVoid_typeof(), 2, ::TYPES[14/*Fuse.Visual*/], ::g::Fuse::Navigation::NavigationEdge_typeof()));
}
...
::g::Fuse::Navigation::VisualNavigation_type* EdgeNavigation_typeof()
{
    ...
    type->interface6.fp_get_PageCount = (void(*)(uObject*, int*))::g::Fuse::Navigation::VisualNavigation__get_PageCount_fn;
    type->interface6.fp_get_PageProgress = (void(*)(uObject*, double*))EdgeNavigation__get_PageProgress_fn;
    type->interface6.fp_get_ActivePage = (void(*)(uObject*, ::g::Fuse::Visual**))::g::Fuse::Navigation::VisualNavigation__get_ActivePage_fn;
    type->interface6.fp_get_State = (void(*)(uObject*, int*))::g::Fuse::Navigation::VisualNavigation__get_State_fn;
    type->interface6.fp_add_PageCountChanged = (void(*)(uObject*, uDelegate*))::g::Fuse::Navigation::VisualNavigation__add_PageCountChanged_fn;
    type->interface6.fp_remove_PageCountChanged = (void(*)(uObject*, uDelegate*))::g::Fuse::Navigation::VisualNavigation__remove_PageCountChanged_fn;
...
void EdgeNavigation__GetPageState_fn(EdgeNavigation* __this, ::g::Fuse::Visual* page, ::g::Fuse::Navigation::NavigationPageState* __retval)
{
    ...
    {
        {
            while (enum7.MoveNext(::TYPES[11/*Uno.Collections.Dictionary<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>.Enumerator*/]))
            {
                ...
                {
                    ::g::Fuse::Navigation::NavigationPageState __uno_retval = (collection8 = uDefault< ::g::Fuse::Navigation::NavigationPageState>(), collection8.Progress = (1.0f - (float)uPtr(sw.Value(::TYPES[12/*Uno.Collections.KeyValuePair<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>*/]))->Progress()), collection8.PreviousProgress = 0.0f, collection8);
                    enum7.Dispose(::TYPES[11/*Uno.Collections.Dictionary<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>.Enumerator*/]);
...
void EdgeNavigation__GoBack_fn(EdgeNavigation* __this)
{
    ...
    {
        {
            while (enum6.MoveNext(::TYPES[11/*Uno.Collections.Dictionary<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>.Enumerator*/]))
            {
        ...
        {
            enum6.Dispose(::TYPES[11/*Uno.Collections.Dictionary<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>.Enumerator*/]);
        }
    }
...
void EdgeNavigation__Goto_fn(EdgeNavigation* __this, ::g::Fuse::Visual* element, int* mode)
{
    ...
    {
        {
            while (enum1.MoveNext(::TYPES[11/*Uno.Collections.Dictionary<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>.Enumerator*/]))
            {
        ...
        {
            enum1.Dispose(::TYPES[11/*Uno.Collections.Dictionary<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>.Enumerator*/]);
        }
    }
...
void EdgeNavigation__OnRooted_fn(EdgeNavigation* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserRootError(::STRINGS[9/*"Element"*/], __this->Parent(), __this, ::STRINGS[7/*"C:\\Users\\...*/], 93, ::STRINGS[10/*"OnRooted"*/]);
...
// public override sealed double get_PageProgress() :229
...
// public static void ResetEdge(Fuse.Visual elm) :40
...
void EdgeNavigation::CheckChildren()
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(Pages()), ::TYPES[5/*Uno.Collections.ICollection<Fuse.Navigation.PageData>*/])); i++)
    {
        ::g::Fuse::Visual* nodeChild = uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(Pages()), ::TYPES[6/*Uno.Collections.IList<Fuse.Navigation.PageData>*/]), uCRef<int>(i), &ret11), ret11))->Visual();
        ...
        if (edge == 4)
        {
            ...
            if (uPtr(_mains)->Count() > 1)
                ::g::Fuse::Diagnostics::UserWarning(::STRINGS[6/*"EdgeNavigat...*/], this, ::STRINGS[7/*"C:\\Users\\...*/], 148, ::STRINGS[8/*"CheckChildren"*/]);
        }
        else
        {
...
void EdgeNavigation::ClearChildren()
{
    ...
    {
        {
            while (enum2.MoveNext(::TYPES[11/*Uno.Collections.Dictionary<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>.Enumerator*/]))
            {
        ...
        {
            enum2.Dispose(::TYPES[11/*Uno.Collections.Dictionary<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>.Enumerator*/]);
        }
    }
...
bool EdgeNavigation::IsAnyPanelActive()
{
    ...
    {
        {
            while (enum5.MoveNext(::TYPES[11/*Uno.Collections.Dictionary<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>.Enumerator*/]))
            {
                ...
                if (uPtr(sw.Value(::TYPES[12/*Uno.Collections.KeyValuePair<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>*/]))->Progress() > 0.0)
                {
                    ...
                    enum5.Dispose(::TYPES[11/*Uno.Collections.Dictionary<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>.Enumerator*/]);
                    return __uno_retval;
                }
            }
        }
...
bool EdgeNavigation::IsDismissPoint(::g::Uno::Float2 windowPoint)
{
    ...
    {
        {
            while (enum4.MoveNext(::TYPES[11/*Uno.Collections.Dictionary<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>.Enumerator*/]))
            {
                ...
                if (uPtr(uPtr(sw.Value(::TYPES[12/*Uno.Collections.KeyValuePair<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>*/]))->Target())->IsPointInside(local))
                {
                    ...
                    enum4.Dispose(::TYPES[11/*Uno.Collections.Dictionary<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>.Enumerator*/]);
                    return __uno_retval;
                }
            }
        }
...
void EdgeNavigation::OnProgressChanged(uObject* s, double progress)
{
    ...
    ::g::Fuse::Gestures::Internal::EdgeSwiper* swiper = uAs< ::g::Fuse::Gestures::Internal::EdgeSwiper*>(s, ::TYPES[13/*Fuse.Gestures.Internal.EdgeSwiper*/]);
    ...
    {
        {
            while (enum3.MoveNext(::TYPES[11/*Uno.Collections.Dictionary<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>.Enumerator*/]))
            {
        ...
        {
            enum3.Dispose(::TYPES[11/*Uno.Collections.Dictionary<Fuse.Navigation.NavigationEdge, Fuse.Gestures.Internal.EdgeSwiper>.Enumerator*/]);
        }
    }
    ...
    ::g::Fuse::Visual* newActive = (_maxProgress == 0.0) ? uCast< ::g::Fuse::Visual*>(NULL, ::TYPES[14/*Fuse.Visual*/]) : maxPage;
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\ExplicitNavigation.uno
// ----------------------------------------------------------------------------------------------
...
::g::Fuse::Navigation::VisualNavigation_type* ExplicitNavigation_typeof()
{
    ...
    type->interface6.fp_Toggle = (void(*)(uObject*, ::g::Fuse::Visual*))::g::Fuse::Navigation::VisualNavigation__Toggle_fn;
    type->interface6.fp_get_PageCount = (void(*)(uObject*, int*))::g::Fuse::Navigation::VisualNavigation__get_PageCount_fn;
    type->interface6.fp_get_PageProgress = (void(*)(uObject*, double*))ExplicitNavigation__get_PageProgress_fn;
    type->interface6.fp_get_ActivePage = (void(*)(uObject*, ::g::Fuse::Visual**))::g::Fuse::Navigation::VisualNavigation__get_ActivePage_fn;
    type->interface6.fp_get_State = (void(*)(uObject*, int*))::g::Fuse::Navigation::VisualNavigation__get_State_fn;
    type->interface6.fp_add_PageCountChanged = (void(*)(uObject*, uDelegate*))::g::Fuse::Navigation::VisualNavigation__add_PageCountChanged_fn;
    type->interface6.fp_remove_PageCountChanged = (void(*)(uObject*, uDelegate*))::g::Fuse::Navigation::VisualNavigation__remove_PageCountChanged_fn;
...
// public override sealed double get_PageProgress() :40
...
{
    uStackFrame __("Fuse.Navigation.ExplicitNavigation", "SetPageProgress(Fuse.Visual,float,float,bool,bool)");
...
{
    uStackFrame __("Fuse.Navigation.ExplicitNavigation", "SetState(Fuse.Navigation.NavigationState)");
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\FindRouter.uno
// --------------------------------------------------------------------------------------
...
static void FindRouter_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)FindRouter__New1_fn, 0, true, type, 0));
}
...
::g::Fuse::Reactive::Expression_type* FindRouter_typeof()
{
    ...
    type->fp_ctor_ = (void*)FindRouter__New1_fn;
...
{
    uStackFrame __("Fuse.Navigation.FindRouter", "Subscribe(Fuse.Reactive.IContext,Fuse.Reactive.IListener)");
    return *__retval = (uObject*)FindRouter__Subscription::New1(__this, ::g::Fuse::Reactive::IContext::Node(uInterface(uPtr(context), ::TYPES[17/*Fuse.Reactive.IContext*/])), listener), void();
}

// public FindRouter() [instance] :28
void FindRouter::ctor_1()
{
    ctor_();
}

// public FindRouter New() [static] :28
FindRouter* FindRouter::New1()
{
    FindRouter* obj1 = (FindRouter*)uNew(FindRouter_typeof());
    obj1->ctor_1();
    return obj1;
}
// }

// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\RouterRequest.uno
// -----------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\RouterModify.uno
// ----------------------------------------------------------------------------------------
...
// public generated GetHistoryAt() :731
void Router__GetHistoryAt__ctor__fn(Router__GetHistoryAt* __this)
{
    __this->ctor_();
}

// public bool HistoryAction(Uno.Collections.List<Fuse.Navigation.RouterPage> stack) :737
...
// public generated GetHistoryAt New() :731
void Router__GetHistoryAt__New1_fn(Router__GetHistoryAt** __retval)
{
    *__retval = Router__GetHistoryAt::New1();
}

// public generated GetHistoryAt() [instance] :731
void Router__GetHistoryAt::ctor_()
{
}

// public bool HistoryAction(Uno.Collections.List<Fuse.Navigation.RouterPage> stack) [instance] :737
bool Router__GetHistoryAt::HistoryAction(::g::Uno::Collections::List* stack)
{
    uStackFrame __("Fuse.Navigation.Router.GetHistoryAt", "HistoryAction(Uno.Collections.List<Fuse.Navigation.RouterPage>)");
    ::g::Fuse::Navigation::RouterPage* ret2;
    ::g::Fuse::Navigation::RouterPageRoute* r = NULL;

    for (int i = uPtr(stack)->Count() - 1; i >= 0; --i)
        r = ::g::Fuse::Navigation::RouterPageRoute::New1((::g::Uno::Collections::List__get_Item_fn(uPtr(stack), uCRef<int>(i), &ret2), ret2), r);
...
// public generated GetHistoryAt New() [static] :731
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\Router.ScriptClass.uno
// ----------------------------------------------------------------------------------------------
...
// public void Run(Fuse.Scripting.Context context) [instance] :359
void Router__GetRouteCallback::Run(::g::Fuse::Scripting::Context* context)
{
    uStackFrame __("Fuse.Navigation.Router.GetRouteCallback", "Run(Fuse.Scripting.Context)");
    uPtr(_callback)->Call(uArray::Init<uObject*>(::TYPES[15/*object[]*/], 1, (::g::Fuse::Scripting::Array*)ToArray()));
}

// private Fuse.Scripting.Array ToArray() [instance] :363
::g::Fuse::Scripting::Array* Router__GetRouteCallback::ToArray()
{
    ...
    ::g::Fuse::Scripting::Array* arr = uPtr(_context)->NewArray(uArray::Init<uObject*>(::TYPES[15/*object[]*/], 1, uBox<int>(::g::Uno::Int_typeof(), len * 2)));
...
// public generated GoForward() :203
void GoForward__ctor_3_fn(GoForward* __this)
{
    __this->ctor_3();
}

// public generated GoForward New() :203
...
// public generated GoForward() [instance] :203
void GoForward::ctor_3()
{
    ctor_2();
}

// public generated GoForward New() [static] :203
...
// public sealed class GotoRoute :233
// {
static void GotoRoute_build(uType* type)
{
    type->SetInterfaces(
        ::g::Fuse::Reactive::IListener_typeof(), offsetof(::g::Fuse::Navigation::RouterModify_type, interface0));
    type->SetFields(13);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)GotoRoute__New4_fn, 0, true, type, 0));
}

::g::Fuse::Navigation::RouterModify_type* GotoRoute_typeof()
{
    static uSStrong< ::g::Fuse::Navigation::RouterModify_type*> type;
    if (type != NULL) return type;

    uTypeOptions options;
    options.BaseDefinition = ::g::Fuse::Navigation::RouterModify_typeof();
    options.FieldCount = 13;
    options.InterfaceCount = 1;
    options.ObjectSize = sizeof(GotoRoute);
    options.TypeSize = sizeof(::g::Fuse::Navigation::RouterModify_type);
    type = (::g::Fuse::Navigation::RouterModify_type*)uClassType::New("Fuse.Navigation.GotoRoute", options);
    type->fp_build_ = GotoRoute_build;
    type->fp_ctor_ = (void*)GotoRoute__New4_fn;
    type->interface0.fp_OnNewData = (void(*)(uObject*, uObject*, uObject*))::g::Fuse::Navigation::RouterModify__FuseReactiveIListenerOnNewData_fn;
    return type;
}

// public GotoRoute() :236
void GotoRoute__ctor_4_fn(GotoRoute* __this)
{
    __this->ctor_4();
}

// public GotoRoute New() :236
void GotoRoute__New4_fn(GotoRoute** __retval)
{
    *__retval = GotoRoute::New4();
}

// public GotoRoute() [instance] :236
void GotoRoute::ctor_4()
{
    uStackFrame __("Fuse.Navigation.GotoRoute", ".ctor()");
    ctor_3(0);
    How(1);
}

// public GotoRoute New() [static] :236
GotoRoute* GotoRoute::New4()
{
    GotoRoute* obj1 = (GotoRoute*)uNew(GotoRoute_typeof());
    obj1->ctor_4();
    return obj1;
}
// }
...
static void GotoRouteCommand_build(uType* type)
{
    ...
    type->SetFields(1);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)GotoRouteCommand__New1_fn, 0, true, type, 0));
}
...
::g::Fuse::Navigation::RouteModificationCommand_type* GotoRouteCommand_typeof()
{
    ...
    type->fp_ctor_ = (void*)GotoRouteCommand__New1_fn;
...
{
    uStackFrame __("Fuse.Navigation.GotoRouteCommand", "ProcessArguments(Fuse.Navigation.RouterRequest,Fuse.Reactive.VarArgFunction.Argument[])");
...
// public generated GotoRouteCommand() [instance] :179
void GotoRouteCommand::ctor_3()
{
    ctor_2();
}

// public generated GotoRouteCommand New() [static] :179
GotoRouteCommand* GotoRouteCommand::New1()
{
    GotoRouteCommand* obj1 = (GotoRouteCommand*)uNew(GotoRouteCommand_typeof());
    obj1->ctor_3();
    return obj1;
}
// }

// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\StructuredNavigation.uno
// ------------------------------------------------------------------------------------------------

// public sealed class HierarchicalNavigation :515
// {
...
::g::Fuse::Navigation::StructuredNavigation_type* HierarchicalNavigation_typeof()
{
    ...
    type->interface9.fp_get_SeekRange = (void(*)(uObject*, ::g::Uno::Float2*))::g::Fuse::Navigation::StructuredNavigation__get_SeekRange_fn;
    type->interface6.fp_GetPage = (void(*)(uObject*, int*, ::g::Fuse::Visual**))::g::Fuse::Navigation::VisualNavigation__GetPage_fn;
    ...
    type->interface6.fp_Toggle = (void(*)(uObject*, ::g::Fuse::Visual*))::g::Fuse::Navigation::VisualNavigation__Toggle_fn;
    type->interface6.fp_get_PageCount = (void(*)(uObject*, int*))::g::Fuse::Navigation::VisualNavigation__get_PageCount_fn;
    type->interface6.fp_get_PageProgress = (void(*)(uObject*, double*))::g::Fuse::Navigation::StructuredNavigation__get_PageProgress_fn;
    type->interface6.fp_get_ActivePage = (void(*)(uObject*, ::g::Fuse::Visual**))::g::Fuse::Navigation::VisualNavigation__get_ActivePage_fn;
    type->interface6.fp_get_State = (void(*)(uObject*, int*))::g::Fuse::Navigation::VisualNavigation__get_State_fn;
    type->interface6.fp_add_PageCountChanged = (void(*)(uObject*, uDelegate*))::g::Fuse::Navigation::VisualNavigation__add_PageCountChanged_fn;
    type->interface6.fp_remove_PageCountChanged = (void(*)(uObject*, uDelegate*))::g::Fuse::Navigation::VisualNavigation__remove_PageCountChanged_fn;
...
// public void set_ReuseExistingVisual(bool value) :524
...
// public HierarchicalNavigation() [instance] :517
void HierarchicalNavigation::ctor_5()
{
    ctor_4(1);
}

// public bool get_ReuseExistingVisual() [instance] :523
bool HierarchicalNavigation::ReuseExistingVisual()
{
    return _reuseExistingVisual;
}

// public void set_ReuseExistingVisual(bool value) [instance] :524
void HierarchicalNavigation::ReuseExistingVisual(bool value)
{
    _reuseExistingVisual = value;
}

// public HierarchicalNavigation New() [static] :517
...
// private delegate bool Router.HistoryAction(Uno.Collections.List<Fuse.Navigation.RouterPage> stack) :773
...
uInterfaceType* INavigation_typeof()
{
    ...
    type->Reflection.SetFunctions(18,
        ...
        new uFunction("get_State", NULL, NULL, offsetof(INavigation, fp_get_State), false, ::g::Fuse::Navigation::NavigationState_typeof(), 0),
        new uFunction("add_StateChanged", NULL, NULL, offsetof(INavigation, fp_add_StateChanged), false, uVoid_typeof(), 1, ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Fuse::Navigation::NavigationState_typeof(), NULL)),
        new uFunction("remove_StateChanged", NULL, NULL, offsetof(INavigation, fp_remove_StateChanged), false, uVoid_typeof(), 1, ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Fuse::Navigation::NavigationState_typeof(), NULL)),
...
static void RouteModificationCommand__InnerSubscription_build(uType* type)
{
    ...
    ::STRINGS[13] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\ModifyRouteCommand.uno");
    ::STRINGS[14] = uString::Const("HandleRequest");
    ::TYPES[17] = ::g::Fuse::Reactive::IContext_typeof();
...
{
    uStackFrame __("Fuse.Navigation.RouteModificationCommand.InnerSubscription", "Dispose()");
...
{
    uStackFrame __("Fuse.Navigation.RouteModificationCommand.InnerSubscription", "OnNewArguments(Fuse.Reactive.VarArgFunction.Argument[])");
    ...
    __this->HandleRequest(args);
    ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[18/*Uno.Action*/], __this, offsetof(::g::Fuse::Reactive::VarArgFunction__Subscription_type, fp_Dispose)), -1, 2);
}
...
{
    uStackFrame __("Fuse.Navigation.RouteModificationCommand.InnerSubscription", ".ctor(Fuse.Navigation.RouteModificationCommand.OuterSubscription)");
...
{
    uStackFrame __("Fuse.Navigation.RouteModificationCommand.InnerSubscription", "HandleRequest(Fuse.Reactive.VarArgFunction.Argument[])");
    ...
    ::g::Fuse::Navigation::Router* router = ::g::Fuse::Navigation::Router::TryFindRouter(::g::Fuse::Reactive::IContext::Node(uInterface(uPtr(uPtr(_outSub)->_context), ::TYPES[17/*Fuse.Reactive.IContext*/])));

    if (router == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[12/*"could not f...*/], this, ::STRINGS[13/*"C:\\Users\\...*/], 101, ::STRINGS[14/*"HandleRequest"*/], NULL);
        return;
    }
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\PageBinding.uno
// ---------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\IRouterOutlet.uno
// -----------------------------------------------------------------------------------------
...
// public sealed class LinearNavigation :508
// {
...
// public sealed class ModifyRoute :219
// {
static void ModifyRoute_build(uType* type)
{
    type->SetInterfaces(
        ::g::Fuse::Reactive::IListener_typeof(), offsetof(::g::Fuse::Navigation::RouterModify_type, interface0));
    type->SetFields(13);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)ModifyRoute__New4_fn, 0, true, type, 0));
}

::g::Fuse::Navigation::RouterModify_type* ModifyRoute_typeof()
{
    static uSStrong< ::g::Fuse::Navigation::RouterModify_type*> type;
    if (type != NULL) return type;
    ...
    options.FieldCount = 13;
    options.InterfaceCount = 1;
    options.ObjectSize = sizeof(ModifyRoute);
    options.TypeSize = sizeof(::g::Fuse::Navigation::RouterModify_type);
    type = (::g::Fuse::Navigation::RouterModify_type*)uClassType::New("Fuse.Navigation.ModifyRoute", options);
    type->fp_build_ = ModifyRoute_build;
    type->fp_ctor_ = (void*)ModifyRoute__New4_fn;
    type->interface0.fp_OnNewData = (void(*)(uObject*, uObject*, uObject*))::g::Fuse::Navigation::RouterModify__FuseReactiveIListenerOnNewData_fn;
    return type;
}

// public ModifyRoute() :222
void ModifyRoute__ctor_4_fn(ModifyRoute* __this)
{
    __this->ctor_4();
}

// public ModifyRoute New() :222
void ModifyRoute__New4_fn(ModifyRoute** __retval)
{
    *__retval = ModifyRoute::New4();
}

// public ModifyRoute() [instance] :222
void ModifyRoute::ctor_4()
{
    ctor_3(0);
}

// public ModifyRoute New() [static] :222
ModifyRoute* ModifyRoute::New4()
{
    ModifyRoute* obj1 = (ModifyRoute*)uNew(ModifyRoute_typeof());
    obj1->ctor_4();
    return obj1;
}
// }
...
static void ModifyRouteCommand_build(uType* type)
{
    ...
    ::TYPES[19] = ::g::Fuse::NameValuePair_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetInterfaces(
        ::g::Fuse::Reactive::IExpression_typeof(), offsetof(::g::Fuse::Navigation::RouteModificationCommand_type, interface0));
    type->SetFields(1);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)ModifyRouteCommand__New1_fn, 0, true, type, 0));
}
...
::g::Fuse::Navigation::RouteModificationCommand_type* ModifyRouteCommand_typeof()
{
    ...
    type->fp_ctor_ = (void*)ModifyRouteCommand__New1_fn;
...
{
    uStackFrame __("Fuse.Navigation.ModifyRouteCommand", "ProcessArguments(Fuse.Navigation.RouterRequest,Fuse.Reactive.VarArgFunction.Argument[])");

    for (int i = 0; i < uPtr(args)->Length(); ++i)
    {
        ::g::Fuse::NameValuePair* nvp = uAs< ::g::Fuse::NameValuePair*>(uPtr(uPtr(args)->Strong< ::g::Fuse::Reactive::VarArgFunction__Argument*>(i))->Value(), ::TYPES[19/*Fuse.NameValuePair*/]);

        if (nvp == NULL)
        {
            ::g::Fuse::Diagnostics::UserError(::STRINGS[15/*"arguments t...*/], __this, ::STRINGS[13/*"C:\\Users\\...*/], 159, ::STRINGS[16/*"ProcessArgu...*/], NULL);
...
// public generated ModifyRouteCommand() [instance] :150
void ModifyRouteCommand::ctor_3()
{
    ctor_2();
}

// public generated ModifyRouteCommand New() [static] :150
ModifyRouteCommand* ModifyRouteCommand::New1()
{
    ModifyRouteCommand* obj1 = (ModifyRouteCommand*)uNew(ModifyRouteCommand_typeof());
    obj1->ctor_3();
    return obj1;
}
// }
...
void NavigatedArgs__FuseScriptingIScriptEventSerialize_fn(NavigatedArgs* __this, uObject* s)
{
    ...
    if (::g::Uno::String::op_Inequality(::g::Uno::UX::Selector__op_Implicit1(uPtr(__this->NewVisual())->Name()), NULL))
        ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[20/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[17/*"name"*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(__this->NewVisual())->Name()));
    else
        ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[20/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[17/*"name"*/], ::STRINGS[18/*""*/]);
}
...
// public generated NavigateTo() :53
...
// public generated NavigateTo New() :53
...
void NavigateTo__Perform1_fn(NavigateTo* __this, uObject* ctx, ::g::Fuse::Node* n)
{
    ...
    if (__this->Target() != NULL)
    {
        ...
        if (__this->ClearForwardHistory() && uIs(ctx, ::TYPES[21/*Fuse.Navigation.StructuredNavigation*/]))
            uPtr(uAs< ::g::Fuse::Navigation::StructuredNavigation*>(ctx, ::TYPES[21/*Fuse.Navigation.StructuredNavigation*/]))->QueueClearForwardHistory();
    }
}
...
// public generated NavigateTo() [instance] :53
...
// public generated NavigateTo New() [static] :53
...
void NavigateToggle__Perform1_fn(NavigateToggle* __this, uObject* ctx, ::g::Fuse::Node* n)
{
    ...
    if (page != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[19/*"No Page was...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 119, ::STRINGS[2/*"Perform"*/], NULL);
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\Navigation.Locators.uno
// -----------------------------------------------------------------------------------------------
...
static void Navigation_build(uType* type)
{
    ...
    ::STRINGS[21] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Navigation.Locators.uno");
    ...
    ::TYPES[16] = ::g::Fuse::Navigation::IBaseNavigation_typeof();
    ::TYPES[22] = ::g::Fuse::Visual_typeof()->MakeMethod(2/*FirstChild<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL);
    ::TYPES[23] = ::g::Fuse::Node_typeof()->MakeMethod(3/*NextSibling<Fuse.Node>*/, ::g::Fuse::Node_typeof(), NULL);
    ::TYPES[14] = ::g::Fuse::Visual_typeof();
    ::TYPES[2] = ::g::Fuse::Navigation::INavigation_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof(),
    ...
    type->Reflection.SetFunctions(8,
        new uFunction("GetNavigationNavigation", NULL, (void*)Navigation__GetNavigationNavigation_fn, 0, true, ::TYPES[16/*Fuse.Navigation.IBaseNavigation*/], 1, ::TYPES[14/*Fuse.Visual*/]),
        new uFunction("IsPage", NULL, (void*)Navigation__IsPage_fn, 0, true, ::g::Uno::Bool_typeof(), 1, ::g::Fuse::Node_typeof()),
        new uFunction("ResetNavigationNavigation", NULL, (void*)Navigation__ResetNavigationNavigation_fn, 0, true, uVoid_typeof(), 1, ::TYPES[14/*Fuse.Visual*/]),
        new uFunction("SetNavigationNavigation", NULL, (void*)Navigation__SetNavigationNavigation_fn, 0, true, uVoid_typeof(), 2, ::TYPES[14/*Fuse.Visual*/], ::TYPES[16/*Fuse.Navigation.IBaseNavigation*/]),
        new uFunction("TryFind", NULL, (void*)Navigation__TryFind_fn, 0, true, ::TYPES[2/*Fuse.Navigation.INavigation*/], 1, ::g::Fuse::Node_typeof()),
        new uFunction("TryFindBaseNavigation", NULL, (void*)Navigation__TryFindBaseNavigation_fn, 0, true, ::TYPES[16/*Fuse.Navigation.IBaseNavigation*/], 1, ::g::Fuse::Node_typeof()),
        new uFunction("TryFindBaseNavigation", NULL, (void*)Navigation__TryFindBaseNavigation1_fn, 0, true, ::TYPES[16/*Fuse.Navigation.IBaseNavigation*/], 2, ::g::Fuse::Node_typeof(), ::TYPES[14/*Fuse.Visual*/]->ByRef()),
        new uFunction("TryFindPage", NULL, (void*)Navigation__TryFindPage_fn, 0, true, ::TYPES[14/*Fuse.Visual*/], 1, ::g::Fuse::Node_typeof()));
}
...
// protected generated Navigation() :17
...
// public static void ResetNavigationNavigation(Fuse.Visual n) :181
void Navigation__ResetNavigationNavigation_fn(::g::Fuse::Visual* n)
{
    Navigation::ResetNavigationNavigation(n);
}

// public static void SetNavigationNavigation(Fuse.Visual n, Fuse.Navigation.IBaseNavigation ctx) :166
...
// protected generated Navigation() [instance] :17
...
uObject* Navigation::GetLocalNavigation(::g::Fuse::Visual* node)
{
    ...
    for (::g::Fuse::Node* x = (::g::Fuse::Node*)uPtr(node)->FirstChild(::TYPES[22/*Fuse.Visual.FirstChild<Fuse.Node>*/]); x != NULL; x = (::g::Fuse::Node*)uPtr(x)->NextSibling(::TYPES[23/*Fuse.Node.NextSibling<Fuse.Node>*/]))
    {
        uObject* c = uAs<uObject*>(x, ::TYPES[16/*Fuse.Navigation.IBaseNavigation*/]);

        if ((c != NULL) && !uIs(c, ::TYPES[14/*Fuse.Visual*/]))
            return c;
    }
...
bool Navigation::IsPage(::g::Fuse::Node* n)
{
    ...
    ::g::Fuse::Visual* v = uAs< ::g::Fuse::Visual*>(n, ::TYPES[14/*Fuse.Visual*/]);
...
// public static void ResetNavigationNavigation(Fuse.Visual n) [static] :181
void Navigation::ResetNavigationNavigation(::g::Fuse::Visual* n)
{
    ...
    uPtr(uPtr(n)->Properties())->Clear(Navigation::_contextHandle_);
}

// public static void SetNavigationNavigation(Fuse.Visual n, Fuse.Navigation.IBaseNavigation ctx) [static] :166
void Navigation::SetNavigationNavigation(::g::Fuse::Visual* n, uObject* ctx)
{
    ...
    uPtr(uPtr(n)->Properties())->Set(Navigation::_contextHandle_, ctx);
}
...
uObject* Navigation::TryFindBaseNavigation1(::g::Fuse::Node* node, ::g::Fuse::Visual** parent)
{
    ...
    *parent = NULL;
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[20/*"TryFindBase...*/], node, ::STRINGS[21/*"C:\\Users\\...*/], 50, ::STRINGS[22/*"TryFindBase...*/]);
        return NULL;
    }

    while (node != NULL)
    {
        ::g::Fuse::Visual* v = uAs< ::g::Fuse::Visual*>(node, ::TYPES[14/*Fuse.Visual*/]);
...
::g::Fuse::Visual* Navigation::TryFindPage1(::g::Fuse::Node* node, uObject** nav, ::g::Fuse::Visual** pageBind)
{
    ...
    ::g::Fuse::Visual* prev = uAs< ::g::Fuse::Visual*>(node, ::TYPES[14/*Fuse.Visual*/]);
    *nav = NULL;
    *pageBind = NULL;

    if (!uPtr(node)->IsRootingStarted())
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[23/*"TryFindPage...*/], node, ::STRINGS[21/*"C:\\Users\\...*/], 111, ::STRINGS[24/*"TryFindPage"*/]);
        return NULL;
    }
                ...
                *pageBind = v;
                ...
                if (uPtr(p)->IsRootingStarted())
                {
                    *nav = Navigation::TryFind(p);
                    ...
                    if (*nav == NULL)
                    {
                        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[25/*"`Page` set ...*/], p, ::STRINGS[21/*"C:\\Users\\...*/], 132, ::STRINGS[24/*"TryFindPage"*/]);
                        return NULL;
                    }
                }
...
static void NavigationAnimation_build(uType* type)
{
    ...
    ::TYPES[25] = ::g::Fuse::Navigation::NavigationPageProxy__StatusChangedHandler_typeof();
    type->SetInterfaces(
...
void NavigationAnimation__OnRooted_fn(NavigationAnimation* __this)
{
    ...
    uPtr(__this->_proxy)->Init(uDelegate::New(::TYPES[25/*Fuse.Navigation.NavigationPageProxy.StatusChangedHandler*/], (void*)NavigationAnimation__NavReady_fn, __this), uDelegate::New(::TYPES[25/*Fuse.Navigation.NavigationPageProxy.StatusChangedHandler*/], (void*)NavigationAnimation__NavUnready_fn, __this), __this->Parent());
}
...
void NavigationAnimation::GoProgress(double p, int variant, ::g::Fuse::Navigation::NavigationArgs* state)
{
    ...
    if (uPtr(state)->Mode() == 0)
    {
        ...
        {
            _delay = true;
            ::g::Fuse::UpdateManager::PerformNextFrame(uDelegate::New(::TYPES[18/*Uno.Action*/], (void*)NavigationAnimation__GoProgressPlay_fn, this), 0, 1);
        }
    }
...
{
    uStackFrame __("Fuse.Navigation.NavigationAnimation", "NavReady(object)");
    ::g::Fuse::Navigation::INavigation::add_PageProgressChanged(uInterface(uPtr(uPtr(_proxy)->Navigation()), ::TYPES[2/*Fuse.Navigation.INavigation*/]), uDelegate::New(::TYPES[24/*Fuse.Navigation.NavigationHandler*/], this, offsetof(NavigationAnimation_type, fp_OnNavigationStateChanged)));
    ForceUpdate();
}
...
{
    uStackFrame __("Fuse.Navigation.NavigationAnimation", "NavUnready(object)");
    ::g::Fuse::Navigation::INavigation::remove_PageProgressChanged(uInterface(uPtr(uPtr(_proxy)->Navigation()), ::TYPES[2/*Fuse.Navigation.INavigation*/]), uDelegate::New(::TYPES[24/*Fuse.Navigation.NavigationHandler*/], this, offsetof(NavigationAnimation_type, fp_OnNavigationStateChanged)));
}
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\Navigation.Events.uno
// ---------------------------------------------------------------------------------------------
...
// public enum NavigationDirection :8
...
// public delegate void NavigationPageProgressHandler(object sender, double Current, double Previous) :49
...
{
    ::TYPES[26] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Navigation::IPageResourceBinding_typeof(), NULL);
    ::TYPES[27] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Fuse::Visual_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Navigation::IPagePropertyListener_typeof(), NULL), NULL);
    ::TYPES[14] = ::g::Fuse::Visual_typeof();
    ::TYPES[28] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Navigation::IPagePropertyListener_typeof(), NULL);
    ::TYPES[29] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Fuse::Navigation::IPageResourceBinding_typeof(), NULL);
    ...
    type->SetFields(0,
        ...
        ::TYPES[26/*Uno.Collections.List<Fuse.Navigation.IPageResourceBinding>*/], (uintptr_t)&NavigationPageProperty::RootedBindings_, uFieldFlagsStatic,
        ::TYPES[27/*Uno.Collections.Dictionary<Fuse.Visual, Uno.Collections.List<Fuse.Navigation.IPagePropertyListener>>*/], (uintptr_t)&NavigationPageProperty::_watchers_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(3,
        new uFunction("GetNavigationPage", NULL, (void*)NavigationPageProperty__GetNavigationPage_fn, 0, true, ::TYPES[14/*Fuse.Visual*/], 1, ::TYPES[14/*Fuse.Visual*/]),
        new uFunction("ResetNavigationPage", NULL, (void*)NavigationPageProperty__ResetNavigationPage_fn, 0, true, uVoid_typeof(), 1, ::TYPES[14/*Fuse.Visual*/]),
        new uFunction("SetNavigationPage", NULL, (void*)NavigationPageProperty__SetNavigationPage_fn, 0, true, uVoid_typeof(), 2, ::TYPES[14/*Fuse.Visual*/], ::TYPES[14/*Fuse.Visual*/]));
}
...
// public static void ResetNavigationPage(Fuse.Visual n) :411
void NavigationPageProperty__ResetNavigationPage_fn(::g::Fuse::Visual* n)
{
    NavigationPageProperty::ResetNavigationPage(n);
}

// public static void SetNavigationPage(Fuse.Visual n, Fuse.Visual page) :365
...
// private static void UpdateListeners(Fuse.Visual node) :375
...
::g::Fuse::Visual* NavigationPageProperty::GetNavigationPage(::g::Fuse::Visual* n)
{
    ...
    if (uPtr(uPtr(n)->Properties())->TryGet(NavigationPageProperty::_pageProperty_, &v))
        return uCast< ::g::Fuse::Visual*>(v, ::TYPES[14/*Fuse.Visual*/]);
...
// public static void ResetNavigationPage(Fuse.Visual n) [static] :411
void NavigationPageProperty::ResetNavigationPage(::g::Fuse::Visual* n)
{
    ...
    uPtr(uPtr(n)->Properties())->Clear(NavigationPageProperty::_pageProperty_);
    NavigationPageProperty::UpdateListeners(n);
}

// public static void SetNavigationPage(Fuse.Visual n, Fuse.Visual page) [static] :365
void NavigationPageProperty::SetNavigationPage(::g::Fuse::Visual* n, ::g::Fuse::Visual* page)
{
    ...
    uPtr(uPtr(n)->Properties())->Set(NavigationPageProperty::_pageProperty_, page);
    NavigationPageProperty::UpdateListeners(n);
}

// private static void UpdateListeners(Fuse.Visual node) [static] :375
void NavigationPageProperty::UpdateListeners(::g::Fuse::Visual* node)
{
    ...
    uObject* ret6;
    uObject* ret7;
    ::g::Uno::Collections::List__Enumerator<uStrong<uObject*> > enum1 = (::g::Uno::Collections::List__GetEnumerator_fn(uPtr(NavigationPageProperty::RootedBindings_), &ret5), ret5);

    try
    {
        {
            while (enum1.MoveNext(::TYPES[29/*Uno.Collections.List<Fuse.Navigation.IPageResourceBinding>.Enumerator*/]))
            {
        ...
        {
            enum1.Dispose(::TYPES[29/*Uno.Collections.List<Fuse.Navigation.IPageResourceBinding>.Enumerator*/]);
        }
    }
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\NavigationPageProxy.uno
// -----------------------------------------------------------------------------------------------
...
static void NavigationPageProxy_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(7,
        new uFunction("Dispose", NULL, (void*)NavigationPageProxy__Dispose_fn, 0, false, uVoid_typeof(), 0),
        new uFunction("get_IsReady", NULL, (void*)NavigationPageProxy__get_IsReady_fn, 0, false, ::g::Uno::Bool_typeof(), 0),
        ...
        new uFunction(".ctor", NULL, (void*)NavigationPageProxy__New2_fn, 0, true, type, 2, ::g::Uno::Action_typeof(), ::g::Uno::Action_typeof()),
...
// private void Fuse.Navigation.IPagePropertyListener.PageChanged(Fuse.Visual n) :130
...
// public NavigationPageProxy New(Uno.Action ready, Uno.Action unready) :143
void NavigationPageProxy__New2_fn(uDelegate* ready, uDelegate* unready, NavigationPageProxy** __retval)
{
    *__retval = NavigationPageProxy::New2(ready, unready);
}
...
// public void Rooted(Fuse.Visual source) :159
...
// public NavigationPageProxy(Uno.Action ready, Uno.Action unready) [instance] :143
void NavigationPageProxy::ctor_1(uDelegate* ready, uDelegate* unready)
{
    uStackFrame __("Fuse.Navigation.NavigationPageProxy", ".ctor(Uno.Action,Uno.Action)");
    NavigationPageProxy__ObsoleteWrapper* collection1;
    ::g::Fuse::Diagnostics::Deprecated(uString::Const("NavigationPageProxy is not meant to be used directly, use specific navigation triggers"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\NavigationPageProxy.uno"), 145, ::STRINGS[32/*".ctor"*/]);
    collection1 = NavigationPageProxy__ObsoleteWrapper::New1();
    uPtr(collection1)->Ready = ready;
    uPtr(collection1)->Unready = unready;
    NavigationPageProxy__ObsoleteWrapper* q = collection1;
    _ready = uDelegate::New(::TYPES[25/*Fuse.Navigation.NavigationPageProxy.StatusChangedHandler*/], (void*)NavigationPageProxy__ObsoleteWrapper__ReadyImpl_fn, uPtr(q));
    _unready = uDelegate::New(::TYPES[25/*Fuse.Navigation.NavigationPageProxy.StatusChangedHandler*/], (void*)NavigationPageProxy__ObsoleteWrapper__UnreadyImpl_fn, q);
}

// public void Dispose() [instance] :100
void NavigationPageProxy::Dispose()
{
    uStackFrame __("Fuse.Navigation.NavigationPageProxy", "Dispose()");
    UnrootImpl();
    _ready = NULL;
    _unready = NULL;
}
...
{
    uStackFrame __("Fuse.Navigation.NavigationPageProxy", "Init(Fuse.Navigation.NavigationPageProxy.StatusChangedHandler,Fuse.Navigation.NavigationPageProxy.StatusChangedHandler,Fuse.Visual)");
    _ready = ready;
    _unready = unready;
    RootImpl(source);
}
...
void NavigationPageProxy::OnPageRootingCompleted()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Got an undesired ready event"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\NavigationPageProxy.uno"), 90, uString::Const("OnPageRootingCompleted"));
        return;
    }
...
// public void Rooted(Fuse.Visual source) [instance] :159
...
{
    uStackFrame __("Fuse.Navigation.NavigationPageProxy", "RootImpl(Fuse.Visual)");
    _source = source;

    if (_source == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Attempting rooting to null source"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\NavigationPageProxy.uno"), 46, uString::Const("RootImpl"));
        return;
    }
    ...
    if (Page() == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Unable to locate Page"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\NavigationPageProxy.uno"), 53, uString::Const("RootImpl"), NULL);
        return;
    }
    ...
    if (_navigation == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Something went wrong locating a Navigator"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\NavigationPageProxy.uno"), 70, uString::Const("RootImpl"));
        return;
    }
...
// public void Unrooted() [instance] :165
...
{
    uStackFrame __("Fuse.Navigation.NavigationPageProxy", "UnrootImpl()");
...
// public NavigationPageProxy New(Uno.Action ready, Uno.Action unready) [static] :143
NavigationPageProxy* NavigationPageProxy::New2(uDelegate* ready, uDelegate* unready)
{
    NavigationPageProxy* obj3 = (NavigationPageProxy*)uNew(NavigationPageProxy_typeof());
    obj3->ctor_1(ready, unready);
    return obj3;
}
// }
...
// public delegate void NavigationStateChangedHandler(object sender, Uno.UX.ValueChangedArgs<Fuse.Navigation.NavigationState> args) :51
uDelegateType* NavigationStateChangedHandler_typeof()
{
    static uSStrong<uDelegateType*> type;
    if (type != NULL) return type;

    type = uDelegateType::New("Fuse.Navigation.NavigationStateChangedHandler", 2, 0);
    type->SetSignature(uVoid_typeof(),
        uObject_typeof(),
        ::g::Uno::UX::ValueChangedArgs_typeof()->MakeType(::g::Fuse::Navigation::NavigationState_typeof(), NULL));
    return type;
}
...
{
    ::TYPES[32] = ::g::Fuse::Navigation::RoutePageProxy__ActiveChanged_typeof();
    ...
    type->SetInterfaces(
        ...
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(NavigationTrigger_type, interface4),
        ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Binding_typeof(), NULL), offsetof(NavigationTrigger_type, interface5),
        ::g::Fuse::Animations::IUnwrappedPlayerFeedback_typeof(), offsetof(NavigationTrigger_type, interface6),
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(NavigationTrigger_type, interface7));
    type->SetFields(38,
    ...
    type->Reflection.SetFunctions(4,
        new uFunction("get_Path", NULL, (void*)NavigationTrigger__get_Path_fn, 0, false, ::g::Fuse::Navigation::RoutePagePath_typeof(), 0),
        new uFunction("set_Path", NULL, (void*)NavigationTrigger__set_Path_fn, 0, false, uVoid_typeof(), 1, ::g::Fuse::Navigation::RoutePagePath_typeof()),
        new uFunction("get_When", NULL, (void*)NavigationTrigger__get_When_fn, 0, false, ::g::Fuse::Navigation::RoutePageTriggerWhen_typeof(), 0),
        new uFunction("set_When", NULL, (void*)NavigationTrigger__set_When_fn, 0, false, uVoid_typeof(), 1, ::g::Fuse::Navigation::RoutePageTriggerWhen_typeof()));
}
...
void NavigationTrigger__OnRooted_fn(NavigationTrigger* __this)
{
    ...
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    __this->_proxy = ::g::Fuse::Navigation::RoutePageProxy::New1(__this->Parent(), uDelegate::New(::TYPES[32/*Fuse.Navigation.RoutePageProxy.ActiveChanged*/], __this, offsetof(NavigationTrigger_type, fp_ActiveChanged)));
...
int NavigationTrigger::Path()
{
    return _path;
}

// public void set_Path(Fuse.Navigation.RoutePagePath value) [instance] :26
void NavigationTrigger::Path(int value)
{
    uStackFrame __("Fuse.Navigation.NavigationTrigger", "set_Path(Fuse.Navigation.RoutePagePath)");
    _path = value;
...
int NavigationTrigger::When()
{
    return _when;
}

// public void set_When(Fuse.Navigation.RoutePageTriggerWhen value) [instance] :43
void NavigationTrigger::When(int value)
{
    uStackFrame __("Fuse.Navigation.NavigationTrigger", "set_When(Fuse.Navigation.RoutePageTriggerWhen)");
    _when = value;
...
void NavigationTriggerAction__Perform_fn(NavigationTriggerAction* __this, ::g::Fuse::Node* n)
{
    ...
    if (ctx == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[26/*"No navigati...*/], __this, ::STRINGS[1/*"C:\\Users\\...*/], 18, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
// public static bool CrossesZero(double a, double b) :11
void NavTriggerUtil__CrossesZero_fn(double* a, double* b, bool* __retval)
{
    *__retval = NavTriggerUtil::CrossesZero(*a, *b);
}

// public static Fuse.Animations.AnimationVariant Opposite(Fuse.Animations.AnimationVariant v) :17
void NavTriggerUtil__Opposite_fn(int* v, int* __retval)
{
    *__retval = NavTriggerUtil::Opposite(*v);
}

// public static bool CrossesZero(double a, double b) [static] :11
bool NavTriggerUtil::CrossesZero(double a, double b)
{
    return ((a < 0.0) && (b > 0.0)) || ((a > 0.0) && (b < 0.0));
}

// public static Fuse.Animations.AnimationVariant Opposite(Fuse.Animations.AnimationVariant v) [static] :17
...
// private sealed class NavigationPageProxy.ObsoleteWrapper :151
// {
static void NavigationPageProxy__ObsoleteWrapper_build(uType* type)
{
    type->SetFields(0,
        ::g::Uno::Action_typeof(), offsetof(NavigationPageProxy__ObsoleteWrapper, Ready), 0,
        ::g::Uno::Action_typeof(), offsetof(NavigationPageProxy__ObsoleteWrapper, Unready), 0);
}
...
uType* NavigationPageProxy__ObsoleteWrapper_typeof()
{
    ...
    uTypeOptions options;
    options.FieldCount = 2;
    options.ObjectSize = sizeof(NavigationPageProxy__ObsoleteWrapper);
    options.TypeSize = sizeof(uType);
    type = uClassType::New("Fuse.Navigation.NavigationPageProxy.ObsoleteWrapper", options);
    type->fp_build_ = NavigationPageProxy__ObsoleteWrapper_build;
    type->fp_ctor_ = (void*)NavigationPageProxy__ObsoleteWrapper__New1_fn;
    return type;
}

// public generated ObsoleteWrapper() :151
void NavigationPageProxy__ObsoleteWrapper__ctor__fn(NavigationPageProxy__ObsoleteWrapper* __this)
{
    __this->ctor_();
}

// public generated ObsoleteWrapper New() :151
void NavigationPageProxy__ObsoleteWrapper__New1_fn(NavigationPageProxy__ObsoleteWrapper** __retval)
{
    *__retval = NavigationPageProxy__ObsoleteWrapper::New1();
}

// public void ReadyImpl(Fuse.Navigation.NavigationPageProxy npp) :154
...
{
    __this->ReadyImpl(npp);
}

// public void UnreadyImpl(Fuse.Navigation.NavigationPageProxy npp) :155
...
{
    __this->UnreadyImpl(npp);
}

// public generated ObsoleteWrapper() [instance] :151
void NavigationPageProxy__ObsoleteWrapper::ctor_()
{
}

// public void ReadyImpl(Fuse.Navigation.NavigationPageProxy npp) [instance] :154
void NavigationPageProxy__ObsoleteWrapper::ReadyImpl(::g::Fuse::Navigation::NavigationPageProxy* npp)
{
    uStackFrame __("Fuse.Navigation.NavigationPageProxy.ObsoleteWrapper", "ReadyImpl(Fuse.Navigation.NavigationPageProxy)");
    uPtr(Ready)->InvokeVoid();
}

// public void UnreadyImpl(Fuse.Navigation.NavigationPageProxy npp) [instance] :155
void NavigationPageProxy__ObsoleteWrapper::UnreadyImpl(::g::Fuse::Navigation::NavigationPageProxy* npp)
{
    uStackFrame __("Fuse.Navigation.NavigationPageProxy.ObsoleteWrapper", "UnreadyImpl(Fuse.Navigation.NavigationPageProxy)");
    uPtr(Unready)->InvokeVoid();
}

// public generated ObsoleteWrapper New() [static] :151
NavigationPageProxy__ObsoleteWrapper* NavigationPageProxy__ObsoleteWrapper::New1()
{
    NavigationPageProxy__ObsoleteWrapper* obj1 = (NavigationPageProxy__ObsoleteWrapper*)uNew(NavigationPageProxy__ObsoleteWrapper_typeof());
    obj1->ctor_();
    return obj1;
}
// }
...
{
    ::TYPES[33] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetInterfaces(
        ::g::Uno::IDisposable_typeof(), offsetof(RouteModificationCommand__OuterSubscription_type, interface0),
        ::TYPES[33/*Fuse.Reactive.IListener*/], offsetof(RouteModificationCommand__OuterSubscription_type, interface1),
    ...
    type->SetFields(2,
        ...
        ::TYPES[33/*Fuse.Reactive.IListener*/], offsetof(RouteModificationCommand__OuterSubscription, _listener), 0,
...
{
    uStackFrame __("Fuse.Navigation.RouteModificationCommand.OuterSubscription", "Dispose()");
...
{
    uStackFrame __("Fuse.Navigation.RouteModificationCommand.OuterSubscription", ".ctor(Fuse.Navigation.RouteModificationCommand,Fuse.Reactive.IContext,Fuse.Reactive.IListener)");
    ctor_();
    _expr = expr;
    _context = context;
    _listener = listener;
    ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(_listener), ::TYPES[33/*Fuse.Reactive.IListener*/]), (uObject*)_expr, this);
}
...
{
    uStackFrame __("Fuse.Navigation.RouteModificationCommand.OuterSubscription", "DisposeInner([bool])");
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\PageData.uno
// ------------------------------------------------------------------------------------
...
static void PageData_build(uType* type)
{
    ...
    ::STRINGS[28] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\PageData.uno");
    ::STRINGS[29] = uString::Const("AttachRouterPage");
    ::TYPES[34] = ::g::Fuse::Navigation::RouterPageChangedHandler_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(0,
        ...
        ::TYPES[34/*Fuse.Navigation.RouterPageChangedHandler*/], offsetof(PageData, RouterPageChanged1), 0,
...
// public void SetContext(object data) :63
...
{
    uStackFrame __("Fuse.Navigation.PageData", "AttachRouterPage(Fuse.Navigation.RouterPage)");
    ::g::Fuse::Visual* visual = Visual();

    if (visual == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[27/*"Attaching t...*/], this, ::STRINGS[28/*"C:\\Users\\...*/], 43, ::STRINGS[29/*"AttachRoute...*/]);
        return;
    }

    RouterPage(rp);
    uPtr(visual)->Prepare(uPtr(rp)->Parameter);
...
{
    uStackFrame __("Fuse.Navigation.PageData", "add_RouterPageChanged(Fuse.Navigation.RouterPageChangedHandler)");
    RouterPageChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(RouterPageChanged1, value), ::TYPES[34/*Fuse.Navigation.RouterPageChangedHandler*/]);
}
...
{
    uStackFrame __("Fuse.Navigation.PageData", "remove_RouterPageChanged(Fuse.Navigation.RouterPageChangedHandler)");
    RouterPageChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(RouterPageChanged1, value), ::TYPES[34/*Fuse.Navigation.RouterPageChangedHandler*/]);
}

// public void SetContext(object data) [instance] :63
void PageData::SetContext(uObject* data)
{
    uStackFrame __("Fuse.Navigation.PageData", "SetContext(object)");
...
{
    uStackFrame __("Fuse.Navigation.PageData", "UpdateContextData(Fuse.Visual,object)");
...
{
    uStackFrame __("Fuse.Navigation.PageData", "Get(Fuse.Visual)");
...
{
    uStackFrame __("Fuse.Navigation.PageData", "GetOrCreate(Fuse.Visual,[bool])");
    uObject* res;
...
static void PageExpression_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(2,
        new uFunction("get_Key", NULL, (void*)PageExpression__get_Key_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction(".ctor", NULL, (void*)PageExpression__New1_fn, 0, true, type, 1, ::g::Uno::String_typeof()));
}
...
{
    uStackFrame __("Fuse.Navigation.PageExpression", "Subscribe(Fuse.Reactive.IContext,Fuse.Reactive.IListener)");
    return *__retval = (uObject*)PageExpression__Subscription::New1(__this, ::g::Fuse::Reactive::IContext::Node(uInterface(uPtr(dc), ::TYPES[17/*Fuse.Reactive.IContext*/])), listener), void();
}
...
{
    ::STRINGS[30] = uString::Const("PageResourceBinding has been deprecated. Use DataBinding instead");
    ::STRINGS[31] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\PageBinding.uno");
    ::STRINGS[32] = uString::Const(".ctor");
    ::STRINGS[33] = uString::Const("target");
    ::STRINGS[34] = uString::Const("Visual");
    ::STRINGS[35] = uString::Const("Node");
    ::TYPES[35] = ::g::Uno::Predicate_typeof()->MakeType(uObject_typeof(), NULL);
    ::TYPES[18] = ::g::Uno::Action_typeof();
    ::TYPES[2] = ::g::Fuse::Navigation::INavigation_typeof();
    ::TYPES[36] = ::g::Fuse::Navigation::NavigatedHandler_typeof();
    ::TYPES[14] = ::g::Fuse::Visual_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof(),
        ::g::Fuse::Navigation::Navigation_typeof(),
    ...
    type->SetFields(16,
        ...
        ::g::Uno::Bool_typeof(), offsetof(PageResourceBinding, _allowNull), 0,
        ::TYPES[2/*Fuse.Navigation.INavigation*/], offsetof(PageResourceBinding, _nav), 0,
        ::TYPES[14/*Fuse.Visual*/], offsetof(PageResourceBinding, _currentPage), 0,
...
PageResourceBinding_type* PageResourceBinding_typeof()
{
    ...
    type->interface6.fp_UpdateSource = (void(*)(uObject*))PageResourceBinding__FuseNavigationIPageResourceBindingUpdateSource_fn;
    type->interface4.fp_Clear = (void(*)(uObject*))::g::Fuse::Node__UnoCollectionsICollectionFuseBindingClear_fn;
    type->interface4.fp_Contains = (void(*)(uObject*, void*, bool*))::g::Fuse::Node__UnoCollectionsICollectionFuseBindingContains_fn;
    type->interface0.fp_RemoveAt = (void(*)(uObject*, int*))::g::Fuse::Node__UnoCollectionsIListFuseBindingRemoveAt_fn;
    type->interface5.fp_GetEnumerator = (void(*)(uObject*, uObject**))::g::Fuse::Node__UnoCollectionsIEnumerableFuseBindingGetEnumerator_fn;
...
// public PageResourceBinding(Uno.UX.Property<T> target, string key) :192
...
// public void set_Default(T value) :173
...
// private void Fuse.Navigation.IPageResourceBinding.UpdateSource() :232
...
// public PageResourceBinding New(Uno.UX.Property<T> target, string key) :192
...
// public PageResourceBinding(Uno.UX.Property<T> target, string key) [instance] :192
void PageResourceBinding::ctor_3(::g::Uno::UX::Property1* target, uString* key)
{
    ...
    ctor_2();
    ::g::Fuse::Diagnostics::Deprecated(::STRINGS[30/*"PageResourc...*/], this, ::STRINGS[31/*"C:\\Users\\...*/], 194, ::STRINGS[32/*".ctor"*/]);

    if (target == NULL)
        U_THROW(::g::Uno::ArgumentNullException::New6(::STRINGS[33/*"target"*/]));
...
// public bool get_AllowNull() [instance] :183
bool PageResourceBinding::AllowNull()
{
    return _allowNull;
}

// public void set_AllowNull(bool value) [instance] :184
...
void PageResourceBinding::OnChanged()
{
    ...
    if (page != NULL)
    {
        if ((::g::Uno::String::op_Equality(Key(), ::STRINGS[34/*"Visual"*/]) || ::g::Uno::String::op_Equality(Key(), ::STRINGS[35/*"Node"*/])) && uIs(page, __type->T(0)))
            ::g::Uno::UX::Property1__Set_fn(uPtr(Target()), uUnboxAny(__type->T(0), page), NULL);
        else
        {
            uObject* resource;

            if (uPtr(page)->TryGetResource(Key(), uDelegate::New(::TYPES[35/*Uno.Predicate<object>*/], (void*)PageResourceBinding__Acceptor_fn, this), &resource))
...
void PageResourceBinding::ReleaseCurrent()
{
    ...
    if (_nav != NULL)
    {
        ::g::Fuse::Navigation::INavigation::remove_Navigated(uInterface(uPtr(_nav), ::TYPES[2/*Fuse.Navigation.INavigation*/]), uDelegate::New(::TYPES[36/*Fuse.Navigation.NavigatedHandler*/], (void*)PageResourceBinding__OnNavigated_fn, this));
        _nav = NULL;
    }
...
void PageResourceBinding::UpdateSource()
{
    ...
    _currentPage = uAs< ::g::Fuse::Visual*>(local, ::TYPES[14/*Fuse.Visual*/]);

    if (_nav != NULL)
    {
        ::g::Fuse::Navigation::INavigation::add_Navigated(uInterface(uPtr(_nav), ::TYPES[2/*Fuse.Navigation.INavigation*/]), uDelegate::New(::TYPES[36/*Fuse.Navigation.NavigatedHandler*/], (void*)PageResourceBinding__OnNavigated_fn, this));
...
// public PageResourceBinding New(Uno.UX.Property<T> target, string key) [static] :192
...
{
    ::STRINGS[36] = uString::Const("$path");
    ::TYPES[37] = ::g::Fuse::IObject_typeof();
    ::TYPES[38] = ::g::Fuse::Marshal_typeof()->MakeMethod(0/*ToType<string>*/, ::g::Uno::String_typeof(), NULL);
    ::TYPES[39] = ::g::Fuse::Navigation::ChildRouterPagesUpdated_typeof();
    ...
    type->SetFields(6,
        ::TYPES[39/*Fuse.Navigation.ChildRouterPagesUpdated*/], offsetof(PagesMap, Updated1), 0);
}
...
// public generated PagesMap() :96
void PagesMap__ctor_1_fn(PagesMap* __this)
{
    __this->ctor_1();
}

// public static string GetObjectPath(object data) :98
void PagesMap__GetObjectPath_fn(uObject* data, uString** __retval)
{
    *__retval = PagesMap::GetObjectPath(data);
}

// protected override sealed Fuse.Navigation.RouterPage Map(object v) :113
void PagesMap__Map_fn(PagesMap* __this, uObject* v, ::g::Fuse::Navigation::RouterPage** __retval)
{
    uStackFrame __("Fuse.Navigation.PagesMap", "Map(object)");
    return *__retval = ::g::Fuse::Navigation::RouterPage::New1(PagesMap::GetObjectPath(v), NULL, v), void();
}

// public generated PagesMap New() :96
void PagesMap__New1_fn(PagesMap** __retval)
{
    *__retval = PagesMap::New1();
}

// protected override sealed void OnUpdated() :123
void PagesMap__OnUpdated_fn(PagesMap* __this)
{
    uStackFrame __("Fuse.Navigation.PagesMap", "OnUpdated()");

    if (::g::Uno::Delegate::op_Inequality(__this->Updated1, NULL))
        uPtr(__this->Updated1)->InvokeVoid();
}

// protected override sealed object Unmap(Fuse.Navigation.RouterPage mv) :118
void PagesMap__Unmap_fn(PagesMap* __this, ::g::Fuse::Navigation::RouterPage* mv, uObject** __retval)
{
    uStackFrame __("Fuse.Navigation.PagesMap", "Unmap(Fuse.Navigation.RouterPage)");
    return *__retval = uPtr(mv)->Context, void();
}

// public generated void add_Updated(Fuse.Navigation.ChildRouterPagesUpdated value) :111
void PagesMap__add_Updated_fn(PagesMap* __this, uDelegate* value)
{
    __this->add_Updated(value);
}

// public generated void remove_Updated(Fuse.Navigation.ChildRouterPagesUpdated value) :111
void PagesMap__remove_Updated_fn(PagesMap* __this, uDelegate* value)
{
    __this->remove_Updated(value);
}

// public generated PagesMap() [instance] :96
void PagesMap::ctor_1()
{
    ctor_();
}

// public generated void add_Updated(Fuse.Navigation.ChildRouterPagesUpdated value) [instance] :111
void PagesMap::add_Updated(uDelegate* value)
{
    uStackFrame __("Fuse.Navigation.PagesMap", "add_Updated(Fuse.Navigation.ChildRouterPagesUpdated)");
    Updated1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Updated1, value), ::TYPES[39/*Fuse.Navigation.ChildRouterPagesUpdated*/]);
}

// public generated void remove_Updated(Fuse.Navigation.ChildRouterPagesUpdated value) [instance] :111
void PagesMap::remove_Updated(uDelegate* value)
{
    uStackFrame __("Fuse.Navigation.PagesMap", "remove_Updated(Fuse.Navigation.ChildRouterPagesUpdated)");
    Updated1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Updated1, value), ::TYPES[39/*Fuse.Navigation.ChildRouterPagesUpdated*/]);
}

// public static string GetObjectPath(object data) [static] :98
uString* PagesMap::GetObjectPath(uObject* data)
{
    uStackFrame __("Fuse.Navigation.PagesMap", "GetObjectPath(object)");
    uString* ret2;
    uString* path = NULL;
    uObject* obj = uAs<uObject*>(data, ::TYPES[37/*Fuse.IObject*/]);

    if ((obj != NULL) && ::g::Fuse::IObject::ContainsKey(uInterface(uPtr(obj), ::TYPES[37/*Fuse.IObject*/]), ::STRINGS[36/*"$path"*/]))
        path = (::g::Fuse::Marshal__ToType_fn(::TYPES[38/*Fuse.Marshal.ToType<string>*/], ::g::Fuse::IObject::Item(uInterface(uPtr(obj), ::TYPES[37/*Fuse.IObject*/]), ::STRINGS[36/*"$path"*/]), &ret2), ret2);

    return path;
}

// public generated PagesMap New() [static] :96
...
// public sealed class PushRoute :249
// {
static void PushRoute_build(uType* type)
{
    type->SetInterfaces(
        ::g::Fuse::Reactive::IListener_typeof(), offsetof(::g::Fuse::Navigation::RouterModify_type, interface0));
    type->SetFields(13);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)PushRoute__New4_fn, 0, true, type, 0));
}

::g::Fuse::Navigation::RouterModify_type* PushRoute_typeof()
{
    static uSStrong< ::g::Fuse::Navigation::RouterModify_type*> type;
    if (type != NULL) return type;
    ...
    options.FieldCount = 13;
    options.InterfaceCount = 1;
    options.ObjectSize = sizeof(PushRoute);
    options.TypeSize = sizeof(::g::Fuse::Navigation::RouterModify_type);
    type = (::g::Fuse::Navigation::RouterModify_type*)uClassType::New("Fuse.Navigation.PushRoute", options);
    type->fp_build_ = PushRoute_build;
    type->fp_ctor_ = (void*)PushRoute__New4_fn;
    type->interface0.fp_OnNewData = (void(*)(uObject*, uObject*, uObject*))::g::Fuse::Navigation::RouterModify__FuseReactiveIListenerOnNewData_fn;
    return type;
}

// public PushRoute() :252
void PushRoute__ctor_4_fn(PushRoute* __this)
{
    __this->ctor_4();
}

// public PushRoute New() :252
void PushRoute__New4_fn(PushRoute** __retval)
{
    *__retval = PushRoute::New4();
}

// public PushRoute() [instance] :252
void PushRoute::ctor_4()
{
    uStackFrame __("Fuse.Navigation.PushRoute", ".ctor()");
    ctor_3(0);
    How(0);
}

// public PushRoute New() [static] :252
PushRoute* PushRoute::New4()
{
    PushRoute* obj1 = (PushRoute*)uNew(PushRoute_typeof());
    obj1->ctor_4();
    return obj1;
}
// }
...
static void PushRouteCommand_build(uType* type)
{
    ...
    type->SetFields(1);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)PushRouteCommand__New1_fn, 0, true, type, 0));
}
...
::g::Fuse::Navigation::RouteModificationCommand_type* PushRouteCommand_typeof()
{
    ...
    type->fp_ctor_ = (void*)PushRouteCommand__New1_fn;
...
{
    uStackFrame __("Fuse.Navigation.PushRouteCommand", "ProcessArguments(Fuse.Navigation.RouterRequest,Fuse.Reactive.VarArgFunction.Argument[])");
...
// public generated PushRouteCommand() [instance] :194
void PushRouteCommand::ctor_3()
{
    ctor_2();
}

// public generated PushRouteCommand New() [static] :194
PushRouteCommand* PushRouteCommand::New1()
{
    PushRouteCommand* obj1 = (PushRouteCommand*)uNew(PushRouteCommand_typeof());
    obj1->ctor_3();
    return obj1;
}
// }

// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\Route.uno
// ---------------------------------------------------------------------------------
...
// internal RouteModificationCommand() :10
...
{
    uStackFrame __("Fuse.Navigation.RouteModificationCommand", "Subscribe(Fuse.Reactive.IContext,Fuse.Reactive.IListener)");
    return *__retval = (uObject*)RouteModificationCommand__OuterSubscription::New1(__this, context, listener), void();
}

// internal RouteModificationCommand() [instance] :10
void RouteModificationCommand::ctor_2()
{
    ctor_1();
}
// }
...
static void RoutePageProxy_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::g::Fuse::Visual_typeof(), offsetof(RoutePageProxy, _Page), 0);
}
...
// public generated Fuse.Visual get_Page() :51
void RoutePageProxy__get_Page_fn(RoutePageProxy* __this, ::g::Fuse::Visual** __retval)
{
    *__retval = __this->Page();
}

// private generated void set_Page(Fuse.Visual value) :51
...
{
    uStackFrame __("Fuse.Navigation.RoutePageProxy", "DiscardLevels(int)");
...
{
    uStackFrame __("Fuse.Navigation.RoutePageProxy", "Dispose()");
...
{
    uStackFrame __("Fuse.Navigation.RoutePageProxy", "Dispose(Fuse.Navigation.RoutePageProxy.Level)");
    Unlisten(level);
...
{
    uStackFrame __("Fuse.Navigation.RoutePageProxy", "ExtendListen(Fuse.Navigation.RoutePageProxy.Level)");
    ...
    uPtr(nextLevel.PageProxy)->Init(uDelegate::New(::TYPES[25/*Fuse.Navigation.NavigationPageProxy.StatusChangedHandler*/], (void*)RoutePageProxy__NavReady_fn, this), uDelegate::New(::TYPES[25/*Fuse.Navigation.NavigationPageProxy.StatusChangedHandler*/], (void*)RoutePageProxy__NavUnready_fn, this), nav);
    return true;
}
...
{
    uStackFrame __("Fuse.Navigation.RoutePageProxy", "GetLevel(object)");
    ...
    ::g::Fuse::Diagnostics::InternalError(uString::Const("Unexpected sender"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\RoutePageProxy.uno"), 119, uString::Const("GetLevel"));
    return -1;
}
...
{
    uStackFrame __("Fuse.Navigation.RoutePageProxy", "GetProgress()");
    ...
    for (int i = 0; i < uPtr(_levels)->Count(); ++i)
    {
        ...
        ::g::Fuse::Navigation::NavigationPageState pp = ::g::Fuse::Navigation::INavigation::GetPageState(uInterface(uPtr(uPtr(level.PageProxy)->Navigation()), ::TYPES[2/*Fuse.Navigation.INavigation*/]), uPtr(level.PageProxy)->Page());
...
{
    uStackFrame __("Fuse.Navigation.RoutePageProxy", "GetState(bool&,bool&)");
    ...
    *isActive = true;
    ...
    for (int i = 0; i < uPtr(_levels)->Count(); ++i)
    {
        bool la = ::g::Fuse::Navigation::INavigation::ActivePage(uInterface(uPtr(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(_levels), uCRef<int>(i), &ret9), ret9).PageProxy)->Navigation()), ::TYPES[2/*Fuse.Navigation.INavigation*/])) == uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(_levels), uCRef<int>(i), &ret10), ret10).PageProxy)->Page();
        *isActive = *isActive && la;
        bool s = ::g::Fuse::Navigation::INavigation::State(uInterface(uPtr(uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(_levels), uCRef<int>(i), &ret11), ret11).PageProxy)->Navigation()), ::TYPES[2/*Fuse.Navigation.INavigation*/])) == 0;
        *isStable = *isStable && s;
    }
}
...
{
    uStackFrame __("Fuse.Navigation.RoutePageProxy", "Init()");
    ...
    uPtr(level.PageProxy)->Init(uDelegate::New(::TYPES[25/*Fuse.Navigation.NavigationPageProxy.StatusChangedHandler*/], (void*)RoutePageProxy__NavReady_fn, this), uDelegate::New(::TYPES[25/*Fuse.Navigation.NavigationPageProxy.StatusChangedHandler*/], (void*)RoutePageProxy__NavUnready_fn, this), _source);
}

// private void InitialUpdate() [instance] :231
void RoutePageProxy::InitialUpdate()
{
    uStackFrame __("Fuse.Navigation.RoutePageProxy", "InitialUpdate()");
...
{
    uStackFrame __("Fuse.Navigation.RoutePageProxy", "Listen(Fuse.Navigation.RoutePageProxy.Level)");

    if (!level.Listening)
    {
        if (::g::Uno::Delegate::op_Inequality(_progressUpdated, NULL))
            ::g::Fuse::Navigation::INavigation::add_PageProgressChanged(uInterface(uPtr(uPtr(level.PageProxy)->Navigation()), ::TYPES[2/*Fuse.Navigation.INavigation*/]), uDelegate::New(::TYPES[24/*Fuse.Navigation.NavigationHandler*/], (void*)RoutePageProxy__OnNavigationProgressChanged_fn, this));

        if (::g::Uno::Delegate::op_Inequality(_activeChanged, NULL))
        {
            ::g::Fuse::Navigation::INavigation::add_ActivePageChanged(uInterface(uPtr(uPtr(level.PageProxy)->Navigation()), ::TYPES[2/*Fuse.Navigation.INavigation*/]), uDelegate::New(::TYPES[53/*Fuse.Navigation.ActivePageChangedHandler*/], (void*)RoutePageProxy__OnActivePageChanged_fn, this));
            ::g::Fuse::Navigation::INavigation::add_StateChanged(uInterface(uPtr(uPtr(level.PageProxy)->Navigation()), ::TYPES[2/*Fuse.Navigation.INavigation*/]), uDelegate::New(::TYPES[56/*Uno.UX.ValueChangedHandler<Fuse.Navigation.NavigationState>*/], (void*)RoutePageProxy__OnStateChanged_fn, this));
        }
...
{
    uStackFrame __("Fuse.Navigation.RoutePageProxy", "NavReady(object)");
...
{
    uStackFrame __("Fuse.Navigation.RoutePageProxy", "NavUnready(object)");
...
{
    uStackFrame __("Fuse.Navigation.RoutePageProxy", "OnNavigationProgressChanged(object,Fuse.Navigation.NavigationArgs)");
...
// public generated Fuse.Visual get_Page() [instance] :51
::g::Fuse::Visual* RoutePageProxy::Page()
{
    return _Page;
}

// private generated void set_Page(Fuse.Visual value) [instance] :51
void RoutePageProxy::Page(::g::Fuse::Visual* value)
{
    _Page = value;
}
...
{
    uStackFrame __("Fuse.Navigation.RoutePageProxy", "ScheduleActiveChanged()");

    if (_activeChangedPending)
        return;

    _activeChangedPending = true;
    ::g::Fuse::UpdateManager::AddDeferredAction2(uDelegate::New(::TYPES[18/*Uno.Action*/], (void*)RoutePageProxy__UpdateActive_fn, this), -1, 2);
}
...
{
    uStackFrame __("Fuse.Navigation.RoutePageProxy", "Unlisten(Fuse.Navigation.RoutePageProxy.Level)");

    if (level.Listening)
    {
        if (::g::Uno::Delegate::op_Inequality(_progressUpdated, NULL))
            ::g::Fuse::Navigation::INavigation::remove_PageProgressChanged(uInterface(uPtr(uPtr(level.PageProxy)->Navigation()), ::TYPES[2/*Fuse.Navigation.INavigation*/]), uDelegate::New(::TYPES[24/*Fuse.Navigation.NavigationHandler*/], (void*)RoutePageProxy__OnNavigationProgressChanged_fn, this));

        if (::g::Uno::Delegate::op_Inequality(_activeChanged, NULL))
        {
            ::g::Fuse::Navigation::INavigation::remove_ActivePageChanged(uInterface(uPtr(uPtr(level.PageProxy)->Navigation()), ::TYPES[2/*Fuse.Navigation.INavigation*/]), uDelegate::New(::TYPES[53/*Fuse.Navigation.ActivePageChangedHandler*/], (void*)RoutePageProxy__OnActivePageChanged_fn, this));
            ::g::Fuse::Navigation::INavigation::remove_StateChanged(uInterface(uPtr(uPtr(level.PageProxy)->Navigation()), ::TYPES[2/*Fuse.Navigation.INavigation*/]), uDelegate::New(::TYPES[56/*Uno.UX.ValueChangedHandler<Fuse.Navigation.NavigationState>*/], (void*)RoutePageProxy__OnStateChanged_fn, this));
        }
...
{
    uStackFrame __("Fuse.Navigation.RoutePageProxy", "UpdateActive()");
...
static void Router__cctor_1_fn(uType* __type)
{
    ...
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[46/*Fuse.Scripting.ScriptMember[]*/], 8, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("bookmark"), uDelegate::New(::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), __type, ::TYPES[15/*object[]*/], NULL), (void*)Router__Bookmark_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("getRoute"), uDelegate::New(::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), __type, ::TYPES[15/*object[]*/], NULL), (void*)Router__GetRoute_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("goBack"), uDelegate::New(::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), __type, ::TYPES[15/*object[]*/], NULL), (void*)Router__GoBack1_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), ::STRINGS[55/*"goto"*/], uDelegate::New(::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), __type, ::TYPES[15/*object[]*/], NULL), (void*)Router__Goto1_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("gotoRelative"), uDelegate::New(::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), __type, ::TYPES[15/*object[]*/], NULL), (void*)Router__GotoRelative_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("modify"), uDelegate::New(::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), __type, ::TYPES[15/*object[]*/], NULL), (void*)Router__Modify2_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("push"), uDelegate::New(::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), __type, ::TYPES[15/*object[]*/], NULL), (void*)Router__Push1_fn), 2), (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::g::Fuse::Scripting::ScriptMethod1_typeof()->MakeType(__type, NULL), uString::Const("pushRelative"), uDelegate::New(::g::Uno::Action3_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), __type, ::TYPES[15/*object[]*/], NULL), (void*)Router__PushRelative_fn), 2)));
}
...
static void Router_build(uType* type)
{
    type->SetDependencies(
        ...
        ::g::Fuse::PreviewState_typeof(),
        ::g::Fuse::Navigation::RouterPageRoute_typeof(),
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::IPreviewStateSaver_typeof(), offsetof(Router_type, interface7));
    type->SetFields(16,
    ...
    type->Reflection.SetFunctions(15,
        ...
        new uFunction("CancelNavigation", NULL, (void*)Router__CancelNavigation_fn, 0, false, uVoid_typeof(), 0),
        ...
        new uFunction("Goto", NULL, (void*)Router__Goto_fn, 0, false, uVoid_typeof(), 2, ::g::Fuse::Navigation::Route_typeof(), ::g::Uno::String_typeof()),
        ...
        new uFunction("Push", NULL, (void*)Router__Push_fn, 0, false, uVoid_typeof(), 2, ::g::Fuse::Navigation::Route_typeof(), ::g::Uno::String_typeof()));
}
...
Router_type* Router_typeof()
{
    ...
    type->interface7.fp_Save = (void(*)(uObject*, ::g::Fuse::PreviewStateData*))Router__FuseIPreviewStateSaverSave_fn;
...
// private static Fuse.Navigation.IRouterOutlet AsRouterOutlet(Fuse.Node n) :614
void Router__AsRouterOutlet_fn(::g::Fuse::Node* n, uObject** __retval)
{
    *__retval = Router::AsRouterOutlet(n);
}

// public Fuse.Navigation.BackButtonAction get_BackButtonAction() :168
void Router__get_BackButtonAction_fn(Router* __this, int* __retval)
{
    *__retval = __this->BackButtonAction();
}

// public void set_BackButtonAction(Fuse.Navigation.BackButtonAction value) :169
...
// public void CancelNavigation() :362
void Router__CancelNavigation_fn(Router* __this)
{
    __this->CancelNavigation();
}

// public bool get_CanGoBack() :268
void Router__get_CanGoBack_fn(Router* __this, bool* __retval)
{
    *__retval = __this->CanGoBack();
}

// private void ClearPrepared() :330
void Router__ClearPrepared_fn(Router* __this)
{
    __this->ClearPrepared();
}

// private bool EnumerateHistory(Fuse.Navigation.Router.HistoryAction action, Uno.Collections.List<Fuse.Navigation.RouterPage> stack, Fuse.Navigation.RouterPage rp) :775
...
// private Fuse.Navigation.IRouterOutlet FindOutletDown(Fuse.Node active) :592
void Router__FindOutletDown_fn(Router* __this, ::g::Fuse::Node* active, uObject** __retval)
{
    *__retval = __this->FindOutletDown(active);
}

// private Fuse.Navigation.IRouterOutlet FindOutletUp(Fuse.Node active) :621
void Router__FindOutletUp_fn(Router* __this, ::g::Fuse::Node* active, uObject** __retval)
{
    *__retval = __this->FindOutletUp(active);
}

// private Fuse.Navigation.IRouterOutlet FindOutletUp(Fuse.Node active, Fuse.Node& page) :627
...
// internal static Fuse.Visual FindRouterOutletPage(Fuse.Node from) :556
void Router__FindRouterOutletPage_fn(::g::Fuse::Node* from, ::g::Fuse::Visual** __retval)
{
    *__retval = Router::FindRouterOutletPage(from);
}

// private void FinishPrepared() :321
void Router__FinishPrepared_fn(Router* __this)
{
    __this->FinishPrepared();
}

// private void Fuse.IPreviewStateSaver.Save(Fuse.PreviewStateData psd) :137
void Router__FuseIPreviewStateSaverSave_fn(Router* __this, ::g::Fuse::PreviewStateData* psd)
{
    uStackFrame __("Fuse.Navigation.Router", "Fuse.IPreviewStateSaver.Save(Fuse.PreviewStateData)");
    uPtr(psd)->Set(uString::Const("router"), __this->_rootPage);
}

// private bool Fuse.Navigation.IBaseNavigation.get_CanGoForward() :687
void Router__FuseNavigationIBaseNavigationget_CanGoForward_fn(Router* __this, bool* __retval)
{
    return *__retval = false, void();
}

// private void Fuse.Navigation.IBaseNavigation.GoForward() :686
void Router__FuseNavigationIBaseNavigationGoForward_fn(Router* __this)
{
}

// private Fuse.Navigation.RouterPageRoute GetCurrent(Fuse.Visual from, [Fuse.Navigation.IRouterOutlet to]) :514
...
// public Fuse.Navigation.Route GetCurrentRoute() :172
void Router__GetCurrentRoute_fn(Router* __this, ::g::Fuse::Navigation::Route** __retval)
{
    *__retval = __this->GetCurrentRoute();
}

// private Fuse.Navigation.RouterPageRoute GetCurrentRouterPageRoute() :177
...
// internal Fuse.Navigation.RouterPageRoute GetHistoryRoute(int at) :723
...
// private int GetOutletDepth(Fuse.Navigation.IRouterOutlet outlet) :577
void Router__GetOutletDepth_fn(Router* __this, uObject* outlet, int* __retval)
{
    *__retval = __this->GetOutletDepth(outlet);
}

// private static Fuse.Navigation.RouterPageRoute GetRelative(Fuse.Scripting.Context c, Fuse.Navigation.Router r, object[] args) :92
...
// internal Fuse.Navigation.RouterPageRoute GetRelativeRoute(Fuse.Node from, Fuse.Navigation.RouterPageRoute rel) :651
...
// private Fuse.Navigation.RouterPageRoute GetRouteUpToRouter(Fuse.Node from) :528
...
// public void Goto(Fuse.Navigation.Route route, [string operationStyle]) :183
...
// internal void OnHistoryChanged() :690
void Router__OnHistoryChanged_fn(Router* __this)
{
    __this->OnHistoryChanged();
}

// private void OnKeyPressed(object sender, Fuse.Input.KeyEventArgs args) :153
...
// protected override sealed void OnUnrooted() :125
...
// private void OnUpFromRoot() :289
void Router__OnUpFromRoot_fn(Router* __this)
{
    __this->OnUpFromRoot();
}

// private void Pop() :295
void Router__Pop_fn(Router* __this)
{
    __this->Pop();
}

// public double get_PrepareProgress() :339
void Router__get_PrepareProgress_fn(Router* __this, double* __retval)
{
    *__retval = __this->PrepareProgress();
}

// public void set_PrepareProgress(double value) :340
void Router__set_PrepareProgress_fn(Router* __this, double* value)
{
    __this->PrepareProgress(*value);
}

// private void PrepareRoute(Fuse.Navigation.RouterPageRoute r, Fuse.Navigation.RoutingOperation operation, string operationStyle) :311
...
// public void Push(Fuse.Navigation.Route route, [string operationStyle]) :189
...
// internal Fuse.Navigation.RouterPage get_RootPage() :719
void Router__get_RootPage_fn(Router* __this, ::g::Fuse::Navigation::RouterPage** __retval)
{
    *__retval = __this->RootPage();
}

// private void SetPrepareProgress(double value) :343
void Router__SetPrepareProgress_fn(Router* __this, double* value)
{
    __this->SetPrepareProgress(*value);
}

// private Fuse.Navigation.RouterPageRoute SetRoute(Fuse.Navigation.RouterPageRoute r, Fuse.Navigation.NavigationGotoMode gotoMode, Fuse.Navigation.RoutingOperation operation, string operationStyle, [bool userRequest]) :377
...
// private Fuse.Navigation.RouterPageRoute SetRouteImpl(Fuse.Visual root, Fuse.Navigation.RouterPage rootPage, Fuse.Navigation.RouterPageRoute r, Fuse.Navigation.NavigationGotoMode gotoMode, Fuse.Navigation.RoutingOperation operation, string operationStyle, Fuse.Navigation.IRouterOutlet& majorChange, [bool canReuse]) :408
...
// internal static Fuse.Navigation.Router TryFindRouter(Fuse.Node n) :696
...
// public Fuse.Navigation.BackButtonAction get_BackButtonAction() [instance] :168
int Router::BackButtonAction()
{
    return _backButtonAction;
}

// public void set_BackButtonAction(Fuse.Navigation.BackButtonAction value) [instance] :169
void Router::BackButtonAction(int value)
{
    _backButtonAction = value;
}

// public void CancelNavigation() [instance] :362
void Router::CancelNavigation()
{
    uStackFrame __("Fuse.Navigation.Router", "CancelNavigation()");
    ...
    if (_prepareOutlet != NULL)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(uString::Const("No active navigation that can be cancelled"), NULL, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.uno"), 373, uString::Const("CancelNavigation"));
}

// public bool get_CanGoBack() [instance] :268
...
// private void ClearPrepared() [instance] :330
...
// private bool EnumerateHistory(Fuse.Navigation.Router.HistoryAction action, Uno.Collections.List<Fuse.Navigation.RouterPage> stack, Fuse.Navigation.RouterPage rp) [instance] :775
bool Router::EnumerateHistory(uDelegate* action, ::g::Uno::Collections::List* stack, ::g::Fuse::Navigation::RouterPage* rp)
{
    uStackFrame __("Fuse.Navigation.Router", "EnumerateHistory(Fuse.Navigation.Router.HistoryAction,Uno.Collections.List<Fuse.Navigation.RouterPage>,Fuse.Navigation.RouterPage)");
    bool ret4;
...
// private Fuse.Navigation.IRouterOutlet FindOutletDown(Fuse.Node active) [instance] :592
uObject* Router::FindOutletDown(::g::Fuse::Node* active)
{
    ...
    ::g::Fuse::Visual* v = uAs< ::g::Fuse::Visual*>(active, ::TYPES[14/*Fuse.Visual*/]);
    ...
    if (v != NULL)
    {
        ...
        for (::g::Fuse::Node* ue = (::g::Fuse::Node*)uPtr(v)->FirstChild(::TYPES[22/*Fuse.Visual.FirstChild<Fuse.Node>*/]); ue != NULL; ue = (::g::Fuse::Node*)uPtr(ue)->NextSibling(::TYPES[23/*Fuse.Node.NextSibling<Fuse.Node>*/]))
        {
...
// private Fuse.Navigation.IRouterOutlet FindOutletUp(Fuse.Node active) [instance] :621
...
// private Fuse.Navigation.IRouterOutlet FindOutletUp(Fuse.Node active, Fuse.Node& page) [instance] :627
uObject* Router::FindOutletUp1(::g::Fuse::Node* active, ::g::Fuse::Node** page)
{
    uStackFrame __("Fuse.Navigation.Router", "FindOutletUp(Fuse.Node,Fuse.Node&)");
    *page = active;
...
// private void FinishPrepared() [instance] :321
...
// private Fuse.Navigation.RouterPageRoute GetCurrent(Fuse.Visual from, [Fuse.Navigation.IRouterOutlet to]) [instance] :514
...
// public Fuse.Navigation.Route GetCurrentRoute() [instance] :172
...
// private Fuse.Navigation.RouterPageRoute GetCurrentRouterPageRoute() [instance] :177
::g::Fuse::Navigation::RouterPageRoute* Router::GetCurrentRouterPageRoute()
{
    uStackFrame __("Fuse.Navigation.Router", "GetCurrentRouterPageRoute()");
    return GetHistoryRoute(0);
}

// internal Fuse.Navigation.RouterPageRoute GetHistoryRoute(int at) [instance] :723
::g::Fuse::Navigation::RouterPageRoute* Router::GetHistoryRoute(int at)
{
    uStackFrame __("Fuse.Navigation.Router", "GetHistoryRoute(int)");
...
// private int GetOutletDepth(Fuse.Navigation.IRouterOutlet outlet) [instance] :577
int Router::GetOutletDepth(uObject* outlet)
{
    ...
    int c = 0;
    ::g::Fuse::Visual* n = uPtr(uAs< ::g::Fuse::Node*>(outlet, ::TYPES[42/*Fuse.Node*/]))->Parent();
...
// internal Fuse.Navigation.RouterPageRoute GetRelativeRoute(Fuse.Node from, Fuse.Navigation.RouterPageRoute rel) [instance] :651
::g::Fuse::Navigation::RouterPageRoute* Router::GetRelativeRoute1(::g::Fuse::Node* from, ::g::Fuse::Navigation::RouterPageRoute* rel)
{
    uStackFrame __("Fuse.Navigation.Router", "GetRelativeRoute(Fuse.Node,Fuse.Navigation.RouterPageRoute)");

    if (!IsRootingCompleted() || !uPtr(from)->IsRootingCompleted())
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Cannot calculate relative node if not rooted"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.uno"), 655, uString::Const("GetRelativeRoute"), NULL);
        return NULL;
    }
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Did not find an outlet relative to the provided Node"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.uno"), 662, uString::Const("GetRelativeRoute"), NULL);
        return NULL;
    }

    ::g::Fuse::Navigation::RouterPageRoute* current = GetRouteUpToRouter(uPtr(uAs< ::g::Fuse::Node*>(outlet, ::TYPES[42/*Fuse.Node*/]))->Parent());
    ::g::Fuse::Navigation::RouterPageRoute* route = (current == NULL) ? rel : (::g::Fuse::Navigation::RouterPageRoute*)uPtr(current)->Append(rel);
    return route;
}

// private Fuse.Navigation.RouterPageRoute GetRouteUpToRouter(Fuse.Node from) [instance] :528
::g::Fuse::Navigation::RouterPageRoute* Router::GetRouteUpToRouter(::g::Fuse::Node* from)
{
    uStackFrame __("Fuse.Navigation.Router", "GetRouteUpToRouter(Fuse.Node)");
    ...
    while (from != NULL)
    {
        ...
        ::g::Fuse::Visual* v = uAs< ::g::Fuse::Visual*>(page, ::TYPES[14/*Fuse.Visual*/]);
        ...
        from = uPtr(uAs< ::g::Fuse::Node*>(outlet, ::TYPES[42/*Fuse.Node*/]))->Parent();
    }

    return route;
}

// public void GoBack() [instance] :260
void Router::GoBack()
{
...
// public void Goto(Fuse.Navigation.Route route, [string operationStyle]) [instance] :183
void Router::Goto(::g::Fuse::Navigation::Route* route, uString* operationStyle)
{
    uStackFrame __("Fuse.Navigation.Router", "Goto(Fuse.Navigation.Route,[string])");
    Modify1(1, ::g::Fuse::Navigation::RouterPageRoute::Convert(route), 0, operationStyle);
}

// private void GoUp() [instance] :275
void Router::GoUp()
{
...
// private bool HasOtherRouter(Fuse.Visual n) [instance] :672
bool Router::HasOtherRouter(::g::Fuse::Visual* n)
{
    uStackFrame __("Fuse.Navigation.Router", "HasOtherRouter(Fuse.Visual)");
    Router* r = (Router*)uPtr(n)->FirstChild(::TYPES[14/*Fuse.Visual*/]->MakeMethod(2/*FirstChild<Fuse.Navigation.Router>*/, __type, NULL));
    return (r != NULL) && (r != this);
}

// public generated void add_HistoryChanged(Fuse.Navigation.HistoryChangedHandler value) [instance] :689
void Router::add_HistoryChanged(uDelegate* value)
{
    ...
    HistoryChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(HistoryChanged1, value), ::TYPES[54/*Fuse.Navigation.HistoryChangedHandler*/]);
}

// public generated void remove_HistoryChanged(Fuse.Navigation.HistoryChangedHandler value) [instance] :689
void Router::remove_HistoryChanged(uDelegate* value)
{
    ...
    HistoryChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(HistoryChanged1, value), ::TYPES[54/*Fuse.Navigation.HistoryChangedHandler*/]);
}

// public bool get_IsMasterRouter() [instance] :149
bool Router::IsMasterRouter()
{
    return _isMasterRouter;
}

// public void set_IsMasterRouter(bool value) [instance] :150
void Router::IsMasterRouter(bool value)
{
    _isMasterRouter = value;
}

// internal void Modify(Fuse.Navigation.ModifyRouteHow how, Fuse.Navigation.RouterPageRoute route, Fuse.Navigation.NavigationGotoMode mode, string operationStyle) [instance] :200
void Router::Modify1(int how, ::g::Fuse::Navigation::RouterPageRoute* route, int mode, uString* operationStyle)
{
    uStackFrame __("Fuse.Navigation.Router", "Modify(Fuse.Navigation.ModifyRouteHow,Fuse.Navigation.RouterPageRoute,Fuse.Navigation.NavigationGotoMode,string)");
    ...
    switch (how)
    {
        ...
        {
            if (route != NULL)
                ::g::Fuse::Diagnostics::UserWarning(uString::Const("PrepareBack does not support an explicit route"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.uno"), 223, uString::Const("Modify"));

            ::g::Fuse::Navigation::RouterPageRoute* popRoute = GetHistoryRoute(1);

            if (popRoute == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(uString::Const("There is no history for PrepareBack"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.uno"), 228, uString::Const("Modify"), NULL);
                return;
            }
...
// internal void OnHistoryChanged() [instance] :690
void Router::OnHistoryChanged()
{
    uStackFrame __("Fuse.Navigation.Router", "OnHistoryChanged()");

    if (::g::Uno::Delegate::op_Inequality(HistoryChanged1, NULL))
        uPtr(HistoryChanged1)->InvokeVoid(this);
}

// private void OnKeyPressed(object sender, Fuse.Input.KeyEventArgs args) [instance] :153
...
// private void OnUpFromRoot() [instance] :289
void Router::OnUpFromRoot()
{
}

// private void Pop() [instance] :295
void Router::Pop()
{
    ...
    if (route == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Cannot pop() - history is empty"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.uno"), 300, uString::Const("Pop"), NULL);
        return;
    }
...
// public double get_PrepareProgress() [instance] :339
double Router::PrepareProgress()
{
    return _prepareProgress;
}

// public void set_PrepareProgress(double value) [instance] :340
...
// private void PrepareRoute(Fuse.Navigation.RouterPageRoute r, Fuse.Navigation.RoutingOperation operation, string operationStyle) [instance] :311
void Router::PrepareRoute(::g::Fuse::Navigation::RouterPageRoute* r, int operation, uString* operationStyle)
{
    uStackFrame __("Fuse.Navigation.Router", "PrepareRoute(Fuse.Navigation.RouterPageRoute,Fuse.Navigation.RoutingOperation,string)");
...
// public void Push(Fuse.Navigation.Route route, [string operationStyle]) [instance] :189
void Router::Push(::g::Fuse::Navigation::Route* route, uString* operationStyle)
{
    uStackFrame __("Fuse.Navigation.Router", "Push(Fuse.Navigation.Route,[string])");
    Modify1(0, ::g::Fuse::Navigation::RouterPageRoute::Convert(route), 0, operationStyle);
}

// internal Fuse.Navigation.RouterPage get_RootPage() [instance] :719
::g::Fuse::Navigation::RouterPage* Router::RootPage()
{
    return _rootPage;
}

// private void SetPrepareProgress(double value) [instance] :343
void Router::SetPrepareProgress(double value)
{
    ...
    if ((pc == NULL) || (pn == NULL))
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Invalid outlet depth in prepare progress"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.uno"), 354, uString::Const("SetPrepareProgress"));
        return;
    }
...
// private Fuse.Navigation.RouterPageRoute SetRoute(Fuse.Navigation.RouterPageRoute r, Fuse.Navigation.NavigationGotoMode gotoMode, Fuse.Navigation.RoutingOperation operation, string operationStyle, [bool userRequest]) [instance] :377
::g::Fuse::Navigation::RouterPageRoute* Router::SetRoute(::g::Fuse::Navigation::RouterPageRoute* r, int gotoMode, int operation, uString* operationStyle, bool userRequest)
{
    uStackFrame __("Fuse.Navigation.Router", "SetRoute(Fuse.Navigation.RouterPageRoute,Fuse.Navigation.NavigationGotoMode,Fuse.Navigation.RoutingOperation,string,[bool])");
    ...
    if (outR == NULL)
    {
        ...
        if (userRequest)
            ::g::Fuse::Diagnostics::UserError(msg, this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.uno"), 394, uString::Const("SetRoute"), NULL);
        else
            ::g::Fuse::Diagnostics::InternalError(msg, this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.uno"), 396, uString::Const("SetRoute"));
...
// private Fuse.Navigation.RouterPageRoute SetRouteImpl(Fuse.Visual root, Fuse.Navigation.RouterPage rootPage, Fuse.Navigation.RouterPageRoute r, Fuse.Navigation.NavigationGotoMode gotoMode, Fuse.Navigation.RoutingOperation operation, string operationStyle, Fuse.Navigation.IRouterOutlet& majorChange, [bool canReuse]) [instance] :408
::g::Fuse::Navigation::RouterPageRoute* Router::SetRouteImpl(::g::Fuse::Visual* root, ::g::Fuse::Navigation::RouterPage* rootPage, ::g::Fuse::Navigation::RouterPageRoute* r, int gotoMode, int operation, uString* operationStyle, uObject** majorChange, bool canReuse)
{
    uStackFrame __("Fuse.Navigation.Router", "SetRouteImpl(Fuse.Visual,Fuse.Navigation.RouterPage,Fuse.Navigation.RouterPageRoute,Fuse.Navigation.NavigationGotoMode,Fuse.Navigation.RoutingOperation,string,Fuse.Navigation.IRouterOutlet&,[bool])");
    ...
    *majorChange = NULL;
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(uString::Const("No router outlet found to handle route: "), r), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.uno"), 418, uString::Const("SetRouteImpl"));
        return NULL;
    }

    ::g::Fuse::Navigation::RouterPage* page = uPtr(r)->RouterPage;
    ::g::Fuse::Visual* pageVisual = NULL;
    int didTransition = ::g::Fuse::Navigation::IRouterOutlet::CompareCurrent(uInterface(uPtr(outlet), ::g::Fuse::Navigation::IRouterOutlet_typeof()), page, &pageVisual);

    if (didTransition == 3)
        return NULL;

    bool leafPush = (r->SubRoute == NULL) && (operation == 1);
    ...
    if (r->SubRoute != NULL)
    {
        if (pageVisual == NULL)
        {
            ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(uString::Const("SubRoute requested but outlet has no active path: "), r), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.uno"), 494, uString::Const("SetRouteImpl"));
            return NULL;
        }
...
// private static Fuse.Navigation.IRouterOutlet AsRouterOutlet(Fuse.Node n) [static] :614
uObject* Router::AsRouterOutlet(::g::Fuse::Node* n)
{
    uStackFrame __("Fuse.Navigation.Router", "AsRouterOutlet(Fuse.Node)");
    Router_typeof()->Init();
...
void Router::Bookmark(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`Router.bookmark` takes one argument"), r, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.ScriptClass.uno"), 246, uString::Const("Bookmark"), NULL);
        return;
    }
    ...
    if (obj == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`Router.bookmark` should be passed an object"), r, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.ScriptClass.uno"), 253, uString::Const("Bookmark"), NULL);
        return;
    }
    ...
    for (int i = 0; i < uPtr(keys)->Length(); ++i)
    {
        ...
        if (::g::Uno::String::op_Equality(p, ::STRINGS[17/*"name"*/]))
            name = (::g::Fuse::Marshal__ToType_fn(::TYPES[38/*Fuse.Marshal.ToType<string>*/], o, &ret3), ret3);
        else if (::g::Uno::String::op_Equality(p, uString::Const("relative")))
        {
            uObject* node = uPtr(c)->Wrap(o);
            relative = uPtr(r)->FindOutletUp(uAs< ::g::Fuse::Node*>(node, ::TYPES[42/*Fuse.Node*/]));

            if (relative == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(uString::Const("Could not find an outlet from the `relative` node"), r, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.ScriptClass.uno"), 278, uString::Const("Bookmark"), NULL);
                return;
            }
        }
        else if (::g::Uno::String::op_Equality(p, uString::Const("path")))
        {
            ...
            if (path == NULL)
            {
                ::g::Fuse::Diagnostics::UserError(uString::Const("`path` should be an array"), r, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.ScriptClass.uno"), 287, uString::Const("Bookmark"), NULL);
                return;
            }
        ...
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(uString::Const("Unrecognized argument: "), p), r, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.ScriptClass.uno"), 295, uString::Const("Bookmark"), NULL);
            return;
        }
    }
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("A `name` is required for the bookmark"), r, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.ScriptClass.uno"), 308, uString::Const("Bookmark"), NULL);
        return;
    }
...
// internal static Fuse.Visual FindRouterOutletPage(Fuse.Node from) [static] :556
::g::Fuse::Visual* Router::FindRouterOutletPage(::g::Fuse::Node* from)
{
    uStackFrame __("Fuse.Navigation.Router", "FindRouterOutletPage(Fuse.Node)");
    Router_typeof()->Init();
    ...
    while ((from != NULL) && (uPtr(from)->Parent() != NULL))
    {
        ...
        if (ro != NULL)
        {
            ::g::Fuse::Visual* v = uAs< ::g::Fuse::Visual*>(from, ::TYPES[14/*Fuse.Visual*/]);

            if (v != NULL)
                return v;

            ::g::Fuse::Diagnostics::InternalError(uString::Const("Unexpected request for RouterOutlet page"), from, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.uno"), 568, uString::Const("FindRouterOutletPage"));
        }
...
// private static Fuse.Navigation.RouterPageRoute GetRelative(Fuse.Scripting.Context c, Fuse.Navigation.Router r, object[] args) [static] :92
::g::Fuse::Navigation::RouterPageRoute* Router::GetRelative(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() < 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Router.gotoRelative(): requires 1+ parameters"), r, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.ScriptClass.uno"), 96, uString::Const("GetRelative"), NULL);
        return NULL;
    }

    ::g::Fuse::Node* node = uAs< ::g::Fuse::Node*>(uPtr(c)->Wrap(uPtr(args)->Strong<uObject*>(0)), ::TYPES[42/*Fuse.Node*/]);
...
void Router::GetRoute(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Router.getRoute(): must provide exactly 1 argument."), r, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.ScriptClass.uno"), 335, uString::Const("GetRoute"), NULL);
        return;
    }
    ...
    if (callback == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Router.getRoute(): argument must be a function."), r, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.ScriptClass.uno"), 341, uString::Const("GetRoute"), NULL);
        return;
    }

    ::g::Fuse::Navigation::Route* route = uPtr(r)->GetCurrentRoute();
    uPtr(c)->Invoke(uDelegate::New(::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Scripting::Context_typeof(), NULL), (void*)Router__GetRouteCallback__Run_fn, Router__GetRouteCallback::New1(route, callback, c)));
}
...
void Router::GoBack1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Router.goBack takes no parameters"), r, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.ScriptClass.uno"), 141, uString::Const("GoBack"), NULL);
        return;
    }
...
void Router::Goto1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (where != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(uString::Const("Router.goto(): invalid route provided"), r, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.ScriptClass.uno"), 45, uString::Const("Goto"), NULL);
}
...
void Router::GotoRelative(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    Router_typeof()->Init();
    ::g::Fuse::Navigation::RouterPageRoute* route = Router::GetRelative(c, r, args);

    if (route != NULL)
        uPtr(r)->Modify1(1, route, 0, ::STRINGS[18/*""*/]);
}

// private static bool HasRouter(Fuse.Node n) [static] :678
bool Router::HasRouter(::g::Fuse::Node* n)
{
    uStackFrame __("Fuse.Navigation.Router", "HasRouter(Fuse.Node)");
    Router_typeof()->Init();
    ::g::Fuse::Visual* v = uAs< ::g::Fuse::Visual*>(n, ::TYPES[14/*Fuse.Visual*/]);
    ...
    return ((Router*)uPtr(v)->FirstChild(::TYPES[14/*Fuse.Visual*/]->MakeMethod(2/*FirstChild<Fuse.Navigation.Router>*/, Router_typeof(), NULL))) != NULL;
}

// private static void Modify(Fuse.Scripting.Context c, Fuse.Navigation.Router r, object[] args) [static] :178
void Router::Modify2(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (uPtr(args)->Length() != 1)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`Router.modify` takes one argument"), r, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.ScriptClass.uno"), 184, uString::Const("Modify"), NULL);
        return;
    }
    ...
    if (obj == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("`Router.modify` should be passed an object"), r, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\Router.ScriptClass.uno"), 191, uString::Const("Modify"), NULL);
        return;
    }
...
// internal static Fuse.Navigation.Router TryFindRouter(Fuse.Node n) [static] :696
Router* Router::TryFindRouter(::g::Fuse::Node* n)
{
    ...
    while (p != NULL)
    {
        ::g::Fuse::Visual* v = uAs< ::g::Fuse::Visual*>(p, ::TYPES[14/*Fuse.Visual*/]);

        if (v != NULL)
        {
            Router* r = (Router*)uPtr(v)->FirstChild(::TYPES[14/*Fuse.Visual*/]->MakeMethod(2/*FirstChild<Fuse.Navigation.Router>*/, Router_typeof(), NULL));
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\RouterCancelNavigation.uno
// --------------------------------------------------------------------------------------------------
...
{
    ::STRINGS[37] = uString::Const("Router not set and none could be found");
    ::STRINGS[38] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\RouterCancelNavigation.uno");
    ::STRINGS[2] = uString::Const("Perform");
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(9,
    ...
    type->Reflection.SetFunctions(3,
        new uFunction(".ctor", NULL, (void*)RouterCancelNavigation__New2_fn, 0, true, type, 0),
        new uFunction("get_Router", NULL, (void*)RouterCancelNavigation__get_Router_fn, 0, false, ::g::Fuse::Navigation::Router_typeof(), 0),
        new uFunction("set_Router", NULL, (void*)RouterCancelNavigation__set_Router_fn, 0, false, uVoid_typeof(), 1, ::g::Fuse::Navigation::Router_typeof()));
}
...
{
    uStackFrame __("Fuse.Navigation.RouterCancelNavigation", "Perform(Fuse.Node)");
    ...
    if (useRouter == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[37/*"Router not ...*/], __this, ::STRINGS[38/*"C:\\Users\\...*/], 20, ::STRINGS[2/*"Perform"*/], NULL);
        return;
    }
...
static void RouterModify_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(15,
        ...
        new uFunction("get_Path", NULL, (void*)RouterModify__get_Path_fn, 0, false, ::g::Fuse::Reactive::IExpression_typeof(), 0),
        new uFunction("set_Path", NULL, (void*)RouterModify__set_Path_fn, 0, false, uVoid_typeof(), 1, ::g::Fuse::Reactive::IExpression_typeof()),
        new uFunction("get_Relative", NULL, (void*)RouterModify__get_Relative_fn, 0, false, ::g::Fuse::Node_typeof(), 0),
        new uFunction("set_Relative", NULL, (void*)RouterModify__set_Relative_fn, 0, false, uVoid_typeof(), 1, ::g::Fuse::Node_typeof()),
        ...
        new uFunction("get_Style", NULL, (void*)RouterModify__get_Style_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_Style", NULL, (void*)RouterModify__set_Style_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()),
...
{
    uStackFrame __("Fuse.Navigation.RouterModify", "Fuse.Reactive.IListener.OnNewData(Fuse.Reactive.IExpression,object)");
    ...
    {
        {
            ...
            __this->PerformRoute(::g::Fuse::Reactive::IContext::Node(uInterface(uPtr(uAs<uObject*>(__this->_pathSub, ::TYPES[17/*Fuse.Reactive.IContext*/])), ::TYPES[17/*Fuse.Reactive.IContext*/])), route);
        }
        {
            __this->DisposePathSub();
        }
...
{
    uStackFrame __("Fuse.Navigation.RouterModify", "OnUnrooted()");
    __this->DisposePathSub();
...
// private void PerformRoute(Fuse.Node n, Fuse.Navigation.RouterPageRoute route) :204
...
// public string get_Style() :133
void RouterModify__get_Style_fn(RouterModify* __this, uString** __retval)
{
    *__retval = __this->Style();
}

// public void set_Style(string value) :134
void RouterModify__set_Style_fn(RouterModify* __this, uString* value)
{
    __this->Style(value);
}

// public Fuse.Navigation.NavigationGotoMode get_Transition() :126
void RouterModify__get_Transition_fn(RouterModify* __this, int* __retval)
{
    *__retval = __this->Transition();
}

// public void set_Transition(Fuse.Navigation.NavigationGotoMode value) :127
void RouterModify__set_Transition_fn(RouterModify* __this, int* value)
{
    __this->Transition(*value);
}

// public RouterModify() [instance] :92
void RouterModify::ctor_2()
{
    _request = ::g::Fuse::Navigation::RouterRequest::New1(0);
    ctor_1();
    ::g::Fuse::Diagnostics::UserWarning(uString::Const("RouterModify is deprecated. Use one of `ModifyRoute`, `GotoRoute` or `PushRoute` instead."), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\RouterModify.uno"), 94, ::STRINGS[32/*".ctor"*/]);
}
...
// public string get_Bookmark() [instance] :119
uString* RouterModify::Bookmark()
{
    uStackFrame __("Fuse.Navigation.RouterModify", "get_Bookmark()");
    return uPtr(_request)->Bookmark;
}

// public void set_Bookmark(string value) [instance] :120
void RouterModify::Bookmark(uString* value)
{
    uStackFrame __("Fuse.Navigation.RouterModify", "set_Bookmark(string)");
    uPtr(_request)->Bookmark = value;
}

// private void DisposePathSub() [instance] :176
void RouterModify::DisposePathSub()
{
    uStackFrame __("Fuse.Navigation.RouterModify", "DisposePathSub()");
...
{
    uStackFrame __("Fuse.Navigation.RouterModify", "get_How()");
...
{
    uStackFrame __("Fuse.Navigation.RouterModify", "set_How(Fuse.Navigation.ModifyRouteHow)");
...
// private void PerformRoute(Fuse.Node n, Fuse.Navigation.RouterPageRoute route) [instance] :204
void RouterModify::PerformRoute(::g::Fuse::Node* n, ::g::Fuse::Navigation::RouterPageRoute* route)
{
    uStackFrame __("Fuse.Navigation.RouterModify", "PerformRoute(Fuse.Node,Fuse.Navigation.RouterPageRoute)");
    ::g::Fuse::Navigation::Router* ind1;
    ...
    if (useRouter == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[37/*"Router not ...*/], this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\RouterModify.uno"), 211, uString::Const("PerformRoute"), NULL);
        return;
    }
...
// public Fuse.Node get_Relative() [instance] :139
::g::Fuse::Node* RouterModify::Relative()
{
    uStackFrame __("Fuse.Navigation.RouterModify", "get_Relative()");
    return uPtr(_request)->Relative;
}

// public void set_Relative(Fuse.Node value) [instance] :140
void RouterModify::Relative(::g::Fuse::Node* value)
{
    uStackFrame __("Fuse.Navigation.RouterModify", "set_Relative(Fuse.Node)");
    uPtr(_request)->Relative = value;
}
...
// public string get_Style() [instance] :133
uString* RouterModify::Style()
{
    uStackFrame __("Fuse.Navigation.RouterModify", "get_Style()");
    return uPtr(_request)->Style;
}

// public void set_Style(string value) [instance] :134
void RouterModify::Style(uString* value)
{
    uStackFrame __("Fuse.Navigation.RouterModify", "set_Style(string)");
    uPtr(_request)->Style = value;
}

// public Fuse.Navigation.NavigationGotoMode get_Transition() [instance] :126
int RouterModify::Transition()
{
    uStackFrame __("Fuse.Navigation.RouterModify", "get_Transition()");
    return uPtr(_request)->Transition;
}

// public void set_Transition(Fuse.Navigation.NavigationGotoMode value) [instance] :127
void RouterModify::Transition(int value)
{
    uStackFrame __("Fuse.Navigation.RouterModify", "set_Transition(Fuse.Navigation.NavigationGotoMode)");
    uPtr(_request)->Transition = value;
}

// public RouterModify New() [static] :92
...
static void RouterPage_build(uType* type)
{
    ...
    ::STRINGS[43] = uString::Const("no-ctx");
    ::STRINGS[44] = uString::Const("@");
    ::TYPES[40] = ::g::Fuse::Node_typeof()->MakeMethod(0/*FindBehavior<Fuse.Navigation.Router>*/, ::g::Fuse::Navigation::Router_typeof(), NULL);
    ::TYPES[41] = ::g::Fuse::Navigation::PagesMap_typeof();
    type->SetFields(0,
        ::g::Uno::String_typeof(), offsetof(RouterPage, Parameter), 0,
        uObject_typeof(), offsetof(RouterPage, Context), 0,
        ::TYPES[41/*Fuse.Navigation.PagesMap*/], offsetof(RouterPage, _childRouterPages), 0,
...
{
    uStackFrame __("Fuse.Navigation.RouterPage", "ToString()");
    return *__retval = ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(__this->Path(), ::STRINGS[39/*"?"*/]), __this->Parameter), ::STRINGS[42/*" "*/]), (__this->Context == NULL) ? ::STRINGS[43/*"no-ctx"*/] : (uString*)::g::Uno::String::op_Addition1(::STRINGS[44/*"@"*/], uBox<int>(::g::Uno::Int_typeof(), ::g::Uno::Object::GetHashCode(uPtr(__this->Context))))), void();
}
...
{
    uStackFrame __("Fuse.Navigation.RouterPage", "add_ChildRouterPagesUpdated(Fuse.Navigation.ChildRouterPagesUpdated)");
    uPtr(uCast< ::g::Fuse::Navigation::PagesMap*>(ChildRouterPages(), ::TYPES[41/*Fuse.Navigation.PagesMap*/]))->add_Updated(value);
}
...
{
    uStackFrame __("Fuse.Navigation.RouterPage", "remove_ChildRouterPagesUpdated(Fuse.Navigation.ChildRouterPagesUpdated)");
    uPtr(uCast< ::g::Fuse::Navigation::PagesMap*>(ChildRouterPages(), ::TYPES[41/*Fuse.Navigation.PagesMap*/]))->remove_Updated(value);
}

// public void DefaultPath(string defaultPath) [instance] :45
void RouterPage::DefaultPath(uString* defaultPath)
{
    uStackFrame __("Fuse.Navigation.RouterPage", "DefaultPath(string)");
...
{
    uStackFrame __("Fuse.Navigation.RouterPage", "ToPathString()");
    uString* ind1;
    ind1 = Path();
    uString* q = (ind1 != NULL) ? ind1 : ::STRINGS[18/*""*/];

    if (::g::Uno::String::op_Inequality(Parameter, NULL))
        q = ::g::Uno::String::op_Addition2(q, ::g::Uno::String::op_Addition2(::STRINGS[39/*"?"*/], Parameter));

    if (Context != NULL)
        q = ::g::Uno::String::op_Addition2(q, ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[40/*"<"*/], uBox<int>(::g::Uno::Int_typeof(), ::g::Uno::Object::GetHashCode(uPtr(Context)))), ::STRINGS[41/*">"*/]));
...
{
    uStackFrame __("Fuse.Navigation.RouterPage", "BubbleHistoryChanged(Fuse.Node)");
    ::g::Fuse::Navigation::Router* router = (::g::Fuse::Navigation::Router*)uPtr(at)->FindBehavior(::TYPES[40/*Fuse.Node.FindBehavior<Fuse.Navigation.Router>*/]);
...
static void RouterPageRoute_build(uType* type)
{
    ...
    ::STRINGS[46] = uString::Const("count can't be < 0");
    ::STRINGS[47] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\RouterPage.uno");
    ::STRINGS[48] = uString::Const("SubDepth");
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    type->SetFields(0,
...
// public RouterPageRoute(Fuse.Navigation.RouterPage routerPage, Fuse.Navigation.RouterPageRoute sub) :135
...
// public Fuse.Navigation.RouterPageRoute Append(Fuse.Navigation.RouterPageRoute subRoute) :209
void RouterPageRoute__Append_fn(RouterPageRoute* __this, RouterPageRoute* subRoute, RouterPageRoute** __retval)
{
    *__retval = __this->Append(subRoute);
}

// internal static Fuse.Navigation.RouterPageRoute Convert(Fuse.Navigation.Route r) :141
void RouterPageRoute__Convert_fn(::g::Fuse::Navigation::Route* r, RouterPageRoute** __retval)
{
    *__retval = RouterPageRoute::Convert(r);
}

// internal string Format() :184
void RouterPageRoute__Format_fn(RouterPageRoute* __this, uString** __retval)
{
    *__retval = __this->Format();
}

// public RouterPageRoute New(Fuse.Navigation.RouterPage routerPage, Fuse.Navigation.RouterPageRoute sub) :135
...
// internal Fuse.Navigation.RouterPageRoute SubDepth(int count) :192
...
// public Fuse.Navigation.Route ToRoute() :169
void RouterPageRoute__ToRoute_fn(RouterPageRoute* __this, ::g::Fuse::Navigation::Route** __retval)
{
    *__retval = __this->ToRoute();
}

// internal Fuse.Navigation.RouterPageRoute Up() :177
void RouterPageRoute__Up_fn(RouterPageRoute* __this, RouterPageRoute** __retval)
{
    *__retval = __this->Up();
}

// public RouterPageRoute(Fuse.Navigation.RouterPage routerPage, Fuse.Navigation.RouterPageRoute sub) [instance] :135
...
// public Fuse.Navigation.RouterPageRoute Append(Fuse.Navigation.RouterPageRoute subRoute) [instance] :209
RouterPageRoute* RouterPageRoute::Append(RouterPageRoute* subRoute)
{
    uStackFrame __("Fuse.Navigation.RouterPageRoute", "Append(Fuse.Navigation.RouterPageRoute)");
...
// internal string Format() [instance] :184
uString* RouterPageRoute::Format()
{
    uStackFrame __("Fuse.Navigation.RouterPageRoute", "Format()");
    uString* q = uPtr(RouterPage)->ToPathString();

    if (SubRoute != NULL)
        q = ::g::Uno::String::op_Addition2(q, ::g::Uno::String::op_Addition2(::STRINGS[45/*"/"*/], uPtr(SubRoute)->Format()));

    return q;
}

// internal Fuse.Navigation.RouterPageRoute SubDepth(int count) [instance] :192
RouterPageRoute* RouterPageRoute::SubDepth(int count)
{
    uStackFrame __("Fuse.Navigation.RouterPageRoute", "SubDepth(int)");

    if (count < 0)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[46/*"count can't...*/], this, ::STRINGS[47/*"C:\\Users\\...*/], 196, ::STRINGS[48/*"SubDepth"*/]);
        return NULL;
    }
...
// public Fuse.Navigation.Route ToRoute() [instance] :169
::g::Fuse::Navigation::Route* RouterPageRoute::ToRoute()
{
    uStackFrame __("Fuse.Navigation.RouterPageRoute", "ToRoute()");
...
// internal Fuse.Navigation.RouterPageRoute Up() [instance] :177
RouterPageRoute* RouterPageRoute::Up()
{
    uStackFrame __("Fuse.Navigation.RouterPageRoute", "Up()");
...
// internal static Fuse.Navigation.RouterPageRoute Convert(Fuse.Navigation.Route r) [static] :141
RouterPageRoute* RouterPageRoute::Convert(::g::Fuse::Navigation::Route* r)
{
    uStackFrame __("Fuse.Navigation.RouterPageRoute", "Convert(Fuse.Navigation.Route)");
    RouterPageRoute* cur = NULL;
    RouterPageRoute* bas = NULL;

    while (r != NULL)
    {
        ::g::Fuse::Navigation::RouterPage* nxtrp = uPtr(r)->RouterPage;

        if (nxtrp == NULL)
            nxtrp = ::g::Fuse::Navigation::RouterPage::New1(uPtr(r)->Path, uPtr(r)->Parameter, NULL);

        RouterPageRoute* nxt = RouterPageRoute::New1(nxtrp, NULL);
...
// public RouterPageRoute New(Fuse.Navigation.RouterPage routerPage, Fuse.Navigation.RouterPageRoute sub) [static] :135
...
// public static Fuse.Navigation.RouterPageRoute ParseFlatRoute(Fuse.IArray path) :134
...
// public static Fuse.Navigation.RouterPageRoute ParseFlatRoute(object[] args, [int pos]) :143
...
// protected virtual Fuse.Node ParseNode(object value) :244
void RouterRequest__ParseNode_fn(RouterRequest* __this, uObject* value, ::g::Fuse::Node** __retval)
{
    return *__retval = uAs< ::g::Fuse::Node*>(value, ::TYPES[42/*Fuse.Node*/]), void();
}

// private static bool ParseNVPComponent(object value, Fuse.Navigation.RouterPageRoute& route) :180
...
// public static bool ParseNVPRoute(object value, Fuse.Navigation.RouterPageRoute& route) :159
...
// private static bool ValidateParameter(object arg, [int depth]) :201
...
{
    uStackFrame __("Fuse.Navigation.RouterRequest", "AddArgument(string,object)");
    int ret2;
    int ret3;
    uString* ret4;
    uString* ret5;
    ...
    if (::g::Uno::String::op_Equality(name, uString::Const("relative")))
        ...
        Bookmark = (::g::Fuse::Marshal__ToType_fn(::TYPES[38/*Fuse.Marshal.ToType<string>*/], value, &ret4), ret4);
    else if (::g::Uno::String::op_Equality(name, uString::Const("style")))
        Style = (::g::Fuse::Marshal__ToType_fn(::TYPES[38/*Fuse.Marshal.ToType<string>*/], value, &ret5), ret5);
    else
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(uString::Const("Unrecognized argument: "), name), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\RouterRequest.uno"), 101, uString::Const("AddArgument"), NULL);
        return false;
    }
...
{
    uStackFrame __("Fuse.Navigation.RouterRequest", "AddPath(object)");
    ...
    if ((_flags & 1) == 1)
    {
        ...
        if (path == NULL)
        {
            ::g::Fuse::Diagnostics::UserError(uString::Const("`path` should be an array"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\RouterRequest.uno"), 59, uString::Const("AddPath"), NULL);
            return false;
        }
...
{
    uStackFrame __("Fuse.Navigation.RouterRequest", "MakeRequest(Fuse.Navigation.Router)");
    bool ret6;
    ...
    if (::g::Uno::String::op_Inequality(Bookmark, NULL))
    {
        if (targetRoute != NULL)
        {
            ::g::Fuse::Diagnostics::UserError(uString::Const("A path and bookmark cannot both be specified"), router, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\RouterRequest.uno"), 116, uString::Const("MakeRequest"), NULL);
            return false;
        }

        if (!(::g::Uno::Collections::Dictionary__TryGetValue_fn(uPtr(uPtr(router)->Bookmarks), Bookmark, (void**)(&targetRoute), &ret6), ret6))
        {
            ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(uString::Const("Unknown bookmark: "), Bookmark), router, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\RouterRequest.uno"), 122, uString::Const("MakeRequest"), NULL);
            return false;
        }
    }
...
// public static Fuse.Navigation.RouterPageRoute ParseFlatRoute(Fuse.IArray path) [static] :134
::g::Fuse::Navigation::RouterPageRoute* RouterRequest::ParseFlatRoute(uObject* path)
{
    uStackFrame __("Fuse.Navigation.RouterRequest", "ParseFlatRoute(Fuse.IArray)");
    uArray* cvt = uArray::New(::TYPES[15/*object[]*/], ::g::Fuse::IArray::Length(uInterface(uPtr(path), ::g::Fuse::IArray_typeof())));
...
// public static Fuse.Navigation.RouterPageRoute ParseFlatRoute(object[] args, [int pos]) [static] :143
::g::Fuse::Navigation::RouterPageRoute* RouterRequest::ParseFlatRoute1(uArray* args, int pos)
{
    uStackFrame __("Fuse.Navigation.RouterRequest", "ParseFlatRoute(object[],[int])");
...
// private static bool ParseNVPComponent(object value, Fuse.Navigation.RouterPageRoute& route) [static] :180
bool RouterRequest::ParseNVPComponent(uObject* value, ::g::Fuse::Navigation::RouterPageRoute** route)
{
    uStackFrame __("Fuse.Navigation.RouterRequest", "ParseNVPComponent(object,Fuse.Navigation.RouterPageRoute&)");
    ...
    ::g::Fuse::NameValuePair* nvp = uAs< ::g::Fuse::NameValuePair*>(value, ::TYPES[19/*Fuse.NameValuePair*/]);
    ...
    ::g::Fuse::Diagnostics::UserError(uString::Const("incompatible path component"), value, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\RouterRequest.uno"), 197, uString::Const("ParseNVPComponent"), NULL);
    return false;
}

// public static bool ParseNVPRoute(object value, Fuse.Navigation.RouterPageRoute& route) [static] :159
bool RouterRequest::ParseNVPRoute(uObject* value, ::g::Fuse::Navigation::RouterPageRoute** route)
{
    uStackFrame __("Fuse.Navigation.RouterRequest", "ParseNVPRoute(object,Fuse.Navigation.RouterPageRoute&)");
    *route = NULL;
...
// private static bool ValidateParameter(object arg, [int depth]) [static] :201
bool RouterRequest::ValidateParameter(uObject* arg, int depth)
{
    uStackFrame __("Fuse.Navigation.RouterRequest", "ValidateParameter(object,[int])");

    if (depth > 50)
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Route parameter must be serializeable, it contains reference loops or is too large"), NULL, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\RouterRequest.uno"), 205, uString::Const("ValidateParameter"), NULL);
        return false;
    }
    ...
    if (uIs(arg, ::g::Fuse::Scripting::Object_typeof()))
    {
        ...
        {
            ::g::Fuse::Diagnostics::UserError(uString::Const("Route parameter must be serializeable, cannot contain Observables."), NULL, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\RouterRequest.uno"), 214, uString::Const("ValidateParameter"), NULL);
            return false;
        }
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Route parameter must be serializeable, cannot contain functions."), NULL, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\RouterRequest.uno"), 237, uString::Const("ValidateParameter"), NULL);
        return false;
    }
...
{
    uStackFrame __("Fuse.Navigation.Router.ScriptRouterRequest", "ParseNode(object)");
    return *__retval = uAs< ::g::Fuse::Node*>(uPtr(__this->_context)->Wrap(value), ::TYPES[42/*Fuse.Node*/]), void();
}
...
StructuredNavigation_type* StructuredNavigation_typeof()
{
    ...
    type->interface9.fp_get_SeekRange = (void(*)(uObject*, ::g::Uno::Float2*))StructuredNavigation__get_SeekRange_fn;
    type->interface6.fp_GetPage = (void(*)(uObject*, int*, ::g::Fuse::Visual**))::g::Fuse::Navigation::VisualNavigation__GetPage_fn;
    ...
    type->interface6.fp_Toggle = (void(*)(uObject*, ::g::Fuse::Visual*))::g::Fuse::Navigation::VisualNavigation__Toggle_fn;
    type->interface6.fp_get_PageCount = (void(*)(uObject*, int*))::g::Fuse::Navigation::VisualNavigation__get_PageCount_fn;
    type->interface6.fp_get_PageProgress = (void(*)(uObject*, double*))StructuredNavigation__get_PageProgress_fn;
    type->interface6.fp_get_ActivePage = (void(*)(uObject*, ::g::Fuse::Visual**))::g::Fuse::Navigation::VisualNavigation__get_ActivePage_fn;
    type->interface6.fp_get_State = (void(*)(uObject*, int*))::g::Fuse::Navigation::VisualNavigation__get_State_fn;
    type->interface6.fp_add_PageCountChanged = (void(*)(uObject*, uDelegate*))::g::Fuse::Navigation::VisualNavigation__add_PageCountChanged_fn;
    type->interface6.fp_remove_PageCountChanged = (void(*)(uObject*, uDelegate*))::g::Fuse::Navigation::VisualNavigation__remove_PageCountChanged_fn;
...
// internal StructuredNavigation(Fuse.Navigation.StructuredNavigation.NavigationStructure mode) :25
...
// public void set_Easing(Fuse.Animations.Easing value) :298
...
void StructuredNavigation__FuseNavigationISeekableNavigationSeek_fn(StructuredNavigation* __this, ::g::Fuse::Navigation::UpdateSeekArgs* args)
{
    ...
    if (__this->_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Seek being called on an unrooted navigation"), __this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\StructuredNavigation.uno"), 408, uString::Const("Fuse.Navigation.ISeekableNavigation.Seek"));
        return;
    }
...
void StructuredNavigation__OnRooted_fn(StructuredNavigation* __this)
{
    ...
    if ((__this->_active != NULL) && !(::g::Uno::Collections::ICollection::Contains_ex(uInterface(uPtr(uPtr(__this->Parent())->Children()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[42/*Fuse.Node*/], NULL)), __this->_active, &ret7), ret7))
        __this->SetActive(NULL);
...
// public override sealed double get_PageProgress() :87
...
// public float2 get_SeekRange() :401
...
// internal StructuredNavigation(Fuse.Navigation.StructuredNavigation.NavigationStructure mode) [instance] :25
...
void StructuredNavigation::ClearForwardHistory()
{
    ...
    if (HasPages() && (_active != Front()))
    {
        ...
        for (int i = target - 1; i >= 0; i--)
            ::g::Uno::Collections::ICollection::Remove_ex(uInterface(uPtr(uPtr(Parent())->Children()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[42/*Fuse.Node*/], NULL)), GetPage(i), &ret3);
    }

    OnHistoryChanged();
}

// public double get_Duration() [instance] :306
...
// public void set_Duration(double value) [instance] :307
void StructuredNavigation::Duration(double value)
{
    ...
    ::g::Fuse::Diagnostics::Deprecated(uString::Const("Use a `NavigationMotion` and the `GotoDuration` property instead of `Navigation.Duration`"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\StructuredNavigation.uno"), 310, uString::Const("set_Duration"));
}

// public Fuse.Animations.Easing get_Easing() [instance] :297
...
// public void set_Easing(Fuse.Animations.Easing value) [instance] :298
void StructuredNavigation::Easing(::g::Fuse::Animations::Easing* value)
{
    ...
    ::g::Fuse::Diagnostics::Deprecated(uString::Const("Use a `NavigationMotion` and the `GotoEasing` property instead of `Navigation.Easing`"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\StructuredNavigation.uno"), 301, uString::Const("set_Easing"));
}
...
void StructuredNavigation::GotoImpl(::g::Fuse::Visual* element, int mode)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(uString::Const("Attempting to navigate to element with different parent"), element, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\StructuredNavigation.uno"), 117, uString::Const("GotoImpl"), NULL);
        SetActive(NULL);
        return;
    }

    if (!(::g::Uno::Collections::ICollection::Contains_ex(uInterface(uPtr(uPtr(Parent())->Children()), ::g::Uno::Collections::ICollection_typeof()->MakeType(::TYPES[42/*Fuse.Node*/], NULL)), element, &ret6), ret6))
    {
        if (Mode() == 1)
        {
            ClearForwardHistory();
            ::g::Uno::Collections::IList::Insert_ex(uInterface(uPtr(uPtr(Parent())->Children()), ::g::Uno::Collections::IList_typeof()->MakeType(::TYPES[42/*Fuse.Node*/], NULL)), uCRef<int>(0), element);
        }
        else
            return;
    }
...
void StructuredNavigation::Motion(::g::Fuse::Motion::MotionConfig* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(uString::Const("Motion should not be changed post-rooting"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\StructuredNavigation.uno"), 44, uString::Const("set_Motion"), NULL);
}
...
void StructuredNavigation::OnUpdated()
{
    ...
    if (_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(uString::Const("Updated called without a region"), this, uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\StructuredNavigation.uno"), 208, uString::Const("OnUpdated"));
        return;
    }
...
// public float2 get_SeekRange() [instance] :401
...
static void PageExpression__Subscription_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::TYPES[2/*Fuse.Navigation.INavigation*/], offsetof(PageExpression__Subscription, _nav), 0,
        ::TYPES[14/*Fuse.Visual*/], offsetof(PageExpression__Subscription, _currentPage), 0,
        ::TYPES[33/*Fuse.Reactive.IListener*/], offsetof(PageExpression__Subscription, _listener), 0);
}
...
PageExpression__Subscription_type* PageExpression__Subscription_typeof()
{
    ...
    type->interface1.fp_UpdateSource = (void(*)(uObject*))PageExpression__Subscription__UpdateSource_fn;
    return type;
}
...
{
    uStackFrame __("Fuse.Navigation.PageExpression.Subscription", ".ctor(Fuse.Navigation.PageExpression,Fuse.Node,Fuse.Reactive.IListener)");
    _pe = pe;
    _node = node;
    _listener = listener;
    ::g::Fuse::Resources::ResourceRegistry::AddResourceChangedHandler(uPtr(_pe)->Key(), uDelegate::New(::TYPES[18/*Uno.Action*/], (void*)PageExpression__Subscription__OnChanged_fn, this));
...
{
    uStackFrame __("Fuse.Navigation.PageExpression.Subscription", "Dispose()");
    bool ret2;
    ReleaseCurrent();
    ::g::Uno::Collections::List__Remove_fn(uPtr(::g::Fuse::Navigation::NavigationPageProperty::RootedBindings_), (uObject*)this, &ret2);
    ::g::Fuse::Resources::ResourceRegistry::RemoveResourceChangedHandler(uPtr(_pe)->Key(), uDelegate::New(::TYPES[18/*Uno.Action*/], (void*)PageExpression__Subscription__OnChanged_fn, this));
    _listener = NULL;
    _node = NULL;
}
...
{
    uStackFrame __("Fuse.Navigation.PageExpression.Subscription", "GotoPage(Fuse.Visual)");
...
{
    uStackFrame __("Fuse.Navigation.PageExpression.Subscription", "get_LocalObject()");
    ::g::Fuse::Node* n = _node;
...
{
    uStackFrame __("Fuse.Navigation.PageExpression.Subscription", "OnChanged()");
    ...
    if (page != NULL)
    {
        if (::g::Uno::String::op_Equality(uPtr(_pe)->Key(), ::STRINGS[34/*"Visual"*/]) || ::g::Uno::String::op_Equality(uPtr(_pe)->Key(), ::STRINGS[35/*"Node"*/]))
            ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(listener), ::TYPES[33/*Fuse.Reactive.IListener*/]), (uObject*)_pe, page);
        else
        {
            uObject* resource;

            if (uPtr(page)->TryGetResource(uPtr(_pe)->Key(), uDelegate::New(::TYPES[35/*Uno.Predicate<object>*/], (void*)PageExpression__Subscription__Acceptor_fn, this), &resource))
                ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(listener), ::TYPES[33/*Fuse.Reactive.IListener*/]), (uObject*)_pe, resource);
        }
    }
}
...
{
    uStackFrame __("Fuse.Navigation.PageExpression.Subscription", "OnNavigated(object,Fuse.Navigation.NavigatedArgs)");
    GotoPage(uPtr(args)->NewVisual());
}
...
{
    uStackFrame __("Fuse.Navigation.PageExpression.Subscription", "ReleaseCurrent()");

    if (_nav != NULL)
    {
        ::g::Fuse::Navigation::INavigation::remove_Navigated(uInterface(uPtr(_nav), ::TYPES[2/*Fuse.Navigation.INavigation*/]), uDelegate::New(::TYPES[36/*Fuse.Navigation.NavigatedHandler*/], (void*)PageExpression__Subscription__OnNavigated_fn, this));
        _nav = NULL;
    }
...
{
    uStackFrame __("Fuse.Navigation.PageExpression.Subscription", "UpdateSource()");
    uObject* local = LocalObject();
    ...
    if (_nav != NULL)
    {
        ::g::Fuse::Navigation::INavigation::add_Navigated(uInterface(uPtr(_nav), ::TYPES[2/*Fuse.Navigation.INavigation*/]), uDelegate::New(::TYPES[36/*Fuse.Navigation.NavigatedHandler*/], (void*)PageExpression__Subscription__OnNavigated_fn, this));
        GotoPage(::g::Fuse::Navigation::INavigation::ActivePage(uInterface(uPtr(_nav), ::TYPES[2/*Fuse.Navigation.INavigation*/])));
    }
    else
        OnChanged();
...
{
    ::STRINGS[49] = uString::Const("unable to find a router");
    ::STRINGS[50] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\FindRouter.uno");
    ::STRINGS[32] = uString::Const(".ctor");
    ::TYPES[33] = ::g::Fuse::Reactive::IListener_typeof();
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof());
    ...
    type->SetFields(0,
        ...
        ::TYPES[33/*Fuse.Reactive.IListener*/], offsetof(FindRouter__Subscription, _listener), 0);
}
...
{
    uStackFrame __("Fuse.Navigation.FindRouter.Subscription", ".ctor(Fuse.Navigation.FindRouter,Fuse.Node,Fuse.Reactive.IListener)");
    _expr = expr;
    _listener = listener;
    ::g::Fuse::Navigation::Router* router = ::g::Fuse::Navigation::Router::TryFindRouter(origin);

    if (router == NULL)
        ::g::Fuse::Diagnostics::UserError(::STRINGS[49/*"unable to f...*/], this, ::STRINGS[50/*"C:\\Users\\...*/], 49, ::STRINGS[32/*".ctor"*/], NULL);
    else
        ::g::Fuse::Reactive::IListener::OnNewData(uInterface(uPtr(listener), ::TYPES[33/*Fuse.Reactive.IListener*/]), (uObject*)_expr, router);
}
...
{
    ::STRINGS[51] = uString::Const("SwipeNavigate: failed to find suitable Navigation object");
    ::STRINGS[52] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\SwipeNavigate.uno");
    ::STRINGS[53] = uString::Const("Fuse.Input.IGesture.OnPointerPressed");
    ::TYPES[43] = ::g::Fuse::Motion::Simulation::PointerVelocity_typeof()->MakeType(::g::Uno::Float2_typeof(), NULL);
    ...
    type->SetFields(16,
        ::TYPES[43/*Fuse.Motion.Simulation.PointerVelocity<float2>*/], offsetof(SwipeNavigate, _velocity), 0,
        ::TYPES[44/*Fuse.Navigation.ISeekableNavigation*/], offsetof(SwipeNavigate, _currentNavigation), 0,
        ...
        ::TYPES[9/*Fuse.Elements.Element*/], offsetof(SwipeNavigate, _lengthNode), 0,
    ...
    type->Reflection.SetFunctions(13,
        ...
        new uFunction("get_LengthNode", NULL, (void*)SwipeNavigate__get_LengthNode_fn, 0, false, ::TYPES[9/*Fuse.Elements.Element*/], 0),
        new uFunction("set_LengthNode", NULL, (void*)SwipeNavigate__set_LengthNode_fn, 0, false, uVoid_typeof(), 1, ::TYPES[9/*Fuse.Elements.Element*/]),
...
{
    uStackFrame __("Fuse.Navigation.SwipeNavigate", "Fuse.Input.IGesture.OnCaptureChanged(Fuse.Input.PointerEventArgs,Fuse.Input.CaptureType,Fuse.Input.CaptureType)");
    int how_ = *how;
    int prev_ = *prev;
    ...
    {
        ::g::Fuse::Navigation::ISeekableNavigation::BeginSeek(uInterface(uPtr(__this->_currentNavigation), ::TYPES[44/*Fuse.Navigation.ISeekableNavigation*/]));
...
{
    uStackFrame __("Fuse.Navigation.SwipeNavigate", "Fuse.Input.IGesture.OnLostCapture(bool)");

    if (__this->_currentNavigation != NULL)
    {
        if (uPtr(uAs< ::g::Fuse::Node*>(__this->_currentNavigation, ::TYPES[42/*Fuse.Node*/]))->IsRootingCompleted() && __this->_startedSeek)
            ::g::Fuse::Navigation::ISeekableNavigation::EndSeek(uInterface(uPtr(__this->_currentNavigation), ::TYPES[44/*Fuse.Navigation.ISeekableNavigation*/]), ::g::Fuse::Navigation::EndSeekArgs::New1(1, 0.0f));
...
{
    uStackFrame __("Fuse.Navigation.SwipeNavigate", "Fuse.Input.IGesture.OnPointerMoved(Fuse.Input.PointerMovedArgs)");
    ...
    if (uPtr(__this->_gesture)->IsHardCapture())
        ::g::Fuse::Navigation::ISeekableNavigation::Seek(uInterface(uPtr(__this->_currentNavigation), ::TYPES[44/*Fuse.Navigation.ISeekableNavigation*/]), __this->GetNavigationArgs());
...
{
    uStackFrame __("Fuse.Navigation.SwipeNavigate", "Fuse.Input.IGesture.OnPointerPressed(Fuse.Input.PointerPressedArgs)");
    __this->_startCoord = (__this->_currentCoord = uPtr(args)->WindowPoint());
    ...
    if (__this->_currentNavigation == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[51/*"SwipeNaviga...*/], __this, ::STRINGS[52/*"C:\\Users\\...*/], 230, ::STRINGS[53/*"Fuse.Input....*/]);
...
{
    uStackFrame __("Fuse.Navigation.SwipeNavigate", "Fuse.Input.IGesture.OnPointerReleased(Fuse.Input.PointerReleasedArgs)");
    __this->_currentCoord = uPtr(args)->WindowPoint();
    ...
    {
        ::g::Fuse::Navigation::ISeekableNavigation::EndSeek(uInterface(uPtr(__this->_currentNavigation), ::TYPES[44/*Fuse.Navigation.ISeekableNavigation*/]), ::g::Fuse::Navigation::EndSeekArgs::New1(__this->DetermineSnap(), __this->ProgressVelocity()));
        __this->_currentNavigation = NULL;
    }
...
void SwipeNavigate::ctor_3()
{
    ...
    _velocity = ((::g::Fuse::Motion::Simulation::PointerVelocity*)::g::Fuse::Motion::Simulation::PointerVelocity::New1(::TYPES[43/*Fuse.Motion.Simulation.PointerVelocity<float2>*/]));
    _forwardDirection = 1;
    _swipeAllow = 3;
    ctor_2();
...
// public Fuse.Elements.Element get_LengthNode() [instance] :160
::g::Fuse::Elements::Element* SwipeNavigate::LengthNode()
{
    return _lengthNode;
}

// public void set_LengthNode(Fuse.Elements.Element value) [instance] :161
void SwipeNavigate::LengthNode(::g::Fuse::Elements::Element* value)
{
    _lengthNode = value;
}

// public float get_MaxPages() [instance] :173
float SwipeNavigate::MaxPages()
{
    return _maxPages;
}

// public void set_MaxPages(float value) [instance] :174
...
// public float get_RelativeDistance() :24
...
// public float get_RelativeDistance() [instance] :24
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\VisualNavigation.uno
// --------------------------------------------------------------------------------------------
...
static void VisualNavigation__cctor_1_fn(uType* __type)
{
    ::g::Uno::UX::Selector_typeof()->Init();
    ::g::Fuse::Scripting::ScriptClass_typeof()->Init();
    VisualNavigation::ActiveIndexName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[54/*"ActiveIndex"*/]);
    ::g::Fuse::Scripting::ScriptClass::Register(__type, uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[46/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[47/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.VisualNavigation>*/], ::STRINGS[55/*"goto"*/], uDelegate::New(::TYPES[48/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.VisualNavigation, object[]>*/], (void*)VisualNavigation__gotoNode_fn), 2)));
}

static void VisualNavigation_build(uType* type)
{
    ::STRINGS[54] = uString::Const("ActiveIndex");
    ::STRINGS[55] = uString::Const("goto");
    ::STRINGS[56] = uString::Const("Navigation.goto() : Argument must be a node object");
    ::STRINGS[57] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\VisualNavigation.uno");
    ::STRINGS[58] = uString::Const("gotoNode");
    ::TYPES[45] = ::g::Uno::Type_typeof();
    ::TYPES[46] = ::g::Fuse::Scripting::ScriptMember_typeof()->Array();
    ...
    ::TYPES[49] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Navigation::PageData_typeof(), NULL);
    ::TYPES[14] = ::g::Fuse::Visual_typeof();
    ::TYPES[50] = ::g::Uno::UX::ValueChangedArgs_typeof()->MakeType(::g::Fuse::Navigation::NavigationState_typeof(), NULL);
    ::TYPES[51] = ::TYPES[14/*Fuse.Visual*/]->MakeMethod(2/*FirstChild<Fuse.Visual>*/, ::TYPES[14/*Fuse.Visual*/], NULL);
    ::TYPES[52] = ::g::Fuse::Node_typeof()->MakeMethod(3/*NextSibling<Fuse.Visual>*/, ::TYPES[14/*Fuse.Visual*/], NULL);
    ::TYPES[53] = ::g::Fuse::Navigation::ActivePageChangedHandler_typeof();
    ::TYPES[54] = ::g::Fuse::Navigation::HistoryChangedHandler_typeof();
    ::TYPES[36] = ::g::Fuse::Navigation::NavigatedHandler_typeof();
    ::TYPES[55] = ::g::Fuse::Navigation::NavigationPageCountHandler_typeof();
    ::TYPES[24] = ::g::Fuse::Navigation::NavigationHandler_typeof();
    ::TYPES[56] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Fuse::Navigation::NavigationState_typeof(), NULL);
    type->SetDependencies(
        ::g::Fuse::Diagnostics_typeof(),
        ::g::Fuse::Navigation::Navigation_typeof(),
        ::g::Fuse::Navigation::PageData_typeof());
    ...
    type->SetFields(16,
        ...
        ::TYPES[49/*Uno.Collections.List<Fuse.Navigation.PageData>*/], offsetof(VisualNavigation, _pages), 0,
        ::TYPES[53/*Fuse.Navigation.ActivePageChangedHandler*/], offsetof(VisualNavigation, ActivePageChanged1), 0,
        ::TYPES[54/*Fuse.Navigation.HistoryChangedHandler*/], offsetof(VisualNavigation, HistoryChanged1), 0,
        ::TYPES[36/*Fuse.Navigation.NavigatedHandler*/], offsetof(VisualNavigation, Navigated1), 0,
        ::TYPES[55/*Fuse.Navigation.NavigationPageCountHandler*/], offsetof(VisualNavigation, PageCountChanged1), 0,
        ::TYPES[24/*Fuse.Navigation.NavigationHandler*/], offsetof(VisualNavigation, PageProgressChanged1), 0,
        ::TYPES[56/*Uno.UX.ValueChangedHandler<Fuse.Navigation.NavigationState>*/], offsetof(VisualNavigation, StateChanged1), 0,
        ::g::Uno::UX::Selector_typeof(), (uintptr_t)&VisualNavigation::ActiveIndexName_, uFieldFlagsStatic);
    type->Reflection.SetFields(1,
        new uField("ActiveIndexName", 24));
    type->Reflection.SetFunctions(33,
        new uFunction("get_Active", NULL, NULL, offsetof(VisualNavigation_type, fp_get_Active), false, ::TYPES[14/*Fuse.Visual*/], 0),
        new uFunction("set_Active", NULL, NULL, offsetof(VisualNavigation_type, fp_set_Active), false, uVoid_typeof(), 1, ::TYPES[14/*Fuse.Visual*/]),
        ...
        new uFunction("get_ActivePage", NULL, (void*)VisualNavigation__get_ActivePage_fn, 0, false, ::TYPES[14/*Fuse.Visual*/], 0),
        new uFunction("add_ActivePageChanged", NULL, (void*)VisualNavigation__add_ActivePageChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[53/*Fuse.Navigation.ActivePageChangedHandler*/]),
        new uFunction("remove_ActivePageChanged", NULL, (void*)VisualNavigation__remove_ActivePageChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[53/*Fuse.Navigation.ActivePageChangedHandler*/]),
        ...
        new uFunction("GetPage", NULL, (void*)VisualNavigation__GetPage_fn, 0, false, ::TYPES[14/*Fuse.Visual*/], 1, ::g::Uno::Int_typeof()),
        new uFunction("GetPageState", NULL, NULL, offsetof(VisualNavigation_type, fp_GetPageState), false, ::g::Fuse::Navigation::NavigationPageState_typeof(), 1, ::TYPES[14/*Fuse.Visual*/]),
        ...
        new uFunction("Goto", NULL, NULL, offsetof(VisualNavigation_type, fp_Goto), false, uVoid_typeof(), 2, ::TYPES[14/*Fuse.Visual*/], ::g::Fuse::Navigation::NavigationGotoMode_typeof()),
        new uFunction("add_HistoryChanged", NULL, (void*)VisualNavigation__add_HistoryChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[54/*Fuse.Navigation.HistoryChangedHandler*/]),
        new uFunction("remove_HistoryChanged", NULL, (void*)VisualNavigation__remove_HistoryChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[54/*Fuse.Navigation.HistoryChangedHandler*/]),
        new uFunction("add_Navigated", NULL, (void*)VisualNavigation__add_Navigated_fn, 0, false, uVoid_typeof(), 1, ::TYPES[36/*Fuse.Navigation.NavigatedHandler*/]),
        new uFunction("remove_Navigated", NULL, (void*)VisualNavigation__remove_Navigated_fn, 0, false, uVoid_typeof(), 1, ::TYPES[36/*Fuse.Navigation.NavigatedHandler*/]),
        ...
        new uFunction("OnChildMovedWhileRooted", NULL, (void*)VisualNavigation__OnChildMovedWhileRooted_fn, 0, false, uVoid_typeof(), 1, ::g::Fuse::Node_typeof()),
        ...
        new uFunction("add_PageCountChanged", NULL, (void*)VisualNavigation__add_PageCountChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[55/*Fuse.Navigation.NavigationPageCountHandler*/]),
        new uFunction("remove_PageCountChanged", NULL, (void*)VisualNavigation__remove_PageCountChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[55/*Fuse.Navigation.NavigationPageCountHandler*/]),
        new uFunction("get_PageProgress", NULL, NULL, offsetof(VisualNavigation_type, fp_get_PageProgress), false, ::g::Uno::Double_typeof(), 0),
        new uFunction("add_PageProgressChanged", NULL, (void*)VisualNavigation__add_PageProgressChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[24/*Fuse.Navigation.NavigationHandler*/]),
        new uFunction("remove_PageProgressChanged", NULL, (void*)VisualNavigation__remove_PageProgressChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[24/*Fuse.Navigation.NavigationHandler*/]),
        ...
        new uFunction("get_State", NULL, (void*)VisualNavigation__get_State_fn, 0, false, ::g::Fuse::Navigation::NavigationState_typeof(), 0),
        new uFunction("add_StateChanged", NULL, (void*)VisualNavigation__add_StateChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[56/*Uno.UX.ValueChangedHandler<Fuse.Navigation.NavigationState>*/]),
        new uFunction("remove_StateChanged", NULL, (void*)VisualNavigation__remove_StateChanged_fn, 0, false, uVoid_typeof(), 1, ::TYPES[56/*Uno.UX.ValueChangedHandler<Fuse.Navigation.NavigationState>*/]),
        new uFunction("Toggle", NULL, NULL, offsetof(VisualNavigation_type, fp_Toggle), false, uVoid_typeof(), 1, ::TYPES[14/*Fuse.Visual*/]));
}
...
VisualNavigation_type* VisualNavigation_typeof()
{
    ...
    type->interface6.fp_GetPage = (void(*)(uObject*, int*, ::g::Fuse::Visual**))VisualNavigation__GetPage_fn;
    ...
    type->interface6.fp_get_PageCount = (void(*)(uObject*, int*))VisualNavigation__get_PageCount_fn;
    ...
    type->interface6.fp_add_PageCountChanged = (void(*)(uObject*, uDelegate*))VisualNavigation__add_PageCountChanged_fn;
    type->interface6.fp_remove_PageCountChanged = (void(*)(uObject*, uDelegate*))VisualNavigation__remove_PageCountChanged_fn;
...
// public void SetActiveIndex(int value, Uno.UX.IPropertyListener origin) :247
...
{
    _pages = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[49/*Uno.Collections.List<Fuse.Navigation.PageData>*/]));
    ctor_2();
}

// public int get_ActiveIndex() [instance] :240
int VisualNavigation::ActiveIndex()
{
    uStackFrame __("Fuse.Navigation.VisualNavigation", "get_ActiveIndex()");
    ::g::Fuse::Navigation::PageData* pd = GetPageData(Active());
    return (pd == NULL) ? -1 : uPtr(pd)->Index;
}

// public void set_ActiveIndex(int value) [instance] :245
...
// public void ClearHistory() [instance] :127
...
void VisualNavigation::add_Navigated(uDelegate* value)
{
    ...
    Navigated1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Navigated1, value), ::TYPES[36/*Fuse.Navigation.NavigatedHandler*/]);
}
...
void VisualNavigation::remove_Navigated(uDelegate* value)
{
    ...
    Navigated1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Navigated1, value), ::TYPES[36/*Fuse.Navigation.NavigatedHandler*/]);
}
...
{
    uStackFrame __("Fuse.Navigation.VisualNavigation", "OnChildMovedWhileRooted(Fuse.Node)");
    ::g::Fuse::Visual* v = uAs< ::g::Fuse::Visual*>(child, ::TYPES[14/*Fuse.Visual*/]);
...
{
    uStackFrame __("Fuse.Navigation.VisualNavigation", "OnStateChanged(Fuse.Navigation.NavigationState)");
    ...
    if (::g::Uno::Delegate::op_Inequality(StateChanged1, NULL))
        uPtr(StateChanged1)->Invoke(2, this, (::g::Uno::UX::ValueChangedArgs__New2_fn(::TYPES[50/*Uno.UX.ValueChangedArgs<Fuse.Navigation.NavigationState>*/], uCRef<int>(newState), &ret4), ret4));
}
...
// public void SetActiveIndex(int value, Uno.UX.IPropertyListener origin) [instance] :247
...
{
    uStackFrame __("Fuse.Navigation.VisualNavigation", "add_StateChanged(Uno.UX.ValueChangedHandler<Fuse.Navigation.NavigationState>)");
    StateChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(StateChanged1, value), ::TYPES[56/*Uno.UX.ValueChangedHandler<Fuse.Navigation.NavigationState>*/]);
}
...
{
    uStackFrame __("Fuse.Navigation.VisualNavigation", "remove_StateChanged(Uno.UX.ValueChangedHandler<Fuse.Navigation.NavigationState>)");
    StateChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(StateChanged1, value), ::TYPES[56/*Uno.UX.ValueChangedHandler<Fuse.Navigation.NavigationState>*/]);
}
...
void VisualNavigation::UpdatePages()
{
    ...
    for (::g::Fuse::Visual* x = (::g::Fuse::Visual*)uPtr(Parent())->FirstChild(::TYPES[51/*Fuse.Visual.FirstChild<Fuse.Visual>*/]); x != NULL; x = (::g::Fuse::Visual*)uPtr(x)->NextSibling(::TYPES[52/*Fuse.Node.NextSibling<Fuse.Visual>*/]))
    {
...
void VisualNavigation::gotoNode(::g::Fuse::Scripting::Context* c, VisualNavigation* nav, uArray* args)
{
    ...
    ::g::Fuse::Visual* target = uAs< ::g::Fuse::Visual*>(uPtr(args)->Strong<uObject*>(0), ::TYPES[14/*Fuse.Visual*/]);

    if (target != NULL)
        uPtr(nav)->Goto(target, 0);
    else
        ::g::Fuse::Diagnostics::UserError(::STRINGS[56/*"Navigation....*/], nav, ::STRINGS[57/*"C:\\Users\\...*/], 30, ::STRINGS[58/*"gotoNode"*/], NULL);
}
// }

// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\WhileNavigationTriggers.uno
// ---------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\WhileCanGoBack.uno
// ------------------------------------------------------------------------------------------
...
void WhileCanGoBack__get_IsOn_fn(WhileCanGoBack* __this, bool* __retval)
{
    ...
    return *__retval = ::g::Fuse::Navigation::IBaseNavigation::CanGoBack(uInterface(uPtr(__this->_context), ::TYPES[16/*Fuse.Navigation.IBaseNavigation*/])), void();
}
...
// public generated WhileCanGoForward() :71
...
void WhileCanGoForward__get_IsOn_fn(WhileCanGoForward* __this, bool* __retval)
{
    ...
    return *__retval = ::g::Fuse::Navigation::IBaseNavigation::CanGoForward(uInterface(uPtr(__this->_context), ::TYPES[16/*Fuse.Navigation.IBaseNavigation*/])), void();
}

// public generated WhileCanGoForward New() :71
void WhileCanGoForward__New2_fn(WhileCanGoForward** __retval)
{
    *__retval = WhileCanGoForward::New2();
}

// public generated WhileCanGoForward() [instance] :71
void WhileCanGoForward::ctor_7()
{
    ctor_6();
}

// public generated WhileCanGoForward New() [static] :71
...
static void WhileHistoryTrigger_build(uType* type)
{
    ...
    ::STRINGS[60] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\WhileCanGoBack.uno");
    ::STRINGS[10] = uString::Const("OnRooted");
    ::TYPES[16] = ::g::Fuse::Navigation::IBaseNavigation_typeof();
    ::TYPES[54] = ::g::Fuse::Navigation::HistoryChangedHandler_typeof();
    type->SetDependencies(
    ...
    type->SetFields(38,
        ::TYPES[16/*Fuse.Navigation.IBaseNavigation*/], offsetof(WhileHistoryTrigger, _context), 0,
        ::TYPES[16/*Fuse.Navigation.IBaseNavigation*/], offsetof(WhileHistoryTrigger, _NavigationContext), 0);
    type->Reflection.SetFunctions(2,
        new uFunction("get_NavigationContext", NULL, (void*)WhileHistoryTrigger__get_NavigationContext_fn, 0, false, ::TYPES[16/*Fuse.Navigation.IBaseNavigation*/], 0),
        new uFunction("set_NavigationContext", NULL, (void*)WhileHistoryTrigger__set_NavigationContext_fn, 0, false, uVoid_typeof(), 1, ::TYPES[16/*Fuse.Navigation.IBaseNavigation*/]));
}
...
void WhileHistoryTrigger__OnRooted_fn(WhileHistoryTrigger* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[59/*"WhileHistor...*/], __this, ::STRINGS[60/*"C:\\Users\\...*/], 23, ::STRINGS[10/*"OnRooted"*/], NULL);
        return;
    }

    __this->SetActive(__this->IsOn());
    ::g::Fuse::Navigation::IBaseNavigation::add_HistoryChanged(uInterface(uPtr(__this->_context), ::TYPES[16/*Fuse.Navigation.IBaseNavigation*/]), uDelegate::New(::TYPES[54/*Fuse.Navigation.HistoryChangedHandler*/], (void*)WhileHistoryTrigger__OnHistoryChanged_fn, __this));
}
...
void WhileHistoryTrigger__OnUnrooted_fn(WhileHistoryTrigger* __this)
{
    ...
    if (__this->_context != NULL)
    {
        ::g::Fuse::Navigation::IBaseNavigation::remove_HistoryChanged(uInterface(uPtr(__this->_context), ::TYPES[16/*Fuse.Navigation.IBaseNavigation*/]), uDelegate::New(::TYPES[54/*Fuse.Navigation.HistoryChangedHandler*/], (void*)WhileHistoryTrigger__OnHistoryChanged_fn, __this));
        __this->_context = NULL;
    }
...
// public generated WhileInactive() :168
...
// public generated WhileInactive New() :168
void WhileInactive__New2_fn(WhileInactive** __retval)
{
    *__retval = WhileInactive::New2();
}

// public generated WhileInactive() [instance] :168
void WhileInactive::ctor_7()
{
    ctor_6();
}

// public generated WhileInactive New() [static] :168
...
// public generated WhileInEnterState() :194
...
// public generated WhileInEnterState New() :194
void WhileInEnterState__New2_fn(WhileInEnterState** __retval)
{
    *__retval = WhileInEnterState::New2();
}

// public generated WhileInEnterState() [instance] :194
void WhileInEnterState::ctor_7()
{
    ctor_6();
}

// public generated WhileInEnterState New() [static] :194
...
// public generated WhileInExitState() :181
...
// public generated WhileInExitState New() :181
void WhileInExitState__New2_fn(WhileInExitState** __retval)
{
    *__retval = WhileInExitState::New2();
}

// public generated WhileInExitState() [instance] :181
void WhileInExitState::ctor_7()
{
    ctor_6();
}

// public generated WhileInExitState New() [static] :181
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\WhileNavigating.uno
// -------------------------------------------------------------------------------------------
...
{
    ::STRINGS[61] = uString::Const("WhileNavigating requires a Navigation context");
    ::STRINGS[62] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\WhileNavigating.uno");
    ::STRINGS[10] = uString::Const("OnRooted");
    ::TYPES[2] = ::g::Fuse::Navigation::INavigation_typeof();
    ::TYPES[56] = ::g::Uno::UX::ValueChangedHandler_typeof()->MakeType(::g::Fuse::Navigation::NavigationState_typeof(), NULL);
    type->SetDependencies(
    ...
    type->SetFields(38,
        ::TYPES[2/*Fuse.Navigation.INavigation*/], offsetof(WhileNavigating, _context), 0);
    type->Reflection.SetFunctions(1,
...
// public generated WhileNavigating New() :31
...
void WhileNavigating__OnRooted_fn(WhileNavigating* __this)
{
    ...
    if (__this->_context == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[61/*"WhileNaviga...*/], __this, ::STRINGS[62/*"C:\\Users\\...*/], 41, ::STRINGS[10/*"OnRooted"*/], NULL);
        return;
    }

    ::g::Fuse::Navigation::INavigation::add_StateChanged(uInterface(uPtr(__this->_context), ::TYPES[2/*Fuse.Navigation.INavigation*/]), uDelegate::New(::TYPES[56/*Uno.UX.ValueChangedHandler<Fuse.Navigation.NavigationState>*/], (void*)WhileNavigating__OnStateChanged_fn, __this));
    __this->SetActive(::g::Fuse::Navigation::INavigation::State(uInterface(uPtr(__this->_context), ::TYPES[2/*Fuse.Navigation.INavigation*/])) != 0);
}
...
void WhileNavigating__OnUnrooted_fn(WhileNavigating* __this)
{
    ...
    if (__this->_context != NULL)
    {
        ::g::Fuse::Navigation::INavigation::remove_StateChanged(uInterface(uPtr(__this->_context), ::TYPES[2/*Fuse.Navigation.INavigation*/]), uDelegate::New(::TYPES[56/*Uno.UX.ValueChangedHandler<Fuse.Navigation.NavigationState>*/], (void*)WhileNavigating__OnStateChanged_fn, __this));
        __this->_context = NULL;
    }
...
{
    uStackFrame __("Fuse.Navigation.WhileNavigating", "OnStateChanged(object,Uno.UX.ValueChangedArgs<Fuse.Navigation.NavigationState>)");
    int ret2;
    SetActive((::g::Uno::UX::ValueChangedArgs__get_Value_fn(uPtr(args), &ret2), ret2) != 0);
}

// public generated WhileNavigating New() [static] :31
...
{
    ::TYPES[57] = ::g::Fuse::Navigation::RoutePageProxy__ProgressUpdated_typeof();
    type->SetInterfaces(
    ...
    type->Reflection.SetFunctions(6,
        ...
        new uFunction("get_Path", NULL, (void*)WhileNavigationTrigger__get_Path_fn, 0, false, ::g::Fuse::Navigation::RoutePagePath_typeof(), 0),
        new uFunction("set_Path", NULL, (void*)WhileNavigationTrigger__set_Path_fn, 0, false, uVoid_typeof(), 1, ::g::Fuse::Navigation::RoutePagePath_typeof()),
...
void WhileNavigationTrigger__OnRooted_fn(WhileNavigationTrigger* __this)
{
    ...
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    __this->_proxy = ::g::Fuse::Navigation::RoutePageProxy::New2(__this->Parent(), uDelegate::New(::TYPES[57/*Fuse.Navigation.RoutePageProxy.ProgressUpdated*/], (void*)WhileNavigationTrigger__ProgressUpdated_fn, __this));
    uPtr(__this->_proxy)->Path(__this->Path());
    uPtr(__this->_proxy)->Init();
}
...
{
    uStackFrame __("Fuse.Navigation.WhileNavigationTrigger", "set_Path(Fuse.Navigation.RoutePagePath)");
    _path = value;
...
{
    uStackFrame __("Fuse.Navigation.WhileNavigationTrigger", "ProgressUpdated(double)");
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Fuse.Navigation\1.4.0\WhilePageActive.uno
// -------------------------------------------------------------------------------------------

// public sealed class WhilePageActive :12
// {
static void WhilePageActive_build(uType* type)
{
    ::STRINGS[63] = uString::Const("Must be used within a navigation context");
    ::STRINGS[64] = uString::Const("C:\\Users\\Shumcom\\AppData\\Local\\Fusetools\\Packages\\Fuse.Navigation\\1.4.0\\WhilePageActive.uno");
    ::STRINGS[10] = uString::Const("OnRooted");
    ::TYPES[2] = ::g::Fuse::Navigation::INavigation_typeof();
    ::TYPES[24] = ::g::Fuse::Navigation::NavigationHandler_typeof();
    type->SetDependencies(
    ...
    type->SetInterfaces(
        ...
        ::g::Fuse::Animations::IBasePlayerFeedback_typeof(), offsetof(::g::Fuse::Triggers::Trigger_type, interface7));
    type->SetFields(38,
        ::TYPES[2/*Fuse.Navigation.INavigation*/], offsetof(WhilePageActive, _navigation), 0,
        ::g::Uno::Float_typeof(), offsetof(WhilePageActive, _threshold), 0,
        ::g::Uno::Float_typeof(), offsetof(WhilePageActive, _limit), 0,
        ::g::Uno::Bool_typeof(), offsetof(WhilePageActive, _hasLimit), 0,
        ::g::Uno::String_typeof(), offsetof(WhilePageActive, _nameEquals), 0);
    type->Reflection.SetFunctions(7,
        new uFunction("get_Limit", NULL, (void*)WhilePageActive__get_Limit_fn, 0, false, ::g::Uno::Float_typeof(), 0),
        new uFunction("set_Limit", NULL, (void*)WhilePageActive__set_Limit_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Float_typeof()),
        new uFunction("get_NameEquals", NULL, (void*)WhilePageActive__get_NameEquals_fn, 0, false, ::g::Uno::String_typeof(), 0),
        new uFunction("set_NameEquals", NULL, (void*)WhilePageActive__set_NameEquals_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::String_typeof()),
        new uFunction(".ctor", NULL, (void*)WhilePageActive__New2_fn, 0, true, type, 0),
        new uFunction("get_Threshold", NULL, (void*)WhilePageActive__get_Threshold_fn, 0, false, ::g::Uno::Float_typeof(), 0),
        new uFunction("set_Threshold", NULL, (void*)WhilePageActive__set_Threshold_fn, 0, false, uVoid_typeof(), 1, ::g::Uno::Float_typeof()));
}
...
::g::Fuse::Triggers::Trigger_type* WhilePageActive_typeof()
{
    ...
    options.InterfaceCount = 8;
    options.DependencyCount = 3;
    options.ObjectSize = sizeof(WhilePageActive);
    options.TypeSize = sizeof(::g::Fuse::Triggers::Trigger_type);
    type = (::g::Fuse::Triggers::Trigger_type*)uClassType::New("Fuse.Navigation.WhilePageActive", options);
    type->fp_build_ = WhilePageActive_build;
    type->fp_ctor_ = (void*)WhilePageActive__New2_fn;
    type->fp_OnRooted = (void(*)(::g::Fuse::Node*))WhilePageActive__OnRooted_fn;
    type->fp_OnUnrooted = (void(*)(::g::Fuse::Node*))WhilePageActive__OnUnrooted_fn;
    type->interface7.fp_OnPlaybackDone = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnPlaybackDone_fn;
    type->interface7.fp_OnStable = (void(*)(uObject*, uObject*))::g::Fuse::Triggers::Trigger__FuseAnimationsIBasePlayerFeedbackOnStable_fn;
    type->interface6.fp_OnProgressUpdated = (void(*)(uObject*, uObject*, double*, double*, int*))::g::Fuse::Triggers::Trigger__FuseAnimationsIUnwrappedPlayerFeedbackOnProgressUpdated_fn;
    type->interface4.fp_Clear = (void(*)(uObject*))::g::Fuse::Node__UnoCollectionsICollectionFuseBindingClear_fn;
...
// public generated WhilePageActive() :12
void WhilePageActive__ctor_6_fn(WhilePageActive* __this)
{
    __this->ctor_6();
}

// public float get_Limit() :35
void WhilePageActive__get_Limit_fn(WhilePageActive* __this, float* __retval)
{
    *__retval = __this->Limit();
}

// public void set_Limit(float value) :36
void WhilePageActive__set_Limit_fn(WhilePageActive* __this, float* value)
{
    __this->Limit(*value);
}

// public string get_NameEquals() :51
void WhilePageActive__get_NameEquals_fn(WhilePageActive* __this, uString** __retval)
{
    *__retval = __this->NameEquals();
}

// public void set_NameEquals(string value) :52
void WhilePageActive__set_NameEquals_fn(WhilePageActive* __this, uString* value)
{
    __this->NameEquals(value);
}

// public generated WhilePageActive New() :12
void WhilePageActive__New2_fn(WhilePageActive** __retval)
{
    *__retval = WhilePageActive::New2();
}

// protected override sealed void OnRooted() :55
void WhilePageActive__OnRooted_fn(WhilePageActive* __this)
{
    uStackFrame __("Fuse.Navigation.WhilePageActive", "OnRooted()");
    ::g::Fuse::Triggers::Trigger__OnRooted_fn(__this);
    __this->_navigation = ::g::Fuse::Navigation::Navigation::TryFind(__this->Parent());

    if (__this->_navigation == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[63/*"Must be use...*/], __this, ::STRINGS[64/*"C:\\Users\\...*/], 61, ::STRINGS[10/*"OnRooted"*/], NULL);
        return;
    }

    ::g::Fuse::Navigation::INavigation::add_PageProgressChanged(uInterface(uPtr(__this->_navigation), ::TYPES[2/*Fuse.Navigation.INavigation*/]), uDelegate::New(::TYPES[24/*Fuse.Navigation.NavigationHandler*/], (void*)WhilePageActive__OnStateChanged_fn, __this));
    __this->Update();
}

// private void OnStateChanged(object sender, Fuse.Navigation.NavigationArgs args) :79
void WhilePageActive__OnStateChanged_fn(WhilePageActive* __this, uObject* sender, ::g::Fuse::Navigation::NavigationArgs* args)
{
    __this->OnStateChanged(sender, args);
}

// protected override sealed void OnUnrooted() :69
void WhilePageActive__OnUnrooted_fn(WhilePageActive* __this)
{
    uStackFrame __("Fuse.Navigation.WhilePageActive", "OnUnrooted()");
    ::g::Fuse::Triggers::Trigger__OnUnrooted_fn(__this);

    if (__this->_navigation != NULL)
    {
        ::g::Fuse::Navigation::INavigation::remove_PageProgressChanged(uInterface(uPtr(__this->_navigation), ::TYPES[2/*Fuse.Navigation.INavigation*/]), uDelegate::New(::TYPES[24/*Fuse.Navigation.NavigationHandler*/], (void*)WhilePageActive__OnStateChanged_fn, __this));
        __this->_navigation = NULL;
    }
}

// public float get_Threshold() :24
void WhilePageActive__get_Threshold_fn(WhilePageActive* __this, float* __retval)
{
    *__retval = __this->Threshold();
}

// public void set_Threshold(float value) :25
void WhilePageActive__set_Threshold_fn(WhilePageActive* __this, float* value)
{
    __this->Threshold(*value);
}

// private void Update() :84
void WhilePageActive__Update_fn(WhilePageActive* __this)
{
    __this->Update();
}

// public generated WhilePageActive() [instance] :12
void WhilePageActive::ctor_6()
{
    _threshold = 1.0f;
    ctor_5();
}

// public float get_Limit() [instance] :35
float WhilePageActive::Limit()
{
    return _limit;
}

// public void set_Limit(float value) [instance] :36
void WhilePageActive::Limit(float value)
{
    _limit = value;
    _hasLimit = true;
}

// public string get_NameEquals() [instance] :51
uString* WhilePageActive::NameEquals()
{
    return _nameEquals;
}

// public void set_NameEquals(string value) [instance] :52
void WhilePageActive::NameEquals(uString* value)
{
    _nameEquals = value;
}

// private void OnStateChanged(object sender, Fuse.Navigation.NavigationArgs args) [instance] :79
void WhilePageActive::OnStateChanged(uObject* sender, ::g::Fuse::Navigation::NavigationArgs* args)
{
    uStackFrame __("Fuse.Navigation.WhilePageActive", "OnStateChanged(object,Fuse.Navigation.NavigationArgs)");
    Update();
}

// public float get_Threshold() [instance] :24
float WhilePageActive::Threshold()
{
    return _threshold;
}

// public void set_Threshold(float value) [instance] :25
void WhilePageActive::Threshold(float value)
{
    _threshold = value;
}

// private void Update() [instance] :84
void WhilePageActive::Update()
{
    uStackFrame __("Fuse.Navigation.WhilePageActive", "Update()");
    ::g::Fuse::Visual* active = ::g::Fuse::Navigation::INavigation::ActivePage(uInterface(uPtr(_navigation), ::TYPES[2/*Fuse.Navigation.INavigation*/]));
    ...
    float progress = 1.0f - ::g::Uno::Math::Abs1(::g::Fuse::Navigation::INavigation::GetPageState(uInterface(uPtr(_navigation), ::TYPES[2/*Fuse.Navigation.INavigation*/]), active).Progress);
    bool set = progress >= Threshold();

    if (_hasLimit)
        set = set && (progress <= Limit());

    if (::g::Uno::String::op_Inequality(NameEquals(), NULL))
        set = set && ::g::Uno::String::op_Equality(::g::Uno::UX::Selector__op_Implicit1(uPtr(active)->Name()), NameEquals());

    SetActive(set);
}

// public generated WhilePageActive New() [static] :12
WhilePageActive* WhilePageActive::New2()
{
    WhilePageActive* obj1 = (WhilePageActive*)uNew(WhilePageActive_typeof());
    obj1->ctor_6();
    return obj1;
}
// }
