...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Runtime\Implementation\Internal\ArrayEnumerable.uno
// ------------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Runtime\Implementation\Internal\BufferConverters.uno
// -------------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Runtime\Implementation\Internal\BufferReader.uno
// ---------------------------------------------------------------------------------------------------------------------------

// public sealed class BufferReader :5
// {
static void BufferReader_build(uType* type)
{
    ...
    type->SetFields(0,
        ::g::Uno::Buffer_typeof(), offsetof(BufferReader, _buffer), 0,
        ::g::Uno::Int_typeof(), offsetof(BufferReader, _position), 0);
...
// public float2 ReadFloat2([bool littleEndian]) :56
...
// public BufferReader(Uno.Buffer buffer) [instance] :10
void BufferReader::ctor_(::g::Uno::Buffer* buffer)
{
    _buffer = buffer;
}

// public byte ReadByte() [instance] :26
...
// public byte[] ReadBytes(int count) [instance] :170
...
// public int ReadCompressedInt() [instance] :180
...
// public float ReadFloat([bool littleEndian]) [instance] :50
...
// public float2 ReadFloat2([bool littleEndian]) [instance] :56
...
// public string ReadString() [instance] :198
uString* BufferReader::ReadString()
{
    uStackFrame __("Uno.Runtime.Implementation.Internal.BufferReader", "ReadString()");
    return ::g::Uno::Text::Utf8::GetString(ReadBytes(ReadCompressedInt()));
}

// public uint ReadUInt([bool littleEndian]) [instance] :146
...
// public BufferReader New(Uno.Buffer buffer) [static] :10
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Runtime\Implementation\Internal\NumericFormatter.uno
// -------------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Runtime\Implementation\Internal\FormatStringItem.uno
// -------------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Runtime\Implementation\Internal\FormatStringLiteral.uno
// ----------------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Runtime\Implementation\Internal\FormatStringToken.uno
// --------------------------------------------------------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Runtime\Implementation\Internal\FormatStringTokenizer.uno
// ------------------------------------------------------------------------------------------------------------------------------------
...
static void NumericFormatter_build(uType* type)
{
    ...
    ::TYPES[3] = ::g::Uno::Char_typeof();
    type->SetFields(0,
        ::TYPES[8/*int*/], (uintptr_t)&NumericFormatter::NumberDecimalDigits_, uFieldFlagsStatic,
        ::TYPES[8/*int*/], (uintptr_t)&NumericFormatter::ExponentialDigits_, uFieldFlagsStatic,
...
uString* NumericFormatter::FormatCustom(uString* formatString, double value)
{
    ...
    return ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2((value < 0.0) ? ::STRINGS[5/*"-"*/] : (uString*)::g::Uno::String::Empty_, integerPart), hasDecimalPoint ? ::STRINGS[6/*"."*/] : (uString*)::g::Uno::String::Empty_), doublePart);
}
...
uString* NumericFormatter::FormatCustom1(uString* formatString, uint64_t value)
{
    ...
    return ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(integerPart, hasDecimalPoint ? ::STRINGS[6/*"."*/] : (uString*)::g::Uno::String::Empty_), doublePart);
}
...
uString* NumericFormatter::FormatFixedPoint1(uString* formatString, uint64_t d)
{
    ...
    return ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::ULong::ToString(d, ::TYPES[11/*ulong*/]), NumericFormatter::DecimalPoint()), NumericFormatter::Padding((uPtr(formatString)->Length() > 1) ? NumericFormatter::Digits(formatString) : NumericFormatter::NumberDecimalDigits_));
}
...
uString* NumericFormatter::FormatGeneral(uString* formatString, double d)
{
    ...
    if (exponent > desiredDigits)
        return ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::Double::ToString(significand, ::TYPES[13/*double*/]), ::STRINGS[10/*"E+"*/]), NumericFormatter::Padding(2 - uPtr(::g::Uno::Int::ToString(exponent, ::TYPES[8/*int*/]))->Length())), ::g::Uno::Int::ToString(exponent, ::TYPES[8/*int*/]));

    return ::g::Uno::String::op_Addition2((d < 0.0) ? ::STRINGS[5/*"-"*/] : (uString*)::g::Uno::String::Empty_, ::g::Uno::Double::ToString(significand * (double)::g::Uno::Math::Pow1(10.0f, (float)exponent), ::TYPES[13/*double*/]));
}
...
uString* NumericFormatter::DecimalPoint()
{
    ...
    if (::g::Uno::String::op_Equality(NumericFormatter::_decimalPoint_, NULL))
        NumericFormatter::_decimalPoint_ = ::g::Uno::Char::ToString(uPtr(::g::Uno::Double::ToString(1.1, ::TYPES[13/*double*/]))->Item(1), ::TYPES[3/*char*/]);
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\UnoCore\1.4.3\Source\Uno\Runtime\Implementation\Internal\Unsafe.uno
// ---------------------------------------------------------------------------------------------------------------------
...
{
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "Quit56", "()V");
