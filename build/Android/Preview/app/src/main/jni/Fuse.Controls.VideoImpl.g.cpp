...
static void VideoDiskCache_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("../../../Local/Fusetools/Packages/Fuse.Controls.Video/1.4.0/VideoDiskCache.uno");
    ...
    {
        {
            while (enum1.MoveNext(::TYPES[15/*Uno.Collections.Dictionary<string, string>.Enumerator*/]))
            {
                ...
                {
                    ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[2/*"Deleting te...*/], pair.Value(::TYPES[16/*Uno.Collections.KeyValuePair<string, string>*/])), 0, ::STRINGS[3/*"../../../Lo...*/], 29);
