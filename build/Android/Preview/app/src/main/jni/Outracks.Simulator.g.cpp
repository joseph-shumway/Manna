...
{
    ::STRINGS[25] = uString::Const("../../../Local/Fusetools/Packages/Fuse.Preview.Core/0.1.0/SimulatorClient.uno");
    ::TYPES[52] = ::g::Outracks::Simulator::ConcurrentQueue_typeof()->MakeType(::g::Outracks::IBinaryMessage_typeof(), NULL);
...
void SimulatorClient::Dispose()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->Message(), 0, ::STRINGS[25/*"../../../Lo...*/], 246);
    }
}
