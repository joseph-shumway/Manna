...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Net.Sockets\1.4.3\Socket.uno
// ----------------------------------------------------------------------------------
...
// C:\Users\Shumcom\AppData\Local\Fusetools\Packages\Uno.Net.Sockets\1.4.3\NetworkStream.uno
// -----------------------------------------------------------------------------------------
...
// public Socket(Uno.Net.Sockets.AddressFamily addressFamily, Uno.Net.Sockets.SocketType socketType, Uno.Net.Sockets.ProtocolType protocolType) :274
...
// public void Listen(int backlog) :456
void Socket__Listen_fn(Socket* __this, int* backlog)
{
    __this->Listen(*backlog);
}

// public Socket New(Uno.Net.Sockets.AddressFamily addressFamily, Uno.Net.Sockets.SocketType socketType, Uno.Net.Sockets.ProtocolType protocolType) :274
...
// private extern Socket New(Uno.Net.Sockets.Socket.SocketHandle handle, bool connected) :294
void Socket__New2_fn(int* handle, bool* connected, Socket** __retval)
{
    *__retval = Socket::New2(*handle, *connected);
}

// public bool Poll(int milliseconds, Uno.Net.Sockets.SelectMode mode) :467
...
// public void Shutdown(Uno.Net.Sockets.SocketShutdown how) :480
void Socket__Shutdown_fn(Socket* __this, int* how)
{
    __this->Shutdown(*how);
}

// private void UpdateRemoteEndPoint() :327
void Socket__UpdateRemoteEndPoint_fn(Socket* __this)
{
    __this->UpdateRemoteEndPoint();
}

// public Socket(Uno.Net.Sockets.AddressFamily addressFamily, Uno.Net.Sockets.SocketType socketType, Uno.Net.Sockets.ProtocolType protocolType) [instance] :274
...
// private extern Socket(Uno.Net.Sockets.Socket.SocketHandle handle, bool connected) [instance] :294
...
// public Uno.Net.Sockets.Socket Accept() [instance] :496
...
// public void Bind(Uno.Net.EndPoint endPoint) [instance] :429
...
// public void Close() [instance] :509
void Socket::Close()
{
...
// public void Connect(Uno.Net.EndPoint endPoint) [instance] :356
...
// public void Listen(int backlog) [instance] :456
...
// public bool Poll(int milliseconds, Uno.Net.Sockets.SelectMode mode) [instance] :467
...
// public void Shutdown(Uno.Net.Sockets.SocketShutdown how) [instance] :480
...
// private void UpdateRemoteEndPoint() [instance] :327
...
// public Socket New(Uno.Net.Sockets.AddressFamily addressFamily, Uno.Net.Sockets.SocketType socketType, Uno.Net.Sockets.ProtocolType protocolType) [static] :274
...
// private extern Socket New(Uno.Net.Sockets.Socket.SocketHandle handle, bool connected) [static] :294
...
// public static Uno.Net.Sockets.Socket.SocketHandle Accept(Uno.Net.Sockets.Socket.SocketHandle sock) :214
void SocketHelpers__Accept_fn(int* sock, int* __retval)
{
    *__retval = SocketHelpers::Accept(*sock);
}

// public static int Bind(Uno.Net.Sockets.Socket.SocketHandle sock, int family, byte[] address, long scopeId, int port) :169
...
// public static int Connect(Uno.Net.Sockets.Socket.SocketHandle sock, int family, byte[] address, long scopeId, int port) :143
...
// public static int Poll(Uno.Net.Sockets.Socket.SocketHandle sock, int milliseconds, Uno.Net.Sockets.SelectMode mode) :195
...
// public static extern int Shutdown(Uno.Net.Sockets.Socket.SocketHandle sock, int how) :242
void SocketHelpers__Shutdown_fn(int* sock, int* how, int* __retval)
{
    *__retval = SocketHelpers::Shutdown(*sock, *how);
}

// public static Uno.Net.Sockets.Socket.SocketHandle Accept(Uno.Net.Sockets.Socket.SocketHandle sock) [static] :214
...
// public static int Bind(Uno.Net.Sockets.Socket.SocketHandle sock, int family, byte[] address, long scopeId, int port) [static] :169
...
// public static int Connect(Uno.Net.Sockets.Socket.SocketHandle sock, int family, byte[] address, long scopeId, int port) [static] :143
...
// public static int Poll(Uno.Net.Sockets.Socket.SocketHandle sock, int milliseconds, Uno.Net.Sockets.SelectMode mode) [static] :195
...
// public static extern int Shutdown(Uno.Net.Sockets.Socket.SocketHandle sock, int how) [static] :242
