// This file was generated based on '../../../Local/Fusetools/Packages/Fuse.Preview.Core/0.1.0/SimulatorClient.uno'.
...
struct ISimulatorClient
{
    ...
    static void Send(const uInterface& __this, uObject* message) { __this.VTable<ISimulatorClient>()->fp_Send(__this, message); }
};
// }
