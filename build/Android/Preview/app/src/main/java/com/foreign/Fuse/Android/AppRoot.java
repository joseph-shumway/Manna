...
public class AppRoot
{
    ...
    {
        android.widget.FrameLayout frameLayout = new android.widget.FrameLayout(com.apps.manna.Manna.GetRootActivity()) {
        		...
        		public boolean onTouchEvent(android.view.MotionEvent motionEvent) {
        			...
        			ExternedBlockHost.callUno_Fuse_Android_AppRoot_OnTouchEvent__343((Object)motionEvent,UnoHelper.GetUnoObjectRef((Object)motionEvent));
